...
class JEMEtSumsCnv_p1 : public T_AthenaPoolTPCnvBase< JEMEtSums, JEMEtSums_p1 > {

public:
  JEMEtSumsCnv_p1() : m_JEMEtSumsCnv(0) {}

  virtual void persToTrans( const JEMEtSums_p1* persObj, JEMEtSums* transObj, MsgStream &log );
  virtual void transToPers( const JEMEtSums* transObj, JEMEtSums_p1* persObj, MsgStream &log );
