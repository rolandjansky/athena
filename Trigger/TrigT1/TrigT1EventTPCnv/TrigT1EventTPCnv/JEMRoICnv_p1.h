...
class JEMRoICnv_p1 : public T_AthenaPoolTPCnvBase< JEMRoI, JEMRoI_p1 > {

public:
  JEMRoICnv_p1() : m_JEMRoICnv(0) {}

  virtual void persToTrans( const JEMRoI_p1* persObj, JEMRoI* transObj, MsgStream &log );
  virtual void transToPers( const JEMRoI* transObj, JEMRoI_p1* persObj, MsgStream &log );
