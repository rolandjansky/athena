...
class CPMTobRoICnv_p1 : public T_AthenaPoolTPCnvBase< CPMTobRoI, CPMTobRoI_p1 > {

public:
  CPMTobRoICnv_p1() : m_CPMTobRoICnv(0) {}

  virtual void persToTrans( const CPMTobRoI_p1* persObj, CPMTobRoI* transObj, MsgStream &log );
  virtual void transToPers( const CPMTobRoI* transObj, CPMTobRoI_p1* persObj, MsgStream &log );
