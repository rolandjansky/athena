...
class JEMHitsCnv_p1 : public T_AthenaPoolTPCnvBase< JEMHits, JEMHits_p1 > {

public:
  JEMHitsCnv_p1() : m_JEMHitsCnv(0) {}

  virtual void persToTrans( const JEMHits_p1* persObj, JEMHits* transObj, MsgStream &log );
  virtual void transToPers( const JEMHits* transObj, JEMHits_p1* persObj, MsgStream &log );
