...
class CPMHitsCnv_p1 : public T_AthenaPoolTPCnvBase< CPMHits, CPMHits_p1 > {

public:
  CPMHitsCnv_p1() : m_CPMHitsCnv(0) {}

  virtual void persToTrans( const CPMHits_p1* persObj, CPMHits* transObj, MsgStream &log );
  virtual void transToPers( const CPMHits* transObj, CPMHits_p1* persObj, MsgStream &log );
