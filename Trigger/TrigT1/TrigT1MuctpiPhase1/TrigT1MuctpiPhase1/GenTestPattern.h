...
#ifndef TRIGT1MUCTPIPHASE1_GENTESTPATTERN_H
#define TRIGT1MUCTPIPHASE1_GENTESTPATTERN_H
...
namespace LVL1MUCTPIPHASE1 {
  ...
  public:
     ...
     * @see Lvl1MuCTPIInput
     */
    GenTestPattern( LVL1MUONIF::Lvl1MuCTPIInputPhase1* theLvl1Input );
    /**
     * Set the sector by hand. The internal sector list is not used here
     * but the sector is written to the Lvl1MuCTPIInputPhase1 directly. There
     ...
     * to the Lvl1MuCTPIInputPhase1 directly. There is no need to call
  ...
  private:
    ...
    LVL1MUONIF::Lvl1MuCTPIInputPhase1* m_input;
...
#endif // TRIGT1MUCTPIPHASE1_GENTESTPATTERN_H
