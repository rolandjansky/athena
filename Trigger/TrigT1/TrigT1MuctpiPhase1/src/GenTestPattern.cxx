...
#include "TrigT1MuctpiPhase1/EventID.h"
...
namespace LVL1MUCTPIPHASE1 {
  ...
  GenTestPattern::GenTestPattern( LVL1MUONIF::Lvl1MuCTPIInputPhase1* theLvl1Input ) {
  ...
  void GenTestPattern::fillSectorDirect( SectorID theSectorID, unsigned int bcid, unsigned int roi1, unsigned int roi2,
    ...
    LVL1MUONIF::Lvl1MuSectorLogicDataPhase1 *secIn = 0;
    if( systemAddress == 0 ) {
      secIn = new LVL1MUONIF::Lvl1MuBarrelSectorLogicDataPhase1();
    } else if( systemAddress == 1 ) {
      secIn = new LVL1MUONIF::Lvl1MuEndcapSectorLogicDataPhase1();
    } else if( systemAddress == 2 ) {
      secIn = new LVL1MUONIF::Lvl1MuForwardSectorLogicDataPhase1();
    } else {
