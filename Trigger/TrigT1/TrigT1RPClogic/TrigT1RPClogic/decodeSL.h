...
namespace TriggerRPC
{
    ...
    unsigned short int moreThan1_1(unsigned long int slword);
    unsigned short int moreThan1_2(unsigned long int slword);
    unsigned short int BunchXID(unsigned long int slword);
}
