///////////////////////////////////////////////////////////////////
// L1CPMTools.cxx, (c) Alan Watson (see header file for license)
///////////////////////////////////////////////////////////////////
...
void L1CPMTools::findCPMResults(const std::map<int, CPMTower*>* towers, int crate, int module,
...
void L1CPMTools::findCPMTobRoIs(const DataVector<CPMTower>* cpmts, DataVector<CPMTobRoI>* rois, int slice) {
...
void L1CPMTools::findCPMTobRoIs(const std::map<int, CPMTower*>* towers, DataVector<CPMTobRoI>* rois, int slice) {
...
void L1CPMTools::findRoIs(const DataVector<CPMTower>* cpmts, DataVector<CPMTobAlgorithm>* tobs, int slice){
...
void L1CPMTools::findRoIs(const std::map<int, CPMTower*>* towers, DataVector<CPMTobAlgorithm>* tobs, int slice){
...
void L1CPMTools::mapTowers(const DataVector<CPMTower>* cpmts, std::map<int, CPMTower*>* towers){
...
CPMTobAlgorithm L1CPMTools::findRoI(double RoIeta, double RoIphi, const std::map<int, CPMTower*>* towers, int slice) {
...
void L1CPMTools::formSums(double RoIeta, double RoIphi, const std::map<int, CPMTower*>* towers, int slice) {
...
void L1CPMTools::formSums(uint32_t roiWord, const std::map<int, CPMTower*>* towers, int slice) {
