///////////////////////////////////////////////////////////////////
// L1JEMJetTools.cxx, (c) Alan Watson (see header file for license)
///////////////////////////////////////////////////////////////////
...
void L1JEMJetTools::mapJetInputs(const DataVector<JetElement>* jes, std::map<int, JetInput*>* elements, int slice){
...
void L1JEMJetTools::findRoIs(const DataVector<JetElement>* jes, DataVector<JEMJetAlgorithm>* rois, int slice){
...
void L1JEMJetTools::findRoIs(const std::map<int, JetInput*>* elements, DataVector<JEMTobRoI>* rois){
...
void L1JEMJetTools::findRoIs(const DataVector<JetElement>* jes, DataVector<JEMTobRoI>* rois, int slice){
