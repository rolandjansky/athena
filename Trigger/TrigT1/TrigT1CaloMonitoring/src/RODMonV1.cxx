...
namespace LVL1 {
// ============================================================================
RODMonV1::RODMonV1(const std::string & type,
...
/*---------------------------------------------------------*/
StatusCode RODMonV1:: initialize()
/*---------------------------------------------------------*/
{
...
/*---------------------------------------------------------*/
StatusCode RODMonV1::fillHistograms()
/*---------------------------------------------------------*/
{
...
void RODMonV1::setLabelsStatus(LWHist* hist, bool xAxis)
{
...
void RODMonV1::setLabelsROBStatusGen(LWHist* hist, bool xAxis)
{
  LWHist::LWHistAxis* axis = (xAxis) ? hist->GetXaxis() : hist->GetYaxis();
...
void RODMonV1::setLabelsROBStatusSpec(LWHist* hist, bool xAxis)
{
  LWHist::LWHistAxis* axis = (xAxis) ? hist->GetXaxis() : hist->GetYaxis();
...
void RODMonV1::setLabelsEvtStatusSpec(LWHist* hist, bool xAxis)
{
  LWHist::LWHistAxis* axis = (xAxis) ? hist->GetXaxis() : hist->GetYaxis();
...
void RODMonV1::setLabelsUnpacking(LWHist* hist, bool xAxis)
{
  LWHist::LWHistAxis* axis = (xAxis) ? hist->GetXaxis() : hist->GetYaxis();
