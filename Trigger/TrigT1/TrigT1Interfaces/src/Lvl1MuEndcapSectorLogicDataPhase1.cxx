...
namespace LVL1MUONIF {
  ...
  Lvl1MuEndcapSectorLogicDataPhase1::Lvl1MuEndcapSectorLogicDataPhase1()
      : Lvl1MuSectorLogicDataPhase1() {
    m_id_system = 1;
    initialize();
  }

  Lvl1MuEndcapSectorLogicDataPhase1& Lvl1MuEndcapSectorLogicDataPhase1::operator=( const Lvl1MuSectorLogicDataPhase1& right ) {
  ...
  Lvl1MuSectorLogicDataPhase1::SectorLogicWord Lvl1MuEndcapSectorLogicDataPhase1::getWordFormat() const {
  ...
  const Lvl1MuSectorLogicDataPhase1& Lvl1MuEndcapSectorLogicDataPhase1::convertFromWordFormat( const SectorLogicWord& value ) {
  ...
  void Lvl1MuEndcapSectorLogicDataPhase1::printOut( std::ostream& out ) const {
