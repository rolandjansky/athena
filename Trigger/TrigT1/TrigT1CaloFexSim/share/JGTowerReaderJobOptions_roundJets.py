...
algseq += CfgMgr.JGTowerReader(                  # adds an instance of your alg to it
    ...
    towerMap = '/afs/cern.ch/user/c/ckaldero/trigger/L1Calo/L1CaloSim/source/athena/Trigger/TrigT1/TrigT1CaloFexSim/JetTowerLists/jFexJet_towerMap_2019-01-07.txt', 
    plotSeeds = True,
    gJet_threshold = 3,
    gSeed_size=0.4,
    gJet_r=1.0
