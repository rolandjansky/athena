...
class METAlg{
  ...
  static StatusCode RhoRMS_LUT(const xAOD::JGTowerContainer* towers, TString metName, float rhoA, float rhoB, float rhoC, TString lut_path, bool useOffline, bool useNegTowers);
