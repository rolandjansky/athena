...
def createJGTowerReader( SuperCellType = "SCell", **kwargs ) :
    ...
    towerReader = JGTowerReader( outputNoise = False, 
                                 ...
                                 noise_file = "Run3L1CaloSimulation/Noise/jTowergTowerNoise.20210304.r12406.root",
                                 jXERHO_correction_file = "Run3L1CaloSimulation/Noise/jTowerCorrection.20210308.r12406.root",
                                 plotSeeds = False,
                                 saveSeeds = True,
                                 dumpTowerInfo = False,
