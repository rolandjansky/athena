...
public:
  ...
  unsigned int numFexSlices() const { return m_numFexSlices; }
  unsigned int l1aFexSlice() const { return m_l1aFexSlice; }
  ...
  unsigned int readoutOffsetPh1Topo()  const { return m_readoutOffsetPh1Topo;}
  ...
  void setnumFexSlices(unsigned int numFexSlices) { m_numFexSlices = numFexSlices; }
  void setl1aFexSlice(unsigned int l1aFexSlice) { m_l1aFexSlice = l1aFexSlice; }
  ...
  void setinputReadoutModeFex(const std::string& inputReadoutModeFex) { m_inputReadoutModeFex = inputReadoutModeFex; }
  void setreadoutOffsetEfex(unsigned int readoutOffsetEfex) { m_readoutOffsetEfex = readoutOffsetEfex; }
  void setreadoutOffsetGfex(unsigned int readoutOffsetGfex) { m_readoutOffsetGfex = readoutOffsetGfex; }
  void setreadoutOffsetJfex(unsigned int readoutOffsetJfex) { m_readoutOffsetJfex = readoutOffsetJfex; }
  void setreadoutOffsetPh1Topo(unsigned int readoutOffsetPh1Topo) { m_readoutOffsetPh1Topo = readoutOffsetPh1Topo; }
...
private:
  ...
  unsigned int m_numFexSlices = 0;
  unsigned int m_l1aFexSlice = 0;
  ...
  unsigned int m_readoutOffsetEfex = 0;
  unsigned int m_readoutOffsetGfex = 0;
  unsigned int m_readoutOffsetJfex = 0;
  unsigned int m_readoutOffsetPh1Topo  = 0;
  


};

#endif // TRIGT1CALOCALIBCONDITIONS_L1CALOREADOUTCONFIGJSON_H
