...
namespace LVL1{
  class L1CaloCells2TriggerTowers : virtual public IL1CaloCells2TriggerTowers,public AthAlgTool{
    public:
    // constructor
      L1CaloCells2TriggerTowers(const std::string& type, const std::string& name, const IInterface* parent );
