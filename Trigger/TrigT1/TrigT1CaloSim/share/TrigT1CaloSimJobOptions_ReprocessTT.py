...
theApp.isOnline=False
from AthenaCommon.AppMgr import ServiceMgr as svcMgr
svcMgr.IOVDbSvc.OnlineMode           = False

from IOVDbSvc.CondDB import conddb

from TrigT1CaloSim.TrigT1CaloReprocessTTFlags import ReprocessTTFlags
...
conddb.addFolder("", "<dbConnection>frontier://ATLF/();schema=ATLAS_COOLOFL_TRIGGER;dbname=OFLP200</dbConnection>/TRIGGER/L1Calo/V2/Calibration/Physics/PprChanCalib<tag>"+ReprocessTTFlags.NoiseCutsDB()+"</tag>", force=True, forceMC=True)
conddb.addFolder("", "<dbConnection>frontier://ATLF/();schema=ATLAS_COOLOFL_TRIGGER;dbname=OFLP200</dbConnection>/TRIGGER/L1Calo/V2/Calibration/PpmDeadChannels<tag>V2-DEADCHANNELS-00-00</tag>", force=True, forceMC=True)
conddb.addFolder("", "<dbConnection>frontier://ATLF/();schema=ATLAS_COOLOFL_TRIGGER;dbname=OFLP200</dbConnection>/TRIGGER/L1Calo/V2/Configuration/PprChanDefaults<tag>V2-CHANDEFAULTS-00-00</tag>", force=True, forceMC=True)
conddb.addFolder("", "<dbConnection>frontier://ATLF/();schema=ATLAS_COOLOFL_TRIGGER;dbname=OFLP200</dbConnection>/TRIGGER/L1Calo/V2/Conditions/DisabledTowers<tag>V2-DISABLEDTOWERS-00-00</tag>", force=True, forceMC=True)
