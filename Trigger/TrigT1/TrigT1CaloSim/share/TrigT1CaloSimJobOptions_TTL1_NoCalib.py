...
#...
if useNoiseCuts and useAutocorrElement:
    # Em
...
if useNoiseCuts and useMatchedElement:
...
# Print Debug Info
log = logging.getLogger( "TrigT1CaloSimJobOptions_TTL1_NoCalib.py" )
...
log.info( "useNoiseCuts = "+str(useNoiseCuts) )
