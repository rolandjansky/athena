...
//
// Pure abstract base class interface to TriggerTowerTools
//

#ifndef _TRIGGER_TRIGT1_TRIGT1CALOCALIBTOOLINTERFACES_ITRIGGERTOWERTOOLS_H_
#define _TRIGGER_TRIGT1_TRIGT1CALOCALIBTOOLINTERFACES_ITRIGGERTOWERTOOLS_H_
...
namespace LVL1{
  ...
  static const InterfaceID IID_ITriggerTowerTools("LVL1::ITriggerTowerTools",1,0);

  class ITriggerTowerTools : virtual public IAlgTool{
    public:
      static const InterfaceID& interfaceID();

      virtual ~ITriggerTowerTools(){};
      ...
      // Database access
      virtual void                                       dbDump(const coral::AttributeList* attrList) = 0;
    ...
    protected:
      ...
      virtual double                                     refValue(const L1CaloCoolChannelId& channelId) const = 0;
      

  };

  inline const InterfaceID& ITriggerTowerTools::interfaceID(){
    return IID_ITriggerTowerTools;
  }
