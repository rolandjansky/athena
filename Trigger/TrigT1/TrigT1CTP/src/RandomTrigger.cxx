...
LVL1CTP::RandomTrigger::RandomTrigger(unsigned int rand_number, const unsigned int aRate, CLHEP::HepRandomEngine* randEng) :
   SpecialTrigger(TrigConf::L1DataDef::RNDM, rand_number, aRate),
