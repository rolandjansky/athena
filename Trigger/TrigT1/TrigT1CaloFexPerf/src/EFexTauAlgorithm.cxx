...
StatusCode
LVL1::EFexTauAlgorithm::getSuperCellsContainer(CaloConstCellContainer*& scells) const
{	
...
StatusCode
LVL1::EFexTauAlgorithm::getTriggerTowerContainer(const xAOD::TriggerTowerContainer*& TTs) const
{	
...
StatusCode
LVL1::EFexTauAlgorithm::getTileCalCellsContainer(const CaloConstCellContainer*& tileCells) const
{
...
void
LVL1::EFexTauAlgorithm::createCellList(const CaloConstCellContainer* scells, std::vector<const CaloCell*>& out) const
{
   out.clear();
...
float
LVL1::EFexTauAlgorithm::CaloCellET(const CaloCell* const &inputCell, float digitScale, float digitThreshold) const
{
...
LVL1::EFexTauAlgorithm::execute()
{
   ...
   if ( m_use_tileCells ) {
      ATH_CHECK(getTileCalCellsContainer(tileCellCon)); // currently no being used
   }
   else {
   ...
   std::vector<const CaloCell*> allSuperCells;
   ...
   for( auto myMaximum : localMaxima ) {
      ...
      SG::AuxElement::Accessor<float>("R3ClusterET")(*clForTau) = eFEXOldCluster;
      SG::AuxElement::Accessor<float>("R3_Ore_ClusterET")(*clForTau) = eFEX_OregonET;
      SG::AuxElement::Accessor<float>("R3_BC_ClusterET")(*clForTau) = eFEX_BC;
      SG::AuxElement::Accessor<float>("R3_BC_ClusterIso")(*clForTau) = denBCiso > 0 ? eFEX_BCiso : 0;
      SG::AuxElement::Accessor<float>("R3_Ore_ClusterIso")(*clForTau) = oreIsoOuterET > 0 ? eFEX_OregonIso : 0;

      SG::AuxElement::Accessor<bool>("R3_Ore_ClusterIso_12pass")(*clForTau) = eFEX_OregonIso_12pass;
      SG::AuxElement::Accessor<bool>("R3_Ore_ClusterIso_20pass")(*clForTau) = eFEX_OregonIso_20pass;

      SG::AuxElement::Accessor<bool>("R3_BC_ClusterIso_12pass")(*clForTau) = eFEX_BCiso_12pass;
      SG::AuxElement::Accessor<bool>("R3_BC_ClusterIso_20pass")(*clForTau) = eFEX_BCiso_20pass;

      SG::AuxElement::Accessor<float>("R3ClusterIso")(*clForTau) = denominator > 0 ? numerator/denominator : 0;
