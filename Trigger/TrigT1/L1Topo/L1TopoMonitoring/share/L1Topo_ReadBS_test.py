...
# L1Topo  Source IDs:
# The ModuleIDs are specified by the bitfield rmmmssss, where ssss is the Slink fibre number (four bits allowing values 0-15) and mmm is the L1Topo module number (three bits allowing values 0-7) and r is a one bit flag distingushing RoI fibres from DAQ fibres.
...
# svcMgr.ByteStreamAddressProviderSvc.TopoProcModuleID=[0x80,0x90]
# Test with DAQ modules - debugging only!
# svcMgr.ByteStreamAddressProviderSvc.TopoProcModuleID=[0x01,0x11]
