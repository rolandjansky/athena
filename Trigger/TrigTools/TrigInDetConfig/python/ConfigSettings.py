...
class _GlobalSettings() : 
    def __init__( self ) : 
        ...
        #self._signatureSuffix     = "" #Obsolete?  #To be used for name of output tracks
        self._roi                 = "" 
...
class _Settings_electron( _GlobalSettings ) : 
    def __init__( self ) : 
        ...
        #self._signatureSuffix     = "Electron" #To be used for name of output tracks
...
class _Settings_tauCore( _GlobalSettings ) : 
    def __init__( self ) : 
        ...
        #self._signatureSuffix     = "TauCore" #To be used for name of output tracks
...
class _Settings_tauIso( _GlobalSettings ) : 
    def __init__( self ) : 
        ...
        #self._signatureSuffix     = "TauIso" #To be used for name of output tracks
...
class _Settings_tauId( _GlobalSettings ): 
    def __init__( self ) : 
        ...
        #self._signatureSuffix     = "Tau" #To be used for name of output tracks
