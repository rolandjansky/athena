...
from ViewAlgs.ViewAlgsConf import MenuAlg, CopyPassing
activeRoIsAfterPrescaling = genMenuAlg("activeRoIsAfterPrescaling")
...
# caloRoIsAfterPrescaling = genMenuAlg("caloRoIsAfterPrescaling")
...
# muonRoIsAfterPrescaling = genMenuAlg("muonRoIsAfterPrescaling")
...
l2CaloStep = genMenuAlg("MenuL2CaloStep") #, [l2CaloHypo], [caloRoIsAfterPrescaling])
...
l2MuonStep = genMenuAlg("MenuL2MuonStep") #, [l2MuonHypo], [muonRoIsAfterPrescaling])
...
l2ComboStep = genMenuAlg("MenuStepL2Combo")
...
caloTrackingStep = genMenuAlg("MenuCaloTrackingStep")#, [CaloMatchingHypo], [l2CaloStep]) 
...
configureFromXML( "HLTTestMenu.xml", menu_ingredients)
