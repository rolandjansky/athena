...
int main() {
  ...
  void * rawStorePtr = static_cast<void*>( testContainer );

  RootType contaierRT = RootType::ByName( "xAOD::TrigCompositeContainer_v1" );  
  log << MSG::INFO << contaierRT.Name() << endmsg;
  BareDataBucket containerDataBucket( rawContainerPtr, 1, ClassID_traits<xAOD::TrigCompositeContainer>::ID(), contaierRT ); // size is ficticious in this test
