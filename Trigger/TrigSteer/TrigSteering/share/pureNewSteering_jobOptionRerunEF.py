...
from TrigSteering.TestingTrigSteeringConfig import TestingReruningTrigSteer_EF
TrigSteer_EF = TestingReruningTrigSteer_EF('TrigSteer_EF', hltFile="pureNewSteering_menu.xml")
TopAlg += TrigSteer_EF
