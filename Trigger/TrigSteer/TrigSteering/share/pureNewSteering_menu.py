...
from TrigSteeringTest.TrigSteeringTestConf import PESA__dummyAlgo, PESA__newDummyAlgo2To1, PESA__newDummyAlgoAllTEs, PESA__dummyHypo

# L2
# examsples below show all the posibilities of configuring Sequences
...
Hypo1 =  PESA__dummyHypo('Hypo1')
Hypo1.PreScale = 2

Hypo2 =  PESA__dummyHypo('Hypo2')
Hypo2.PreScale = 2

menu.addSequence("EM15i" , [ Egamma, Egamma2, "PESA::dummyAlgo/EgammaAdv3", Hypo1 ] , "em15i" )  # use bot here, mixing with old fassioned way
...
menu.addSequence("EM25i" , [defalgo, Hypo2], "em25i" )
...
# EF
Hypo3 = PESA__dummyHypo('Hypo3')
Hypo3.PreScale = 2

Hypo4 = PESA__dummyHypo('Hypo4')
Hypo4.PreScale = 2
...
menu.addSequence("em25i'" ,[ "PESA::dummyAlgo/electron_EF", Hypo3 ] ,"e25i" )
menu.addSequence("e25i" ,[ "PESA::dummyAlgo/electronAdv_EF", Hypo4 ]  ,"e25i'" )
...
# L2
chain = HLTChain( chain_name="em25i_L2", chain_counter="1", lower_chain_name="EM25i", level="L2", prescale="1", pass_through="1")
...
chain = HLTChain( chain_name="Z_EF", chain_counter="31", lower_chain_name="Z_L2", level="EF", prescale="1", pass_through="0")
...
chain = HLTChain( chain_name="H_EF", chain_counter="32", lower_chain_name="H_L2", level="EF", prescale="1", pass_through="0")
