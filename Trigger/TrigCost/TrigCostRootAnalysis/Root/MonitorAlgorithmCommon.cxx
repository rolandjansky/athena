...
namespace TrigCostRootAnalysis {
   ...
   * AlgsInEvent structs.
   */
  void MonitorAlgorithmCommon::getAllAlgsInEvent(Int_t _eventNumber, UInt_t _level, const TrigCostData* _costData) {
    // Nothing has changed, current list is fine
    if (m_eventNumber == _eventNumber && m_level == _level) return;
