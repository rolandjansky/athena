 ...
 *			searchButton	:	Set to true if the script is to add a search button and a clear button. Searches are only run when the search button is clicked
 *
...
(function(){
	...
	$.fn.columnFilters = function(settings) {
		...
		return this.each(function() {
		    ...
		    if(settings.searchButton){
			$('thead', obj).append('<button id="searchButn">Search</button>');
			$('thead', obj).append('<button id="clearButn">Clear</button>');
		    }	
