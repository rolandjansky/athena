...
if __name__ == "__main__":
    ...
    #    
    import TrigCostRate.TrigCostRateConfig as TrigROSConfig
    
    p = TrigROSConfig.prepareRatesParser()
    ...
    run = TrigROSConfig.prepareROSConfig(options, args)
    ...
    #
    TrigROSConfig.doAfterExecWork(options, args, run)
