...
EFMissingETFromHelperMT::~EFMissingETFromHelperMT()
{
}



StatusCode EFMissingETFromHelperMT::initialize()
{
  ATH_MSG_DEBUG( "called EFMissingETFromHelperMT::initialize()" );
...
StatusCode EFMissingETFromHelperMT::finalize()
{
  return StatusCode::SUCCESS;
}
