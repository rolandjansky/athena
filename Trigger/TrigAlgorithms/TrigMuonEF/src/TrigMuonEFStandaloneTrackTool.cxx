...
if (m_useMdtData>0) {
  if ( muonRoI ) {
	...
	if (select) {
	  //unsigned int   ah = (*it);
	  //std::cout<<"selected hash id "<<ah<<std::endl;
	  mdt_hash_ids.push_back((*it));
	}
	//                 else
	//                 {
	//                     //unsigned int   ah = (*it);
	//                     //std::cout<<"NOT                selected hash id "<<ah<<std::endl;
	//                 }
      }
      ...
      //std::cout<<" mdt_hash_ids = to temporary one "<<std::endl;
