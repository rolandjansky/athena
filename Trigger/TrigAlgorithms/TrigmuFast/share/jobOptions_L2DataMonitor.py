...
FakeLvl1ConversionTestBeam_L2.MUONROIroiNumber=10
#FakeLvl1ConversionTestBeam_L2.OutputLevel = FATAL

TriggerConfig.sequenceListFileLocation = "L2DataMonOnlineSeq.xml" 
...
DataMonitor = Algorithm ( "DataMonitor_l2_L2" )
...
#DataMonitor.OutputLevel = FATAL

DataMonitor.MUlvl1INFO = TRUE

DataMonitor.SectorId = 31;

DataMonitor.TestbeamRun = TRUE
