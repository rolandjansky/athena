...
#ifndef PHYSICS_MU_RPCTRIGTB_H
#define PHYSICS_MU_RPCTRIGTB_H
...
class RpcTrigTB: public RpcTrigStd {
  
public:
    RpcTrigTB(MuMessageInterface& msg,
...
inline std::string
RpcTrigTB::name(void) const
{
    return s_name;
}


#endif // PHYSICS_MU_RPCTRIGTB_H
