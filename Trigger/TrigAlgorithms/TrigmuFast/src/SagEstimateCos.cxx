...
const string SagEstimateCos::s_name = "Sagitta computing";

SagEstimateCos::SagEstimateCos(MuMessageInterface& msg,
...
SagEstimateCos::~SagEstimateCos(void)
{
}

bool
SagEstimateCos::run(MuonFeatureDetails* det)
{
    int nit,nitmx=10;
