...
//**********************************************************************
TriggerJetGroomerToolMT::TriggerJetGroomerToolMT(const std::string& name): 
...
StatusCode TriggerJetGroomerToolMT::initialize() {

  ATH_MSG_INFO("Initializing TriggerJetGroomerToolMT " << name() << ".");
...
StatusCode TriggerJetGroomerToolMT::finalize() {
...
JetContainer*
TriggerJetGroomerToolMT::groom(const JetContainer* in,
                               const PseudoJetContainer& pjContainer) const {
