...
def TrackCountMonitoring():
    ...
    for i in range(len(alg.min_pt)):
        monTool.defineHistogram('counts_minpTcut={}_maxZ0cut={}'.format(alg.min_pt[i],alg.max_z0[i]), path='EXPERT', type='TH1I', title='counts for min pT and max z0 cut',xbins=100, xmin=-0.5, xmax=4999.5)
    return monTool
