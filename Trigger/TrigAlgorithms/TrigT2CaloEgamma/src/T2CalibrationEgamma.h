...
#ifndef TRIGT2CALOEGAMMA_T2CALIBRATIONEGAMMA
#define TRIGT2CALOEGAMMA_T2CALIBRATIONEGAMMA
#include <vector>
#include <math.h>
#include "TrigT2CaloCommon/T2Calibration.h"

class T2CalibrationEgamma : public T2Calibration {
public:
	T2CalibrationEgamma() : T2Calibration(){}
	~T2CalibrationEgamma(){}
