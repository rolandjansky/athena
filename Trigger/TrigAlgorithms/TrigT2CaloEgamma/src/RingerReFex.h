...
class RingerReFex : public IReAlgToolCalo
{
  ...
  private:
    ...
    SG::WriteHandleKey<xAOD::TrigRingerRingsContainer> m_ringerDummyContainerKey {this, "RingerDummyKey", "HLT_FastCaloDummyRinger", "TrigRingerRings dummy container key"};
