...
class TrigmuIsoOnlineMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="muIso_Online"):
        ...
        self.Histograms += [ defineHistogram('StrategyMI', type='TH1F', title="MuIso Reconstruction Strategy; Strategy Code", xbins=6, xmin=-1.5, xmax=4.5) ]
        self.Histograms += [ defineHistogram('CALOiso', type='TH1F', title="MuIso SumEt in calo;E [GeV]; nevents", xbins=200, xmin=-4., xmax=15.) ]
