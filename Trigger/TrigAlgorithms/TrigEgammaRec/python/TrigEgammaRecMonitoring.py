...
class TrigEgammaRecValidationMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="TrigEgammaRecValidationMonitoring"):
        ...
        self.Histograms += [ defineHistogram('ClusterEt', 	type='TH1F', title="EFEgamma Hypo Cluster E_{T}; E_{T}^{em} [MeV]",
        ...
        self.Histograms += [ defineHistogram('Eoverp', 	type='TH1F', title="EFEgamma Hypo Et/Pt; Eoverp",
        ...
        self.Histograms += [ defineHistogram('F1', 	type='TH1F', title="EFEgamma Hypo fraction of energy found in 1st em sampling;Fraction",
                                             xbins=50, xmin=-0.1, xmax=1.1 ) ]

        self.Histograms += [ defineHistogram('E237', 	type='TH1F', title="EFEgamma Hypo uncor energy in 3x7 cells in em sampling 2; E [MeV]",
                                             xbins=50, xmin=-15000, xmax=150000 ) ]

        self.Histograms += [ defineHistogram('E277', 	type='TH1F', title="EFEgamma Hypo uncor energy in 7x7 cells in em sampling 2;E [MeV]",
                                             xbins=50, xmin=-15000, xmax=150000 ) ]

        self.Histograms += [ defineHistogram('EtHad1', 	type='TH1F', title="EFEgamma Hypo E leakage into 1st sampling of had calo; E [MeV]",
                                             xbins=50, xmin=-15000, xmax=150000 ) ]

        self.Histograms += [ defineHistogram('WEta1', 	type='TH1F', title="EFEgamma Hypo corrected width in 3 strips in the 1st samp. ; Width",
                                             xbins=20, xmin=0, xmax=1 ) ]

        self.Histograms += [ defineHistogram('WEta2', 	type='TH1F', title="EFEgamma  Hypo corrected width in 3 strips in the 2st samp. ; Width",
                                             xbins=20, xmin=0, xmax=0.05 ) ]

        self.Histograms += [ defineHistogram('E2tsts1', 	type='TH1F', title="EFEgamma Hypo 2nd maximum in strips; E [MeV]",
                                             xbins=50, xmin=-1000, xmax=5000 ) ]

        self.Histograms += [ defineHistogram('Emins1', 	type='TH1F', title="EFEgamma Hypo energy of strip with minimum between max 1 & 2; E [MeV]",
                                             xbins=50, xmin=-1000, xmax=5000 ) ]

        self.Histograms += [ defineHistogram('Fracs1', 	type='TH1F', title="EFEgamma Hypo energy outside core (E(+-7)-E(+-3))/E(+-7); E [MeV]",
                                             xbins=50, xmin=-5000, xmax=10000 ) ]

        self.Histograms += [ defineHistogram('wtots1', 	type='TH1F', title="EFEgamma Hypo total width in em sampling 1 in 20 strips; Width",
                                             xbins=20, xmin=0, xmax=20 ) ]

        self.Histograms += [ defineHistogram('EtConeIso', 	type='TH1F', title="EFEgamma Hypo fraction of Et in a ring of 0.1<DR<0.20 above noise to total Et; Fraction",
        ...
        self.Histograms += [ defineHistogram('Ph_e2tsts1', 	type='TH1F', title="EF Photon Hypo 2nd maximum in strips; E [MeV]",
                                             xbins=50, xmin=-1000, xmax=5000 ) ]
