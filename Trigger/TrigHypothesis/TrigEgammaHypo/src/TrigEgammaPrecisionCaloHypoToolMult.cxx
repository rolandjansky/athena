...
TrigEgammaPrecisionCaloHypoToolMult::TrigEgammaPrecisionCaloHypoToolMult( const std::string& type, 
						const std::string& name, 
						const IInterface* parent )
  : base_class( type, name, parent ),
    m_decisionId( HLT::Identifier::fromToolName( name ) ) {}

TrigEgammaPrecisionCaloHypoToolMult::~TrigEgammaPrecisionCaloHypoToolMult() {}

StatusCode TrigEgammaPrecisionCaloHypoToolMult::initialize() {
...
StatusCode TrigEgammaPrecisionCaloHypoToolMult::decide( std::vector<ITrigEgammaPrecisionCaloHypoTool::ClusterInfo>& input )  const {
