...
TrigEgammaPrecisionPhotonHypoAlg::TrigEgammaPrecisionPhotonHypoAlg( const std::string& name,  
                                                                        ISvcLocator* pSvcLocator ) :
  ::HypoBase( name, pSvcLocator ) {}


StatusCode TrigEgammaPrecisionPhotonHypoAlg::initialize() 
{
...
StatusCode TrigEgammaPrecisionPhotonHypoAlg::execute( const EventContext& context ) const 
{  
