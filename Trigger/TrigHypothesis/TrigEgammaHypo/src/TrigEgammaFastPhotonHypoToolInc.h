...
*/
#ifndef TRIGEGAMMAHYPO_TrigEgammaFastPhotonHypoToolInc_H
#define TRIGEGAMMAHYPO_TrigEgammaFastPhotonHypoToolInc_H 1
...
class TrigEgammaFastPhotonHypoToolInc : virtual public ::AthAlgTool
{ 
  public: 
    TrigEgammaFastPhotonHypoToolInc( const std::string& type, 
