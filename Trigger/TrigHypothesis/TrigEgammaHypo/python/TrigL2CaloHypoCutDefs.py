...
class L2CaloPhotonCutMaps():
    def __init__(self):
        self.MapsHADETthr = {
                'loose':   [0.091, 0.0828, 0.0952, 0.0795, 0.0719, 0.0783, 0.0955, 0.0924, 0.0713],
                'medium':  [0.091, 0.0828, 0.0952, 0.0795, 0.0719, 0.0783, 0.0955, 0.0924, 0.0713],
                'tight':   [0.091, 0.0828, 0.0952, 0.0795, 0.0719, 0.0783, 0.0955, 0.0924, 0.0713],
            }
        self.MapsCARCOREthr = {
                'loose':   [0.8852, 0.8676, 0.8785, 0.8588, 0.8588, 0.8599, 0.8898, 0.8579, 0.8659],
                'medium':  [0.8852, 0.8676, 0.8785, 0.8588, 0.8588, 0.8599, 0.8898, 0.8579, 0.8659],
                'tight':   [0.8852, 0.8676, 0.8785, 0.8588, 0.8588, 0.8599, 0.8898, 0.8579, 0.8659],
            }
        self.MapsCAERATIOthr = {
                'loose':   [-999., -999., -999., -999., -999., -999., -999., -999., -999.],
                'medium':  [0.4655, 0.4014, 0.4091, 0.39, 0.4249, 0.4842, 0.205, 0.3927, 0.415],
                'tight':   [0.4655, 0.4014, 0.4091, 0.39, 0.4249, 0.4842, 0.205, 0.3927, 0.415],
            }
