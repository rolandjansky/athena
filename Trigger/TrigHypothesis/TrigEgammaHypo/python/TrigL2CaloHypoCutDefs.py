...
class L2CaloPhotonCutMaps():
    def __init__(self):
        ...
        self.MapsHADETthr = {
                'loose':   [0.0588, 0.0564, 0.054, 0.048, 0.0297, 0.06, 0.06, 0.06, 0.054],
                'medium':  [0.0588, 0.0564, 0.054, 0.048, 0.0297, 0.06, 0.06, 0.06, 0.054],
                'tight':   [0.0588, 0.0564, 0.054, 0.048, 0.0297, 0.06, 0.06, 0.06, 0.054],
            }
        self.MapsCARCOREthr = {
                'loose':   [0.7112, 0.6968, 0.6952, 0.6864, 0.5976, 0.6616, 0.704 , 0.7008, 0.696],
                'medium':  [0.7112, 0.6968, 0.6952, 0.6864, 0.5976, 0.6616, 0.704 , 0.7008, 0.696],
                'tight':   [0.7112, 0.6968, 0.6952, 0.6864, 0.5976, 0.6616, 0.704 , 0.7008, 0.696],
            }
        self.MapsCAERATIOthr = {
                'loose':   [-999., -999., -999., -999., -999., -999., -999., -999., -999.],
