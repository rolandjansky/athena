...
# FileName updated to Run-3 naming conventions
# Same for Class name and CutMaps name

from AthenaCommon.Logging import logging
log_trigegFast = logging.getLogger( 'TrigFastCaloCutMaps' )
class TrigFastCaloElectronCutMaps():
