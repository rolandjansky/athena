...
#ifndef TRIG_TRIGMUONEFEXTRAPOLATORMULTIHYPO_H
#define TRIG_TRIGMUONEFEXTRAPOLATORMULTIHYPO_H
...
class TrigMuonEFExtrapolatorMultiHypo: public HLT::HypoAlgo {
      enum { MaxNumberTools = 20 };  
   public:
      TrigMuonEFExtrapolatorMultiHypo(const std::string & name, ISvcLocator* pSvcLocator);
      ~TrigMuonEFExtrapolatorMultiHypo();
