...
class TrigHLTJetHypoValidationMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="HLTJetHypo_Validation"):
        super(TrigHLTJetHypoValidationMonitoring, self).__init__(name)
...
class TrigHLTJetHypoOnlineMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="HLTJetHypo_Online"):
        """ defines histograms for online """
        super(TrigHLTJetHypoOnlineMonitoring, self).__init__(name)
...
class TrigHLTJetHypoCosmicMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="HLTJetHypo_Cosmic"):
        """ defines histograms for cosmic """
        super(TrigHLTJetHypoCosmicMonitoring, self).__init__(name)
