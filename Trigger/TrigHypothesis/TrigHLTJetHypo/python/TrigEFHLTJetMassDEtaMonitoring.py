...
class TrigEFHLTJetMassDEtaValidationMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="TrigEFHLTJetMassDEtaValidationMonitoring"):
        super(TrigEFHLTJetMassDEtaValidationMonitoring, self).__init__(name)
...
class TrigEFHLTJetMassDEtaOnlineMonitoring(TrigGenericMonitoringToolConfig):
    def __init__ (self, name="TrigEFHLTJetMassDEtaOnlineMonitoring"):
        """ defines histograms for online """
        super(TrigEFHLTJetMassDEtaOnlineMonitoring, self).__init__(name)
