 ...
 *                     
 *********************************************************************/
#ifndef TRIGEFHLTHTHYPO_H
#define TRIGEFHLTHTHYPO_H
...
class TrigEFHLTHTHypo : public HLT::HypoAlgo {

 public:

  TrigEFHLTHTHypo(const std::string& name, ISvcLocator* pSvcLocator);
  ~TrigEFHLTHTHypo();
