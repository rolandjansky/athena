 ...
 *
 *********************************************************************/
#ifndef TRIGEFHLTJETHYPO_H
#define TRIGEFHLTJETHYPO_H
...
class TrigEFHLTJetHypo : public HLT::HypoAlgo {

 public:

  TrigEFHLTJetHypo(const std::string& name, ISvcLocator* pSvcLocator);
  ~TrigEFHLTJetHypo();
