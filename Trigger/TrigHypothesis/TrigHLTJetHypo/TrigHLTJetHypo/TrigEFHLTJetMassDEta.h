 ...
 *
 *********************************************************************/
#ifndef TRIGEFHLTJETMASSDETA_H
#define TRIGEFHLTJETMASSDETA_H
...
class TrigEFHLTJetMassDEta : public HLT::HypoAlgo {

 public:

  TrigEFHLTJetMassDEta(const std::string& name, ISvcLocator* pSvcLocator);
  ~TrigEFHLTJetMassDEta();
