...
def TrigDisappearingTrackTriggerHypoToolFromDict( chainDict ):
    ...
    monTool.defineHistogram('pix4_sct0_n_pix',     type='TH1F', path='EXPERT', title="Pix4Sct0 N Pixel hits;N Pixel hits;Nevents", xbins=10, xmin=0, xmax=10) 
    ...
    monTool.defineHistogram('pix4_sct0_n_bl',      type='TH1F', path='EXPERT', title="Pix4Sct0 N B-layer hits;N B-layer hits;Nevents", xbins=10, xmin=0, xmax=10) 
    ...
    monTool.defineHistogram('pix4_sct1p_n_sct',     type='TH1F', path='EXPERT', title="Pix4Sct1p N SCT hits;N SCT hits;Nevents", xbins=20, xmin=0, xmax=20) 
    ...
    monTool.defineHistogram('pix4_sct1p_n_pix',     type='TH1F', path='EXPERT', title="Pix4Sct1p N Pixel hits;N Pixel hits;Nevents", xbins=10, xmin=0, xmax=10) 
    ...
    monTool.defineHistogram('pix3_sct0_n_pix',     type='TH1F', path='EXPERT', title="Pix3Sct0 N Pixel hits;N Pixel hits;Nevents", xbins=10, xmin=0, xmax=10) 
    monTool.defineHistogram('pix3_sct0_n_bl',      type='TH1F', path='EXPERT', title="Pix3Sct0 N B-layer hits;N B-layer hits;Nevents", xbins=4, xmin=0, xmax=4) 
    ...
    monTool.defineHistogram('pix3_sct1p_n_pix',     type='TH1F', path='EXPERT', title="Pix3Sct1p N Pixel hits;N Pixel hits;Nevents", xbins=10, xmin=0, xmax=10) 
    monTool.defineHistogram('pix3_sct1p_n_sct',     type='TH1F', path='EXPERT', title="Pix3Sct1p N SCT hits;N SCT hits;Nevents", xbins=10, xmin=0, xmax=10) 
    monTool.defineHistogram('pix3_sct1p_n_bl',      type='TH1F', path='EXPERT', title="Pix3Sct1p N B-layer hits;N B-layer hits;Nevents", xbins=4, xmin=0, xmax=4) 
