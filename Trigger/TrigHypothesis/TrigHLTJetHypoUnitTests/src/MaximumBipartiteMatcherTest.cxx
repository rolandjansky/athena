...
class MaximumBipartiteMatcherTest: public ::testing::Test {
public:
  MaximumBipartiteMatcherTest() {
...
TEST_F(MaximumBipartiteMatcherTest, zeroInputJets){
  /* test with 0 jets - fails, no passed for failed jets */

  HypoJetVector jets;
  MaximumBipartiteMatcher matcher(m_conditions, m_name);
...
TEST_F(MaximumBipartiteMatcherTest, tooFewSelectedJets){
...
TEST_F(MaximumBipartiteMatcherTest, oneSelectedJet){
...
TEST_F(MaximumBipartiteMatcherTest, twoSelectedJets){
...
TEST_F(MaximumBipartiteMatcherTest, threeSelectedJets){
...
TEST_F(MaximumBipartiteMatcherTest, fourSelectedJets){
...
TEST_F(MaximumBipartiteMatcherTest, overlappingEtaRegions){
  /* 4 jets over repsective thresholds - check good/bad jet list, pass.
     Expect no failed jets (alg stops on success) and no checks on the
     unused jet*/
