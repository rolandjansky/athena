        ...
        m_ldTrkPt(0.0)
{
  ...
  declareProperty("SumPtRatioMax1P", mp_sumPtRatio_1PCut = 9999.9 );//disabled by default

  /** cut on ratio of sumPt in isolation to core, MP */
  declareProperty("SumPtRatioMaxMP", mp_sumPtRatio_MPCut = 9999.9 );//disabled by default
...
// ----------------------------------------------------------------------
{
  ...
  m_sumPtRatio_MPCut = mp_sumPtRatio_MPCut.value();
  m_sumPtRatio_1PCut = mp_sumPtRatio_1PCut.value();
