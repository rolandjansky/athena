...
TrigL2TauCaloHypoAlgMT::TrigL2TauCaloHypoAlgMT( const std::string& name, 
				      ISvcLocator* pSvcLocator ) :
  ::HypoBase( name, pSvcLocator ) {}

TrigL2TauCaloHypoAlgMT::~TrigL2TauCaloHypoAlgMT() {}

StatusCode TrigL2TauCaloHypoAlgMT::initialize() {
...
StatusCode TrigL2TauCaloHypoAlgMT::finalize() {   
  return StatusCode::SUCCESS;
}
...
StatusCode TrigL2TauCaloHypoAlgMT::execute_r( const EventContext& context ) const {  
  ...
  // input for decision
  std::vector<ITrigL2TauCaloHypoTool::ClusterInfo> toolInput;
