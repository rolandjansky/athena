...
class TrigL2CaloRingerCutDefs:
  ...
  def __init__(self, threshold, IDinfo, trigType):
    ...
    #self._CalibFile = EgammaSliceFlags.ringerVersion()
    #self._logger.info('TrigMultiVarHypo version: %s',self._CalibFile)
    #self._CalibFile           = 'TrigMultiVarHypo/mc15_20170211'
