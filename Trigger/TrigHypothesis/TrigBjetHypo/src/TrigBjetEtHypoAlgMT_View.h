...
*/
#ifndef TRIGBJETHYPO_TRIGBJETETHYPOALGMT_VIEW_H
#define TRIGBJETHYPO_TRIGBJETETHYPOALGMT_VIEW_H 1
...
class TrigBjetEtHypoAlgMT_View : public ::HypoBase { 
 public: 

  TrigBjetEtHypoAlgMT_View( const std::string& name, ISvcLocator* pSvcLocator );

  virtual ~TrigBjetEtHypoAlgMT_View(); 
