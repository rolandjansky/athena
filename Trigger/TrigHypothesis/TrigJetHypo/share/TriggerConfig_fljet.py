#configuration file for fljet signature
include.block("TrigJetHypo/TriggerConfig_fljet.py")

l2chain = HLTChain( chain_name="fljet_L2", chain_counter="1", lower_chain_name="L1_FJ30", level="L2", prescale="1", pass_through="1")
l2chain.addTriggerTypeBit(1)
l2chain.addStreamTag("jets")


efchain = HLTChain( chain_name="fljet_EF", chain_counter="1", lower_chain_name="fljet_L2", level="EF", prescale="1", pass_through="1")
...
if TriggerFlags.JetSlice.doL2Calo():
    ...
    t2JetHypo=TriggerConfig_L2_TrigJetHypo("L2","fljet") 

   TE = triggerPythonConfig.addSequence( TE, appendLevel(
        [ t2caloJet.classAndInstanceName()[0], t2JetHypo.classAndInstanceName()[0]], "L2"), "L2_fljet" )
...
if TriggerFlags.JetSlice.doEFCalo():
   ...
   trigJetHypo =TriggerConfig_TrigJetHypo("EF","fljet") 
   sequence+=trigJetHypo.classAndInstanceName()

   TE = triggerPythonConfig.addSequence( TE, appendLevel(sequence,"EF"), "EF_fljet")
