...
#ifndef TRIGL2HTALLTE_H
#define TRIGL2HTALLTE_H
/////////////////////////////////////////////////////////////////////////////////////////////////////
/// Name    : TrigL2HTAllTE.h
...
class TrigL2HTAllTE : public HLT::AllTEAlgo {

 public:

  TrigL2HTAllTE(const std::string& name, ISvcLocator* pSvcLocator);
  ~TrigL2HTAllTE();
