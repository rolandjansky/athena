...
/**************************************************************************
**
**   File: Trigger/TrigHypothesis/TrigBPhysHypo/TrigEFBMuMuXHypo_xAOD.cxx
**
...
TrigEFBMuMuXHypo_xAOD::TrigEFBMuMuXHypo_xAOD(const std::string & name, ISvcLocator* pSvcLocator):
...
TrigEFBMuMuXHypo_xAOD::~TrigEFBMuMuXHypo_xAOD()
{ }

HLT::ErrorCode TrigEFBMuMuXHypo_xAOD::hltInitialize()
{
  msg() << MSG::INFO << "Running TrigEFBMuMuXHypo_xAOD::hltInitialize" << endreq;
...
HLT::ErrorCode TrigEFBMuMuXHypo_xAOD::hltFinalize()
{

  msg() << MSG::INFO << "Running TrigEFBMuMuXHypo_xAOD::hltFinalize" << endreq;
  MsgStream log(msgSvc(), name());

  msg() << MSG::INFO << "|----------------------- SUMMARY FROM TrigEFBMuMuXHypo_xAOD -------------|" << endreq;
...
HLT::ErrorCode TrigEFBMuMuXHypo_xAOD::hltExecute(const HLT::TriggerElement* outputTE, bool& pass)
{
  
  if ( msgLvl() <= MSG::DEBUG )
    msg() << MSG::DEBUG << "Running TrigEFBMuMuXHypo_xAOD::hltExecute" << endreq;
