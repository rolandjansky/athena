...
/*------------------------------------------------------------------------------------*/
TrigEFBgammaXFex::TrigEFBgammaXFex(const std::string & name, ISvcLocator* pSvcLocator):
...
/*-------------------------------------------*/
TrigEFBgammaXFex::~TrigEFBgammaXFex()
/*-------------------------------------------*/
{
...
/*-------------------------------------------*/
HLT::ErrorCode TrigEFBgammaXFex::hltInitialize()
/*-------------------------------------------*/
{
...
/*-------------------------------------------*/
HLT::ErrorCode TrigEFBgammaXFex::hltFinalize()
/*-------------------------------------------*/
{
...
/*--------------------------------------------------------------*/
HLT::ErrorCode TrigEFBgammaXFex::acceptInput(const HLT::TriggerElement* inputTE, bool& pass)
/*--------------------------------------------------------------*/
{
  bool result = false;
...
// get RoI descriptor
  ...
  if (msgLvl() <= MSG::DEBUG) msg() << MSG::DEBUG << " In EFBgammaXFEX acceptInput" << endreq;
...
/*--------------------------------------------------------------*/
HLT::ErrorCode TrigEFBgammaXFex::hltExecute(const HLT::TriggerElement* /* inputTE */, HLT::TriggerElement* outputTE)
/*--------------------------------------------------------------*/
{
     if (msgLvl() <= MSG::DEBUG) msg() << MSG::DEBUG << " In EFBgammaXFEX hltExecute" << endreq;
...
/*-------------------------------------------*/
bool TrigEFBgammaXFex::PassTrackPair(const Trk::Perigee* trckPerigee1, const Trk::Perigee* trckPerigee2)
/*-------------------------------------------*/
{
  bool passed=false;
