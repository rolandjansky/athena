...
/**************************************************************************
 **
 **   File: Trigger/TrigHypothesis/TrigBPhysHypo/TrigEFBMuMuXFex_xAOD.cxx
 **
...
/*----------------------------------------------------------------------------*/
TrigEFBMuMuXFex_xAOD::TrigEFBMuMuXFex_xAOD(const std::string & name, ISvcLocator* pSvcLocator):
HLT::ComboAlgo(name, pSvcLocator),
m_fitterSvc("Trk::TrkVKalVrtFitter/VertexFitterTool",this),
//m_trigBphysColl_b(NULL),
//m_trigBphysColl_X(NULL),
m_xAODTrigBphysColl_b(NULL),
m_xAODTrigBphysColl_X(NULL)
...
/*----------------------------------------------------------------------------*/
TrigEFBMuMuXFex_xAOD::~TrigEFBMuMuXFex_xAOD()
{ }


/*----------------------------------------------------------------------------*/
HLT::ErrorCode TrigEFBMuMuXFex_xAOD::hltInitialize()
{
    msg() << MSG::INFO << "Running TrigEFBMuMuXFex_xAOD::hltInitialize" << endreq;
...
/*----------------------------------------------------------------------------*/
HLT::ErrorCode TrigEFBMuMuXFex_xAOD::hltFinalize()
{
    
    msg() << MSG::INFO << "Running TrigEFBMuMuXFex_xAOD::hltFinalize" << endreq;
    
    msg() << MSG::INFO << "|----------------------- SUMMARY FROM TrigEFBMuMuXFex_xAOD -------------|" << endreq;
...
/*----------------------------------------------------------------------------*/
HLT::ErrorCode TrigEFBMuMuXFex_xAOD::acceptInputs(HLT::TEConstVec& , bool& pass)
{
    if ( msgLvl() <= MSG::DEBUG )
        msg() << MSG::DEBUG << "Running TrigEFBMuMuXFex_xAOD::acceptInputs" << endreq;
...
/*----------------------------------------------------------------------------*/
HLT::ErrorCode TrigEFBMuMuXFex_xAOD::hltExecute(HLT::TEConstVec& inputTE, HLT::TriggerElement*  outputTE )
{
    if ( msgLvl() <= MSG::DEBUG )
        msg() << MSG::DEBUG << "Running TrigEFBMuMuXFex_xAOD::hltExecute" << endreq;
    ...
    m_xAODTrigBphysColl_b = new xAOD::TrigBphysContainer();
    xAOD::TrigBphysAuxContainer xAODTrigBphysAuxColl_b;
    m_xAODTrigBphysColl_b->setStore(&xAODTrigBphysAuxColl_b);
    
    m_xAODTrigBphysColl_X = new xAOD::TrigBphysContainer();
    xAOD::TrigBphysAuxContainer xAODTrigBphysAuxColl_X;
    m_xAODTrigBphysColl_X->setStore(&xAODTrigBphysAuxColl_X);
    ...
    if( !(muidIDtracks1.size()> 0 && muidIDtracks2.size() > 0) )
    {
        ...
        delete m_xAODTrigBphysColl_b;
        delete m_xAODTrigBphysColl_X;
        m_xAODTrigBphysColl_b = 0;
        m_xAODTrigBphysColl_X = 0;
        if ( timerSvc() ) m_TotTimer->stop();
        return HLT::OK;
    } else {
                    ...
                    for (int itrk1=0 ; trkIt1 != lastTrkIt; itrk1++, trkIt1++)
                    {
                        ...
                        if(m_doB_KMuMuDecay) {
                            ...
                            if (trigPartBplusMuMuKplus) {
                                ...
                                m_xAODTrigBphysColl_b->push_back( xaodObj );
                        ...
                        if( nTriedCombinations > m_maxNcombinations ) {
                            ...
                            ATH_MSG(DEBUG) << "  Bphys Collection size is " << m_xAODTrigBphysColl_b->size() << endreq;
                            if(m_xAODTrigBphysColl_b->size() > 0)
                            ...
                            if(m_doBd_KstarMuMuDecay || m_doBs_Phi1020MuMuDecay || m_doLb_LambdaMuMuDecay || m_doBc_DsMuMuDecay) {
                                ...
                                if(m_doBd_KstarMuMuDecay) {
                                    ...
                                    if (trigPartBdMuMuKstar) {
                                        ...
                                        m_xAODTrigBphysColl_b->push_back( xaod_trigPartBdMuMuKstar );
                                        ...
                                        m_xAODTrigBphysColl_X->push_back( xaod_trigPartKstar );
                                        ...
                                        int iKstar = m_xAODTrigBphysColl_X->size() - 1;
                                        ElementLink<xAOD::TrigBphysContainer> trigPartXEL(*m_xAODTrigBphysColl_X,iKstar);
                                ...
                                if(m_doBs_Phi1020MuMuDecay) {
                                    ...
                                    if (trigPartBsMuMuPhi) {
                                        ...
                                        m_xAODTrigBphysColl_b->push_back( xaod_trigPartBsMuMuPhi );
                                        ...
                                        m_xAODTrigBphysColl_X->push_back( xaod_trigPartPhi );
                                        ...
                                        int iPhi = m_xAODTrigBphysColl_X->size() - 1;
                                        ElementLink<xAOD::TrigBphysContainer> trigPartXEL(*m_xAODTrigBphysColl_X,iPhi);
                                ...
                                if(m_doLb_LambdaMuMuDecay) {
                                    ...
                                    if (trigPartLbMuMuLambda) {
                                        ...
                                        m_xAODTrigBphysColl_b->push_back( xaod_trigPartLbMuMuLambda );
                                        ...
                                        m_xAODTrigBphysColl_X->push_back( xaod_trigPartLambda );
                                        ...
                                        int iLambda = m_xAODTrigBphysColl_X->size() - 1;
                                        ElementLink<xAOD::TrigBphysContainer> trigPartXEL(*m_xAODTrigBphysColl_X,iLambda);
                                        ...
                                        if ( xPhiMuMuMass < m_upperBc_DsMuMuMassCut - PIMASS ) {
                                            ...
                                            for (int itrk3=0 ; trkIt3 != lastTrkIt; itrk3++, trkIt3++)
                                            {
                                                ...
                                                if (trigPartBcMuMuDs) {
                                                    ...
                                                    m_xAODTrigBphysColl_b->push_back( xaod_trigPartBcMuMuDs );
                                                    ...
                                                    m_xAODTrigBphysColl_X->push_back( xaod_trigPartDs );
                                                    ...
                                                    int iDs = m_xAODTrigBphysColl_X->size() - 1;
                                                    ElementLink<xAOD::TrigBphysContainer> trigPartXEL(*m_xAODTrigBphysColl_X,iDs);
    ...
    if(m_xAODTrigBphysColl_b!=0 && m_xAODTrigBphysColl_b->size()>0) {
        if ( msgLvl() <= MSG::DEBUG ) msg()  << MSG::DEBUG << "REGTEST: Store Bphys Collection " << m_xAODTrigBphysColl_b << " size: " << m_xAODTrigBphysColl_b->size() << endreq;
        HLT::ErrorCode sc = attachFeature(outputTE, m_xAODTrigBphysColl_b, "EFBMuMuXFex" );
        if(sc != HLT::OK) {
        ...
        sc = attachFeature(outputTE, m_xAODTrigBphysColl_X, "EFBMuMuXFex_X" );
        if(sc != HLT::OK) {
...
/*----------------------------------------------------------------------------*/
TrigEFBphys* TrigEFBMuMuXFex_xAOD::checkBMuMu2X(const Trk::Track* mu1, const Trk::Track* mu2, const Trk::Track* track1, const Trk::Track* track2, const int decay, TrigEFBphys* & trigPartX)
{
...
/*----------------------------------------------------------------------------*/
TrigEFBphys* TrigEFBMuMuXFex_xAOD::checkBcMuMuDs(const Trk::Track* mu1, const Trk::Track* mu2, const Trk::Track* track1, const Trk::Track* track2, double xPhiMass, const Trk::Track* track3, TrigEFBphys* & trigPartX)
{
    TrigEFBphys* trigPartXMuMu(0);
...
/*----------------------------------------------------------------------------*/
TrigEFBphys* TrigEFBMuMuXFex_xAOD::checkBplusMuMuKplus(const Trk::Track* mu1, const Trk::Track* mu2, const Trk::Track* track1)
{
    TrigEFBphys* trigPartXMuMu(0);
...
/*----------------------------------------------------------------------------*/
void TrigEFBMuMuXFex_xAOD::addUnique(std::vector<const Trk::Track*>& tracks, const Trk::Track* trkIn)
{
...
/*----------------------------------------------------------------------------*/
double TrigEFBMuMuXFex_xAOD::XMass(const Trk::Track* particle1, const Trk::Track* particle2, int decay)
{
...
/*----------------------------------------------------------------------------*/
double TrigEFBMuMuXFex_xAOD::X3Mass(const Trk::Track* particle1, const Trk::Track* particle2, const Trk::Track* particle3)
{
    std::vector<double> massHypo;
    massHypo.clear();
    massHypo.push_back(KPLUSMASS);
...
/*----------------------------------------------------------------------------*/
double TrigEFBMuMuXFex_xAOD::KMuMuMass(const Trk::Track* mu1, const Trk::Track* mu2,
...
/*----------------------------------------------------------------------------*/
double TrigEFBMuMuXFex_xAOD::XMuMuMass(const Trk::Track* mu1, const Trk::Track* mu2,
...
/*----------------------------------------------------------------------------*/
double TrigEFBMuMuXFex_xAOD::X3MuMuMass(const Trk::Track* mu1, const Trk::Track* mu2,
