...
/**************************************************************************
 **
 **   File: Trigger/TrigHypothesis/TrigBPhysHypo/TrigEFMultiMuHypo_xAOD.cxx
 **
...
TrigEFMultiMuHypo_xAOD::TrigEFMultiMuHypo_xAOD(const std::string & name, ISvcLocator* pSvcLocator):
...
TrigEFMultiMuHypo_xAOD::~TrigEFMultiMuHypo_xAOD()
{ }

HLT::ErrorCode TrigEFMultiMuHypo_xAOD::hltInitialize()
{
...
HLT::ErrorCode TrigEFMultiMuHypo_xAOD::hltFinalize()
{
  msg() << MSG::INFO << "in finalize()" << endreq;
  msg() << MSG::INFO << "|----------------------- SUMMARY FROM TrigEFMultiMuHypo_xAOD -------------|" << endreq;
...
//-------------------------------------------------------------------------------------
HLT::ErrorCode TrigEFMultiMuHypo_xAOD::hltExecute(const HLT::TriggerElement* outputTE, bool& pass)
{
