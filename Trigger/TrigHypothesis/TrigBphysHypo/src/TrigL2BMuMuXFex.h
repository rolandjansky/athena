...
*/  
    ...
    // lvl1
    std::vector<float> mon_ROIsEta;
    std::vector<float> mon_ROIsPhi;

    // muons
    std::vector<float> mon_muon1Eta;
    std::vector<float> mon_muon1Phi;
    std::vector<float> mon_muon1Pt;
    std::vector<float> mon_muon1Z0;
    std::vector<float> mon_muon1A0;
    std::vector<float> mon_muon2Eta;
    std::vector<float> mon_muon2Phi;
    std::vector<float> mon_muon2Pt;
    std::vector<float> mon_muon2Z0;
    std::vector<float> mon_muon2A0;
    
    // tracks
    std::vector<int>   mon_nTracks;
    std::vector<float> mon_etaTracks;
    std::vector<float> mon_pTTracks;
    std::vector<float> mon_phiTracks;

    // B+/-
    int mon_BMuMuK_n;
    std::vector<float> mon_BMuMuK_InvMass_B;
    std::vector<float> mon_BMuMuK_PtB_K;  
    std::vector<float> mon_BMuMuK_EtaB_K;
    std::vector<float> mon_BMuMuK_PhiB_K;
    std::vector<float> mon_BMuMuK_VtxMass_B;
    std::vector<float> mon_BMuMuK_Chi2toNDoF_B;
    std::vector<float> mon_BMuMuK_VtxPtB_K;
    std::vector<float> mon_BMuMuK_VtxEtaB_K;
    std::vector<float> mon_BMuMuK_VtxPhiB_K;

    // Bs+/- before vertexing
    int mon_BsMuMuPhi_n;
    std::vector<float> mon_BsMuMuPhi_InvMassBs_Phi;
    std::vector<float> mon_BsMuMuPhi_InvMass_Bs;
    std::vector<float> mon_BsMuMuPhi_PtPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_EtaPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_PhiPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_PtPhi_Km;
    std::vector<float> mon_BsMuMuPhi_EtaPhi_Km;
    std::vector<float> mon_BsMuMuPhi_PhiPhi_Km;
    // after Phi vertexing
    std::vector<float> mon_BsMuMuPhi_VtxMassBs_Phi;
    std::vector<float> mon_BsMuMuPhi_Chi2toNDoFBs_Phi;
    std::vector<float> mon_BsMuMuPhi_VtxPtPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxEtaPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxPhiPhi_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxPtPhi_Km;
    std::vector<float> mon_BsMuMuPhi_VtxEtaPhi_Km;
    std::vector<float> mon_BsMuMuPhi_VtxPhiPhi_Km;
    // after Bs vertexing
    std::vector<float> mon_BsMuMuPhi_VtxMass_Bs;
    std::vector<float> mon_BsMuMuPhi_Chi2toNDoF_Bs;
    std::vector<float> mon_BsMuMuPhi_VtxPtBs_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxEtaBs_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxPhiBs_Kp;
    std::vector<float> mon_BsMuMuPhi_VtxPtBs_Km;
    std::vector<float> mon_BsMuMuPhi_VtxEtaBs_Km;
    std::vector<float> mon_BsMuMuPhi_VtxPhiBs_Km;
        
    // Bd
    int mon_BdMuMuKs_n;
    std::vector<float> mon_BdMuMuKs_InvMassBd_Ks;
    std::vector<float> mon_BdMuMuKs_InvMass_Bd;
    std::vector<float> mon_BdMuMuKs_PtKs_Ka;
    std::vector<float> mon_BdMuMuKs_EtaKs_Ka;
    std::vector<float> mon_BdMuMuKs_PhiKs_Ka;
    std::vector<float> mon_BdMuMuKs_PtKs_Pi;
    std::vector<float> mon_BdMuMuKs_EtaKs_Pi;
    std::vector<float> mon_BdMuMuKs_PhiKs_Pi;
    // after K* vertexing
    std::vector<float> mon_BdMuMuKs_VtxMassBd_Ks;
    std::vector<float> mon_BdMuMuKs_Chi2toNDoFBd_Ks;
    std::vector<float> mon_BdMuMuKs_VtxPtKs_Ka;
    std::vector<float> mon_BdMuMuKs_VtxEtaKs_Ka;
    std::vector<float> mon_BdMuMuKs_VtxPhiKs_Ka;
    std::vector<float> mon_BdMuMuKs_VtxPtKs_Pi;
    std::vector<float> mon_BdMuMuKs_VtxEtaKs_Pi;
    std::vector<float> mon_BdMuMuKs_VtxPhiKs_Pi;
    // after Bd vertexing
    std::vector<float> mon_BdMuMuKs_VtxMass_Bd;
    std::vector<float> mon_BdMuMuKs_Chi2toNDoF_Bd;
    std::vector<float> mon_BdMuMuKs_VtxPtBd_Ka;
    std::vector<float> mon_BdMuMuKs_VtxEtaBd_Ka;
    std::vector<float> mon_BdMuMuKs_VtxPhiBd_Ka;
    std::vector<float> mon_BdMuMuKs_VtxPtBd_Pi;
    std::vector<float> mon_BdMuMuKs_VtxEtaBd_Pi;
    std::vector<float> mon_BdMuMuKs_VtxPhiBd_Pi;
        
    // Lb+/- before vertexing
    // Lb+/-
    int mon_LbMuMuL_n;
    std::vector<float> mon_LbMuMuL_InvMassLb_L;
    std::vector<float> mon_LbMuMuL_InvMass_Lb;
    std::vector<float> mon_LbMuMuL_PtL_Pr;
    std::vector<float> mon_LbMuMuL_EtaL_Pr;
    std::vector<float> mon_LbMuMuL_PhiL_Pr;
    std::vector<float> mon_LbMuMuL_PtL_Pi;
    std::vector<float> mon_LbMuMuL_EtaL_Pi;
    std::vector<float> mon_LbMuMuL_PhiL_Pi;
    // after L vertexing
    std::vector<float> mon_LbMuMuL_VtxMassLb_L;
    std::vector<float> mon_LbMuMuL_Chi2toNDoFLb_L;
    std::vector<float> mon_LbMuMuL_VtxPtL_Pr;
    std::vector<float> mon_LbMuMuL_VtxEtaL_Pr;
    std::vector<float> mon_LbMuMuL_VtxPhiL_Pr;
    std::vector<float> mon_LbMuMuL_VtxPtL_Pi;
    std::vector<float> mon_LbMuMuL_VtxEtaL_Pi;
    std::vector<float> mon_LbMuMuL_VtxPhiL_Pi;
    // after Lb vertexing
    std::vector<float> mon_LbMuMuL_VtxMass_Lb;
    std::vector<float> mon_LbMuMuL_Chi2toNDoF_Lb;
    std::vector<float> mon_LbMuMuL_VtxPtLb_Pr;
    std::vector<float> mon_LbMuMuL_VtxEtaLb_Pr;
    std::vector<float> mon_LbMuMuL_VtxPhiLb_Pr;
    std::vector<float> mon_LbMuMuL_VtxPtLb_Pi;
    std::vector<float> mon_LbMuMuL_VtxEtaLb_Pi;
    std::vector<float> mon_LbMuMuL_VtxPhiLb_Pi;

    // Bc+/- before vertexing
    int mon_BcMuMuDs_n;
    std::vector<float> mon_BcMuMuDs_InvMassBc_Phi;
    std::vector<float> mon_BcMuMuDs_InvMassBc_Ds;
    std::vector<float> mon_BcMuMuDs_InvMass_Bc;
    std::vector<float> mon_BcMuMuDs_PtPhi_Kp;
    std::vector<float> mon_BcMuMuDs_EtaPhi_Kp;
    std::vector<float> mon_BcMuMuDs_PhiPhi_Kp;
    std::vector<float> mon_BcMuMuDs_PtPhi_Km;
    std::vector<float> mon_BcMuMuDs_EtaPhi_Km;
    std::vector<float> mon_BcMuMuDs_PhiPhi_Km;
    std::vector<float> mon_BcMuMuDs_PtDs_pi;
    std::vector<float> mon_BcMuMuDs_EtaDs_pi;
    std::vector<float> mon_BcMuMuDs_PhiDs_pi;
    // after Ds vertexing
    std::vector<float> mon_BcMuMuDs_VtxMassBc_Ds;
    std::vector<float> mon_BcMuMuDs_Chi2toNDoFBc_Ds;
    std::vector<float> mon_BcMuMuDs_VtxPtDs_Kp;
    std::vector<float> mon_BcMuMuDs_VtxEtaDs_Kp;
    std::vector<float> mon_BcMuMuDs_VtxPhiDs_Kp;
    std::vector<float> mon_BcMuMuDs_VtxPtDs_Km;
    std::vector<float> mon_BcMuMuDs_VtxEtaDs_Km;
    std::vector<float> mon_BcMuMuDs_VtxPhiDs_Km;
    std::vector<float> mon_BcMuMuDs_VtxPtDs_pi;
    std::vector<float> mon_BcMuMuDs_VtxEtaDs_pi;
    std::vector<float> mon_BcMuMuDs_VtxPhiDs_pi;
    // after Bc vertexing
    std::vector<float> mon_BcMuMuDs_VtxMass_Bc;
    std::vector<float> mon_BcMuMuDs_Chi2toNDoF_Bc;
    std::vector<float> mon_BcMuMuDs_VtxPtBc_Kp;
    std::vector<float> mon_BcMuMuDs_VtxEtaBc_Kp;
    std::vector<float> mon_BcMuMuDs_VtxPhiBc_Kp;
    std::vector<float> mon_BcMuMuDs_VtxPtBc_Km;
    std::vector<float> mon_BcMuMuDs_VtxEtaBc_Km;
    std::vector<float> mon_BcMuMuDs_VtxPhiBc_Km;
    std::vector<float> mon_BcMuMuDs_VtxPtBc_pi;
    std::vector<float> mon_BcMuMuDs_VtxEtaBc_pi;
    std::vector<float> mon_BcMuMuDs_VtxPhiBc_pi;
