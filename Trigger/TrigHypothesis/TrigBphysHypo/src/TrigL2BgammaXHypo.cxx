...
/*------------------------------------------------------------------------------------*/
TrigL2BgammaXHypo::TrigL2BgammaXHypo(const std::string & name, ISvcLocator* pSvcLocator):
...
/*-------------------------------------------*/
TrigL2BgammaXHypo::~TrigL2BgammaXHypo()
/*-------------------------------------------*/
{
}

/*-------------------------------------------*/
HLT::ErrorCode TrigL2BgammaXHypo::hltInitialize()
/*-------------------------------------------*/
{
...
/*-------------------------------------------*/
HLT::ErrorCode TrigL2BgammaXHypo::hltFinalize()
/*-------------------------------------------*/
{
...
/*--------------------------------------------------------------*/
HLT::ErrorCode TrigL2BgammaXHypo::hltExecute(const HLT::TriggerElement* outputTE, bool& pass)
/*--------------------------------------------------------------*/
{
