...
/*------------------------------------------------------------------------------------*/
TrigEFJpsieeHypo::TrigEFJpsieeHypo(const std::string & name, ISvcLocator* pSvcLocator):
...
/*-------------------------------------------*/
TrigEFJpsieeHypo::~TrigEFJpsieeHypo()
/*-------------------------------------------*/
{
}

/*-------------------------------------------*/
HLT::ErrorCode TrigEFJpsieeHypo::hltInitialize()
/*-------------------------------------------*/
{
...
/*-------------------------------------------*/
HLT::ErrorCode TrigEFJpsieeHypo::hltFinalize()
/*-------------------------------------------*/
{
...
/*--------------------------------------------------------------*/
HLT::ErrorCode TrigEFJpsieeHypo::hltExecute(const HLT::TriggerElement* outputTE, bool& pass)
/*--------------------------------------------------------------*/
{
