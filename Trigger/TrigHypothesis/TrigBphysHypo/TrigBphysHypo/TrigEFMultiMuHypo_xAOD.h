...
/**************************************************************************
 **
 **   File: Trigger/TrigHypothesis/TrigBphysHypo/TrigEFMultiMuHypo_xAOD.h
 **
...
#ifndef TRIG_TrigEFMultiMuHypo_xAOD_H 
#define TRIG_TrigEFMultiMuHypo_xAOD_H
...
class TrigEFMultiMuHypo_xAOD: public HLT::HypoAlgo  {
  
  public:
    TrigEFMultiMuHypo_xAOD(const std::string & name, ISvcLocator* pSvcLocator);
    ~TrigEFMultiMuHypo_xAOD();
