...
#ifndef TRIG_TrigEFBMuMuHypo_xAOD_H 
#define TRIG_TrigEFBMuMuHypo_xAOD_H
...
class TrigEFBMuMuHypo_xAOD: public HLT::HypoAlgo  {
  
  public:
    TrigEFBMuMuHypo_xAOD(const std::string & name, ISvcLocator* pSvcLocator);
    ~TrigEFBMuMuHypo_xAOD();
