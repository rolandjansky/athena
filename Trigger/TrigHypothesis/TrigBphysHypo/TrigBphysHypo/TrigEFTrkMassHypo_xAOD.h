...
#ifndef TRIGEFTRKMASSHYPO_xAOD_H
#define TRIGEFTRKMASSHYPO_xAOD_H
...
class TrigEFTrkMassHypo_xAOD: public HLT::HypoAlgo
{

public:
    TrigEFTrkMassHypo_xAOD(const std::string& name, ISvcLocator* pSvcLocator);
    ~TrigEFTrkMassHypo_xAOD();
