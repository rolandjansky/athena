...
double FTK_RawTrack::getInvPt() const{
  ...
  if (this->trackVersion()==0) {
    ...
    invpt_f = (invpt-sixteen_bit_offset);
...
float FTK_RawTrack::getD0() const{
  ...
  if (this->trackVersion()==0) {
    ...
    d0_f = ((double)d0 - (double)sixteen_bit_offset)/d0_multiplier;
  } else {
...
float FTK_RawTrack::getZ0() const{
  ...
  if (this->trackVersion()==0) {
    ...
    z0_f = ((double)z0 - (double) sixteen_bit_offset)/z0_multiplier;
  } else {
...
float FTK_RawTrack::getPhi() const{
  ...
  if (this->trackVersion()==0) {
    ...
    phi_f = ((double)phi - (double) sixteen_bit_offset)/phi_multiplier;
  } else {
...
double FTK_RawTrack::getChi2() const{
  ...
  if (this->trackVersion()==0) {
    ...
    chi2_f = (double)chi2/chi2_multiplier;
  } else {
