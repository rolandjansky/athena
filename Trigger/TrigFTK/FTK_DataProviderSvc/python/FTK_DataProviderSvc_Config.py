...
class ConfiguredFTK_UncertaintyTool(FTK_UncertaintyTool) :
    def __init__(self, name = "FTK_UncertaintyTool"):
...
class ConfiguredFTK_DataProviderSvc(FTK_DataProviderSvc) :
    def __init__(self, name = "ConfiguredFTK_DataProviderSvc", OutputLevel=INFO):
        ...
        self.TrackParticleContainerName= "FTK_TrackParticleCollection"
        ...
        self.UncertaintyTool=FTK_UncertaintyTool
...
class TrigFTK_DataProviderSvc(FTK_DataProviderSvc) :
    ...
    def __init__(self, name = "TrigFTK_DataProviderSvc",OutputLevel=INFO):
        ...
        from TrkVertexSeedFinderTools.TrkVertexSeedFinderToolsConf import Trk__CrossDistancesSeedFinder
        TrigFTK_VtxSeedFinder = Trk__CrossDistancesSeedFinder(name = "InDetTrigCrossDistancesSeedFinder",
                                                  trackdistcutoff = 1.,
                                                  trackdistexppower = 2)
        ...
        TrigFTK_ImpactPoint3dEstimator = Trk__ImpactPoint3dEstimator(name         = "InDetTrigTrkImpactPoint3dEstimator",
                                                         Extrapolator = InDetTrigExtrapolator,
                                                         )
        ...
        TrigFTK_AnnealingMaker = Trk__DetAnnealingMaker(name = "InDetTrigTrkAnnealingMaker")
        TrigFTK_AnnealingMaker.SetOfTemperatures = [64.,16.,4.,2.,1.5,1.] # not default
        ToolSvc += TrigFTK_AnnealingMaker


        from TrkVertexFitters.TrkVertexFittersConf import Trk__SequentialVertexSmoother
        TrigFTK_VertexSmoother =  Trk__SequentialVertexSmoother(name="InDetTrigSequentialVertexSmoother")
        ToolSvc += TrigFTK_VertexSmoother


        from TrkVertexFitters.TrkVertexFittersConf import Trk__AdaptiveVertexFitter
        TrigFTK_VxFitterTool = Trk__AdaptiveVertexFitter(name                         = "InDetTrigAdaptiveVxFitterTool",
