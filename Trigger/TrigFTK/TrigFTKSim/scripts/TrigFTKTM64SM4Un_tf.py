...
def addFTKSimulationArgs(parser):
    ...
    parser.add_argument('--UberFinalMerge', type=trfArgClasses.argFactory(trfArgClasses.argBool, runarg=True), 
    ...
    for tower in range(ntowers) :
      parser.add_argument('--outputNTUP_FTKTMP_{0}File'.format(tower), 
                    ...
                    help='Subregion {0} merged FTK temp file'.format(tower), group='TrigFTKMerge')
