...
FTKRoadFinder.badmap_path_for_hit = "badModulemap_FTK.bmap" # if = "" dont use WC 
...
if FTKRoadFinder.UseTSPBank :
    ...
    FTKRoadFinder.bankpath = ["baseDS_v16/patt/pattgen_raw_7L_50x64x144_reg0.patt.bz2"]
...
#bank path how to write-> = [ [reg 0 subreg0-X],[reg 1 subreg0-X],[reg 2 subreg0-X],--- ]
FTKTrackFitter.bankpath =["baseDS_v16/gcon/corrgen_raw_7L_1M_reg0_sub0.gcon.bz2"] 
FTKTrackFitter.bankregion = [0]
FTKTrackFitter.banksubregion = [0]
...
if not FTKTrackFitter.doTrackFile :
   Stream1.ItemList += ["FTKAthTrackContainer#*"]
