...
# 2 includes correction for 400/600um pixels and ToT imbalance used for better centroid, with a bug fix as of April 2014
# >=100 will use realistic clustering as implemented in FTK_IM
# 100 is a simple "realistic" clustering, with a centroid calculation similar to PIXEL_CLUSTERING_MODE=0 but with integer output as in FTK_IM and also accounting for long pixels
# 101 is the first version of the realistic clustering as implemented in FTK_IM including ToT correction
