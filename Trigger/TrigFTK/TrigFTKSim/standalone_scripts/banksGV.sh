...
bankdir=/share/ftkdata/volpig/bases/conf8Lb
queue=pbs
...
#myPython=/osg/app/atlas_app/atlas_rel/15.6.0/sw/lcg/external/Python/2.5.4/slc4_ia32_gcc34/bin/python
#export ROOTSYS=/osg/app/atlas_app/atlas_rel/15.6.0/sw/lcg/app/releases/ROOT/5.22.00d/slc4_ia32_gcc34/root/
...
./ftk.py -q ${queue} -m16 -r ${bankdir} -t ${bankdir} -o FORCE_REGION,DATAFILE_LIST='${inputdir}/inputprod_raw_${dataset}${i}.list' -d raw_8Lb_50x64x144_${sample} -a ${actionTSP0}
