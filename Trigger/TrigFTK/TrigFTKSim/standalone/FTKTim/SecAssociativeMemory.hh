...
class SecAssociativeMemory : public IOTimeBase,  public IBoardBase {


public:
  SecAssociativeMemory() {}

  SecAssociativeMemory(int bd_index)
    : IOTimeBase(bd_index, AM_T_IN, AM_T_OUT, AM_T_PROC, AM_T_DELAY) 
  {

  }

  SecAssociativeMemory(int bd_index, double bd_t_in, double bd_t_out, double bd_t_proc, double bd_t_delay)
  ...
  //  ClassDef(SecAssociativeMemory,2)
};
