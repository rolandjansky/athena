...
StatusCode L2MuonSAIOMonMT :: fillVariablesPerOfflineMuonPerChain(const EventContext& ctx, const xAOD::Muon* mu, const std::string &chain) const {
...
StatusCode L2MuonSAIOMonMT :: matchL2IO_wContainer(const EventContext &ctx, const std::string &chain, std::vector< const xAOD::L2CombinedMuon* > &Trig_L2IOobjects) const {
...
StatusCode L2MuonSAIOMonMT :: L2OverlapRemover( std::vector< const xAOD::L2CombinedMuon* > matchSA_L2IOobjects, std::vector< bool > &isoverlap, std::vector< bool > &passOR ) const {
...
bool L2MuonSAIOMonMT :: isOverlap( const xAOD::L2CombinedMuon* matchSA_L2IOobject1, const xAOD::L2CombinedMuon* matchSA_L2IOobject2 ) const {
...
StatusCode L2MuonSAIOMonMT :: chooseBestMuon( std::vector< const xAOD::L2CombinedMuon* > matchSA_L2IOobjects, std::vector< bool > &passOR, std::vector< unsigned int > &mucombResult ) const{
...
bool L2MuonSAIOMonMT :: muCombHypo_TDTworkaround( const std::string &chain, std::vector< const xAOD::L2CombinedMuon* > Trig_L2IOobjects, std::vector< bool > &pass_muCombHypo ) const{
...
bool L2MuonSAIOMonMT :: isPassedmuCombHypo( const std::string &chain, const xAOD::L2CombinedMuon* Trig_L2IOobject ) const{
...
StatusCode L2MuonSAIOMonMT :: decision_ptthreshold( const std::string &chain, std::vector< float > &my_EtaBins, std::vector< float > &my_muCombThres,
...
std::tuple<float,float,float> L2MuonSAIOMonMT :: L2ORPosForMatchFunc(const xAOD::L2StandAloneMuon *trig){
  return std::forward_as_tuple(trig->pt(), trig->etaMS(), trig->phiMS());
}


std::tuple<float,float,float> L2MuonSAIOMonMT :: L2ORPosForMatchFunc(const xAOD::L2CombinedMuon *trig){
  return std::forward_as_tuple( (trig->pt()/1e3 * trig->charge() ), trig->eta(), trig->phi());
}


const xAOD::L2CombinedMuon* L2MuonSAIOMonMT :: searchL2InsideOut( const EventContext &ctx, const xAOD::Muon *mu, std::string trig) const {
...
const xAOD::Muon* L2MuonSAIOMonMT :: searchTagOfflineMuon( const EventContext& ctx, const xAOD::Muon* probe ) const{
