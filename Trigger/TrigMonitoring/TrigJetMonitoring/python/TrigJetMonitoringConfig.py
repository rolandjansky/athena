...
## monitoring triggers 
#EF_j20_a2hi_EFFS_L1ZDC <-- L2_mbZdc_a_c_NoAlg  <-- L1_ZDC_A_C 
hlt_basicL2Triggers = { 'L2_NoAlg':'L2_L1J10_NoAlg' }
hlt_basicEFTriggers = { 'EF_fj15':'EF_fj15_a4hi_EFFS_L1FJ0', 'EF_j30':'EF_j30_a4hi_EFFS_L2mbMbts', 'EF_j50':'EF_j50_a4hi_EFFS_L1J10' }
...
## L1 items   
hlt_level1ItemNames           = { 'L1_J10':'L1_J10' }
hlt_level1EtThresholds        = { 'L1_J10':10. }
hlt_level1EtNBins             = [ 40 ]
hlt_level1EtBinsLow           = [ 0. ]
hlt_level1EtBinsHigh          = [ 400. ]

## L2 chains  
#hlt_level2ChainNames          = { 'L2_j165':'L2_j165_c4cchad'}
#hlt_level2EtThresholds        = { 'L2_j165_c4cchad':165. }
#hlt_level2EtNBins             = [  22  ]
#hlt_level2EtBinsLow           = [  130. ]
#hlt_level2EtBinsHigh          = [  460. ]

hlt_level2ChainNames          = { 'L2_NoAlg':'L2_L1J10_NoAlg' }
hlt_level2EtThresholds        = { 'L2_L1J10_NoAlg':10. }
hlt_level2EtNBins             = [  50 ]
hlt_level2EtBinsLow           = [  0. ]
hlt_level2EtBinsHigh          = [  500. ]
...
hlt_efChainNames              = { 'EF_fj15':'EF_fj15_a4hi_EFFS_L1FJ0', 'EF_j30':'EF_j30_a4hi_EFFS_L2mbMbts', 'EF_j50':'EF_j50_a4hi_EFFS_L1J10' }
hlt_efEtThresholds            = { 'EF_fj15_a4hi_EFFS_L1FJ0':15., 'EF_j30_a4hi_EFFS_L2mbMbts':30., 'EF_j50_a4hi_EFFS_L1J10':50. }
hlt_efEtNBins                 = [ 50, 50, 50 ]
hlt_efEtBinsLow               = [ 0., 0., 0. ]
hlt_efEtBinsHigh              = [ 500., 500., 500.]


hlt_offlineEtThresholds        = { 'L1_J10':10., 'L2_L1J10_NoAlg':10., 'EF_fj15_a4tchad_EFFS_L1FJ0':15., 'EF_j30_a4tchad_EFFS_L1MBTS':30., 'EF_j50_a4hi_EFFS_L1J10':50. }
...
def TrigJetMonitoringTool():
  ...
  HLTJetMon = HLTJetMonTool ( 
            ...
            DoL2Efficiency       = True,         # w.r.t offline (L2 eff = L1 & L2)
            ...
            # SG Keys for L1, L2, EF, OF Jets
            L1JetKey             = "LVL1_ROI",
            L2JetKey             = "HLT_TrigT2CaloJet",
            EFJetKey             = "HLT_TrigJetRec",
            ...
            # Define basic L2/EF chains
            BasicL2Chains        = hlt_basicL2Triggers,
            ...
            # L2 Chains for trigger efficiency
            L2ChainNames            = hlt_level2ChainNames,
            L2EffNBinsEt            = hlt_level2EtNBins,
            L2EffBinLoEtGeV         = hlt_level2EtBinsLow,
            L2EffBinHiEtGeV         = hlt_level2EtBinsHigh,
            #L2EffEtThresGeV         = hlt_level2EtThresholds,
