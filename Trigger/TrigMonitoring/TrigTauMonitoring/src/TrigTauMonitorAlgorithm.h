...
class TrigTauMonitorAlgorithm : public AthMonitorAlgorithm {
 ...
 private:
  ...
  void fillL1Efficiencies(const EventContext& ctx, const std::vector<const xAOD::TauJet*>& offline_tau_vec, const std::string& nProng, const std::string& trigL1Item, const std::vector<const xAOD::EmTauRoI*>& L1rois) const;
