...
#define TRIGMUONMONITORING_TRIGMUONEFFICIENCYMON_H
 ...
 */
class TrigMuonEfficiencyMon : public TrigMuonMonitorAlgorithm{
...
#endif //TRIGMUONMONITORING_TRIGMUONEFFICIENCYMON_H
