...
def TrigCaloMonConfig(inputFlags):
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_eta,HLT_phi',title='Number of HLT Clusters; #eta; #phi; ', type='TH2F',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_phi',title='HLT Cluster #phi; #phi; Entries',
				path=hist_path,xbins=64,xmin=-3.14153,xmax=3.14153)
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_barrel_high_et_eta,HLT_barrel_high_et_phi',title='Number of high-E_{T} HLT Clusters; #eta; #phi; ', type='TH2F',
	    			path=hist_path,xbins=50,xmin=-1.5,xmax=1.5,ybins=64,ymin=-3.14153,ymax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_barrel_high_et_et',title='high-E_{T} HLT Clusters E_{T}; E_{T} [GeV]; Entries',
    				path=hist_path,xbins=100,xmin=0.0,xmax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_barrel_high_et_eta',title='high-E_{T} HLT Clusters #eta; #eta; Entries',
    				path=hist_path,xbins=50,xmin=-1.5,xmax=1.5)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_barrel_high_et_phi',title='high-E_{T} HLT Cluster #phi; #phi; Entries',
    				path=hist_path,xbins=64,xmin=-3.14153,xmax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_barrel_high_et_size',title='high-E_{T} HLT Cluster Size; Number of Cells; Entries',
				path=hist_path,xbins=91,xmin=-10.0,xmax=1810.0)
    ...
    hist_path='HLT_L2CaloEMClusters/HLT_Matched_to_HLT'
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_vs_OFF_minimum_delta_phi',title='HLT vs OFF Cluster #Delta#phi; #phi_{_{OFF}} -  #phi_{_{HLT}}; Entries',
				path=hist_path,xbins=50,xmin=0.0,xmax=0.02)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_et,OFF_match_et',title='HLT vs OFF Cluster E_{T}; E_{T_{OFF}} [GeV]; E_{T_{HLT}} [GeV]', type='TH2F',
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_et,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; E_{T,OFF} [GeV]; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=100,xmin=0.0,xmax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_eta,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #eta_{_{ OFF}}; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=20,xmin=-5.0,xmax=5.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_phi,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #phi_{_{ OFF}}; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=16,xmin=-3.14153,xmax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_eta,HLT_with_OFF_match_phi,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #eta; #phi', type='TProfile2D',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_num',title='Number of HLT Clusters (With OFF Matches); Num Clusters; Entries',
				path=hist_path,xbins=101,xmin=-1.0,xmax=201.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_eta,HLT_with_OFF_match_phi',title='Number of HLT Clusters (With OFF Matches); #eta; #phi; ', type='TH2F',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_et',title='HLT Clusters E_{T} (With OFF Matches); E_{T} [GeV]; Entries',
				path=hist_path,xbins=100,xmin=0.0,xmax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_eta',title='HLT Clusters #eta (With OFF Matches); #eta; Entries',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_with_OFF_match_phi',title='HLT Cluster #phi (With OFF Matches); #phi; Entries',
				path=hist_path,xbins=64,xmin=-3.14153,xmax=3.14153)
    ...
    L2CaloEMClustersMonGroup.defineHistogram('HLT_no_OFF_match_num',title='Number of HLT Clusters (No OFF Matches); Num Clusters; Entries',
				path=hist_path,xbins=101,xmin=-1.0,xmax=201.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_no_OFF_match_eta,HLT_no_OFF_match_phi',title='Number of HLT Clusters (No OFF Matches); #eta; #phi; ', type='TH2F',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_no_OFF_match_et',title='HLT Clusters E_{T} (No OFF Matches); E_{T} [GeV]; Entries',
				path=hist_path,xbins=100,xmin=0.0,xmax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_no_OFF_match_eta',title='HLT Clusters #eta (No OFF Matches); #eta; Entries',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0)
    L2CaloEMClustersMonGroup.defineHistogram('HLT_no_OFF_match_phi',title='HLT Cluster #phi (No OFF Matches); #phi; Entries',
				path=hist_path,xbins=64,xmin=-3.14153,xmax=3.14153)
    ...
    L2CaloEMClustersMonGroup.defineHistogram('OFF_vs_HLT_minimum_delta_r',title='HLT vs OFF Cluster #DeltaR; #DeltaR; Entries',
				path=hist_path,xbins=50,xmin=0.0,xmax=0.1)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_vs_HLT_minimum_delta_eta',title='HLT vs OFF Cluster #Delta#eta; #eta_{_{OFF}} -  #eta_{_{HLT}}; Entries',
				path=hist_path,xbins=50,xmin=-0.2,xmax=0.2)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_vs_HLT_minimum_delta_phi',title='HLT vs OFF Cluster #Delta#phi; #phi_{_{OFF}} -  #phi_{_{HLT}}; Entries',
				path=hist_path,xbins=50,xmin=0.0,xmax=0.02)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_with_HLT_match_et,HLT_match_et',title='HLT vs OFF Cluster E_{T}; E_{T_{OFF}} [GeV]; E_{T_{HLT}} [GeV]', type='TH2F',
				path=hist_path,xbins=100,xmin=0.0,xmax=100.0, ybins=100,ymin=0.0,ymax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_vs_HLT_resolution',title='HLT vs OFF Cluster #DeltaE_{T} / E_{T}; E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} [%]; Entries',
				path=hist_path,xbins=100,xmin=-40.0,xmax=40.0)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_with_HLT_match_et,OFF_vs_HLT_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; E_{T,OFF} [GeV]; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=100,xmin=0.0,xmax=100.0)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_with_HLT_match_eta,OFF_vs_HLT_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #eta_{_{ OFF}}; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=20,xmin=-5.0,xmax=5.0)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_with_HLT_match_phi,OFF_vs_HLT_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #phi_{_{ OFF}}; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=hist_path,xbins=16,xmin=-3.14153,xmax=3.14153)
    L2CaloEMClustersMonGroup.defineHistogram('OFF_with_HLT_match_eta,OFF_with_HLT_match_phi,OFF_vs_HLT_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #eta; #phi', type='TProfile2D',
				path=hist_path,xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
	...
	########################
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_eta,HLT_phi',title='Number of HLT Clusters; #eta; #phi; ', type='TH2F',
				path=path_names[i]+'/HLT_Clusters',xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_phi',title='HLT Cluster #phi; #phi; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=64,xmin=-3.14153,xmax=3.14153)
	...
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_et,HLT_time',title='Number of HLT Clusters; E_{T} [GeV]; Time', type='TProfile',
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_eta,HLT_barrel_high_et_phi',title='Number of high-E_{T} HLT Clusters; #eta; #phi; ', type='TH2F',
				path=path_names[i]+'/HLT_Clusters',xbins=50,xmin=-1.5,xmax=1.5,ybins=64,ymin=-3.14153,ymax=3.14153)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_et',title='high-E_{T} HLT Clusters E_{T}; E_{T} [GeV]; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_eta',title='high-E_{T} HLT Clusters #eta; #eta; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=50,xmin=-1.5,xmax=1.5)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_phi',title='high-E_{T} HLT Cluster #phi; #phi; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=64,xmin=-3.14153,xmax=3.14153)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_type',title='high-E_{T} HLT Cluster Type; Size Enum; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=16,xmin=0.5,xmax=16.5)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_time',title='high-E_{T} HLT Cluster time; time; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=60,xmin=-10.0,xmax=10.0)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_et,HLT_barrel_high_et_time',title='Number of high-E_{T} HLT Clusters; E_{T} [GeV]; Time', type='TProfile',
				path=path_names[i]+'/HLT_Clusters',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_barrel_high_et_size',title='high-E_{T} HLT Cluster Size; Number of Cells; Entries',
				path=path_names[i]+'/HLT_Clusters',xbins=91,xmin=-10.0,xmax=1810.0)
	...
	########################
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_eta,OFF_phi',title='Number of OFF Clusters; #eta; #phi; ', type='TH2F',
				path=path_names[i]+'/OFF_Clusters',xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_phi',title='OFF Cluster #phi; #phi; Entries',
				path=path_names[i]+'/OFF_Clusters',xbins=64,xmin=-3.14153,xmax=3.14153)
	...
	########################
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_et,OFF_match_et',title='HLT vs OFF Cluster E_{T}; E_{T_{OFF}} [GeV]; E_{T_{HLT}} [GeV]', type='TH2F',
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_phi,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #phi_{_{ OFF}}; < E_{T_{OFF}} - E_{T_{HLT}} / E_{T_{OFF}} >', type='TProfile',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=16,xmin=-3.14153,xmax=3.14153)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_eta,HLT_with_OFF_match_phi,HLT_vs_OFF_resolution',title='HLT vs OFF Cluster < #DeltaE_{T} / E_{T} >; #eta; #phi', type='TProfile2D',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_eta,HLT_with_OFF_match_phi',title='Number of HLT Clusters (With OFF Matches); #eta; #phi; ', type='TH2F',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_et',title='HLT Clusters E_{T} (With OFF Matches); E_{T} [GeV]; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_eta',title='HLT Clusters #eta (With OFF Matches); #eta; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=50,xmin=-5.0,xmax=5.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_phi',title='HLT Cluster #phi (With OFF Matches); #phi; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=64,xmin=-3.14153,xmax=3.14153)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_time',title='HLT Cluster time (With OFF Matches); time; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=75,xmin=-25.0,xmax=25.0)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_et,HLT_with_OFF_match_time',title='Number of HLT Clusters (With OFF Matches); E_{T} [GeV]; Time', type='TProfile',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_with_OFF_match_type',title='HLT Cluster Type (With OFF Matches); Size Enum; Entries',
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_num',title='Number of HLT Clusters (No OFF Matches); Num Clusters; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=101,xmin=-10.0,xmax=2010.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_eta,HLT_no_OFF_match_phi',title='Number of HLT Clusters (No OFF Matches); #eta; #phi; ', type='TH2F',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=50,xmin=-5.0,xmax=5.0,ybins=64,ymin=-3.14153,ymax=3.14153)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_et',title='HLT Clusters E_{T} (No OFF Matches); E_{T} [GeV]; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_eta',title='HLT Clusters #eta (No OFF Matches); #eta; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=50,xmin=-5.0,xmax=5.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_phi',title='HLT Cluster #phi (No OFF Matches); #phi; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=64,xmin=-3.14153,xmax=3.14153)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_time',title='HLT Cluster time (No OFF Matches); time; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=75,xmin=-25.0,xmax=25.0)
	TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_et,HLT_no_OFF_match_time',title='Number of HLT Clusters (No OFF Matches); E_{T} [GeV]; Time', type='TProfile',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=100,xmin=0.0,xmax=100.0)
        TopoCaloClustersMonGroup[i].defineHistogram('HLT_no_OFF_match_type',title='HLT Cluster Type (No OFF Matches); Size Enum; Entries',
				path=path_names[i]+'/HLT_Matched_to_OFF',xbins=16,xmin=0.5,xmax=16.5)
	...
	########################
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_vs_HLT_delta_eta',title='HLT vs OFF Cluster #Delta#eta; #eta_{_{OFF}} -  #eta_{_{HLT}}; Entries',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=50,xmin=-0.2,xmax=0.2)
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_vs_HLT_delta_phi',title='HLT vs OFF Cluster #Delta#phi; #phi_{_{OFF}} -  #phi_{_{HLT}}; Entries',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=50,xmin=0.0,xmax=0.02)
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_vs_HLT_delta_time',title='HLT vs OFF Cluster time; Time; Entries',
        ...
        TopoCaloClustersMonGroup[i].defineHistogram('OFF_with_HLT_match_phi',title='OFF Cluster #phi (With HLT Matches); #phi; Entries',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=64,xmin=-3.14153,xmax=3.14153)
	...
	TopoCaloClustersMonGroup[i].defineHistogram('OFF_with_HLT_match_et,OFF_with_HLT_match_time',title='Number of OFF Clusters (With HLT Matches); E_{T} [GeV]; Time', type='TProfile',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=100,xmin=0.0,xmax=100.0)
	...
	TopoCaloClustersMonGroup[i].defineHistogram('OFF_no_HLT_match_time',title='OFF Cluster time (No HLT Matches); time; Entries',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=75,xmin=-25.0,xmax=25.0)
	TopoCaloClustersMonGroup[i].defineHistogram('OFF_no_HLT_match_et,OFF_no_HLT_match_time',title='Number of OFF Clusters (No HLT Matches); E_{T} [GeV]; Time', type='TProfile',
				path=path_names[i]+'/OFF_Matched_to_HLT',xbins=100,xmin=0.0,xmax=100.0)
