 ...
 * @date Feb, 2016
 * @brief Tests for TrigMuonEFCbTrackCnv_p5.
 */
              ...
              const TrigMuonEFCbTrack& p2)
{
  ...
  assert (p2.getIDTrackParticleLink().isDefault());
}
...
void testit (const TrigMuonEFCbTrack& trans1)
{
  ...
  TrigMuonEFCbTrackCnv_p5 cnv;
  TrigMuonEFInfoContainerCnv_tlp1 tlcnv;
  cnv.setRuntimeTopConverter (&tlcnv);
  TrigMuonEFCbTrack_p4 pers;
