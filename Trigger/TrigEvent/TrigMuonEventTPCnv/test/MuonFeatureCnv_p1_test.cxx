 ...
 * @date Feb, 2016
 * @brief Tests for MuonFeatureCnv_p1.
 */
              ...
              const MuonFeature& p2)
{
  ...
  assert (0 == p2.sp1_r());
  assert (0 == p2.sp1_z());
  assert (0 == p2.sp1_slope());
  assert (0 == p2.sp2_r());
  assert (0 == p2.sp2_z());
  assert (0 == p2.sp2_slope());
  assert (0 == p2.sp3_r());
  assert (0 == p2.sp3_z());
  assert (0 == p2.sp3_slope());
  assert (0 == p2.br_radius());
  assert (0 == p2.br_sagitta());
  assert (0 == p2.ec_alpha());
  assert (0 == p2.ec_beta());
  assert (0 == p2.dq_var1());
  assert (0 == p2.dq_var2());
}
