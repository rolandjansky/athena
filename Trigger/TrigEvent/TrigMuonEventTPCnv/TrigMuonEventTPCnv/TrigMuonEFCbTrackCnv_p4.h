 ...
 *
 **********************************************************************************/
#ifndef TRIGMUONEVENTTPCNV_TRIGMUONEFCBTRACKCNV_P4_H
#define TRIGMUONEVENTTPCNV_TRIGMUONEFCBTRACKCNV_P4_H
...
class TrigMuonEFCbTrackCnv_p4 : public T_AthenaPoolTPCnvBase<TrigMuonEFCbTrack, TrigMuonEFCbTrack_p4>
{

 public:

  TrigMuonEFCbTrackCnv_p4() : m_P4IPtCotThPhiMCnv(0), m_TrigMuonEFTrackCnv(0) {}
