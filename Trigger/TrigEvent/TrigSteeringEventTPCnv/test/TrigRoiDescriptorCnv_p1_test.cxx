...
// $Id$
/**
 * @file TrigSteeringEventTPCnv/test/TrigRoiDescriptorCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigRoiDescriptorCnv_p1.
 */
...
void testit (const TrigRoiDescriptor& trans1)
{
  ...
  TrigRoiDescriptorCnv_p1 cnv;
  TrigRoiDescriptor_p1 pers;
