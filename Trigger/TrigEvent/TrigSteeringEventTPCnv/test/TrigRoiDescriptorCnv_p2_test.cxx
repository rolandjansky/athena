...
// $Id$
/**
 * @file TrigSteeringEventTPCnv/test/TrigRoiDescriptorCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigRoiDescriptorCnv_p2.
 */
...
void testit (const TrigRoiDescriptor& trans1)
{
  ...
  TrigRoiDescriptorCnv_p2 cnv;
  TrigRoiDescriptor_p2 pers;
