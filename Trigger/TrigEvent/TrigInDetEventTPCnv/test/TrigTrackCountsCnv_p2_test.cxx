...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigTrackCountsCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigTrackCountsCnv_p2.
 */
...
void compare (const TrigTrackCounts& p1,
              const TrigTrackCounts& p2)
{
...
void testit (const TrigTrackCounts& trans1)
{
  MsgStream log (0, "test");
  TrigTrackCountsCnv_p2 cnv;
  TrigTrackCounts_p2 pers;
  cnv.transToPers (&trans1, &pers, log);
  TrigTrackCounts trans2;
...
void test1()
{
  ...
  TrigTrackCounts trans1 (z0_pt, eta_phi);
