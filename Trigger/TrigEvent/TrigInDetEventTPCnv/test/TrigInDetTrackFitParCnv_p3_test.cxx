...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigInDetTrackFitParCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigInDetTrackFitParCnv_p3.
 */
...
void testit (const TrigInDetTrackFitPar& trans1)
{
  ...
  TrigInDetTrackFitParCnv_p3 cnv;
  TrigInDetTrackFitPar_p3 pers;
