 ...
 * @date Feb, 2016
 * @brief Tests for TrigInDetTrackCnv_p1.
 */
              ...
              const TrigInDetTrack& p2)
{
  ...
  assert (0 == p2.NPixelSpacePoints());
  //assert (p1.NSCT_SpacePoints() == p2.NSCT_SpacePoints());
  assert (0 == p2.NSCT_SpacePoints());
  //assert (p1.HitPattern() == p2.HitPattern());
  assert (0 == p2.HitPattern());
  //assert (p1.rdoList() == p2.rdoList());
  assert (p2.rdoList().empty());
