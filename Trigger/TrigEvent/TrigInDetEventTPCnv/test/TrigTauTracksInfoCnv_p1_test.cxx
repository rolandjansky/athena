...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigTauTracksInfoCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigTauTracksInfoCnv_p1.
 */
...
void testit (const TrigTauTracksInfo& trans1)
{
  ...
  TrigTauTracksInfoCnv_p1 cnv;
  TrigTauTracksInfoCnv_tlp1 tlcnv;
  cnv.setRuntimeTopConverter (&tlcnv);
  TrigTauTracksInfo_p1 pers;
