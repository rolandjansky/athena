...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigInDetTrackFitParCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigInDetTrackFitParCnv_p2.
 */
...
void testit (const TrigInDetTrackFitPar& trans1)
{
  ...
  TrigInDetTrackFitParCnv_p2 cnv;
  TrigInDetTrackFitPar_p2 pers;
