...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigSpacePointCountsCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigSpacePointCountsCnv_p3.
 */
...
void testit (const TrigSpacePointCounts& trans1)
{
  ...
  TrigSpacePointCountsCnv_p3 cnv;
  TrigSpacePointCounts_p3 pers;
