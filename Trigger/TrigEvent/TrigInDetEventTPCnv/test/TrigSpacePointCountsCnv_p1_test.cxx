...
// $Id$
/**
 * @file TrigInDetEventTPCnv/test/TrigSpacePointCountsCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigSpacePointCountsCnv_p1.
 */
...
void testit (const TrigSpacePointCounts& trans1)
{
  ...
  TrigSpacePointCountsCnv_p1 cnv;
  TrigSpacePointCounts_p1 pers;
