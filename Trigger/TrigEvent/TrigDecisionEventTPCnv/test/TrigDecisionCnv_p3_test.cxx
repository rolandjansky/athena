...
// $Id$
/**
 * @file TrigDecisionEventTPCnv/test/TrigDecisionCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigDecisionCnv_p3.
 */
...
void testit (const TrigDec::TrigDecision& trans1)
{
  ...
  TrigDec::TrigDecisionCnv_p3 cnv;
  TrigDec::TrigDecision_p3 pers;
