...
// $Id$
/**
 * @file TrigDecisionEventTPCnv/test/TrigDecisionCnv_p4_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrigDecisionCnv_p4.
 */
...
void testit (const TrigDec::TrigDecision& trans1)
{
  ...
  TrigDec::TrigDecisionCnv_p4 cnv;
  TrigDec::TrigDecision_p4 pers;
