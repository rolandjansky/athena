...
*/
/**
 * @file TrigCaloEventTPCnv/test/TrigTauClusterCnv_p4_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2016
 * @brief Tests for TrigTauClusterCnv_p4.
 */
...
void testit (const TrigTauCluster& trans1)
{
  ...
  TrigTauClusterCnv_p4 cnv;
  TrigTauCluster_p4 pers;
