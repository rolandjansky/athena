...
*/
/**
 * @file TrigCaloEventTPCnv/test/TrigEMClusterCnv_p4_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2016
 * @brief Tests for TrigEMClusterCnv_p4.
 */
              ...
              const TrigEMCluster& p2)
{
  ...
  assert (p1.e233() == p2.e233());
  assert (p1.wstot() == p2.wstot());
...
void testit (const TrigEMCluster& trans1)
{
  ...
  TrigEMClusterCnv_p4 cnv;
  TrigEMCluster_p4 pers;
