...
*/
/**
 * @file TrigCaloEventTPCnv/test/TrigTauClusterCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2016
 * @brief Tests for TrigTauClusterCnv_p3.
 */
...
void testit (const TrigTauCluster& trans1)
{
  ...
  TrigTauClusterCnv_p3 cnv;
  TrigTauCluster_p3 pers;
