...
*/
/**
 * @file TrigCaloEventTPCnv/test/TrigTauClusterCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2016
 * @brief Tests for TrigTauClusterCnv_p2.
 */
...
void testit (const TrigTauCluster& trans1)
{
  ...
  TrigTauClusterCnv_p2 cnv;
  TrigTauClusterCnv_tlp1 tlcnv;
  cnv.setRuntimeTopConverter (&tlcnv);
  TrigTauCluster_p2 pers;
