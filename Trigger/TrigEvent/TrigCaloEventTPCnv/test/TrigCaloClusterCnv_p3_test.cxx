...
// $Id$
/**
 * @file TrigCaloEventTPCnv/test/TrigCaloClusterCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Mar, 2014
 * @brief Regression tests for TrigCaloClusterCnv_p3.
 */
...
void test1()
{
  ...
  TrigCaloCluster_p3 pcl;
  TrigCaloClusterCnv_p3 cnv;
  ...
  for (int i=0; i < TrigCaloCluster_p3::MAXSIZE_P; i++)
    assert (cl2.rawEnergy((CaloSampling::CaloSample)i) == i*10000 + 20000);
  for (int i=TrigCaloCluster_p3::MAXSIZE_P; i < MAXSIZE; i++)
