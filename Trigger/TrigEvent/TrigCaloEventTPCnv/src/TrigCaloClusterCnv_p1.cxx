                                            ...
                                            MsgStream& log )
{
  ...
  log << MSG::DEBUG << "TrigCaloClusterCnv_p1::persToTrans" << endreq;
  ...
  transObj->m_quality             = static_cast<unsigned int>(persObj->m_quality);   
                                            ...
                                            MsgStream& log )
{
  ...
  log << MSG::DEBUG << "TrigCaloClusterCnv_p1::transToPers" << endreq;
