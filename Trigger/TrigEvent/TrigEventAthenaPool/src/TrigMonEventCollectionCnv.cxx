...
TrigMonEventCollection* TrigMonEventCollectionCnv::createTransient() 
{
  ...
  if( compareClassGuid(tlp1_guid) ) {
    ...
    std::unique_ptr< TrigMonEventCollection_tlp1 >   col_vect( this->poolReadObject< TrigMonEventCollection_tlp1 >() );
    ...
    std::unique_ptr< TrigMonEventCollection_p1 >   col_vect( this->poolReadObject< TrigMonEventCollection_p1 >() );
