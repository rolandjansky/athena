...
*/
/**
 * @file TrigMonitoringEventTPCnv/test/TrigMonROBDataCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Dec, 2019
 * @brief Tests for TrigMonROBDataCnv_p1.
 */
...
void testit (const TrigMonROBData& trans1)
{
  ...
  TrigMonROBDataCnv_p1 cnv;
  TrigMonROBData_p1 pers;
...
{
  std::cout << "TrigMonitoringEventTPCnv/TrigMonROBDataCnv_p1_test\n";
  test1();
  return 0;
}
