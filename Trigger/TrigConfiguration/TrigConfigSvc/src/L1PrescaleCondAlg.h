...
namespace TrigConf {
   ...
   private:
      ...
      mutable tbb::concurrent_unordered_map<unsigned int, std::shared_ptr<const L1PrescalesSet>> m_pssMap ATLAS_THREAD_SAFE;
      ...
      Gaudi::Property< unsigned int > m_psk { this, "L1Psk", 0, "L1 prescale key, used when property 'Source' set to 'DB' or 'FILE'" };
