...
#ifndef TRIGT1CALOEFEXANALYSIS_EFEXERATIORATEALGO
#define TRIGT1CALOEFEXANALYSIS_EFEXERATIORATEALGO
...
class EFexEratioRateAlgo : public AthAlgorithm
{
public :

	// Usual athena stuff
	EFexEratioRateAlgo( const std::string& name, ISvcLocator* pSvcLocator );
	virtual ~EFexEratioRateAlgo();
