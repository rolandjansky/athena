    ...
    def setRingerSelection(self):
        ...
        if 'noringer' in self.chainPart['addInfo'] or 'ion' in self.chainPart['extra']:
          ...
          self._ringer_selection=False
            ...
            log.debug('Special ringer chain: %s', self.chainPart['chainPartName'])
        ...
        log.debug("Apply ringer is set to: %s",self._ringer_selection)
...
############################### DEFINE GROUPS OF CHAINS HERE ##############################
    ...
    def setup_electron(self):
        ...
        if 'perf' in self.chainPartName:
            dofastrecseq=False
        log.debug('setup_electron %s: ringer is set to %s for %s GeV chains',self.chainName,self._ringer_selection,thr )
