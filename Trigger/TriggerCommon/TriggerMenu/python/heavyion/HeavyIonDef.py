...
###########################
    def setup_hi_ultraperipheral(self):
        ...
        chainSuffix=""
        if "gg" in self.chainPart['hypoL2Info'] or "loose" in self.chainPart['hypoL2Info'] or "medium" in self.chainPart['hypoL2Info'] or "tight" in self.chainPart['hypoL2Info']:
