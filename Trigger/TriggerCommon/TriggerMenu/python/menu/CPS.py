...
def defineCPSGroups():
    ...
    if "primaries"  not in TriggerFlags.triggerMenuSetup():
        ...
        'RATE:CPS:HLT_e5_tight_idperf':['e5_lhtight_idperf',],
        ...
        'RATE:CPS:HLT_e5_loose_idperf' : ['e5_lhloose_idperf',],        
        ...
        'RATE:CPS:HLT_e24_medium_idperf_L1EM20VH' :['e24_lhmedium_idperf_L1EM20VH',],
        ...
        'RATE:CPS:HLT_e5_tight_e4_etcut_Jpsiee' : ['e5_lhtight_e4_etcut_Jpsiee',
        ...
        "RATE:CPS:HLT_e60_vloose"        : ['e60_lhvloose', 
                                            'e60_lhvloose_nod0'],
        ...
        'RATE:CPS:HLT_e10_tight_idperf' :['e10_lhtight_idperf',],
        ...
        "RATE:CPS:HLT_e40_vloose"        : ['e40_lhvloose', 
                                            'e40_lhvloose_nod0'],
        ...
        "RATE:CPS:HLT_e17_vloose"        : ['e17_lhvloose',
                                            'e17_lhvloose_nod0'],
        ...
        'RATE:CPS:HLT_5j85_jes' : ['5j85_jes',
                               '5j85_lcw',
                               '5j85_lcw_jes',
                               '5j85_lcw_nojcalib',
                               '5j85_nojcalib',
        ...
        'RATE:CPS:HLT_e24_vloose_L1EM20VH' :['e24_lhvloose_L1EM20VH',
                                             'e24_lhvloose_nod0_L1EM20VH',],
                        
        'RATE:CPS:HLT_j420_jes' : ['j420_jes',
                               'j420_lcw',
                               'j420_lcw_jes',
                               'j420_lcw_nojcalib',
                             ],
   ...
   #                                    'xe100_pufit_wEFMu_L1XE50', 
        ...
        "RATE:CPS:HLT_e20_vloose"        : ['e20_lhvloose', 
                                            'e20_lhvloose_nod0'],
        ...
        "RATE:CPS:HLT_e15_vloose_L1EM13VH"        : ['e15_lhvloose_L1EM13VH',
                                                     'e15_lhvloose_nod0_L1EM13VH'],
               
        'RATE:CPS:HLT_j260_320eta490' : ['j260_320eta490_jes',
                                         'j260_320eta490_lcw',
        ...
        'RATE:CPS:HLT_e24_vloose_L1EM18VH': ['e24_lhvloose_L1EM18VH',
        ...
        "RATE:CPS:HLT_e12_vloose_L1EM10VH"        :  ['e12_lhvloose_L1EM10VH',
    ...
    if "v6"  in TriggerFlags.triggerMenuSetup():
        ...
        'RATE:CPS:HLT_j460_a10lcwL1J100' : [	'j460_a10_lcw_L1J100',],
...
#                                                                       ],
    ...
    if "v6" in TriggerFlags.triggerMenuSetup() or "v7" in TriggerFlags.triggerMenuSetup() and "primaries" not in TriggerFlags.triggerMenuSetup():
        ...
        'RATE:CPS:HLT_j460_a10_nojcalibL1J100' : [	'j460_a10_sub_L1J100',
    ...
    if "v7" in TriggerFlags.triggerMenuSetup():
        HLT_CPS_Groups.update({
        'RATE:CPS:HLT_j460_lcw_subjesL1J100' : ['j460_a10_lcw_subjes_L1J100',],
})
    ...
    if "v7" in TriggerFlags.triggerMenuSetup() and "primaries" not in TriggerFlags.triggerMenuSetup():
        ...
        'RATE:CPS:HLT_j380_a10rL1J100' : [ 'j380_a10r_L1J100' ,            
                                          'j380_a10_lcw_subjes_L1J100',],

        'RATE:CPS:HLT_j420_lcw_subjes_a10' : ['j420_a10_lcw_subjes_L1J100',
                                   #'j420_a10_lcw_sub_L1J100',
                                   #'j420_a10_sub_L1J100',
                                   'j420_a10r_L1J100',
        ],
