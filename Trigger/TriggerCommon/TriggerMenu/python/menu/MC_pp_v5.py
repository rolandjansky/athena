...
def setupMenu():
    ...
    TriggerFlags.JetSlice.signatures = TriggerFlags.JetSlice.signatures() + [
        ...
        #Partial scan
        ['j200_PS', 'L1_J100', [], [PhysicsStream], ['RATE:SingleJet', 'BW:Jets'], -1],         
        ['3j175_PS','L1_J100', [], [PhysicsStream], ['RATE:MultiJet', 'BW:Jets'], -1],
    ...
    'L1_J120', [], [PhysicsStream], ['RATE:SingleJet', 'BW:Jets'], -1],
        ...
        ['j60_280eta320',          'L1_J15.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ['j60_320eta490',          'L1_J15.32ETA49', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],

        ['j85_280eta320',           'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ['j85_280eta320_jes',       'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ['j85_280eta320_lcw',       'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ['j85_280eta320_lcw_jes',    'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ...
        #Forward jets
        ['j85_280eta320_nojcalib',         'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
        ['j85_280eta320_lcw_nojcalib',     'L1_J20.28ETA32', [], [PhysicsStream], ['RATE:SingleJet',  'BW:Jets'], -1],
    ...
    TriggerFlags.BjetSlice.signatures = TriggerFlags.BjetSlice.signatures() + [
        ...
        ### Run1 configuration
        # main menu
        ['2j75_bmedium_j75', 'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j70_btight_j70',  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ...
        # low lumi menu
        ['2j70_bmedium_j70',	 'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j65_btight_j65',      'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ...
        ['2j45_bmedium_2j45_L13J25.0ETA22', 'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j35_btight_2j35_L13J25.0ETA22',  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['j70_bmedium_3j70_L13J25.0ETA22',  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:SingleBJet', 'BW:Jets'], -1], 
        ['j65_btight_3j65_L13J25.0ETA22',    'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:SingleBJet', 'BW:Jets'], -1], 
        ...
        ### split configuration
        # main menu
        ['2j75_bmedium_split_j75',             	  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j70_btight_split_j70',                 'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ...
        # low lumi menu
        ['2j70_bmedium_split_j70',	          'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j65_btight_split_j65',	          'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ...
        ['2j45_bmedium_split_2j45_L13J25.0ETA22', 'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['2j35_btight_split_2j35_L13J25.0ETA22',  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:MultiBJet', 'BW:Jets'], -1], 
        ['j70_bmedium_split_3j70_L13J25.0ETA22',  'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:SingleBJet', 'BW:Jets'], -1], 
        ['j65_btight_split_3j65_L13J25.0ETA22',   'L1_3J25.0ETA22',	[], [PhysicsStream], ['RATE:SingleBJet', 'BW:Jets'], -1], 
    ...
    TriggerFlags.EgammaSlice.signatures = TriggerFlags.EgammaSlice.signatures() + [
        ...
        ['e60_medium',                           'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ['e120_loose',                           'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ['e140_loose',                           'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['e60_lhmedium',                         'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e120_lhloose',                         'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e140_lhloose',                         'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ...
        ['e60_vloose',                          'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e70_vloose',                          'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e80_vloose',                          'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e100_vloose',                         'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e120_vloose',                         'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ...
        ['e60_lhvloose',                        'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e70_lhvloose',                        'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e80_lhvloose',                        'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e100_lhvloose',                       'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e120_lhvloose',                       'L1_EM50V',     [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ...
        ['e60_etcut',                            'L1_EM50V',  [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e80_etcut',                            'L1_EM50V',  [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e100_etcut',                           'L1_EM50V',  [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ['e120_etcut',                           'L1_EM50V',  [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1], 
        ...
        ['e60_loose',                            'L1_EM50V',    [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ['e70_loose',                            'L1_EM50V',    [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['e60_lhloose',                          'L1_EM50V',   [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ['e70_lhloose',                          'L1_EM50V',   [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['g120_loose_HLTCalo',                    'L1_EM50V',    [], [PhysicsStream], ['RATE:SinglePhoton','BW:Egamma'], 1],
        ...
        ### NOT IN THE LIST ['e65_loose1',                       'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ### NOT IN THE LIST ['e80_loose1',                       'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ### NOT IN THE LIST ['e100_loose1',                      'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ['e120_loose1',  'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['e60_medium1',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ### NOT IN THE LIST ['e60_loose1',                       'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['g120_loose',                    'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton','BW:Egamma'], 1], 
        ['g140_loose',                    'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton','BW:Egamma'], 1],         
        ...
        ['g80_loose',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], -1], 
        ['g100_loose',                    'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], -1], 
        ...
        ['g60_loose',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], 1],
        ['g70_loose',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], 1],
        ...
        #['g60_etcut',                      'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        #['g80_etcut',                      'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        #['g100_etcut',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        #['g120_etcut',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ### NOT IN THE LIST ['g60_loose1',                      'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], 1],
        ### NOT IN THE LIST ['g80_loose1',                      'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], 1],
        ### NOT IN THE LIST ['g100_loose1',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], 1],
        
        # Run 2 Baseline chains
        ### NOT IN THE LIST ['g120_loose1',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton','BW:Egamma'], 1],
        ### NOT IN THE LIST ['g140_loose1',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton','BW:Egamma'], 1],
        ...
        ['g0_hiptrt_L1EM50V',                     'L1_EM50V', [], [PhysicsStream], ['RATE:SinglePhoton', 'BW:Egamma'], -1], 
    ...
    TriggerFlags.CombinedSlice.signatures = TriggerFlags.CombinedSlice.signatures() + [
        ...
        ['g70_loose_xe70noL1',              'L1_EM50V',    ['L1_EM50V',''],    [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["g70_loose","xe70noL1"]]],
        ['g60_loose_xe60noL1',              'L1_EM50V',    ['L1_EM50V',''],    [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["g60_loose","xe60noL1"]]],
        ...
        ['e70_loose_xe70noL1',              'L1_EM50V',['L1_EM50V',''], [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["e70_loose","xe70noL1"]]],
        ['e60_loose_xe60noL1',              'L1_EM50V',['L1_EM50V',''], [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["e60_loose","xe60noL1"]]],
        ['e70_lhloose_xe70noL1',            'L1_EM50V',['L1_EM50V',''], [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["e70_lhloose","xe70noL1"]]],
        ['e60_lhloose_xe60noL1',            'L1_EM50V',['L1_EM50V',''], [PhysicsStream], ['RATE:EgammaMET', 'BW:Egamma'], -1,['serial',-1,["e60_lhloose","xe60noL1"]]],
    ...
    TriggerFlags.StreamingSlice.signatures = TriggerFlags.StreamingSlice.signatures() + [
        ...
        ['noalg_L11INVM5-EMs2-EMall',     'L1_1INVM5-EMs2-EMall',   [], [PhysicsStream], ["RATE:L1TopoStreamers", "BW:Other"], -1 ], 
        ['noalg_L11INVM5-EM7s2-EMall',    'L1_1INVM5-EM7s2-EMall',   [], [PhysicsStream], ["RATE:L1TopoStreamers", "BW:Other"], -1 ], 
        ['noalg_L11INVM5-EM12s2-EMall',   'L1_1INVM5-EM12s2-EMall',   [], [PhysicsStream], ["RATE:L1TopoStreamers", "BW:Other"], -1 ], 
