...
def getL1TopoSeed(l1items):
    l1topo_seeds = ",".join([ x for x in l1items if "-" in x ])
    return l1topo_seeds
...
def getEBnoL1PSSeed(l1items, l1seedname):
    ...
    if ('L1_PhysicsLow' in l1seedname):
      noL1PS_seeds = 'L1_2MU6,L1_3MU4,L1_2EM15,L1_EM15HI_2TAU12IM_J25_3J12,L1_EM15HI_2TAU12IM_XE35,L1_EM15HI_TAU40_2TAU15,L1_EM15VH_MU10,L1_EM15VH_3EM7,L1_EM22VHI,L1_2EM8VH_MU10,L1_MU10_TAU12IM_J25_2J12,L1_MU10_TAU12IM_XE35,L1_MU10_TAU20,L1_MU4_3J15,L1_J75,L1_3J40,L1_4J15,L1_XE50,L1_2J15_XE55,L1_TAU60,L1_TAU20_2TAU12_XE35,L1_TAU20IM_2TAU12IM_J25_2J20_3J12,L1_TAU20IM_2TAU12IM_XE35,L1_TAU20IM_2J20_XE45,L1_MU20'
    elif ('L1_PhysicsHigh' in l1seedname):
      noL1PS_seeds = 'L1_XE80,L1_J100.31ETA49,L1_3MU6,L1_J400'
    elif ('L1_EMPTY' in l1seedname):
      noL1PS_seeds = 'L1_J12_EMPTY'
    elif ('L1_FIRSTEMPTY' in l1seedname):
      noL1PS_seeds = 'L1_J12_FIRSTEMPTY'
    elif ('L1_UNPAIRED_ISO' in l1seedname):
      noL1PS_seeds = 'L1_J12_UNPAIRED_ISO,L1_J30.31ETA49_UNPAIRED_ISO,L1_BCM_Wide_UNPAIRED_ISO,L1_BCM_AC_UNPAIRED_ISO,L1_BCM_CA_UNPAIRED_ISO'
...
def getL1LowLumi(l1seed):
    ...
    L1LowLumi_seeds = 'L1_EM20VH,L1_2EM10VH,L1_MU15,L1_2MU6,L1_3MU4,L1_EM15VH_MU10,L1_EM15I_MU4,L1_EM7_MU10,L1_2EM8VH_MU10,L1_TAU60,L1_TAU20IM_2TAU12IM_J25_2J20_3J12,L1_TAU20_2J20_XE45,L1_EM15HI_2TAU12IM_XE35,L1_MU10_TAU12IM_XE35,L1_TAU20_2TAU12_XE35,L1_TAU20IM_2TAU12IM_XE35,L1_EM15HI_2TAU12IM,L1_EM15HI_2TAU12IM_J25_3J12,L1_EM15HI_TAU40_2TAU15,L1_MU10_TAU20,L1_MU10_TAU12_J25_2J12,L1_MU10_TAU12IM_J25_2J12,L1_MU10_TAU12IM,L1_J75,L1_4J15,L1_XE50,L1_3J25.0ETA23,L1_3J40,L1_2J15_XE55,L1_MU6_J40,L1_J75.31ETA49,L1_MU4_3J20'
