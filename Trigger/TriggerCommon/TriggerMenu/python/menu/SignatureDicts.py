...
MinBiasChainParts = {
    ...
    'IDinfo'         : [],
    'ZDCinfo'        : ['lg', 'hg'],
    'trkInfo'        : ['hlttr', 'ftk', 'costr','FTKVtx'],
    ...
    'recoAlg'        : ['mbts', 'sptrk', 'sp', 'noalg', 'perf', 'hmt', 'hmftk', 'hmtperf', 'idperf', 'zdcperf'],
    'addInfo'        : ['peb','hipeb'],
