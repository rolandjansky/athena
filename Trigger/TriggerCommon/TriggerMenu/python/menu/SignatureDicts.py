...
JetChainParts = {
    ...
    'scan'         : ['FS','PS'],
    'addInfo'      : ['perf'],    
    'TLA'          : ['1i2c200m400TLA', '1i2c400m600TLA', '1i2c600m800TLA',
                      '1i2c800m1000TLA',
                      '2i3c100m300TLA','2i3c300m500TLA','2i3c500m700TLA',
                      '2i3c100m8000TLA','2i3c200m8000TLA'],
...
MuonChainParts = {
    ...
    'extra'          : ['noL1'],
    'IDinfo'         : [],
    'isoInfo'        : ['iloose', 'imedium', 'itight', 'ivarloose', 'ivarmedium'],
    'reccalibInfo'   : ['msonly', 'l2msonly', 'l2idonly', 'idperf','muoncalib', 'mucombTag','muL2'],
