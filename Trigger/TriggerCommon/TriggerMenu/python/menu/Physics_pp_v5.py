...
def setupMenu():
 ...
 #Beamspot chanis first try ATR-9847                                                                                                               
	...
	#others
        ...
        ['noalg_mb_L1RD0_UNPAIRED_ISO',   'L1_RD0_UNPAIRED_ISO', [], ['MinBias'], ["RATE:Minbias", "BW:Minbias"], -1],
        ['noalg_mb_L1RD1_EMPTY',          'L1_RD1_EMPTY',        [], ['MinBias'], ["RATE:Cosmic_Minbias", "BW:MinBias"], -1],
