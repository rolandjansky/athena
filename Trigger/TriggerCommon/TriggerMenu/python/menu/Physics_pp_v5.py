...
# taumass chains
 ...
 #Beamspot chanis first try ATR-9847                                                                                                               
	...
	['mb_sptrk_pt4_L1RD3_FILLED',                 'L1_RD3_FILLED', [], ['MinBias'], ["RATE:MinBias", "BW:MinBias"], -1],
        ...
        #perf                                                                                                                                
        ['mb_sp1400_hmtperf_L1TE10', 'L1_TE10', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_hmtperf_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_hmtperf_L1TE10.0ETA24', 'L1_TE10.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_hmtperf_L1TE20.0ETA24', 'L1_TE20.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1400_trk100_hmt_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_trk100_hmt_L1TE20.0ETA24', 'L1_TE20.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp300_trk10_sumet50_hmt_L1TE10', 'L1_TE10', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp600_trk10_sumet50_hmt_L1TE10.0ETA24', 'L1_TE10.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp300_trk10_sumet60_hmt_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp600_trk10_sumet60_hmt_L1TE20.0ETA24', 'L1_TE20.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp2500_hmtperf_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],

	#ATR-9999
	['mb_sp2_hmtperf_L1TE0', 'L1_TE0', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	['mb_sp2_hmtperf_L1TE0.0ETA24', 'L1_TE0.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp1300_hmtperf_L1TE15', 'L1_TE15', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp1500_hmtperf_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1500_hmtperf_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1500_hmtperf_L1TE15', 'L1_TE15', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp1700_hmtperf_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1700_hmtperf_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1700_hmtperf_L1TE15', 'L1_TE15', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp900_pusup350_trk60_hmt_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp900_pusup350_trk60_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp1400_trk90_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	['mb_sp1400_trk90_hmt_L1TE10', 'L1_TE10', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_trk90_hmt_L1TE10.0ETA24', 'L1_TE10.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
	...
	['mb_sp1400_pusup550_trk90_hmt_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1400_pusup550_trk90_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1600_trk100_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1600_pusup550_trk100_hmt_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE10', 'L1_TE10', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE10.0ETA24', 'L1_TE10.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE15', 'L1_TE15', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1600_pusup550_trk100_hmt_L1TE20.0ETA24', 'L1_TE20.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['mb_sp1800_pusup600_trk110_hmt_L1TE5', 'L1_TE5', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE5.0ETA24', 'L1_TE5.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE10', 'L1_TE10', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE10.0ETA24', 'L1_TE10.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE15', 'L1_TE15', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE20', 'L1_TE20', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ['mb_sp1800_pusup600_trk110_hmt_L1TE20.0ETA24', 'L1_TE20.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
...
#        ['larhec_L1RD0_FIRSTEMPTY', 'L1_RD0_FIRSTEMPTY', [], ['LArCellsEmpty'], ['RATE:CosmicSlice', 'RATE:Cosmic_LArCalibration', 'BW:Detector'], -1],
    ...
    TriggerFlags.StreamingSlice.signatures = [
        ...
        ['noalg_mb_L1TE0',  'L1_TE0', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['noalg_mb_L1TE20',  'L1_TE20', [], ['MinBias', 'express'], ["BW:MinBias", "RATE:MinBias"], -1],
        ...
        ['noalg_mb_L1TE0.0ETA24',  'L1_TE0.0ETA24', [], ['MinBias'], ["BW:MinBias", "RATE:MinBias"], -1],
...
#
	...
	['noalg_L1J20',  'L1_J20',   [], [PhysicsStream], ["RATE:SeededStreamers", "BW:Jets"], -1 ],
        ...
        ['noalg_L1TE0',  'L1_TE0', [], [PhysicsStream], ["RATE:SeededStreamers", "BW:MET"], -1 ],
        ...
        ['noalg_L1TE0.0ETA24',  'L1_TE0.0ETA24', [], [PhysicsStream], ["RATE:SeededStreamers", "BW:MET"], -1 ],
...
chain_list=[
    ...
    'mb_sp1400_hmtperf_L1TE10.0ETA24',
    'mb_sp1400_hmtperf_L1TE20',
    'mb_sp1400_hmtperf_L1TE20.0ETA24',
    ...
    'mb_sp1400_pusup550_trk90_hmt_L1TE5.0ETA24',
    'mb_sp1400_trk100_hmt_L1TE20',
    'mb_sp1400_trk100_hmt_L1TE20.0ETA24',
    ...
    'mb_sp1400_trk90_hmt_L1TE5.0ETA24',
    'mb_sp1500_hmtperf_L1TE10',
    'mb_sp1500_hmtperf_L1TE10.0ETA24',
    'mb_sp1500_hmtperf_L1TE15',
    'mb_sp1500_hmtperf_L1TE20',
    'mb_sp1500_hmtperf_L1TE20.0ETA24',
    'mb_sp1500_hmtperf_L1TE5',
    'mb_sp1500_hmtperf_L1TE5.0ETA24',
    'mb_sp1600_pusup550_trk100_hmt_L1TE10',
    'mb_sp1600_pusup550_trk100_hmt_L1TE10.0ETA24',
    'mb_sp1600_pusup550_trk100_hmt_L1TE15',
    'mb_sp1600_pusup550_trk100_hmt_L1TE20',
    'mb_sp1600_pusup550_trk100_hmt_L1TE20.0ETA24',
    'mb_sp1600_pusup550_trk100_hmt_L1TE5',
    'mb_sp1600_pusup550_trk100_hmt_L1TE5.0ETA24',
    ...
    'mb_sp1600_trk100_hmt_L1TE5.0ETA24',
    'mb_sp1700_hmtperf_L1TE10',
    'mb_sp1700_hmtperf_L1TE10.0ETA24',
    'mb_sp1700_hmtperf_L1TE15',
    'mb_sp1700_hmtperf_L1TE20',
    'mb_sp1700_hmtperf_L1TE20.0ETA24',
    'mb_sp1700_hmtperf_L1TE5',
    'mb_sp1700_hmtperf_L1TE5.0ETA24',
    'mb_sp1800_hmtperf',
    'mb_sp1800_hmtperf_L1TE30.0ETA24',
    'mb_sp1800_pusup600_trk110_hmt_L1TE10',
    'mb_sp1800_pusup600_trk110_hmt_L1TE10.0ETA24',
    'mb_sp1800_pusup600_trk110_hmt_L1TE15',
    'mb_sp1800_pusup600_trk110_hmt_L1TE20',
    'mb_sp1800_pusup600_trk110_hmt_L1TE20.0ETA24',
    'mb_sp1800_pusup600_trk110_hmt_L1TE5',
    'mb_sp1800_pusup600_trk110_hmt_L1TE5.0ETA24',
    ...
    'mb_sp600_trk10_sumet50_hmt_L1TE10.0ETA24',
    'mb_sp600_trk10_sumet60_hmt_L1MBTS_1_1',
    'mb_sp600_trk10_sumet60_hmt_L1TE20.0ETA24',
    ...
    'mb_sp900_pusup350_trk60_hmt_L1TE5',
    'mb_sp900_pusup350_trk60_hmt_L1TE5.0ETA24',
