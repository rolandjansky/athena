...
class TauHypoProvider:
    ...
    def GetHypo(self, level, threshold, criteria, part, strategy):
        ...
        if strategy == 'calo' or strategy =='ptonly' or strategy == 'mvonly' or strategy == 'caloonly' or strategy == 'track' or strategy == 'trackonly' or strategy == 'tracktwo' or strategy == 'tracktwoEF' or strategy == 'tracktwoEFmvaTES' or strategy == 'tracktwoMVA' or strategy == 'tracktwoMVABDT' or strategy == 'tracktwoRNN' or strategy == 't2MVA' or strategy == 'trackcalo' or strategy == 'tracktwocalo' or strategy == 'tracktwo2015' or strategy == 'FTK' or strategy == 'FTKRefit' or strategy == 'FTKNoPrec':
            ...
            if part == 'id':
                ...
                # accept 0p taus in FTK chains
                    ...
                    if strategy != 'tracktwo' and strategy != 'tracktwoEF' and strategy != 'tracktwoEFmvaTES' and strategy != 'tracktwoMVA' and strategy != 'tracktwoMVABDT' and strategy != 'tracktwoRNN' and strategy != 't2MVA' and strategy != 'FTK' and strategy != 'FTKRefit' and strategy != 'FTKNoPrec':
                        theVars = ['LowerPtCut','LowerTrackPtCut']
                        theThresh = [int(threshold)*self.GeV,1.*self.GeV]
                        currentHypo = HLTTrackTauHypo(currentHypoKey, theVars, theThresh)
                    elif strategy == 'tracktwoMVA' or strategy == 'tracktwoMVABDT' or strategy == 't2MVA' or strategy == 'tracktwoRNN':
                        theVars = ['NTrackMin','NTrackMax','NWideTrackMax','EtCalibMin', 'Level','Method']
                        theThresh = [0,3,1,0.*self.GeV,-1111,0]
                        if strategy == 'tracktwoRNN':
                            theVars.extend(['RejectRNN0p'])
                            theThresh.extend([True])
                        currentHypo = EFTauMVHypo(currentHypoKey, theVars, theThresh)
                    else:
                        theVars = ['NTrackMin','NTrackMax','NWideTrackMax','EtCalibMin', 'Level','Method']
