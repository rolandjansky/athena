...
#ATR-19302: giving compilation issues, add later
        TopoOutput( algoname='0INVM70-27DPHI32-EM10his1-EM10his6',          module=1, fpga=0, clock=0, firstbit=16 ),
        TopoOutput( algoname='0INVM70-27DPHI32-EM10his1-EM12his6',          module=1, fpga=0, clock=0, firstbit=17 ),
...
# ATR-15197        TopoOutput( algoname='2INVM9-MU6ab-MU4ab',                          module=1, fpga=1, clock=1, firstbit=15 ), #v6
        ...
        TopoOutput( algoname='2DISAMB-J25ab-0DR28-TAU20abi-TAU12abi',       module=1, fpga=1, clock=1, firstbit=3 ), 
