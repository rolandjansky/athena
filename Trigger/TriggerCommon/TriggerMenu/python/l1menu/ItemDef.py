  ...
  # ATR-12470
    ...
    #                     LVL1MenuItem('L1_BPH-4M8-MU6MU4-BO').setLogic( TOPO_4INVM8_CMU6ab_CMU4ab & physcond)    # noqa: F821
                    ...
                    if '_v7' in TriggerFlags.triggerMenuSetup() or 'HI_v5' in TriggerFlags.triggerMenuSetup() or '_PhaseII' in TriggerFlags.triggerMenuSetup():
                        LVL1MenuItem('L1_63DETA-J30J15').setLogic( TOPO_63DETA127_FJ20s1_FJ20s2 & physcond)
                    if '_v8' in TriggerFlags.triggerMenuSetup() or '_v7' in TriggerFlags.triggerMenuSetup() or 'HI_v5' in TriggerFlags.triggerMenuSetup() or '_PhaseII' in TriggerFlags.triggerMenuSetup():
                    ...
                    if '_v8' in TriggerFlags.triggerMenuSetup():     
                        ...
                        LVL1MenuItem('L1_MJJ-400-0DPHI20').setLogic( TOPO_400INVM9999_0DPHI20_AJ30s6_AJ20s6 & physcond)    # noqa: F821
                        LVL1MenuItem('L1_MJJ-400-0DPHI22').setLogic( TOPO_400INVM9999_0DPHI22_AJ30s6_AJ20s6 & physcond)    # noqa: F821
                        LVL1MenuItem('L1_MJJ-400-0DPHI24').setLogic( TOPO_400INVM9999_0DPHI24_AJ30s6_AJ20s6 & physcond)    # noqa: F821
                        LVL1MenuItem('L1_MJJ-400-0DPHI26').setLogic( TOPO_400INVM9999_0DPHI26_AJ30s6_AJ20s6 & physcond)    # noqa: F821
