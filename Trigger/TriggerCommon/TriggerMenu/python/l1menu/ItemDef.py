...
class ItemDef:
    ...
    def registerItems(tm):
        ...
        #FTK items
        LVL1MenuItem('L1_MU6_FTK').setLogic( d.MU6  & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_MU15_FTK').setLogic( d.MU15  & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_MU20_FTK').setLogic( d.MU20  & physcond).setTriggerType(TT.ftk)
        ...
        #FTK items
        LVL1MenuItem('L1_TAU12IM_FTK').setLogic( d.HA12IM & physcond).setTriggerType( TT.ftk)
        LVL1MenuItem('L1_TAU20IM_FTK').setLogic( d.HA20IM & physcond).setTriggerType( TT.ftk)
        LVL1MenuItem('L1_MU20_TAU12IM_FTK').setLogic( d.MU20 & d.HA12IM & physcond).setTriggerType( TT.ftk)
        LVL1MenuItem('L1_TAU20IM_2TAU12IM_J25_2J20_3J12_FTK').setLogic( d.HA20IM & d.HA12IM.x(2)     & d.J25 & d.J20.x(2) & d.J12.x(3) & physcond).setTriggerType( TT.ftk )
        LVL1MenuItem('L1_DR-TAU20ITAU12I-J25_FTK').setLogic( d.TOPO_1DISAMB_J25ab_0DR28_TAU20abi_TAU12abi & physcond).setTriggerType(TT.ftk)
        ...
        #FTK items
        LVL1MenuItem('L1_4J15_FTK'   ).setLogic( d.J15.x(4)    & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_4J20_FTK'   ).setLogic( d.J20.x(4)    & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_4J15.0ETA25_FTK' ).setLogic( d.J150ETA25.x(4) & physcond).setTriggerType(TT.ftk) 
        LVL1MenuItem('L1_J100_FTK'  ).setLogic( d.J100 & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_J15_FTK'   ).setLogic( d.J15  & physcond).setTriggerType(TT.ftk)
        LVL1MenuItem('L1_J40_FTK'   ).setLogic( d.J40  & physcond).setTriggerType(TT.ftk)
...
#        LVL1MenuItem('L1_ZB_J20').setLogic(ZB_EM15 & d.J20 & physcond).setTriggerType(TT.zerobs)
  ...
  # ATR-12470
        ...
        LVL1MenuItem('L1_EM3_ALFA_ANY_VETO_MBTS' ).setLogic( d.EM3 & ALFA_ANY  & Not(MBTS_INNER) & physcond).setTriggerType(TT.alfa)
        LVL1MenuItem('L1_EM3_ALFA_EINE'          ).setLogic( d.EM3 & ALFA_EINE & physcond).setTriggerType(TT.alfa)
        LVL1MenuItem('L1_EM3_ALFA_EINE_VETO_MBTS').setLogic( d.EM3 & ALFA_EINE & Not(MBTS_INNER) & physcond).setTriggerType(TT.alfa)
        ...
        LVL1MenuItem('L1_TRT_ALFA_ANY_VETO_MBTS'           ).setLogic( d.NIMTRT & Not(MBTS_INNER) & ALFA_ANY & physcond).setTriggerType(TT.alfa)

        LVL1MenuItem('L1_TRT_ALFA_EINE'                    ).setLogic( d.NIMTRT & ALFA_EINE & physcond).setTriggerType(TT.alfa)
        LVL1MenuItem('L1_TRT_ALFA_EINE_VETO_MBTS'          ).setLogic( d.NIMTRT & Not(MBTS_INNER) & ALFA_EINE & physcond).setTriggerType(TT.alfa)
...
#                    LVL1MenuItem('L1_CMU6_2CMU4').setLogic( d.TOPO_MULT_CMU4ab.x(2) & d.TOPO_MULT_CMU6ab & physcond) # MU6_2MU4_BarrelOnly
