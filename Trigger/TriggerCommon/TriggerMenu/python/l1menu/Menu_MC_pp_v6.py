...
def defineMenu():
    ...
    Lvl1Flags.thresholds = [
        ...
        # 16 x EM
        'EM3', 'EM7', 'EM8VH', 'EM8I', 'EM10VH', 'EM12', 'EM13VH', 'EM15', 'EM15VH', 'EM15I', 'EM15HI', 'EM18VH', 'EM20VH', 'EM20VHI', 'EM22VHI', 'EM24VHI', 
        ...
        # 3 x Central Jet
        'JJ15.23ETA49','J40.0ETA25', 'J20.28ETA31',
       ...
       'BPTX0','BPTX1',
        ...
        #ZH 
        '10MINDPHI-AJ20s2-XE50', '10MINDPHI-Js2-XE50', '10MINDPHI-J20s2-XE50', '10MINDPHI-J20ab-XE50', '10MINDPHI-CJ20ab-XE50', 
        #Jpsi T&P
...
#SX        '2DR15-CMU6ab-CMU4ab',
    ...
    Lvl1Flags.items = [
        ...
        'L1_EM3','L1_EM7','L1_EM12', 'L1_EM8VH', 'L1_EM8I', 'L1_EM10VH', 'L1_EM13VH', 'L1_EM15','L1_EM15I', 'L1_EM15HI','L1_EM15VH', 'L1_EM18VH', 'L1_EM20VH', 'L1_EM20VHI', 'L1_EM22VHI', 'L1_EM24VHI', # see Jira ATR-10334'L1_EM22VHLIL', #'L1_EM50V',
...
#        "L1_TAU20IM_2TAU12IM_XE40",  
        ...
        'L1_MU4_3J15', 'L1_MU4_3J20','L1_MU4_J30',
        #'L1_MU4_J50',
        ...
        "L1_3J15", "L1_3J20","L1_3J40", 'L1_3J15.0ETA25', "L1_3J50", "L1_4J15", "L1_4J20", "L1_4J20.0ETA49",
        #"L1_3J75",
        #"L1_4J30",
        "L1_6J15",
        "L1_J75_3J20", "L1_J30.0ETA49_2J20.0ETA49","L1_J40.0ETA25_2J15.31ETA49","L1_J40.0ETA25_2J25_J20.31ETA49",
        
        # multi jet central
        "L1_3J25.0ETA23", "L1_4J15.0ETA25", "L1_5J15.0ETA25", 
        
        # combined jet
        "L1_2J15_XE55", "L1_J40_XE50", "L1_J75_XE40", "L1_J75_XE50", "L1_J30.0ETA49_XE50",
...
#        'L1_MBTSC10','L1_MBTSC12','L1_MBTSC14',
        ...
        # ZH
        'L1_DPHI-AJ20s2XE50', 'L1_J40_DPHI-Js2XE50', 'L1_J40_DPHI-J20s2XE50', 'L1_J40_DPHI-J20XE50', 'L1_J40_DPHI-CJ20XE50',
...
#new bhysics
        ...
        'L1_BPH-2M8-MU6MU4_BPH-0DR15-MU6MU4',
...
#SX adding
        ...
        'L1_BPH-2M8-2MU4_BPH-0DR15-2MU4'  : 296,
        'L1_BPH-7M15-2MU4_BPH-0DR24-2MU4'  : 297,
        'L1_BPH-2M8-MU6MU4_BPH-0DR15-MU6MU4'  : 298,
