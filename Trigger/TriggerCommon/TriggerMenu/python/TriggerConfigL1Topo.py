...
#            self.registeredAlgos[name].algoId=self.runningid
    ...
    def defineMenu(menuName = None ):
        ...
        from TriggerJobOpts.TriggerFlags import TriggerFlags
        menumodule = __import__('TriggerMenu.l1topomenu.Menu_%s' % menuName.replace("_primaries",""), globals(), locals(), ['defineMenu'])
    ...
    def registerMenu(self):
        ...
        """
        algodefmodule = __import__('TriggerMenu.l1topomenu.TopoAlgoDef', globals(), locals(), ['TopoAlgoDef'])
