...
#Rulebook to use
BOOK=$TestArea/Trigger/TriggerCommon/TriggerMenuPython/rules/Physics_pp_rulebook_PT.txt
#Bandwidth file for the express stream
ES_REF1=$TestArea/Trigger/TriggerCommon/TriggerMenuPython/rules/bw_express.txt
#Rates for the bandwidth calculation
ES_REF2=$TestArea/Trigger/TriggerCommon/TriggerMenuPython/rules/online_rates_1_39e31_165632_350_400.xml
INPUT_RATE=13900
...
for LUMI in $POINTS; do
    ...
    python $TestArea/Trigger/TriggerCommon/TriggerMenuPython/scripts/cnvXml_express.py \
        --lv1xml=$L1XML \
        --hltxml=$HLTXML \
