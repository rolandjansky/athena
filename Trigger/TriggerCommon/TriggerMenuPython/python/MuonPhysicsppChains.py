...
Muons += [
    L2EFChain_mu_MSonly('mu22_IDTrkNoCut_tight_IDT',7648),
]
...
Muons += [
    ...
    # 2012 version for comparison with new alg
    L2EFChain_mu_EFFSonly_2012('mu24_mu6_EFFSOnly_2012',  135, 2, TrigMuonEFCombinerMultiHypoConfig('Muon', '24GeV', '6GeV')),
    ...
    L2EFChain_mu_Seeded_EFFS('mu24_tight_mu6_EFFS_2012', mu24_tight_TMEFonly,  'mu24_mu6_EFFSOnly_2012', 547),
