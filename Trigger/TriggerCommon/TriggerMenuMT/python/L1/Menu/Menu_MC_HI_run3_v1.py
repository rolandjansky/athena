...
def defineMenu():
    ...
    L1MenuFlags.items = [
        ...
        # RNDM
        'L1_RD0_FILLED', 'L1_RD0_UNPAIRED_ISO',  'L1_RD0_EMPTY', 'L1_RD0_FIRSTINTRAIN',
        ...
        'L1_BCM_2A_UNPAIRED_ISO',    'L1_BCM_2C_UNPAIRED_ISO',
        'L1_BCM_2A_UNPAIRED_NONISO', 'L1_BCM_2C_UNPAIRED_NONISO',
