...
def setupMenu():
    ...
    TriggerFlags.TestSlice.signatures = [
        ...
        # combined
        ChainProp(name='HLT_TestChain6_muv1_TestChain10_ev1_L1EM7_MU10', l1SeedThresholds=['MU10','EM7'], stream=['Main'], groups=['RATE:Test','BW:Other'], mergingStrategy = 'parallel'), 
        ChainProp(name='HLT_TestChain6_muv2_TestChain8_ev2_L1EM7_MU10',  l1SeedThresholds=['MU10','EM7'], stream=['Main'], groups=['RATE:Test','BW:Other'], mergingStrategy = 'parallel'),
        ChainProp(name='HLT_TestChain5_ev1_TestChain8_ev1_L12EM3',      stream=['Main'], groups=['RATE:Test','BW:Other'], mergingStrategy = 'parallel'),
#        ChainProp(name='HLT_TestChain5_ev1_TestChain8_ev1_2TestChain6_muv1_L1EM3_L1EM3_L12MU6', stream=['Main'], groups=['RATE:Test','BW:Other']   ),
        ...
        ChainProp(name='HLT_TestChain6_muv1_TestChain5_ev1dr_L1EM7_MU10', l1SeedThresholds=['MU10','EM7'], stream=['Main'], groups=['RATE:Test','BW:Other'], mergingStrategy = 'parallel'), 
        ChainProp(name='HLT_2TestChain4_muv1dr_L12MU6', stream=['Main'], groups=['RATE:Test','BW:Other'] ),

        # FSNOSEED not implemented in emulation
        ChainProp(name='HLT_TestChain10_muEmpty1_TestChain6_muEmpty1_L12MU6',  l1SeedThresholds=['MU6','MU6'],  stream=['Main'], groups=['RATE:Test','BW:Other'], mergingStrategy = 'parallel') 
