...
def setupMenu():
    ...
    TriggerFlags.TauSlice.signatures = TriggerFlags.TauSlice.signatures() + [
        ...
        # ATR-20450
        ChainProp(name="HLT_tau35_mediumRNN_tracktwoMVA_tau25_mediumRNN_tracktwoMVA_L1TAU20IM_2TAU12IM_4J12p0ETA25",  l1SeedThresholds=['TAU20IM','TAU12IM'], groups=MultiTauGroup),
    ]
