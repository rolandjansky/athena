...
def setupMenu():
    ...
    TriggerFlags.EgammaSlice.signatures = [
        ...
        #--------- primary special
        ChainProp(name='HLT_e20_lhtight_ivarloose_L1ZAFB-25DPHI-eEM18I', l1SeedThresholds=['EM12'], groups=PrimaryLegGroup+SingleElectronGroup), 
        ...
        ChainProp(name='HLT_2g15_tight_L1DPHI-M70-2eEM12I', l1SeedThresholds=['EM12'], groups=SupportLegGroup+SinglePhotonGroup), 
    ...
    TriggerFlags.JetSlice.signatures = [
        ...
        ChainProp(name='HLT_j260_320eta490_L1J75_31ETA49', l1SeedThresholds=['FSNOSEED'], groups=SingleJetGroup),
        ...
        ChainProp(name='HLT_j460_a10t_lcw_jes_L1J100', l1SeedThresholds=['FSNOSEED'], groups=PrimaryLegGroup+SingleJetGroup),
        ...
        ChainProp(name='HLT_5j70_0eta240_L14J20', l1SeedThresholds=['FSNOSEED'], groups=MultiJetGroup), # this chain is supposed to be seeded off L1_4J15 in principle, needs CF fix
        ChainProp(name='HLT_3j200_L1J100', l1SeedThresholds=['FSNOSEED'], groups=MultiJetGroup),
        # FP: workaround tmp for l1SeedThresholds
        ChainProp(name='HLT_j80_L1J15', l1SeedThresholds=['FSNOSEED'], groups=['PS:Online']+SingleJetGroup),
        ChainProp(name='HLT_2j60_L1J15', l1SeedThresholds=['FSNOSEED'], groups=['PS:Online']+MultiJetGroup),
    ...
    TriggerFlags.BjetSlice.signatures = [
        ChainProp(name='HLT_j225_subjesgscIS_ftf_bmv2c1040_split_L1J100',   l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j275_subjesgscIS_ftf_bmv2c1060_split_L1J100',   l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j300_subjesgscIS_ftf_bmv2c1070_split_L1J100',   l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j360_subjesgscIS_ftf_bmv2c1077_split_L1J100',   l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j275_pf_subjesgscIS_ftf_boffperf_split_L1J100', l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j45_pf_subjesgscIS_ftf_boffperf_split_L1J20',   l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j45_subjesgscIS_ftf_boffperf_split_L1J20',      l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
        ChainProp(name='HLT_j275_subjesgscIS_ftf_boffperf_split_L1J100',    l1SeedThresholds=['FSNOSEED'], groups=SingleBjetGroup),
    ]
