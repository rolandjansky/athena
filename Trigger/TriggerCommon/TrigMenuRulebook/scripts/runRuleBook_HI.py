...
if doDBRuleBookDownload:
    ...
    rulebook = ["Physics_HI_v2_rules", "Cosmic_HI_v1_rules", "Standby_HI_v2_rules", "VdM_HI_v2_rules"]
...
#filled_bunches = 296   
empty_bunches = 1000
empty_after_filled_bunches = 1000
unp_iso_bunches = 100
unp_noniso_bunches = 60
...
#l1_xml = "/afs/cern.ch/atlas/software/releases/17.1.6/AtlasCAFHLT/17.1.6.2.1/InstallArea/XML/TriggerMenuXML/LVL1config_Physics_HI_v2.xml"
#hlt_xml = "/afs/cern.ch/atlas/software/releases/17.1.6/AtlasCAFHLT/17.1.6.2.1/InstallArea/XML/TriggerMenuXML/HLTconfig_Physics_HI_v2_17.1.6.2.1.xml"
...
#        command = "--rulebook=%s --log=rulebook_%s.log --use_lowest_rule --no-bgrp-scaling --hlt-xml=%s --lvl1-xml=%s --target_lumi=%s " % (rulebook[0], lumi_point, hlt_xml, l1_xml, lumi_point)
        ...
        prescale_name = "%s_%04.1f_%04.1fe26"%(short_rulebookname, (float(lumi_point)/125.),float(lumi_point)/100.)
        ...
        if len(sys.argv)>2:
            ...
            --joblist rulebook \
            --max-num-files -1 \
            --forwardArgs='-k TRIGRATE --prescaleXML=prescales"+lumi_point+".xml '"
