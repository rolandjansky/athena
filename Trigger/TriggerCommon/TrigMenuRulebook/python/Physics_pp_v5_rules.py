...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_3mu4','HLT_3mu4_l2msonly']
muon_Rules_0p5e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
                    1000 : TriggerRule(PS=1, comment=''), 
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu10_bJpsimumu_noL2', 'HLT_2mu10_l2msonly_bJpsimumu_noL2', 'HLT_mu10_mu10_l2msonly_bJpsimumu_noL2',]
bphys_Rules_2e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
    1000 : TriggerRule(PS=1, comment=''), 
    }])))
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu6_bJpsimumu_noL2','HLT_2mu6_l2msonly_bJpsimumu_noL2','HLT_mu6_mu6_l2msonly_bJpsimumu_noL2',]
bphys_Rules_1e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(PS=1, comment=''), 
    lumi_l1topo_enable_bphys : TriggerRule(rate=0.5, comment='Prescaled'),
                        }])))
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_mu6_mu4_bJpsimumu_noL2','HLT_mu6_mu4_l2msonly_bJpsimumu_noL2','HLT_mu6_l2msonly_mu4_bJpsimumu_noL2','HLT_mu6_l2msonly_mu4_l2msonly_bJpsimumu_noL2']
bphys_Rules_1e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(PS=1, comment=''), 
    lumi_disable_l1_mu6_2mu4 : TriggerRule(PS=1, comment='Prescaled at L1'),
    lumi_l1topo_enable_bphys : TriggerRule(rate=0.5, comment='Prescaled'),
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu4_bJpsimumu_noL2','HLT_2mu4_l2msonly_bJpsimumu_noL2','HLT_mu4_mu4_l2msonly_bJpsimumu_noL2']
bphys_Rules_0p5e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(PS=1, comment=''), 
        lumi_disable_l1_2mu4 : TriggerRule(PS=1, comment='Prescaled at L1'),
    lumi_l1topo_enable_bphys : TriggerRule(rate=0.5, comment='Prescaled'),
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu10_bDimu_noL2','HLT_2mu10_l2msonly_bDimu_noL2','HLT_mu10_mu10_l2msonly_bDimu_noL2']
bphys_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(PS=-1, comment=''),
    lumi_l1topo_enable_bphys : TriggerRule(rate=1.0, comment='1 Hz when 2MU6 is prescaled'),
                    }])))
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu6_bDimu_noL2','HLT_2mu6_l2msonly_bDimu_noL2','HLT_mu6_mu6_l2msonly_bDimu_noL2']
bphys_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(rate=0.2, comment=''),
    lumi_disable_l1_mu6_2mu4 : TriggerRule(rate=1.0, comment='1 Hz when 2MU6 is primary'),
    lumi_l1topo_enable_bphys : TriggerRule(rate=0.2, comment=''),
    }])))
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_mu6_mu4_bDimu_noL2','HLT_mu6_mu4_l2msonly_bDimu_noL2','HLT_mu6_l2msonly_mu4_bDimu_noL2','HLT_mu6_l2msonly_mu4_l2msonly_bDimu_noL2']
bphys_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
                        1000 : TriggerRule(PS=-1, comment='Disabled'),
        lumi_disable_l1_2mu4 : TriggerRule(rate=1.0, comment='1 Hz when MU6_2MU4 is primary'),
    lumi_disable_l1_mu6_2mu4 : TriggerRule(rate=0.2, comment='0.2 Hz after MU6_2MU4 is prescaled'),
...
# l2msonly, noL2: put them for the moment but CPU cost to be reviewed
HLT_list=['HLT_2mu4_bDimu_noL2','HLT_2mu4_l2msonly_bDimu_noL2','HLT_mu4_mu4_l2msonly_bDimu_noL2']
bphys_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
                    1000 : TriggerRule(rate=1.0, comment='1 Hz when 2MU4 is primary'),
    lumi_disable_l1_2mu4 : TriggerRule(rate=0.2, comment='0.2 Hz after 2MU4 is prescaled'),
     }])))
...
bjet_Rules_0p15e34.update(dict(map(None,L1_list,len(L1_list)*[{
    1000 : TriggerRule(PS=1, comment=''), 
    1501 : TriggerRule(rate=500, maxRate=500, comment='Prescaled'),
    }])))
...
bjet_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
    1000 : TriggerRule(rate=5.0, comment=''), 
    }])))
...
HLT_list=[
    # MU4
    'HLT_mu4_j15_bperf_split_dr05',
    'HLT_mu4_j25_bperf_split_dr05',
    'HLT_mu4_j35_bperf_split_dr05',
    # MU4_J12
    'HLT_mu4_j55_bperf_split_dr05',
    # MU6_J20
    'HLT_mu6_j85_bperf_split_dr05',
    'HLT_mu6_j110_bperf_split_dr05',
    # MU6_J40
    'HLT_mu6_j150_bperf_split_dr05',
    'HLT_mu6_j175_bperf_split_dr05',
    # MU6_J75
    'HLT_mu6_j260_bperf_split_dr05',
    'HLT_mu6_j320_bperf_split_dr05',
    'HLT_mu6_j400_bperf_split_dr05',
    ]
bjet_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
    1000 : TriggerRule(rate=1.0, comment=''),
    }])))
...
# Exceptionally, e24_(lh)medium_L1EM20VHI is kept alive until L1_EM20VHI is prescaled
...
egamma_Rules_0p5e34.update(dict(map(None,HLT_list,len(HLT_list)*[{
    ...
    5001 : TriggerRule(PS=6, comment='Prescaled for supporting', ESValue=0),
    }])))
...
# Exceptionally, e24_(lh)medium_L1EM20H is kept alive until L1_EM20VH is prescaled
...
egamma_Rules_supporting.update(dict(map(None,HLT_list,len(HLT_list)*[{
                      1000 : TriggerRule(PS=10, comment='', ESValue=0),
...
egamma_Rules_supporting.update({
    ...
    # EM10_XS20
    # eff 0.16
    'HLT_e13_etcut_trkcut_j20_perf_xe15_2dphi05'            : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_j20_perf_xe15_2dphi05_mt25'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_j20_perf_xe15_6dphi05'            : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_j20_perf_xe15_6dphi05_mt25'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    # eff 0.11
    'HLT_e13_etcut_trkcut_xs15_j20_perf_xe15_2dphi05'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_xs15_j20_perf_xe15_2dphi05_mt25'  : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_xs15_j20_perf_xe15_6dphi05'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_xs15_j20_perf_xe15_6dphi05_mt25'  : {  1000 : TriggerRule(rate=0.5, comment='') },
    #
    'HLT_e13_etcut_trkcut_xs15_mt25'                        : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e13_etcut_trkcut_xs15'                             : {  1000 : TriggerRule(rate=0.5, comment='') },
    #
    # EM15_XS30    
    # eff 0.05
    'HLT_e18_etcut_trkcut_j20_perf_xe20_6dphi15'            : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e18_etcut_trkcut_j20_perf_xe20_6dphi15_mt35'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    # eff 0.03
    'HLT_e18_etcut_trkcut_xs20_j20_perf_xe20_6dphi15'       : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e18_etcut_trkcut_xs20_j20_perf_xe20_6dphi15_mt35'  : {  1000 : TriggerRule(rate=0.5, comment='') },
    #
    'HLT_e18_etcut_trkcut_xs20_mt35'                        : {  1000 : TriggerRule(rate=0.5, comment='') },
    'HLT_e18_etcut_trkcut_xs20'                             : {  1000 : TriggerRule(rate=0.5, comment='') },
    })
...
egamma_Rules_supporting.update({
    'L1_2EM3'        : {  1000 : TriggerRule(rate=700, maxRate=700, comment='') },
    'L1_EM7_2EM3'    : {  1000 : TriggerRule(rate=1100, maxRate=1100, comment='') },
    'L1_EM12_2EM3'   : {  1000 : TriggerRule(rate=2200, maxRate=2200, comment='') },
    })
...
dedicated_Rules = {
    ...
    'L1_EM7_MU10'                                               : {  1000 : TriggerRule(PS=1, comment=''),
                                                                     5001 : TriggerRule(rate=500, maxRate=500, comment='Prescaled') },
    # 13 kHz @ 2e34
    'L1_EM15_MU4'                                               : {  1000 : TriggerRule(PS=1, comment=''),
                                                                     5001 : TriggerRule(rate=500, maxRate=500, comment='Prescaled') },
    # HLT unPS, limited by L1 after 5001
    # 9 Hz @ 2e34
    'HLT_g10_loose_L1EM7_mu10_iloose_taumass'                   : {  1000 : TriggerRule(PS=1, comment='') },
    # 20 Hz @ 2e34
    'HLT_g20_loose_L1EM15_mu4_iloose_taumass'                   : {  1000 : TriggerRule(PS=1, comment='') },

    # too high rate (122 Hz, 129 Hz), prescaled
    'HLT_g10_etcut_L1EM7_mu10_iloose_taumass'                   : {  1000 : TriggerRule(rate=1.0, comment='') },
    'HLT_g20_etcut_L1EM15_mu4_iloose_taumass'                   : {  1000 : TriggerRule(rate=1.0, comment='') },

    # too high rate (~1 kHz), prescaled
    'HLT_g20_etcut_L1EM15_mu4_taumass'                          : {  1000 : TriggerRule(rate=1.0, comment='') },
    'HLT_g10_etcut_L1EM7_mu10_taumass'                          : {  1000 : TriggerRule(rate=1.0, comment='') },
