...
TriggerHLTList = [
    ...
    ('xAOD::TrackParticleContainer#HLT_TrigGSFTrackParticles',                     'BS ESD AODFULL AODSLIM',  'Egamma'),
    ('xAOD::TrackParticleAuxContainer#HLT_TrigGSFTrackParticlesAux.',              'BS ESD AODFULL AODSLIM',  'Egamma'),
