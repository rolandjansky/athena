...
# Run 3 performance studies
    ...
    # JTowers and GTowers
    ( 'xAOD::JGTowerContainer#JTowers',                         'ESD AODFULL', 'L1'),
    ( 'xAOD::JGTowerAuxContainer#JTowersAux.',                  'ESD AODFULL', 'L1'),
    ( 'xAOD::JGTowerContainer#GTowers',                         'ESD AODFULL', 'L1'),
    ( 'xAOD::JGTowerAuxContainer#GTowersAux.',                  'ESD AODFULL', 'L1'),
    # jFEX jets
    ...
    # jFEX MET
    ( 'xAOD::EnergySumRoI#jNOISECUTPerf',                         'ESD AODFULL', 'L1'),
