...
TriggerHLTListRun3 = [
    ...
    ('xAOD::TrigCompositeAuxContainer#HLT_SpacePointCountsAux.pixSP.pixCL_1.pixCL_2.pixCLmin3.pixCLBarrel.pixCLEndcapA.pixCLEndcapC.sctSP.sctSPBarrel.sctSPEndcapA.sctSPEndcapC',     'BS ESD AODFULL AODSLIM', 'MinBias'),
