...
from TrigHTTAlgorithms.TrigHTTAlgorithmsConf import HTTRoadUnionTool, HTTHoughTransformTool, HTTHoughTransform_d0phi0_Tool, HTTHough1DShiftTool, HTTLLPDoubletHoughTransformTool
    ...
    for d0 in d0_list:
        for iSlice in range(nSlice):
            ...
            try:
                ...
                t.hitExtend_x = intList(algo_tag['hitExtend_x']) # TODO also change to floats?
...
def addHough_d0phi0_Tool(map_tag, algo_tag, doHitTracing):
    ...
    for iSlice in range(nSlice):
        ...
        try:
            ...
            t.hitExtend_x = intList(algo_tag['lrt_straighttrack_hitExtend_x']) # TODO also change to floats?
...
def addHough1DShiftTool(map_tag, algo_tag):
    ...
    for ptstep in range(splitpt):
        ...
        for iSlice in range(nSlice):
            ...
            tool.threshold = algo_tag['threshold'][0] # TODO not sure if 1d wants window threshold too
            ...
            #tool.bitShifts = '/usatlas/u/rileyx/usatlasdata/HTT_TDAQ/21.9/eos/Elliot_bitShifts/HoughShifts_5OuterLayers_v2_cutpatterns_0.99.txt'
