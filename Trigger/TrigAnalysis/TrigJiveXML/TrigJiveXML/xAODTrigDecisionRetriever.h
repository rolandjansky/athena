...
#ifndef JIVEXML_XAODTRIGDECISONRETRIEVER_H
#define JIVEXML_XAODTRIGDECISONRETRIEVER_H
...
namespace JiveXML{
  ...
  class xAODTrigDecisionRetriever : virtual public IDataRetriever, public AthAlgTool {
