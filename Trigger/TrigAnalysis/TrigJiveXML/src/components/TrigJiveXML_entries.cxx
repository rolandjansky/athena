...
DECLARE_COMPONENT( LVL1TrigTowerRetriever )
DECLARE_COMPONENT( MuonROIRetriever )
DECLARE_COMPONENT( TrigSiSpacePointRetriever )
DECLARE_COMPONENT( TriggerInfoRetriever )
DECLARE_COMPONENT( CTPDecisionRetriever )
DECLARE_COMPONENT( xAODEmTauROIRetriever )
DECLARE_COMPONENT( xAODJetROIRetriever )
DECLARE_COMPONENT( xAODMuonROIRetriever )
DECLARE_COMPONENT( xAODTrigDecisionRetriever )
DECLARE_COMPONENT( xAODTriggerTowerRetriever )
