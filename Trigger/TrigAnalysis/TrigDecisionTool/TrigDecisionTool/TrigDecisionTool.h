...
namespace Trig {
  ...
  private:
    ...
    SG::SlotSpecificObj< std::atomic<bool> > m_forceConfigUpdate; //!< Cache for registering new input files. Only using first entry in vector (SlotSpecificObj cannot store primitives)
