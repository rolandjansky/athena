...
namespace FeatureAccessImpl {
  ...
  template<>
  void collect<Muon_ROI>(const HLT::TriggerElement* te, std::vector<Trig::Feature<Muon_ROI> >& data, const std::string&, unsigned int condition, const std::string&, HLT::NavigationCore* navigation) {
    l1collect<Muon_ROI>(te, data, condition, &LVL1_ROI::getMuonROIs, navigation);
  }

  template<>
  void collect<EmTau_ROI>(const HLT::TriggerElement* te, std::vector<Trig::Feature<EmTau_ROI> >& data, const std::string&, unsigned int condition, const std::string&, HLT::NavigationCore* navigation) {
    l1collect<EmTau_ROI>(te, data, condition, &LVL1_ROI::getEmTauROIs, navigation);
  }

  template<>
  void collect<Jet_ROI>(const HLT::TriggerElement* te, std::vector<Trig::Feature<Jet_ROI> >& data, const std::string&, unsigned int condition, const std::string&, HLT::NavigationCore* navigation) {
