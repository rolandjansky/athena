...
#ifndef TRIGINDETANALYSIS_TRACK_H
#define TRIGINDETANALYSIS_TRACK_H
...
inline std::ostream& operator<<( std::ostream& s, const TrigInDetAnalysis::Track& t) { 
    return s<< "[ " 
	    << "\teta=" << t.eta()
	    << "\tphi=" << t.phi()
	    << "\tz0="  << t.z0()
...
#endif // TRIGINDETANALYSIS_TRACK_H
