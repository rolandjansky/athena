...
ClassImp(TrigInDetAnalysis::Track)

TrigInDetAnalysis::Track::Track()  :
...
TrigInDetAnalysis::Track::Track(double  eta, double  phi, double  z0, double  a0, double  pT, double chi2, double dof,
