...
public:
	...
	Lepton(const xAOD::Electron* ptr, std::size_t tag=0) : m_obj(reinterpret_cast<const xAOD::IParticle*>(ptr)), m_tag(tag) {}
	Lepton(const xAOD::Photon* ptr, std::size_t tag=0) : m_obj(reinterpret_cast<const xAOD::IParticle*>(ptr)), m_tag(tag) {}
	...
	const xAOD::Electron* electron() const { return reinterpret_cast<const xAOD::Electron*>(m_obj); }
	const xAOD::Muon* muon() const { return static_cast<const xAOD::Muon*>(m_obj); }
	const xAOD::Photon* photon() const { return reinterpret_cast<const xAOD::Photon*>(m_obj); }
