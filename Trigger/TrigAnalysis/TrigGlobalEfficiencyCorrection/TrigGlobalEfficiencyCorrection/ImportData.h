...
enum TriggerType
{
	...
	TT_SINGLE_PH = TT_SINGLELEPTON_FLAG | TT_PHOTON_FLAG,
	// dilepton triggers
	...
	TT_EMU = TT_DILEPTON_FLAG | TT_ELECTRON_FLAG | TT_MUON_FLAG,
	TT_2PH_SYM = TT_DILEPTON_SYM | TT_PHOTON_FLAG,
	TT_2PH_ASYM = TT_DILEPTON_ASYM | TT_PHOTON_FLAG,
	// trilepton triggers
	...
	TT_2E_MU_SYM = TT_TRILEPTON_FLAG | TT_SYM | TT_ELECTRON_FLAG | TT_MUON_FLAG,
	TT_E_2MU_SYM = TT_2E_MU_SYM | TT_X2Y_FLAG,
	TT_2E_MU_ASYM = TT_TRILEPTON_FLAG | TT_ASYM | TT_ELECTRON_FLAG | TT_MUON_FLAG,
	TT_E_2MU_ASYM = TT_2E_MU_ASYM | TT_X2Y_FLAG ,
	TT_3PH_SYM = TT_TRILEPTON_SYM | TT_PHOTON_FLAG,
	TT_3PH_HALFSYM = TT_TRILEPTON_HALFSYM | TT_PHOTON_FLAG,
	TT_3PH_ASYM = TT_TRILEPTON_ASYM | TT_PHOTON_FLAG
};
