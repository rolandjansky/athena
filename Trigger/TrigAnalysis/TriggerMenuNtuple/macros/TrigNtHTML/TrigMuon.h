...
// Thu Dec  3 18:24:04 2009 by ROOT version 5.22/00d
...
#include <TChain.h>
#include <TFile.h>
   const Int_t kMaxL1MuonRoI = 4;
   const Int_t kMaxMufast = 8;
   const Int_t kMaxmuFast_esd = 8;
   const Int_t kMaxInDet_SiTrk_Muon = 38;
   const Int_t kMaxInDet_IDSCAN_Muon = 38;
   const Int_t kMaxMucomb = 20;
   const Int_t kMaxMuisol = 3;
   const Int_t kMaxTilemu = 4;
   const Int_t kMaxTileTrackMu = 4;
   const Int_t kMaxTrigMuonEF = 8;
   const Int_t kMaxTrigMuGirl = 16;
   const Int_t kMaxMuidIndex = 4;
   const Int_t kMaxMuidMSmuon = 4;
   const Int_t kMaxMuidSAmuon = 4;
   const Int_t kMaxMuidCBmuon = 4;
   const Int_t kMaxMuidIEmuon = 4;
   const Int_t kMaxStacoIndex = 5;
   const Int_t kMaxStacoMSmuon = 4;
   const Int_t kMaxStacoSAmuon = 4;
   const Int_t kMaxStacoCBmuon = 4;
   const Int_t kMaxStacoIEmuon = 4;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f) {
         ...
         f->cd("trigntupleTTBAR.root:/Muon");
      }
