...
//!==========================================================================
bool TrigEgammaL2CaloSelectorTool::is_correct_trigInfo(const TrigInfo &info){
...
//!==========================================================================
bool TrigEgammaL2CaloSelectorTool::emulation(const xAOD::TrigEMCluster *emCluster,  bool &pass, const TrigInfo &info)
{
  pass=false;
