...
def create_egamma_emulation_tool(trigList, **kw):
  ...
  from TrigEgammaEmulationTool.TrigEgammaEmulationToolConf import Trig__TrigEgammaL2HelperSelectorTool
  ...
  EgammaL2HelperEmulator = ToolFactory(Trig__TrigEgammaL2HelperSelectorTool,
  ...
  emulator = ToolFactory( Trig__TrigEgammaEmulationTool, 
                          ...
                          L2SelectorTool          = EgammaL2HelperEmulator(),
