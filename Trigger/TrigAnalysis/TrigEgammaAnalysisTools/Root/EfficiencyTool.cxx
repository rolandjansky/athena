...
{
    ATH_MSG_DEBUG("Executing EfficiencyTool for " << basePath);
...
void EfficiencyTool::setDetail(bool doDetail) {
    m_detailedHists = doDetail;
}

void EfficiencyTool::setTP(bool tp) {
    m_tp = tp;
}

void EfficiencyTool::setEmulation(bool doEmu) {
    m_doEmulation = doEmu;
}
