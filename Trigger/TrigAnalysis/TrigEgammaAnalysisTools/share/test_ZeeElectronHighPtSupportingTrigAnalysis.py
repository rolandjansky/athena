...
ServiceMgr += THistSvc()
ServiceMgr.THistSvc.Output += ["Validation_Zee_HighPtSupportingTriggers DATAFILE='Validation_Zee_HighPtSupportingTriggers.root' OPT='RECREATE'"]
...
Res = TrigEgammaNavZeeTPRes(name="NavZeeTPRes",
        ...
        OutputLevel=2,
        File="Validation_Zee_HighPtSupportingTriggers",
        )
