...
if not 'DIR' in dir():
     dirtouse='/afs/cern.ch/work/j/jolopezl/datasets/valid1.160009.PowhegPythia8_AU2CT10_ggH125_gamgam.recon.AOD.e3458_s2578_r6220_tid05203483_00'
else :
     dirtouse=DIR
...
ServiceMgr += THistSvc()
ServiceMgr.THistSvc.Output += ["Validation_ggh125 DATAFILE='Validation_ggH125.root' OPT='RECREATE'"]
...
Alg = TrigEgammaAnalysisAlg(name="MyAlg",Tools=[Perf,TrigEgammaEmulationTool(OutputLevel=2)])