...
ServiceMgr += THistSvc()
ServiceMgr.THistSvc.Output += ["Validation_Zee_LowMidPtSupportingTriggers DATAFILE='Validation_Zee_LowMidPtSupportingTriggers.root' OPT='RECREATE'"]
...
Res = TrigEgammaNavZeeTPRes(name="NavZeeTPRes",
        ...
        OutputLevel=2,
        File="Validation_Zee_LowMidPtSupportingTriggers",
        )
