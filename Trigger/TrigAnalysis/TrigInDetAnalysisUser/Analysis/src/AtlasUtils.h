...
inline TGraphErrors* myTGraphErrorsDivide(TGraphErrors* g1,TGraphErrors* g2) {
...
inline TGraphAsymmErrors* myTGraphErrorsDivide(TGraphAsymmErrors* g1,TGraphAsymmErrors* g2) {
...
inline TGraphAsymmErrors* myMakeBand(TGraphErrors* g0, TGraphErrors* g1,TGraphErrors* g2) {
  // default is g0
    //const Int_t debug=0;
...
inline void myAddtoBand(TGraphErrors* g1, TGraphAsymmErrors* g2) {
...
inline TGraphErrors* TH1TOTGraph(TH1 *h1){
...
inline void myText(Double_t x,Double_t y,Color_t color,char *text) {
...
inline void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,char *text) {
  ...
  Double_t ytmp=(y1+y2)/2.;
  mline.DrawLineNDC(x1,ytmp,x2,y);

}


inline void myMarkerText(Double_t x,Double_t y,Int_t color,Int_t mstyle,char *text) {
