...
ClassImp(TrigTauEtMissEFObject )


TrigTauEtMissEFObject::TrigTauEtMissEFObject()
  : TrigTauEtMissObject(),
    m_Ez(-1.e+9),
    m_SumE(-1.e+9),
    m_flag(0),
...
TrigTauEtMissEFObject::TrigTauEtMissEFObject(const TrigTauEtMissEFObject & other)
  : TrigTauEtMissObject(other),
    m_Ez( other.m_Ez ),
    m_SumE( other.m_SumE ),
    m_flag( other.m_flag ),
    m_comp_number( other.m_comp_number ),
...
void TrigTauEtMissEFObject::reset()
{
