...
#ifndef _TTPVALCUTSTUDY_H_
#define _TTPVALCUTSTUDY_H_
...
public:
  ...
  TTPValCutStudy(TrigTauBugFix::POOLFILE poolfile = TrigTauBugFix::RDO, TrigTauBugFix::TTPVERSION version = TrigTauBugFix::TTP15, bool debug1 = false);
  TTPValCutStudy (TString filename1 , TrigTauBugFix::POOLFILE poolfile = TrigTauBugFix::RDO, TrigTauBugFix::TTPVERSION version = TrigTauBugFix::TTP15,  bool debug1 = false);
  ...
  void effSequencePlotsUpdate(TString name);		//prints L1, L2, EF turn on curves in one plot; former macro effSequencePlot2.cxx
  void effSequencePlotsPrintCSC(TPostScript & ps);
  void reset();
