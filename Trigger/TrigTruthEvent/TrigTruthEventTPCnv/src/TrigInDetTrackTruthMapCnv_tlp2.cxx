...
void T_TPCnv<TrigInDetTrackTruthMap, TrigInDetTrackTruthMap_tlp2 >::
persToTrans (const TrigInDetTrackTruthMap_tlp2* pers,
             TrigInDetTrackTruthMap* trans,
             MsgStream& msg)
{
  setPStorage (const_cast<TrigInDetTrackTruthMap_tlp2*> (pers));
