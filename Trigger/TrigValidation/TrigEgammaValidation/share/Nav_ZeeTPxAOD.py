...
from TrigEgammaValidation.TrigEgammaValidationConf import NavZeeTPxAODValidation
zee = NavZeeTPxAODValidation()
...
zee.ElectronTightPPSelector = theelectroncuttightid
...
zee.ElectronMediumPPSelector = theelectroncutmediumid
