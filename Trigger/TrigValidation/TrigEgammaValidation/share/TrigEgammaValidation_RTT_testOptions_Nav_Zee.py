...
from TrigEgammaValidation.TrigEgammaValidationConf import NavZeeValidation, NavRateValidation, NavRateExpert
zee = NavZeeValidation()
zee.Chains = ['eNoCut', 
 'e10Ringer',
 'e5_medium',
 'e5_medium1',
