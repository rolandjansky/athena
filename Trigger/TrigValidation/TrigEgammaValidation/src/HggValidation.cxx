...
HggValidation::HggValidation(const std::string & name, ISvcLocator * pSvcLocator)
  : FEXValidationAlgo(name, pSvcLocator, "Validation")
{
}

HggValidation::~HggValidation()
{
}

StatusCode HggValidation::childInitialize()
{
  StatusCode sc;
  ...
  addHistogram(new TH1F("TruthEtHist", "Truth E_{T} for Hgg ; E_{T} [GeV] ; Count", 80, 0., 80.));
  addHistogram(new TH1F("TruthEtaHist", "Truth \\eta for Hgg ; \\eta ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthPhiHist", "Truth \\phi for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  
  addHistogram(new TH1F("TruthL1Et", "Level 1 Truth E_{T} for Hgg ; E_{T} [GeV] ; Count", 80, 0., 80.));
  addHistogram(new TH1F("TruthL1Eta", "Level 1 Truth \\eta for Hgg ; \\eta ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthL1Phi", "Level 1 Truth \\phi for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  
  addHistogram(new TH1F("TruthL2Et", "Level 2 Truth E_{T} for Hgg ; E_{T} [GeV] ; Count", 80, 0., 80.));
  addHistogram(new TH1F("TruthL2Eta", "Level 2 Truth \\eta for Hgg ; \\eta ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthL2Phi", "Level 2 Truth \\phi for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  
  // For ID Efficiencies
  addHistogram(new TH1F("TruthL2IDScanEt", "E_{T} after Level 2 ID (ID Scan Match) for Hgg ; E_{T} [GeV]", 80, 0., 80.));
  addHistogram(new TH1F("TruthL2IDScanPhi", "\\phi after Level 2 ID (ID Scan Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthL2IDScanEta", "\\eta after Level 2 ID (ID Scan Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));
  
  addHistogram(new TH1F("TruthL2IDSiEt", "E_{T} after Level 2 ID (SiTrack Match) for Hgg ; E_{T} [GeV] ; Count", 80, 0., 80.));
  addHistogram(new TH1F("TruthL2IDSiPhi", "\\phi after Level 2 ID (SiTrack Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthL2IDSiEta", "\\eta after Level 2 ID (SiTrack Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));

  // EF Calo
  addHistogram(new TH1F("TruthEFScanCaloEt", "Truth E_{T} after EF Calo (and L2 ID Scan Match) for Hgg ; E_{T} [GeV] ; Count", 80, 0, 80.));
  addHistogram(new TH1F("TruthEFScanCaloPhi", "Truth \\phi after EF Calo (and L2 ID Scan Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthEFScanCaloEta", "Truth \\eta after EF Calo (and L2 ID Scan Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));

  addHistogram(new TH1F("TruthEFSiCaloEt", "Truth E_{T} after EF Calo (and L2 ID SiTrack Match) for Hgg ; E_{T} [GeV] ; Count", 80, 0, 80.));
  addHistogram(new TH1F("TruthEFSiCaloPhi", "Truth \\phi after EF Calo (and L2 ID SiTrack Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthEFSiCaloEta", "Truth \\eta after EF Calo (and L2 ID SiTrack Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));

  // EF ID
  addHistogram(new TH1F("TruthEFScanTrackEt", "Truth E_{T} after EF Track (and L2 ID Scan Match) for Hgg ; E_{T} [GeV] ; Count", 80, 0, 80.));
  addHistogram(new TH1F("TruthEFScanTrackPhi", "Truth \\phi after EF Track (and L2 ID Scan Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthEFScanTrackEta", "Truth \\eta after EF Track (and L2 ID Scan Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));

  addHistogram(new TH1F("TruthEFSiTrackEt", "Truth E_{T} after EF Track (and L2 ID SiTrack Match) for Hgg ; E_{T} [GeV] ; Count", 80, 0, 80.));
  addHistogram(new TH1F("TruthEFSiTrackPhi", "Truth \\phi after EF Track (and L2 ID SiTrack Match) for Hgg ; \\phi [rad] ; Count", 128, -3.2, 3.2));
  addHistogram(new TH1F("TruthEFSiTrackEta", "Truth \\eta after EF Track (and L2 ID SiTrack Match) for Hgg ; \\eta ; Count", 128, -3.2, 3.2));
  ...
  addHistogram(new TH2F("ResEtL1TruthEt", "Level 1 resolution E_{T} versus E_{T} for \\gamma ; E_{T} [GeV] ; E_{T} Resolution (%)", 80, 0., 80., 200, -100., 100.));
  addHistogram(new TH2F("ResEtL1TruthEta", "Level 1 resolution E_{T} versus \\eta for \\gamma ; \\eta ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  addHistogram(new TH2F("ResEtL1TruthPhi", "Level 1 resolution E_{T} versus \\phi for \\gamma ; \\phi ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  ...
  addHistogram(new TH2F("ResEtL2TruthEt", "Level 2 resolution E_{T} versus E_{T} for \\gamma ; E_{T} [GeV] ; E_{T} Resolution (%)", 80, 0., 80., 200, -100., 100.));
  addHistogram(new TH2F("ResEtL2TruthEta", "Level 2 resolution E_{T} versus \\eta for \\gamma ; \\eta ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  addHistogram(new TH2F("ResEtL2TruthPhi", "Level 2 resolution E_{T} versus \\phi for \\gamma ; \\phi ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  ...
  addHistogram(new TH2F("ResEtEFScanTruthEt", "Event Filter [L2 Scan] resolution E_{T} versus E_{T} for \\gamma ; E_{T} [GeV] ; E_{T} Resolution (%)", 80, 0., 80., 200, -100., 100.));
  addHistogram(new TH2F("ResEtEFScanTruthEta", "Event Filter [L2 Scan] resolution E_{T} versus \\eta for \\gamma ; \\eta ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  addHistogram(new TH2F("ResEtEFScanTruthPhi", "Event Filter [L2 Scan] resolution E_{T} versus \\phi for \\gamma ; \\phi ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  ...
  addHistogram(new TH2F("ResEtEFSiTruthEt", "Event Filter [L2 SiTrack] resolution E_{T} versus E_{T} for \\gamma ; E_{T} [GeV] ; E_{T} Resolution (%)", 80, 0., 80., 200, -100., 100.));
  addHistogram(new TH2F("ResEtEFSiTruthEta", "Event Filter [L2 SiTrack] resolution E_{T} versus \\eta for \\gamma ; \\eta ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));
  addHistogram(new TH2F("ResEtEFSiTruthPhi", "Event Filter [L2 SiTrack] resolution E_{T} versus \\phi for \\gamma ; \\phi ; E_{T} Resolution (%)", 128, -3.2, 3.2, 200, -100., 100.));

  return StatusCode::SUCCESS;
}

StatusCode HggValidation::childExecute()
{
  StatusCode sc;
  ...
  if (sc.isFailure()) {
    (*m_log) << MSG::WARNING
	    << "No AOD MC truth particle container found in TDS. Aborting!!!"
	    << endreq;
  ...
  for ( ; themcpartTES != mcpartTESend; ++themcpartTES) { // For each event collection
	...
	for ( ; itrParticle != itrParticleE; ++itrParticle) { // For each particle in the event
	  ...
	  // Finds a H
	  if ( (*itrParticle)->pdg_id() == 25) {
	    
	    const HepMC::GenVertex* endVert=(*itrParticle)->end_vertex();
	    // finds gamma
	    if ( endVert != 0 ) { // Find a H0 in an End Vertex
	      for (HepMC::GenVertex::particles_out_const_iterator itrTruthDaughter = endVert->particles_out_const_begin();
		   itrTruthDaughter != endVert->particles_out_const_end();
		   itrTruthDaughter++) { // For each particle out of the decay

		if (fabs((*itrTruthDaughter)->pdg_id()) == 22) { // If it is a gamma
			...
			if ( (matchedL1->getEMClus() > m_L1EmClus) &&
			  ...
			  if (doL2) {
			    ...
			    if (matchedL2) {
			      ...
			      // Fill FEX histograms for gammas
                              cd(name()+"/Dump");
				...
				if (doL2ID) {
				  ...
				  // It shouldn't!!! So lets see if it did!
...
StatusCode HggValidation::childFinalize()
{
  cd(name()+"/Dump");
  FillTable();
