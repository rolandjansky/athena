...
#ifndef NAV_OFFLINE_VALIDATION
#define NAV_OFFLINE_VALIDATION
...
class NavOfflineValidation : public NavAuxValidation 
{
 public:	
	NavOfflineValidation(const std::string & name, ISvcLocator * pSvcLocator);
	~NavOfflineValidation();
