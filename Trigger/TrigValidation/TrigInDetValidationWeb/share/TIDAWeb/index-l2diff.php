...
<?php 
  ...
  tableRow( $l2diff_dir, L2_reta_vs_eta_sigma, "L2 deta/deta",   L2_reta_vs_pt_sigma, "L2 deta/dpt"); 
  tableRow( $l2diff_dir, L2_ript_vs_pt_sigma,  "L2 d(1/pt)/dpt", L2_rzed_vs_pt_sigma, "L2 dz/dpt"); 

  tableRow( $l2diff_dir, L2_rzed_vs_eta_sigma, "L2 dz/deta",  L2_rzed_vs_pt_sigma, "L2 dz/d|pt|"); 
  tableRow( $l2diff_dir, L2_rd0_vs_eta_sigma,  "L2 dd0/deta", L2_rd0_vs_pt_sigma,  "L2 dd0/d|pt|"); 

  tableRow( $l2diff_dir, L2_rd0_vs_signed_pt_sigma,  "L2 dd0/d|pt|", L2_rzed_vs_signed_pt_sigma,  "L2 dz/d|pt|"); 
  print("</table>\n");  
?>
