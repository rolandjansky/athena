...
<?php 
  ...
  tableRow( $efdiff_dir, EF_reta_vs_eta_sigma, "EF deta/deta",   EF_reta_vs_pt_sigma, "EF deta/dpt"); 
  tableRow( $efdiff_dir, EF_ript_vs_pt_sigma,  "EF d(1/pt)/dpt", EF_rzed_vs_pt_sigma, "EF dz/dpt"); 

  tableRow( $efdiff_dir, EF_rzed_vs_eta_sigma, "EF dz/deta",  EF_rzed_vs_pt_sigma, "EF dz/d|pt|"); 
  tableRow( $efdiff_dir, EF_rd0_vs_eta_sigma,  "EF dd0/deta", EF_rd0_vs_pt_sigma,  "EF dd0/d|pt|"); 

  tableRow( $efdiff_dir, EF_rd0_vs_signed_pt_sigma,  "EF dd0/d|pt|", EF_rzed_vs_signed_pt_sigma,  "EF dz/d|pt|"); 
  print("</table>\n");  
?>
