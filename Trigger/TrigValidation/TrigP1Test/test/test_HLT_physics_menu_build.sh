...
# art-description:  Run athenaHLT on all events to create trigger configuration, generates and uploads SMKs created from the HLT first and compares after rerun jobs from DB, then compare the SMK created from the HLT_physicsV8 first and rerun jobs. Runs the same thing also for the physics HI v5 menu
# art-type: build
...
export NAME=HLT_physicsV8_menu_rerundb
export JOB_LOG="${NAME}.log"
...
export NAME=HLT_physicsV8_menu_checkkeys
export JOB_LOG="${NAME}.log"
...
export NAME=HLT_physicsV8_rerunLVL1_menu
export JOB_LOG="${NAME}.log"
...
export NAME=HLT_physicsV8_rerunLVL1_menu_rerundb
export JOB_LOG="${NAME}.log"
