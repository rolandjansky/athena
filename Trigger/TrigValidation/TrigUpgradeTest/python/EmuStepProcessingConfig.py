...
#            Chain(name='HLT_2mu6_L12MU6',  L1Item="L1_2MU6",      ChainSteps=[ChainStep("Step_2muSA", [muSA,muSA])  ] )
        ...
        HLTChains += MuChains
        EnabledMuChains= [c.L1Item.strip().split("_")[1] +" : "+ c.name for c in MuChains]
    ...
    if doElectron:
        ...
        HLTChains += ElChains
        EnabledElChains= [c.L1Item.strip().split("_")[1] +" : "+ c.name for c in ElChains]
