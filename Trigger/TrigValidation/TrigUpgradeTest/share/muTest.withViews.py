...
### If you want to run for L2SA, L2CB and EFSA, ###
### please change each bool to True.            ###
doL2SA=True
doL2CB=True
doEFSA=False
...
if TriggerFlags.doID:
  ...
  theFTF.TracksName = "TrigFastTrackFinder_Tracks"
  
  # A simple algorithm to confirm that data has been inherited from parent view
  # Required to satisfy data dependencies
  ViewVerify = CfgMgr.AthViews__ViewDataVerifier("electronViewDataVerifier")
  ViewVerify.DataObjects = [('xAOD::L2StandAloneMuonContainer','StoreGateSvc+MuFastAlgMuInfo')]
...
if TriggerFlags.doMuon:
  ...
  if doL2SA:
    ### set up L1MURoIsFilter ###
    from DecisionHandling.DecisionHandlingConf import RoRSeqFilter, DumpDecisions
    filterL1MURoIsAlg = RoRSeqFilter("filterL1MURoIsAlg")
    filterL1MURoIsAlg.Input = ["MURoIDecisions"]
    filterL1MURoIsAlg.Output = ["FilteredMURoIDecisions"]
    filterL1MURoIsAlg.Chains = testChains
    filterL1MURoIsAlg.OutputLevel = DEBUG
    ...
    muFastAlg.MuFastDecisions = "MuFastAlgMuInfo"
    muFastAlg.MuFastComposite = "MuFastAlg_Decisions"
    muFastAlg.MuFastForID = "MuFastAlgIdInfo"
    muFastAlg.MuFastForMS = "MuFastAlgMsInfo"
    ...
    muFastStep = seqAND("muFastStep", [filterL1MURoIsAlg, l2MuViewsMaker, l2MuViewNode, trigMufastHypo, muFastDecisionsDumper])

  ### set up muComb ###
  if TriggerFlags.doID and doL2SA and doL2CB:
    ...
    muCombInViewAlgs = parOR("muCombInViewAlgs", IDSequence + [ muCombAlg ])
    l2muCombViewsMaker.ViewNodeName = "muCombInViewAlgs"

    l2muCombSequence = seqAND("l2muCombSequence", [ InDetCacheCreatorTrigViews, l2muCombViewsMaker, muCombInViewAlgs, trigmuCombHypo ] )
