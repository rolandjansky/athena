...
export EXTRA="generateMenuDiagnostics=True;isOnline=True;doWriteBS=False;doWriteRDOTrigger=True;forceEnableAllChains=True;fpeAuditor=True;doMETSlice=False"
