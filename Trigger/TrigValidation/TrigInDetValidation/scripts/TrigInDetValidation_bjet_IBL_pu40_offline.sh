...
athena.py  -c 'XMLDataSet="TrigInDetValidation_bjet_IBL_pu40_offline";EventMax=900;doIDNewTracking=True;runMergedChain=True;globalTag="OFLCOND-RUN12-SDR-17"' TrigInDetValidation_RTT_topOptions_BjetSlice.py 
...
TIDAcomparitor.exe data-bjet-pileup.root data-bjet_bjet-pileup.root HLT_j55_bperf_InDetTrigTrackingxAODCnv_Bjet_IDTrig HLT_j55_bperf_split_InDetTrigTrackingxAODCnv_Bjet_IDTrig_forID HLT_j55_bperf_split_InDetTrigTrackingxAODCnv_Bjet_FTF_forID -d HLTEF-plots
