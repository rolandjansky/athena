...
# art-description: art job for all_ttbar_idtrigconfig_pu55
# art-type: grid
...
import os
os.system("printf 'from TrigInDetConfig.ConfigSettingsBase import _ConfigSettingsBase \ndef override(self):\n     self._newConfig=True\n\n_ConfigSettingsBase.override = override ' > newconfig.py ; cat newconfig.py ")
...
preinclude_file = 'RDOtoRDOTrigger:newconfig.py'
