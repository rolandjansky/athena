#!/bin/bash
# art-description: art job for test_trigindetvalidation_beamspot_ttbar_pu40_zfinder
# art-type: grid
...
export RTTJOBNAME=test_trigindetvalidation_beamspot_ttbar_pu40_zfinder
