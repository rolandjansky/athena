#!/bin/bash
# art-description: art job for test_trigindetvalidation_bjet_ibl_pu40_offline_2016config
# art-type: grid
...
export RTTJOBNAME=test_trigindetvalidation_bjet_ibl_pu40_offline_2016config
