#!/bin/bash
# art-description: art job for tau_IBL_pu46_ml
...
export RTTJOBNAME=TrigInDetValidation_tau_IBL_pu46_ml
      ...
      case "$ArtProcess" in
            ...
            *)
                  ...
                  if [ $RUNATHENA -eq 1 ]; then
                      ARGS="$jobList;EventMax=2000;mlExtensions=True;PdgId=15"
...
for git in $jobList ; do 
    ...
    ARGS="$git;EventMax=2000;mlExtensions=True;PdgId=15"
...
TIDArun-art.sh data-tau-IBL.root data-tau_IBL_pu46_ml-reference.root HLT_tau25_idperf_track_InDetTrigTrackingxAODCnv_Tau_FTF HLT_tau25_idperf_track_InDetTrigTrackingxAODCnv_Tau_IDTrig HLT_tau25_idperf_tracktwo_InDetTrigTrackingxAODCnv_TauIso_FTF_forID3 HLT_tau25_idperf_tracktwo_InDetTrigTrackingxAODCnv_Tau_IDTrig_forID3 -d HLTEF-plots  2>&1 | tee TIDArun_2.log
...
TIDArun-art.sh data-tau-IBL.root data-tau_IBL_pu46_ml-reference.root HLT_tau25_idperf_track_InDetTrigTrackingxAODCnv_Tau_FTF HLT_tau25_idperf_tracktwo_InDetTrigTrackingxAODCnv_TauCore_FTF_forID1 HLT_tau25_idperf_tracktwo_InDetTrigTrackingxAODCnv_TauIso_FTF_forID3 -d HLTL2-plots  2>&1 | tee TIDArun_3.log
