#!/bin/bash
# art-description: art job for test_trigindetvalidation_el_zee_ibl_pu40_offline_rzmatcher
# art-type: grid
...
export RTTJOBNAME=test_trigindetvalidation_el_zee_ibl_pu40_offline_rzmatcher
