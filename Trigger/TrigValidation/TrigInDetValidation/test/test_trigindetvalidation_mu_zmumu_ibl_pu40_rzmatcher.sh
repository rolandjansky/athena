#!/bin/bash
# art-description: art job for test_trigindetvalidation_mu_zmumu_ibl_pu40_rzmatcher
# art-type: grid
...
export RTTJOBNAME=test_trigindetvalidation_mu_zmumu_ibl_pu40_rzmatcher
