...
athena.py  -c 'ARTConfig=$fileList;EventMax=5000'             TrigInDetValidation/TrigInDetValidation_RTT_topOptions_MuonSlice.py
...
TIDArun-art.sh data-muon-bphys-merge.root data-mu_bphys_IBL-reference.root HLT_mu6_idperf_InDetTrigTrackingxAODCnv_Muon_FTF HLT_mu6_idperf_InDetTrigTrackingxAODCnv_Muon_IDTrig   -d HLTEF-plots  expert-monitoring.root  expert-monitoring*-ref.root --auto -o times
