...
#InDetFlags.storeSeparateLargeD0Container.set_Value_and_Lock(False)  this causes FATAL Failed to retrieve  ( 'CaloExtensionCollection' , 'StoreGateSvc+ParticleCaloExtension_LRT' 
