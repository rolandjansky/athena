...
if not use_new_tm:
  ...
  cosmicTrigChainlist.append(['id_cosmic',               5042, '', [], ['IDCosmic', 'express'], ['RATE:CosmicSlice', 'RATE:Cosmic_Tracking', 'BW:Detector'], 1])
  cosmicTrigChainlist.append(['id_cosmic_trtxk',         5043, '', [], ['IDCosmic'], ['RATE:CosmicSlice', 'BW:Detector'], 1])
  cosmicTrigChainlist.append(['id_cosmic_trtxk_central', 5044, '', [], ['IDCosmic'], ['RATE:CosmicSlice', 'BW:Detector'], 1])
