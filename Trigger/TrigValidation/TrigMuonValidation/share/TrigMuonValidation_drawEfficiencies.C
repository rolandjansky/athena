...
void TrigMuonValidation_drawEfficiencies(TString inputFile, TString saveName){
  ...
  TH1 *h1 = (TH1*)f1->Get("Muons/All/matched/AllAuthors/Muons_All_matched_AllAuthors_Eff_eta");
  TH1 *h2 = (TH1*)f1->Get("Muons/All/matched/AllAuthors/Muons_All_matched_AllAuthors_Eff_phi");
  TH1 *h3 = (TH1*)f1->Get("Muons/All/matched/AllAuthors/Muons_All_matched_AllAuthors_Eff_pt");

  TH1 *htruth = (TH1*)f1->Get("Muons/All/truth/all/Muons_All_truth_all_pt");
  TH1 *hmatched = (TH1*)f1->Get("Muons/All/matched/AllAuthors/Muons_All_matched_AllAuthors_nphiLayers");
