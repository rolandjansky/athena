...
/*! \file WorstCaseYellow.cxx file makes a worst case summary, with status: Red replaced by status: Yellow
 * \author Andrea Dotti
*/
#include <dqm_core/AlgorithmManager.h>
#include <dqm_core/Result.h> 	 
#include <dqm_core/Parameter.h>
#include <dqm_algorithms/summary/WorstCaseYellow.h>

static dqm_algorithms::summary::WorstCaseYellow myInstance;

dqm_algorithms::summary::WorstCaseYellow::WorstCaseYellow()
{
  dqm_core::AlgorithmManager::instance().registerSummaryMaker("WorstCaseYellow",this);
}
...
{
  return new WorstCaseYellow();
}

dqm_core::Result*
dqm_algorithms::summary::WorstCaseYellow::execute( const std::string & , 
					     ...
					     const dqm_core::ParametersMap & map)
{
  ...
  if ( red > 0 ) {
    newresult->status_=dqm_core::Result::Yellow; //ONLY change from WorstCaseSummary
  } else if ( yellow > 0 ) {
