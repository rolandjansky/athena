...
StatusCode DQTLumiMonTool::bookHistograms( ){ // avoid compilation warnings
  //if(newRun){
    failedBooking = false
    || registerHist(m_path, m_aveMu_vs_LB = new TProfile("aveMu_vs_LB", "Number of interactions per event;LB;<#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nLooseVtx_vs_LB = new TProfile("nLooseVtx_vs_LB", "Number of loose vertices per event;LB;<NlooseVtx/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nTightVtx_vs_LB = new TProfile("nTightVtx_vs_LB", "Number of tight vertices per event;LB;<NtightVtx/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nLooseVtx_perMu_vs_LB = new TProfile("nLooseVtx_perMu_vs_LB", "Number of loose vertices per event per Mu;LB;<NlooseVtx/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nTightVtx_perMu_vs_LB = new TProfile("nTightVtx_perMu_vs_LB", "Number of tight vertices per event per Mu;LB;<NtightVtx/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    ...
    || registerHist(m_path, m_nClustersAll_vs_LB = new TProfile("nClustersAll_vs_LB", "Number of pixel clusters per event, all;LB;<NclustersAll/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersECA_vs_LB = new TProfile("nClustersECA_vs_LB", "Number of pixel clusters per event, endcap A;LB;<NlustersECA/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersECC_vs_LB = new TProfile("nClustersECC_vs_LB", "Number of pixel clusters per event, endcap C;LB;<NclustersECC/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB0_vs_LB  = new TProfile("nClustersB0_vs_LB",  "Number of pixel clusters per event, barrel layer 0;LB;<NclustersB0/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB1_vs_LB  = new TProfile("nClustersB1_vs_LB",  "Number of pixel clusters per event, barrel layer 1;LB;<NclustersB1/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB2_vs_LB  = new TProfile("nClustersB2_vs_LB",  "Number of pixel clusters per event, barrel layer 2;LB;<NclustersB2/event>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersAll_perMu_vs_LB = new TProfile("nClustersAll_perMu_vs_LB", "Number of pixel clusters per event per Mu, all;LB;<NclustersAll/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersECA_perMu_vs_LB = new TProfile("nClustersECA_perMu_vs_LB", "Number of pixel clusters per event per Mu, endcap A;LB;<NlustersECA/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersECC_perMu_vs_LB = new TProfile("nClustersECC_perMu_vs_LB", "Number of pixel clusters per event per Mu, endcap C;LB;<NclustersECC/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB0_perMu_vs_LB  = new TProfile("nClustersB0_perMu_vs_LB",  "Number of pixel clusters per event per Mu, barrel layer 0;LB;<NclustersB0/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB1_perMu_vs_LB  = new TProfile("nClustersB1_perMu_vs_LB",  "Number of pixel clusters per event per Mu, barrel layer 1;LB;<NclustersB1/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
    || registerHist(m_path, m_nClustersB2_perMu_vs_LB  = new TProfile("nClustersB2_perMu_vs_LB",  "Number of pixel clusters per event per Mu, barrel layer 2;LB;<NclustersB2/event/#mu>_{LB}", 1000, 0, 1000)).isFailure()
