...
public:
  ...
  int& istup(int i) {return ISTUP[i];};
  ...
  int& mothup1(int i) {return MOTHUP[i].first;};
  int& mothup2(int i) {return MOTHUP[i].second;};
  ...
  int& icolup1(int i) {return ICOLUP[i].first;};
  int& icolup2(int i) {return ICOLUP[i].second;};
  ...
  double& pup(int i,int p) {return PUP[i][p];};
  ...
  double& vtimup(int i) {return VTIMUP[i];};
  ...
  double& spinup(int i) {return SPINUP[i];};
