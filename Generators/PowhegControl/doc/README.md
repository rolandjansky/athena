...
run. See [here](PowhegForATLAS#Generators_PowhegControl) for more details.

## Powheg in Athena: PowhegControl

PowhegControl is a convenient interface to a series of
...
sections:
[Generators/PowhegControl](powheg_for_atlas#Generators_PowhegControl) and
[External/Powheg](powheg_for_atlas#External_Powheg).

## Recommended releases

PowhegControl is available in most recent Athena releases (a full list is
...
See [this section](powheg_for_atlas#External_Powheg) for the corresponding
