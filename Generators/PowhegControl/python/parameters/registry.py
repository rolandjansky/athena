...
class Registry(object):
    ...
    def __init__(self):
        ...
        self.add_default("Bmass", atlas_common.mass.b, name="mass_b", description="b-quark mass in GeV")
        self.add_default("bornktmin", 0, description="generation cut: minimum kt in underlying Born. [<0:default to 0]")
        ...
        self.add_default("bottomthr", atlas_common.mass.b, description="threshold in GeV for generating emission off b-quarks. [<0:default to 5.0]")
        ...
        self.add_default("btlscalect", 0, description="use the scales of the underlying-Born configuration for the subtraction terms. [1:enabled]")
        self.add_default("btlscalereal", 0, description="compute scales that depend on the real kinematics. [1:enabled]")
        self.add_default("bwcutoff", 15, description="mass window is hmass +/- bwcutoff * hwidth")
        ...
        self.add_default("charmthr", atlas_common.mass.c, description="threshold in GeV for generating emission off c-quarks. [<0:default to 1.5]")
        ...
        self.add_default("check_bad_st2", 0, description="check stage 2 output. [1:enabled]")
        ...
        self.add_default("hdamp", 0, description="apply damping factor (in GeV) for high-pt radiation: h**2/(pt2+h**2). [>0:enabled]")
        self.add_default("hdecaymode", 0, description="DEPRECATED: this does nothing. It specifies decay mode in Powheg's PYTHIA/HERWIG which we do not use.")
        ...
        self.add_default("hfact", -1, frozen=True, description="DEPRECATED: enable hdamp and bornzerodamp. [>0:enabled]")
        ...
        self.add_default("novirtual", 0, description="ignore virtual contributions. [1:enabled]")
        ...
        self.add_default("ptsqmin", 0.8, description="minimum pT in GeV for generating emission off light quarks. [<0:default to 0.8]")
        ...
        self.add_default("stage2init", 0, description="[1:enabled]")
        ...
        self.add_default("testsuda", 0, frozen=True, description="test Sudakov form factor. [1:enabled]")
        ...
        self.add_default("withdamp", -1, frozen=True, description="enable hdamp and bornzerodamp. [1:enabled]")
