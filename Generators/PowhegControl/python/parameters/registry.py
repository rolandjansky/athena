...
class Registry(object):
    ...
    def __init__(self):
        ...
        self.add_default("MadSpin_seed", -1, description="MadSpin seed [-1: let MadSpin decide]")
        self.add_default("MadSpin_Nevents_for_max_weigth", -1, description="number of events for the estimate of the max. weight [-1: let MadSpin decide]")
        self.add_default("MadSpin_max_weight_ps_point", -1, description="number of PS to estimate the maximum for each event [-1: let MadSpin decide]")
