...
class Registry(object):
    ...
    def __init__(self):
        ...
        self.add_default("BrWlep", powheg_atlas_common.branching_ratio.W_to_leptons, name="BR_W_to_leptons", description="total W branching ratio to leptons")
        ...
        self.add_default("correlations", 1, name="correlate_top_decays", description="if 1, correlate top quark decays; otherwise treat them as uncorrelated")
        self.add_default("cutallpairs", -1, description="[-1:use Powheg default]")
        self.add_default("dampscfact", 1.0, description="prefactor for hdamp, i.e. hdamp -> hdamp * dampscfact")
        ...
        self.add_default("hbzd", 5.0, description="theta[hbdz - R/(P_ij*B)] Born zero damping")
        ...
        self.add_default("lhfm/dmass", powheg_atlas_common.mass.d, name="mass_d", description="d-quark mass in GeV")
        ...
        self.add_default("lhfm/smass", powheg_atlas_common.mass.s, name="mass_s", description="s-quark mass in GeV")
        self.add_default("lhfm/taumass", powheg_atlas_common.mass.tau, name="mass_tau", description="mass of tau in GeV")
        self.add_default("lhfm/umass", powheg_atlas_common.mass.u, name="mass_u", description="u-quark mass in GeV")
        ...
        self.add_default("samesignleptons", 0, hidden=True, description="produce two same-sign leptons in ttW decay [1:enabled]")
        self.add_default("scalechoice", 0, description="renormalisation/factorisation scale choice for ttW processes; see documentation for possible values")
        ...
        self.add_default("vdecaymodeZ1", None, description="first Z decay mode.")
        self.add_default("vdecaymodeZ2", None, description="second Z decay mode.")
        ...
        self.add_default("Zwidth", powheg_atlas_common.width.Z, name="width_Z", description="Z boson width in GeV")
        self.add_default("zz_res_type", 0, description="Control over Higgs -> ZZ resonance. [0:resonant AND non-resonant production (only recommended for a heavy Higgs with mass > 200 GeV); 1:non-resonant ZZ continuum production only; 2:resonant Higgs->ZZ production only]")
