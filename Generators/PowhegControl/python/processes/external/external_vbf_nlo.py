...
class ExternalVBFNLO(ExternalBase):
    ...
    def __init__(self, vector_boson, allowed_decay_modes):
        ...
        self.add_keyword("vdecaymode", self.allowed_decay_modes[0], name="decay_mode", description="{} boson decay mode. [{}]".format(vector_boson, allowed_decay_modes))
    ...
    def needs_scheduling(self, process):
        ...
        with open("vbfnlo.input", "wb") as f:
