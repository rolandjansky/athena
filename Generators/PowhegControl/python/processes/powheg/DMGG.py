...
class DMGG(PowhegV2):
    """! Default Powheg configuration for dark matter plus monojet production (GG-mediated).
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        self.add_keyword("decaymode", self.allowed_decay_modes[-1], name="DM_model", description="GG-mediated dark matter model to use: [{}]".format("; ".join(self.allowed_decay_modes)))
    ...
    def validate_decays(self):
        ...
        list(self.parameters_by_keyword("decaymode"))[0].value = __decay_mode_lookup[self.DM_model]
