...
class chi1chi1(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        """
        super(chi1chi1, self).__init__(base_directory, os.path.join("weakinos", "chaIchaJ"), powheg_executable="pwhg_main_xixj", **kwargs)
        ...
        self.allowed_weakinos = {"chi1+": 1000024, "chi1-": -1000024, "chi2+": 1000037, "chi2-": -1000037}
        ...
        self.add_keyword("fin2", "chi1+", name="chargino_B")
    ...
    def validate_weakinos(self):
        ...
        weakinos = []
        for parameter in ["chargino_A", "chargino_B"]:
        ...
        list(self.parameters_by_name("chargino_A"))[0].value = max(weakinos)
        list(self.parameters_by_name("chargino_B"))[0].value = min(weakinos)
