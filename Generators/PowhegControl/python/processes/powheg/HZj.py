...
class HZj(PowhegV2):
    """! Default Powheg configuration for associated Higgs boson and Z-boson production plus one jet, with quark mass effects.
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        """
        super(HZj, self).__init__(base_directory, "HZJ", **kwargs)
        ...
        self.add_keyword("max_z_mass", 2.0 * list(self.parameters_by_name("beam_energy"))[0].value)
        ...
        self.add_keyword("vdecaymode", self.allowed_decay_modes[0], name="decay_mode", description="Z boson decay mode. [{}]".format("; ".join(self.allowed_decay_modes)))
