...
class chi0chi0(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        self.allowed_weakinos = {"chi10": 1000022, "chi20": 1000023, "chi30": 1000025, "chi40": 1000035}
        ...
        self.add_keyword("fin2", "chi20", name="neutralino_B")
        ...
        self.add_keyword("itmx1osres", 6)
        self.add_keyword("itmx1rm")
        self.add_keyword("itmx2", 7)
        self.add_keyword("itmx2osres", 10)
        ...
        self.add_keyword("ncall1osres", 15000)
    ...
    def validate_weakinos(self):
        ...
        weakinos = []
        for parameter in ["neutralino_A", "neutralino_B"]:
            weakino_name = self.parameters_by_name(parameter)[0].value
            self.check_decay_mode(weakino_name, self.allowed_weakinos.keys())
            weakinos.append(self.allowed_weakinos[weakino_name])
        self.parameters_by_name("neutralino_A")[0].value = min(weakinos)
        self.parameters_by_name("neutralino_B")[0].value = max(weakinos)
...
#        self.add_keyword("nubound", 200000)
#        self.add_keyword("xupbound", 6)
#  Cross-section test : 0.17% PASSED
#  Neg. weight test   : 14.45% FAILED
#  Upper bound test   : 0.91% PASSED
#    > cross-section  : 0.91%
#    > radiation      : 0.00%
#  Output EVNT files  : 0     FAILED
#  Single-core generation of 550 events took 2.72 hours [0.056Hz]
#  ... time taken for integration:   2.70 hours
#  ... est. generation of 5k events: 0.15 hours
