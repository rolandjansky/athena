...
class DMV(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        self.add_keyword("vdecaymode", self.allowed_decay_modes[2], name="DM_model", description="dark matter model to use. [{}]".format("; ".join(self.allowed_decay_modes)))
    ...
    def validate_decays(self):
        ...
        __decay_mode_lookup = {"vector EFT": 1, "axial-vector EFT": 2, "vector full theory": -1, "axial-vector full theory": -2}
        list(self.parameters_by_keyword("vdecaymode"))[0].value = __decay_mode_lookup[self.DM_model]
