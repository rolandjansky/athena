...
class VBF_ZZ(PowhegV2):
    ...
    def validate_decays(self):
        ...
        list(self.parameters_by_keyword("vdecaymodeZ1"))[0].value = _decay_mode_lookup[" ".join(_decay_products[0:2])]
        list(self.parameters_by_keyword("vdecaymodeZ2"))[0].value = _decay_mode_lookup[" ".join(_decay_products[2:4])]
