...
class VBF_ssWW(PowhegV2):
    """! Default Powheg configuration for same-sign W-boson pair plus jet pair production through vector boson fusion.
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        """
        super(VBF_ssWW, self).__init__(base_directory, "vbf_wp_wp", **kwargs)
    ...
    def validate_decays(self):
        ...
        list(self.parameters_by_keyword("vdecaymodew1"))[0].value = __decay_mode_lookup[" ".join(__decay_products[0:2])]
        list(self.parameters_by_keyword("vdecaymodew2"))[0].value = __decay_mode_lookup[" ".join(__decay_products[2:4])]
