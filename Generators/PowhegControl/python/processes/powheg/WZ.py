...
class WZ(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        """
        super(self.__class__, self).__init__(base_directory, "WZ", **kwargs)
    ...
    def validate_decays(self):
        ...
        self.parameters_by_keyword("WmZevee")[0].value = 0  # disable the one used as a proxy for decay mode
