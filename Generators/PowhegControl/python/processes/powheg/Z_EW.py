...
class Z_EW(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        self.add_keyword("complexmasses")
        ...
        self.add_keyword("emalpharunning")
    ...
    def validate_decays(self):
        ...
        if not list(self.externals["PHOTOS"].parameters_by_keyword("PHOTOS_enabled"))[0].value and list(self.parameters_by_keyword("no_ew"))[0].value == 0:
