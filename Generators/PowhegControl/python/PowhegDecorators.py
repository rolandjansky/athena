...
def decorate( powheg_controller, decorator ) :
  if decorator == 'CKM' :
    ...
    PowhegV2Decorator(powheg_controller)
  else :
...
class HiggsDecorator :
  ...
  def append_to_run_card( self ) :
    with open( str(self.decorated.TestArea)+'/powheg.input', 'a' ) as f :
      ...
      f.write( 'higgsfixedwidth '+str(self.decorated.higgsfixedwidth)+' ! 0 = OS, 1 = MSBAR, 2 = DRBAR\n' )
...
class HiggsV2Decorator :
  ...
  def append_to_run_card( self ) :
    with open( str(self.decorated.TestArea)+'/powheg.input', 'a' ) as f :
      ...
      f.write( 'runningscales '+str(self.decorated.runningscales)+' ! choice for ren and fac scales\n' )
...
class HVJDecorator :
  def __init__( self, decorated ) :
    ...
    self.decorated.use_massive_t = False
  ...
  def append_to_run_card( self ) :
    ...
    with open( str(self.decorated.TestArea)+'/powheg.input', 'a' ) as f :
      ...
      f.write( 'doublefst 1                                         ! \n' )
      f.write( 'factsc2min '+str(self.decorated.factsc2min)+'       ! \n' )
      f.write( 'frensc2min '+str(self.decorated.frensc2min)+'       ! \n' )
      ...
      f.write( 'sudscalevar '+str(self.decorated.sudscalevar)+'     ! \n' )
