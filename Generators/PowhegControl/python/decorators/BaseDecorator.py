...
class BaseDecorator(object) :
  ...
  def __init__( self, decorated ) :
    ...
    # Random seeds
    self.decorated.add_parameter( 'manyseeds', 0,   desc='(default 0, disabled) read multiple seeds for the random number generator from pwgseeds.dat' )
    self.decorated.fix_parameter( 'rand1', 0,       desc='(default 0, disabled) user-initiated random seed (disabled for reproducibility)' )
    self.decorated.fix_parameter( 'rand2', 0,       desc='(default 0, disabled) user-initiated random seed (disabled for reproducibility)' )
