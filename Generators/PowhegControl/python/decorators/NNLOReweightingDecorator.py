...
class NNLOReweightingDecorator(object) :
  ...
  def __init__( self, decorated ) :
    ...
    self.decorated.add_phantom( 'NNLO_reweighting_inputs', {}, desc='(default empty) dictionary of labels => (pre-existing) HNNLO output' )
    self.decorated.add_phantom( 'NNLO_output_weights', {},     desc='(default empty) dictionary of weight ID string => weight calculation in NNLOPS format' )
