...
//---------------------------------------------------------------------------
  ...
  for (itr = events()->begin(); itr!=events()->end(); ++itr) {
    ...
    for(HepMC::GenEvent::particle_const_iterator pitr=genEvt->particles_begin();pitr!=genEvt->particles_end(); ++pitr ) {
      ...
      const HepMC::GenParticlePtr part = (*pitr);
...
const HepMC::GenParticlePtr  TTbarPlusHeavyFlavorFilter::findInitial(const HepMC::GenParticlePtr part, bool looping) const{
