...
bool BoostedHadTopAndTopPair::isFromTop(const HepMC::GenParticlePtr part) const{

  const HepMC::GenParticlePtr initpart = findInitial(part);
  HepMC::GenVertexPtr prod = initpart->production_vertex();
...
const HepMC::GenParticlePtr  BoostedHadTopAndTopPair::findInitial(const HepMC::GenParticlePtr part) const{
...
bool BoostedHadTopAndTopPair::isHadronic(const HepMC::GenParticlePtr part) const{
...
bool BoostedHadTopAndTopPair::isFinalParticle(const HepMC::GenParticlePtr part) const{
...
HepMC::FourVector BoostedHadTopAndTopPair::momentumBofW(const HepMC::GenParticlePtr part){
