#ifndef GENERATORFILTERS_QCDTRUTHJETFILTERTEST_H
#define GENERATORFILTERS_QCDTRUTHJETFILTERTEST_H
...
class QCDTruthJetFilterTest : public GenFilter {
public:

  QCDTruthJetFilterTest(const std::string& name, ISvcLocator* pSvcLocator);
...
private:
  ...
  bool m_noFilter;  //!< Pass all events including those failing filter (weight=0)
