...
import glob
svcMgr.EventSelector.InputCollections = glob.glob('/tmp/soumya/HIJING_FLOW/*root*')
...
job=AlgSequence()
from FlowAfterburner.FlowAfterburnerConf import CheckFlow_New
job += CheckFlow_New()
...
CheckFlow_New.McEventKey = "GEN_EVENT"
CheckFlow_New.RapidityCutMax = 5.5
#==============================================================
#
