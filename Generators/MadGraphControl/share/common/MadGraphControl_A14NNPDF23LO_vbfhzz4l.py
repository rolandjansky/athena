...
def parseargs(runArgs,safefactor=2.,nevents=10000):
    options = {}
...
HCparams = {}
if options["runNumber"] == 344152:
  HCparams['kHvv']=2.5
  HCparams['kAvv']=-5.0
elif options["runNumber"] == 344153:
  HCparams['kHvv']=5.0
  HCparams['kAvv']=5.0
elif options["runNumber"] == 344154:
  HCparams['kHvv']=5.0
  HCparams['kAvv']=6.0
elif options["runNumber"] == 344155:
  HCparams['kHvv']=-2.5
  HCparams['kAvv']=-5.0
elif options["runNumber"] == 344156:
  HCparams['kHvv']=-5.0
  HCparams['kAvv']=5.0
elif options["runNumber"] == 344157:
  HCparams['kHvv']=-5.0
  HCparams['kAvv']=-6.0
elif options["runNumber"] == 345049:
  HCparams['kHvv']=10.0
  HCparams['kAvv']=-10.0
else:
  raise RuntimeError("runNumber {0:d} not recognised in these jobOptions. Available options are: 344152-344157 or 345049".format(options["runNumber"]))  
...
evgenConfig.keywords = ['BSM', 'Higgs', 'VBF', 'VBFHiggs', 'mH125', 'BSMHiggs', 'dijet', 'resonance', 'ZZ']
...
# Generate_tf.py --ecmEnergy=13000 --firstEvent=1 --randomSeed=1 --jobConfig=generateEvents_vbfhzz4l_0pphmkHv2p5kAvm5.py --outputEVNTFile=EVNT.00001.root --runNumber=344152 --maxEvents=10
#---------------------------------------------------------------------------------------------------
