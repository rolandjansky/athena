...
if runArgs.runNumber==410409:
    mgproc="""generate p p > ttbar w z [QCD]"""
    name='tWZ_NLO_minDR2_Ztoll'
else:
...
get_matrix_card = subprocess.Popen(['get_files','-data','bg_matrix_2_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("bg_matrix_2_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_bg_wmzt/matrix_2.f")
get_matrix_card = subprocess.Popen(['get_files','-data','bg_matrix_7_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("bg_matrix_7_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_bg_wmzt/matrix_7.f")
get_matrix_card = subprocess.Popen(['get_files','-data','bxg_matrix_2_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("bxg_matrix_2_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_bxg_wpztx/matrix_2.f")
get_matrix_card = subprocess.Popen(['get_files','-data','bxg_matrix_8_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("bxg_matrix_8_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_bxg_wpztx/matrix_8.f")
get_matrix_card = subprocess.Popen(['get_files','-data','gb_matrix_6_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("gb_matrix_6_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_gb_wmzt/matrix_6.f")
get_matrix_card = subprocess.Popen(['get_files','-data','gb_matrix_8_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("gb_matrix_8_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_gb_wmzt/matrix_8.f")
get_matrix_card = subprocess.Popen(['get_files','-data','gbx_matrix_7_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("gbx_matrix_7_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_gbx_wpztx/matrix_7.f")
get_matrix_card = subprocess.Popen(['get_files','-data','gbx_matrix_8_tWZ_minDR2_MG233.f'])
get_matrix_card.wait()
shutil.copy("gbx_matrix_8_tWZ_minDR2_MG233.f",process_dir+"/SubProcesses/P0_gbx_wpztx/matrix_8.f")
##
...
evgenConfig.description = "MG5aMCatNLO/Pythia8 tWZ minDR2"
