...
cps = []
if "_ta_" in JOname:
    if lqPDGID == 43: cps.extend( ["dTL", "dTR", "uVTL"] )
    elif lqPDGID == 42:  cps.extend( ["uTL", "uTR", "dVTL"] )

if "_mu_" in JOname:
    if lqPDGID == 43: cps.extend( ["dML", "dMR", "uVML"] )
    elif lqPDGID == 42:  cps.extend( ["uML", "uMR", "dVML"] )

if "_el_" in JOname:
    if lqPDGID == 43: cps.extend( ["dEL", "dER", "uVEL"] )
    elif lqPDGID == 42:  cps.extend( ["uEL", "uER", "dVEL"] )
