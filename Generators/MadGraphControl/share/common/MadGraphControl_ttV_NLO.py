...
ttee               = [410218,410370,410371,410276,345937]
ttmumu             = [410219,410372,410373,410277,345938]
tttautau           = [410220,410374,410375,410278]

ttZnunu            = [410156,410378,410379]
ttZqq              = [410157,410380,410381]
ttgamma            = [407320]

ttW                = [410155,410376,41037,345939]
...
m4l_mll_pt_Filters = [345937,345938,345939]
...
if runArgs.runNumber in ttee:
    ...
    if runArgs.runNumber in mll_1_5GeV:
        ...
        mllcut=5
    if runArgs.runNumber in m4l_mll_pt_Filters:
        nevents=25000 
        name +='_m4l_mll_pt_Filters'
        print name
...
if runArgs.runNumber in ttee and runArgs.runNumber in m4l_mll_pt_Filters:
    evgenConfig.minevents  = 1000 
elif runArgs.runNumber in ttmumu and runArgs.runNumber in m4l_mll_pt_Filters:
    evgenConfig.minevents  = 1000 
elif runArgs.runNumber in ttW and runArgs.runNumber in m4l_mll_pt_Filters:
