...
if ( runArgs.runNumber==308459 or runArgs.runNumber==308460 ):
    c = 0.5
elif (runArgs.runNumber>=308461 and runArgs.runNumber<=308467 ):
    c = 2.0
else:
    print 'ERROR - no c parameter specified'

if ( runArgs.runNumber==308461 ):
    mhh = '260'
elif ( runArgs.runNumber==308462 ):
    mhh = '400'
elif ( runArgs.runNumber==308459 or  runArgs.runNumber==308463 ):
    mhh = '500'
elif ( runArgs.runNumber==308464 ):
    mhh = '600'
elif ( runArgs.runNumber==308465 ):
    mhh = '800'
elif ( runArgs.runNumber==308466 ):
    mhh = '900'
elif ( runArgs.runNumber==308460 or runArgs.runNumber==308467):
    mhh = '1000'
else:
...
filtSeq.Expression = "HiggsToBBTauTauFilter and TauTautoHadHadFilter and LepTauPtFilter"
