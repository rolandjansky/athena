...
Wt_DR1_incl_P8    = [412000]
Wt_DR1_dil_P8     = [412001]

mgproc="""generate p p > ttbar w [QCD]"""

if runArgs.runNumber==412000:
    name='Wt_DR1_NLO_inclusive_P8'
    decay_mode = 'inclusive'
    parton_shower='PYTHIA8'
elif runArgs.runNumber==412001:
    name='Wt_DR1_NLO_dilepton_P8'
    decay_mode = 'dilepton'
    parton_shower='PYTHIA8'
else:
...
evgenConfig.description = "MG5aMCatNLO/Pythia8 Wt DR1 " + decay_mode
