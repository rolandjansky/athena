...
masses['1000022']= (masses['1000006']-10.)
masses['1000024']= (masses['1000021'])
masses['1000023']= (masses['1000024']-1.)
...
add process p p > t t1~ go j $ susylq susylq~ b1 b2 t2 b1~ b2~ t2~ @2
add process p p > t t1~ go j j $ susylq susylq~ b1 b2 t2 b1~ b2~ t2~ @3
'''
njets = 2 
...
if 'MadSpin' in runArgs.jobConfig[0].split('_')[-2]:
    ...
    decay_chains = [ "t1~ > n1 fu~ fd b~" , "t > w+ b, w+ > all all" ]
