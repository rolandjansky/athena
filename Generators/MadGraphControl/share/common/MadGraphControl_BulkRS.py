...
""" % (float(scenario[1:])/10., 125., 125., float(mass))
    ...
    str_param_card='SMRS_widths/Cards/param_card.dat'

    # I don't think this is really necessary -- running new_process above should be sufficient.
    # Also found that this generate process somehow gets the wrong run_card, causing crashes.
    #
