...
evgenConfig.description = 'gluino pair production and decay via off-shell stops and/or sbottoms, m_glu = %s GeV, m_stop/sbottom = %s GeV, m_N1 = %s GeV, m_C1 = %s GeV'%(masses['1000021'],masses['1000005'],masses['1000022'],masses['1000024'])
