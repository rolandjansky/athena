...
### DSID list
if runArgs.runNumber==412002:
    name='Wt_DR1_NLO_inclusive_P8'
    decay_mode = 'inclusive'
elif runArgs.runNumber==412003:
...
generate(run_card_loc='run_card.dat', param_card_loc=param_card_loc,
        mode=mode, proc_dir=process_dir, madspin_card_loc=madspin_card_loc)
...
evgenConfig.description    = 'MG5_aMC@NLO+Pythia8+EvtGen '+name+' '+decay_mode
evgenConfig.keywords      += [ 'SM', 'top']
evgenConfig.contact        = [ 'kevin.finelli@cern.ch' ]
