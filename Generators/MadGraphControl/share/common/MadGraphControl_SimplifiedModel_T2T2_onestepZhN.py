...
evgenLog.info('Registered generation of stop2 pair production, stop2 to Z+stop1, h+stop1, stop1->t+LSP; grid point '+str(runArgs.runNumber)+' decoded into mass point ' + str(masses['2000006']))
