...
name = 'SMRS_c'+str(int(10*c))+'_G_hh_4tau_m'+str(mhh)
...
evgenConfig.description = "Bulk Randall-Sundrum model KK graviton -> hh -> 4tau with NNPDF2.3 LO A14 tune"
evgenConfig.inputfilecheck = stringy
evgenConfig.keywords = ["exotic", "RandallSundrum", "warpedED", "graviton", "Higgs","BSM"]
evgenConfig.process = "RS_G_hh_4tau"
