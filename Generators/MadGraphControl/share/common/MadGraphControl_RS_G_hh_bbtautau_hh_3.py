...
if (runArgs.runNumber>=308309 and runArgs.runNumber<=308313):
    c = 1.0
elif (runArgs.runNumber>=308314 and runArgs.runNumber<=308318):
    c = 2.0
else:
    print 'ERROR - no c parameter specified'

if ( runArgs.runNumber==308309 or runArgs.runNumber==308314 ):
    mhh = '275'
elif ( runArgs.runNumber==308310 or runArgs.runNumber==308315 ):
    mhh = '325'
elif ( runArgs.runNumber==308311 or runArgs.runNumber==308316 ):
    mhh = '350'
elif ( runArgs.runNumber==308312 or runArgs.runNumber==308317 ):
    mhh = '450'
elif ( runArgs.runNumber==308313 or runArgs.runNumber==308318 ):
    mhh = '550'
