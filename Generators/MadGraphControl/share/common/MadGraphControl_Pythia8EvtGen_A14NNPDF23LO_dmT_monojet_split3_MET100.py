...
generate p p > chi chi~ / etab etabbar etat etatbar a h z w+ w- $med @1 
add process p p > j chi chi~ / etab etabbar etat etatbar a h z w+ w- $med @2 
add process p p > j j chi chi~ / etab etabbar etat etatbar a h z w+ w- $med NP=4 QCD=2 @3 
...
PYTHIA8_Process='pp>{chi,1000022}{chi~,-1000022}'
