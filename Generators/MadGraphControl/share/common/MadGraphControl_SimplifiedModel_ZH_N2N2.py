...
process = '''
generate p p > h1 z, (h1 > n2 n2) , (z > l+ l-) @1 
'''
njets = 0
...
evgenConfig.description = 'h1 z production, decay via n2, n2 in simplified model, m_N2 = %s GeV, m_N1 = %s GeV'%(masses['1000023'],masses['1000022'])
