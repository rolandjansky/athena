...
evgenConfig.description = "DM simplified scalar models %s, mchi = %.1f GeV, mphi = %.1f GeV, WidthPhi = %.5f" %(model_string,mchi,mphi,Wphi)
...
if (filter_string == "T") and (model_string == "ttscalar" or model_string == "ttpseudo"):
    ...
    evgenLog.info('1 Jet 100 and MET 60 filter is applied')
    include('GeneratorFilters/MissingEtFilter.py')
    filtSeq.MissingEtFilter.METCut = 60000.
    filtSeq.Expression = "MissingEtFilter"

    include( 'GeneratorFilters/JetFilterAkt6.py')
    filtSeq.QCDTruthJetFilter.MinPt = 100. * 1000.
