...
V_5 = Vertex(name = 'V_5',
             particles = [ P.hD, P.hD, P.hD ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_32})

V_6 = Vertex(name = 'V_6',
             particles = [ P.hD, P.n1, P.n1 ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
...
V_23 = Vertex(name = 'V_23',
              particles = [ P.Zp, P.Zp, P.hD, P.hD ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_9})

V_24 = Vertex(name = 'V_24',
              particles = [ P.Zp, P.Zp, P.hD ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_39 = Vertex(name = 'V_39',
              ...
              color = [ '1' ],
              lorentz = [ L.FFV2, L.FFV4 ],
              couplings = {(0,1):C.GC_25,(0,0):C.GC_20})
...
V_68 = Vertex(name = 'V_68',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV2, L.FFV3 ],
              couplings = {(0,1):C.GC_24,(0,0):C.GC_20})
