...
Decay_n1 = Decay(name = 'Decay_n1',
                 particle = P.n1,
                 partial_widths = {(P.vx,P.n2):'((2*gx**2*Mn1**2 - 12*gx**2*Mn1*Mn2 + 2*gx**2*Mn2**2 + (2*gx**2*Mn1**4)/MVdark**2 - (4*gx**2*Mn1**2*Mn2**2)/MVdark**2 + (2*gx**2*Mn2**4)/MVdark**2 - 4*gx**2*MVdark**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MVdark**2 - 2*Mn2**2*MVdark**2 + MVdark**4))/(32.*cmath.pi*abs(Mn1)**3)',
                                   (P.Zp,P.n2):'((2*gZx**2*Mn1**2 - 12*gZx**2*Mn1*Mn2 + 2*gZx**2*Mn2**2 + (2*gZx**2*Mn1**4)/MZp**2 - (4*gZx**2*Mn1**2*Mn2**2)/MZp**2 + (2*gZx**2*Mn2**4)/MZp**2 - 4*gZx**2*MZp**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MZp**2 - 2*Mn2**2*MZp**2 + MZp**4))/(32.*cmath.pi*abs(Mn1)**3)'})

Decay_n2 = Decay(name = 'Decay_n2',
                 particle = P.n2,
                 partial_widths = {(P.vx,P.n1):'((2*gx**2*Mn1**2 - 12*gx**2*Mn1*Mn2 + 2*gx**2*Mn2**2 + (2*gx**2*Mn1**4)/MVdark**2 - (4*gx**2*Mn1**2*Mn2**2)/MVdark**2 + (2*gx**2*Mn2**4)/MVdark**2 - 4*gx**2*MVdark**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MVdark**2 - 2*Mn2**2*MVdark**2 + MVdark**4))/(32.*cmath.pi*abs(Mn2)**3)',
                                   (P.Zp,P.n1):'((2*gZx**2*Mn1**2 - 12*gZx**2*Mn1*Mn2 + 2*gZx**2*Mn2**2 + (2*gZx**2*Mn1**4)/MZp**2 - (4*gZx**2*Mn1**2*Mn2**2)/MZp**2 + (2*gZx**2*Mn2**4)/MZp**2 - 4*gZx**2*MZp**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MZp**2 - 2*Mn2**2*MZp**2 + MZp**4))/(32.*cmath.pi*abs(Mn2)**3)'})
...
Decay_vx = Decay(name = 'Decay_vx',
                 ...
                 partial_widths = {(P.b,P.b__tilde__):'((24*gxd**2*MB**2 + 12*gxd**2*MVdark**2)*cmath.sqrt(-4*MB**2*MVdark**2 + MVdark**4))/(48.*cmath.pi*abs(MVdark)**3)',
                                   ...
                                   (P.n1,P.n2):'((-2*gx**2*Mn1**2 + 12*gx**2*Mn1*Mn2 - 2*gx**2*Mn2**2 - (2*gx**2*Mn1**4)/MVdark**2 + (4*gx**2*Mn1**2*Mn2**2)/MVdark**2 - (2*gx**2*Mn2**4)/MVdark**2 + 4*gx**2*MVdark**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MVdark**2 - 2*Mn2**2*MVdark**2 + MVdark**4))/(48.*cmath.pi*abs(MVdark)**3)',
...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.b,P.b__tilde__):'((24*gZq**2*MB**2 + 12*gZq**2*MZp**2)*cmath.sqrt(-4*MB**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.c,P.c__tilde__):'(gZq**2*MZp**4)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.d,P.d__tilde__):'(gZq**2*MZp**4)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.n1,P.n2):'((-2*gZx**2*Mn1**2 + 12*gZx**2*Mn1*Mn2 - 2*gZx**2*Mn2**2 - (2*gZx**2*Mn1**4)/MZp**2 + (4*gZx**2*Mn1**2*Mn2**2)/MZp**2 - (2*gZx**2*Mn2**4)/MZp**2 + 4*gZx**2*MZp**2)*cmath.sqrt(Mn1**4 - 2*Mn1**2*Mn2**2 + Mn2**4 - 2*Mn1**2*MZp**2 - 2*Mn2**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.s__tilde__):'(gZq**2*MZp**4)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.t,P.t__tilde__):'((24*gZq**2*MT**2 + 12*gZq**2*MZp**2)*cmath.sqrt(-4*MT**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.u,P.u__tilde__):'(gZq**2*MZp**4)/(4.*cmath.pi*abs(MZp)**3)'})
