...
V_36 = Vertex(name = 'V_36',
              particles = [ P.e__plus__, P.e__minus__, P.vx ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_11})

V_37 = Vertex(name = 'V_37',
              particles = [ P.mu__plus__, P.mu__minus__, P.vx ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_11})

V_38 = Vertex(name = 'V_38',
              particles = [ P.ta__plus__, P.ta__minus__, P.vx ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_11})
...
V_53 = Vertex(name = 'V_53',
              particles = [ P.u__tilde__, P.u, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_12})

V_54 = Vertex(name = 'V_54',
              particles = [ P.c__tilde__, P.c, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_12})

V_55 = Vertex(name = 'V_55',
              particles = [ P.t__tilde__, P.t, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_12})
...
V_73 = Vertex(name = 'V_73',
              particles = [ P.d__tilde__, P.d, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_74 = Vertex(name = 'V_74',
              particles = [ P.s__tilde__, P.s, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_75 = Vertex(name = 'V_75',
              particles = [ P.b__tilde__, P.b, P.vx ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})
