...
V_15 = Vertex(name = 'V_15',
              particles = [ P.n1__tilde__, P.b, P.phix__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_10})

V_16 = Vertex(name = 'V_16',
              particles = [ P.b__tilde__, P.n1, P.phix ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_10})

V_17 = Vertex(name = 'V_17',
              particles = [ P.g, P.phix__tilde__, P.phix ],
              color = [ 'T(1,3,2)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_7})

V_18 = Vertex(name = 'V_18',
              particles = [ P.g, P.g, P.phix__tilde__, P.phix ],
...
V_43 = Vertex(name = 'V_43',
              ...
              color = [ '1' ],
              lorentz = [ L.FFV2, L.FFV4 ],
              couplings = {(0,1):C.GC_30,(0,0):C.GC_25})
