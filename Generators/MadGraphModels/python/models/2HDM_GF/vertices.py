...
# additional vertices for gluon fusion
#    67 -> 318 V_6 - > V_227     67 - 318   68 - 319  69 - 320  70 - 321  71 - 322  72 - 323  73 - 324  74 - 325
V_227 = Vertex(name = 'V_227',
             particles = [ P.G, P.G, P.h1 ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.VVS3 ],
             couplings = {(0,0):C.GC_318})  #  67

V_228 = Vertex(name = 'V_228',
             particles = [ P.G, P.G, P.h2 ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.VVS3 ],
             couplings = {(0,0):C.GC_321})  # 70

V_229 = Vertex(name = 'V_229',
             particles = [ P.G, P.G, P.h3 ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.VVS1 ],
             couplings = {(0,0):C.GC_324})  # 73

V_230 = Vertex(name = 'V_230',
              particles = [ P.G, P.G, P.G, P.h1 ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VVVS2 ],
              couplings = {(0,0):C.GC_319})  # 68

V_231 = Vertex(name = 'V_231',
              particles = [ P.G, P.G, P.G, P.G, P.h1 ],
              color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVVVS1, L.VVVVS2, L.VVVVS3 ],
              couplings = {(1,1):C.GC_320,(0,0):C.GC_320,(2,2):C.GC_320})  #  69 69 69

V_232 = Vertex(name = 'V_232',
              particles = [ P.G, P.G, P.G, P.h2 ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VVVS2 ],
              couplings = {(0,0):C.GC_322}) # 71

V_233 = Vertex(name = 'V_233',
              particles = [ P.G, P.G, P.G, P.G, P.h2 ],
              color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVVVS1, L.VVVVS2, L.VVVVS3 ],
              couplings = {(1,1):C.GC_323,(0,0):C.GC_323,(2,2):C.GC_323})  # 72 72 72

V_234 = Vertex(name = 'V_234',
              particles = [ P.G, P.G, P.G, P.h3 ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VVVS1 ],
              couplings = {(0,0):C.GC_325}) # 74
