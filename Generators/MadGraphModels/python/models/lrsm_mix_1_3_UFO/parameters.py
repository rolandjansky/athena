...
GD = Parameter(name = 'GD',
               nature = 'internal',
               type = 'complex',
               value = '-(gs**2*MT**4*(MH02**2/MT**2 + (-4 + MH02**2/MT**2)*cmath.atan(1/cmath.sqrt(-1 + (4*MT**2)/MH02**2))**2))/(2.*cmath.pi**2*MH02**4*vev)',
               texname = 'G_D')

GH = Parameter(name = 'GH',
               nature = 'internal',
               type = 'real',
               value = '-(gs**2*MT**4*(MH**2/MT**2 + (-4 + MH**2/MT**2)*cmath.atan(1/cmath.sqrt(-1 + (4*MT**2)/MH**2))**2))/(2.*cmath.pi**2*MH**4*vev)',
               texname = 'G_H')
