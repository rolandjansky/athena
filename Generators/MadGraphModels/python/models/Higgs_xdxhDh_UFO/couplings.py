...
GC_131 = Coupling(name = 'GC_131',
                  value = '-(complex(0,1)*yx)/2.',
                  order = {'NP':1,'QED':1})

GC_132 = Coupling(name = 'GC_132',
                  value = '-(complex(0,1)*yx)',
                  order = {'NP':1,'QED':1})
...
GC_142 = Coupling(name = 'GC_142',
                  value = '-(cw*ee*complex(0,1)*yx)/(2.*sw) - (ee*complex(0,1)*sw*yx)/(2.*cw)',
                  order = {'NP':1,'QED':2})
...
GC_144 = Coupling(name = 'GC_144',
                  value = '-(cw*ee*complex(0,1)*vev*yx)/(2.*sw) - (ee*complex(0,1)*sw*vev*yx)/(2.*cw)',
                  order = {'NP':1,'QED':1})

GC_145 = Coupling(name = 'GC_145',
                  value = '-(cw*ee*complex(0,1)*vev**2*yx)/(4.*sw) - (ee*complex(0,1)*sw*vev**2*yx)/(4.*cw)',
                  order = {'NP':1})
