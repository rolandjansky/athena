...
V_12 = Vertex(name = 'V_12',
              particles = [ P.a, P.G__minus__, P.G__plus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_134})

V_13 = Vertex(name = 'V_13',
              particles = [ P.G0, P.G0, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSSS3 ],
              couplings = {(0,0):C.GC_131})

V_14 = Vertex(name = 'V_14',
              particles = [ P.G0, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSSS4 ],
              couplings = {(0,0):C.GC_133})

V_15 = Vertex(name = 'V_15',
              particles = [ P.G0, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSS2 ],
              couplings = {(0,0):C.GC_139})

V_16 = Vertex(name = 'V_16',
              particles = [ P.G__minus__, P.G__plus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSSS2 ],
              couplings = {(0,0):C.GC_132})

V_17 = Vertex(name = 'V_17',
              particles = [ P.H, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSSS3 ],
              couplings = {(0,0):C.GC_131})

V_18 = Vertex(name = 'V_18',
              particles = [ P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.SSS2 ],
...
V_70 = Vertex(name = 'V_70',
              particles = [ P.W__minus__, P.G0, P.G__plus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_136})

V_71 = Vertex(name = 'V_71',
              particles = [ P.W__minus__, P.G__plus__, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_135})

V_72 = Vertex(name = 'V_72',
              particles = [ P.W__minus__, P.G__plus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
...
V_75 = Vertex(name = 'V_75',
              particles = [ P.W__plus__, P.G0, P.G__minus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_136})

V_76 = Vertex(name = 'V_76',
              particles = [ P.W__plus__, P.G__minus__, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_137})

V_77 = Vertex(name = 'V_77',
              particles = [ P.W__plus__, P.G__minus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
...
V_87 = Vertex(name = 'V_87',
              particles = [ P.Z, P.G0, P.G0, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_142})

V_88 = Vertex(name = 'V_88',
              particles = [ P.Z, P.G__minus__, P.G__plus__, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_143})

V_89 = Vertex(name = 'V_89',
              particles = [ P.Z, P.H, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSSS1 ],
              couplings = {(0,0):C.GC_142})

V_90 = Vertex(name = 'V_90',
              particles = [ P.Z, P.H, P.x__tilde__, P.x ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
...
V_110 = Vertex(name = 'V_110',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,1):C.GC_83,(0,0):C.GC_75})
