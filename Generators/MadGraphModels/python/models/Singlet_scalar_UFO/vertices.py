...
V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.se ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_67})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.se ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_67})

V_9 = Vertex(name = 'V_9',
             particles = [ P.H, P.H, P.se ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_67})
...
V_15 = Vertex(name = 'V_15',
              particles = [ P.a, P.a, P.se ],
              color = [ '1' ],
              lorentz = [ L.VVS4 ],
              couplings = {(0,0):C.GC_52})

V_16 = Vertex(name = 'V_16',
              particles = [ P.g, P.g, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.VVS4 ],
              couplings = {(0,0):C.GC_54})

V_17 = Vertex(name = 'V_17',
              particles = [ P.W__minus__, P.W__plus__, P.se ],
              color = [ '1' ],
              lorentz = [ L.VVS4 ],
              couplings = {(0,0):C.GC_80})

V_18 = Vertex(name = 'V_18',
              particles = [ P.a, P.Z, P.se ],
              color = [ '1' ],
              lorentz = [ L.VVS4 ],
              couplings = {(0,0):C.GC_112})

V_19 = Vertex(name = 'V_19',
              particles = [ P.Z, P.Z, P.se ],
              color = [ '1' ],
              lorentz = [ L.VVS4 ],
...
V_43 = Vertex(name = 'V_43',
              particles = [ P.b__tilde__, P.b, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_59})

V_44 = Vertex(name = 'V_44',
              particles = [ P.c__tilde__, P.c, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_61})

V_45 = Vertex(name = 'V_45',
              particles = [ P.d__tilde__, P.d, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_63})

V_46 = Vertex(name = 'V_46',
              particles = [ P.s__tilde__, P.s, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_65})

V_47 = Vertex(name = 'V_47',
              particles = [ P.t__tilde__, P.t, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_68})

V_48 = Vertex(name = 'V_48',
              particles = [ P.u__tilde__, P.u, P.se ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_70})

V_49 = Vertex(name = 'V_49',
              particles = [ P.a, P.a, P.so ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_53})

V_50 = Vertex(name = 'V_50',
              particles = [ P.a, P.Z, P.so ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_113})

V_51 = Vertex(name = 'V_51',
              particles = [ P.Z, P.Z, P.so ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_117})

V_52 = Vertex(name = 'V_52',
              particles = [ P.W__minus__, P.W__plus__, P.so ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
...
V_57 = Vertex(name = 'V_57',
              particles = [ P.g, P.g, P.g, P.se ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VVVS3 ],
              couplings = {(0,0):C.GC_56})

V_58 = Vertex(name = 'V_58',
              particles = [ P.g, P.g, P.g, P.g, P.se ],
              color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVVVS1, L.VVVVS3, L.VVVVS4 ],
              couplings = {(1,1):C.GC_58,(0,0):C.GC_58,(2,2):C.GC_58})
...
V_60 = Vertex(name = 'V_60',
              particles = [ P.b__tilde__, P.b, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_60})

V_61 = Vertex(name = 'V_61',
              particles = [ P.c__tilde__, P.c, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_62})

V_62 = Vertex(name = 'V_62',
              particles = [ P.d__tilde__, P.d, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_64})

V_63 = Vertex(name = 'V_63',
              particles = [ P.s__tilde__, P.s, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_66})

V_64 = Vertex(name = 'V_64',
              particles = [ P.t__tilde__, P.t, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_69})

V_65 = Vertex(name = 'V_65',
              particles = [ P.u__tilde__, P.u, P.so ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
...
V_111 = Vertex(name = 'V_111',
               particles = [ P.a, P.W__minus__, P.W__plus__, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVS3 ],
               couplings = {(0,0):C.GC_82})

V_112 = Vertex(name = 'V_112',
               particles = [ P.a, P.W__minus__, P.W__plus__, P.so ],
               color = [ '1' ],
               lorentz = [ L.VVVS1 ],
...
V_123 = Vertex(name = 'V_123',
               particles = [ P.a, P.a, P.W__minus__, P.W__plus__, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
               couplings = {(0,0):C.GC_84})

V_124 = Vertex(name = 'V_124',
               particles = [ P.W__minus__, P.W__plus__, P.Z, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVS3 ],
...
V_126 = Vertex(name = 'V_126',
               particles = [ P.W__minus__, P.W__plus__, P.Z, P.so ],
               color = [ '1' ],
               lorentz = [ L.VVVS1 ],
               couplings = {(0,0):C.GC_75})

V_127 = Vertex(name = 'V_127',
               particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
...
V_141 = Vertex(name = 'V_141',
               particles = [ P.a, P.W__minus__, P.W__plus__, P.Z, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVVS5 ],
...
V_147 = Vertex(name = 'V_147',
               particles = [ P.W__minus__, P.W__plus__, P.Z, P.Z, P.se ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
...
V_161 = Vertex(name = 'V_161',
               ...
               couplings = {(0,0):C.GC_98,(0,1):C.GC_107})
...
V_179 = Vertex(name = 'V_179',
               ...
               couplings = {(0,0):C.GC_99,(0,1):C.GC_106})
