...
GC_14 = Coupling(name = 'GC_14',
                 value = '-4*Fphi*complex(0,1)*gSM',
                 order = {'NP':2})

GC_15 = Coupling(name = 'GC_15',
                 value = '-(complex(0,1)*Gphi*gSM)',
                 order = {'NP':2})
