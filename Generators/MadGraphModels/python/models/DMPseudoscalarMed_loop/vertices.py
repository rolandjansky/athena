...
V_77 = Vertex(name = 'V_77',
              ...
              couplings = {(0,0):C.GC_73,(0,1):C.GC_80})
...
V_107 = Vertex(name = 'V_107',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS3 ],
               couplings = {(0,0):C.GC_114,(0,1):C.GC_116})
...
V_109 = Vertex(name = 'V_109',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS3 ],
               couplings = {(0,0):C.GC_106,(0,1):C.GC_108})
...
V_111 = Vertex(name = 'V_111',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS3 ],
               couplings = {(0,0):C.GC_131,(0,1):C.GC_131})
...
V_122 = Vertex(name = 'V_122',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS3 ],
               couplings = {(0,0):C.GC_146,(0,1):C.GC_144})

V_123 = Vertex(name = 'V_123',
               particles = [ P.c__tilde__, P.c, P.G0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS3 ],
               couplings = {(0,0):C.GC_112,(0,1):C.GC_110})
...
V_164 = Vertex(name = 'V_164',
               particles = [ P.a, P.a, P.phim ],
               color = [ '1' ],
               lorentz = [ L.VVS2 ],
               couplings = {(0,0):C.GC_14})

V_165 = Vertex(name = 'V_165',
               particles = [ P.g, P.g, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.VVS1 ],
               couplings = {(0,0):C.GC_15})

V_166 = Vertex(name = 'V_166',
               particles = [ P.g, P.g, P.g, P.phim ],
               color = [ 'f(1,2,3)' ],
               lorentz = [ L.VVVS1 ],
               couplings = {(0,0):C.GC_16})

V_167 = Vertex(name = 'V_167',
               particles = [ P.chi__tilde__, P.chi, P.phim ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_13})

V_168 = Vertex(name = 'V_168',
               particles = [ P.d__tilde__, P.d, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_117})

V_169 = Vertex(name = 'V_169',
               particles = [ P.s__tilde__, P.s, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_133})

V_170 = Vertex(name = 'V_170',
               particles = [ P.b__tilde__, P.b, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_109})

V_171 = Vertex(name = 'V_171',
               particles = [ P.e__plus__, P.e__minus__, P.phim ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_123})

V_172 = Vertex(name = 'V_172',
               particles = [ P.mu__plus__, P.mu__minus__, P.phim ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_129})

V_173 = Vertex(name = 'V_173',
               particles = [ P.ta__plus__, P.ta__minus__, P.phim ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_143})

V_174 = Vertex(name = 'V_174',
               particles = [ P.u__tilde__, P.u, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_147})

V_175 = Vertex(name = 'V_175',
               particles = [ P.c__tilde__, P.c, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_113})

V_176 = Vertex(name = 'V_176',
               particles = [ P.t__tilde__, P.t, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
