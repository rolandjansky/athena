...
V_35 = Vertex(name = 'V_35',
              particles = [ P.X__tilde__, P.X, P.a, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFVV1, L.FFVV2 ],
              couplings = {(0,0):C.GC_61,(0,1):C.GC_62})

V_36 = Vertex(name = 'V_36',
              particles = [ P.X__tilde__, P.X, P.a, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFVV1, L.FFVV2 ],
              couplings = {(0,0):C.GC_55,(0,1):C.GC_56})

V_37 = Vertex(name = 'V_37',
              particles = [ P.X__tilde__, P.X, P.Z, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFVV1, L.FFVV2 ],
              couplings = {(0,0):C.GC_59,(0,1):C.GC_60})

V_38 = Vertex(name = 'V_38',
              particles = [ P.X__tilde__, P.X, P.W__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFVV1, L.FFVV2 ],
...
V_57 = Vertex(name = 'V_57',
              particles = [ P.X__tilde__, P.X, P.a, P.W__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFVVV1, L.FFVVV2 ],
...
V_68 = Vertex(name = 'V_68',
              particles = [ P.X__tilde__, P.X, P.a, P.a, P.W__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFVVVV1, L.FFVVVV3 ],
...
V_70 = Vertex(name = 'V_70',
              particles = [ P.X__tilde__, P.X, P.W__minus__, P.W__plus__, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFVVV1, L.FFVVV2 ],
...
V_72 = Vertex(name = 'V_72',
              particles = [ P.X__tilde__, P.X, P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFVVVV1, L.FFVVVV3 ],
...
V_84 = Vertex(name = 'V_84',
              particles = [ P.X__tilde__, P.X, P.a, P.W__minus__, P.W__plus__, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFVVVV2, L.FFVVVV4 ],
...
V_90 = Vertex(name = 'V_90',
              particles = [ P.X__tilde__, P.X, P.W__minus__, P.W__plus__, P.Z, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFVVVV1, L.FFVVVV3 ],
...
V_103 = Vertex(name = 'V_103',
               ...
               couplings = {(0,0):C.GC_37,(0,1):C.GC_50})

V_104 = Vertex(name = 'V_104',
               particles = [ P.mu__plus__, P.mu__minus__, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,1):C.GC_50,(0,0):C.GC_37})
...
V_115 = Vertex(name = 'V_115',
               ...
               couplings = {(0,0):C.GC_38,(0,1):C.GC_49})
...
V_127 = Vertex(name = 'V_127',
               ...
               couplings = {(0,0):C.GC_37,(0,1):C.GC_49})
