...
GC_18 = Coupling(name = 'GC_18',
                 value = 'complex(0,1)*G*GghddL',
                 order = {'QCD':1})

GC_19 = Coupling(name = 'GC_19',
                 value = 'complex(0,1)*G*GghddR',
                 order = {'QCD':1})

GC_20 = Coupling(name = 'GC_20',
                 value = 'complex(0,1)*G*GghdhdhL',
                 order = {'QCD':1})

GC_21 = Coupling(name = 'GC_21',
                 value = 'complex(0,1)*G*GghdhdhR',
                 order = {'QCD':1})

GC_22 = Coupling(name = 'GC_22',
                 value = 'complex(0,1)*G*GghdhdL',
                 order = {'QCD':1})

GC_23 = Coupling(name = 'GC_23',
                 value = 'complex(0,1)*G*GghdhdR',
                 order = {'QCD':1})

GC_24 = Coupling(name = 'GC_24',
                 value = 'complex(0,1)*G*GghuhuhL',
                 order = {'QCD':1})

GC_25 = Coupling(name = 'GC_25',
                 value = 'complex(0,1)*G*GghuhuhR',
                 order = {'QCD':1})

GC_26 = Coupling(name = 'GC_26',
                 value = 'complex(0,1)*G*GghuhuL',
                 order = {'QCD':1})

GC_27 = Coupling(name = 'GC_27',
                 value = 'complex(0,1)*G*GghuhuR',
                 order = {'QCD':1})

GC_28 = Coupling(name = 'GC_28',
                 value = 'complex(0,1)*G*GghuuL',
                 order = {'QCD':1})

GC_29 = Coupling(name = 'GC_29',
                 value = 'complex(0,1)*G*GghuuR',
                 order = {'QCD':1})

GC_30 = Coupling(name = 'GC_30',
                 value = 'complex(0,1)*G*GguhuL',
                 order = {'QCD':1})
...
GC_157 = Coupling(name = 'GC_157',
                  value = '-2*G/cmath.tan(2*Gtheta)',
                  order = {'QCD':1})

GC_158 = Coupling(name = 'GC_158',
                  value = '2*complex(0,1)*G**2/cmath.tan(2*Gtheta)',
                  order = {'QCD':2})

GC_159 = Coupling(name = 'GC_159',
                  value = '-3*complex(0,1)*G**2 + complex(0,1)*G**2*csc(Gtheta)**2 + complex(0,1)*G**2*sec(Gtheta)**2',
                  order = {'QCD':2})
