...
Decay_lqsd = Decay(name = 'Decay_lqsd',
                   particle = P.lqsd,
                   partial_widths = {(P.d,P.ve):'(gsdvL**2*Msd**4)/(16.*cmath.pi*abs(Msd)**3)',
                                     (P.e__minus__,P.u):'(Msd**2*(3*gsdlL**2*Msd**2 + 3*gsdlR**2*Msd**2))/(48.*cmath.pi*abs(Msd)**3)'})

Decay_lqsu = Decay(name = 'Decay_lqsu',
                   particle = P.lqsu,
                   partial_widths = {(P.d,P.e__plus__):'(Msu**2*(3*gsulL**2*Msu**2 + 3*gsulR**2*Msu**2))/(48.*cmath.pi*abs(Msu)**3)',
                                     (P.u,P.ve__tilde__):'(gsuvL**2*Msu**4)/(16.*cmath.pi*abs(Msu)**3)'})
