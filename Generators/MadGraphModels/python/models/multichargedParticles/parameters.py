...
#QQb = Parameter(name = 'QQb',
#               nature = 'external',
#               type = 'real',
#               value = 2,
#               texname = '\\text{QQb}',
#               lhablock = 'MultiChargedParticles1',
#               lhacode = [ 10000000 ])
#	       
#QbPDG = Parameter(name = 'QbPDG',
#               nature = 'internal',
#               type = 'real',
#               value = '10000000+abs(QQb)*100.',
#               texname = '\\text{QbPDG}')

MQb0p3 = Parameter(name = 'MQb0p3',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb0p3}',
               lhablock = 'MultiChargedParticles',
               lhacode = [ 10000030 ])
	 
MQb0p6 = Parameter(name = 'MQb0p6',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb0p6}',
...
MQb10p0 = Parameter(name = 'MQb10p0',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb10p0}',
...
MQb20p0 = Parameter(name = 'MQb20p0',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb20p0}',
...
MQb40p0 = Parameter(name = 'MQb40p0',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb40p0}',
...
MQb60p0 = Parameter(name = 'MQb60p0',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb60p0}',
...
MQb100p0 = Parameter(name = 'MQb100p0',
               nature = 'external',
               type = 'real',
               value = 600,
               texname = '\\text{MQb100p0}',
               lhablock = 'MultiChargedParticles',
               lhacode = [ 10010000 ])
