...
FFV13 = Lorentz(name = 'FFV13',
                spins = [ 2, 2, 3 ],
                structure = '-(P(-1,3)*Gamma(-1,-2,-3)*Gamma(3,2,-2)*ProjM(-3,1)) + P(3,3)*ProjM(2,1) - P(-1,3)*Gamma(-1,-3,-2)*Gamma(3,2,-3)*ProjP(-2,1) + P(3,3)*ProjP(2,1)')
...
VVV14 = Lorentz(name = 'VVV14',
                spins = [ 3, 3, 3 ],
                structure = '-4*Epsilon(1,2,3,-2)*P(-2,3)*P(-1,1)*P(-1,2) - 4*Epsilon(1,2,3,-2)*P(-2,2)*P(-1,1)*P(-1,3) - 4*Epsilon(1,2,3,-2)*P(-2,1)*P(-1,2)*P(-1,3) + 3*Epsilon(2,3,-1,-2)*P(-2,3)*P(-1,1)*P(1,2) - Epsilon(2,3,-1,-2)*P(-2,1)*P(-1,3)*P(1,2) + 3*Epsilon(2,3,-1,-2)*P(-2,2)*P(-1,1)*P(1,3) - Epsilon(2,3,-1,-2)*P(-2,1)*P(-1,2)*P(1,3) - 3*Epsilon(1,3,-1,-2)*P(-2,3)*P(-1,2)*P(2,1) + Epsilon(1,3,-1,-2)*P(-2,2)*P(-1,3)*P(2,1) + Epsilon(1,3,-1,-2)*P(-2,2)*P(-1,1)*P(2,3) - 3*Epsilon(1,3,-1,-2)*P(-2,1)*P(-1,2)*P(2,3) - Epsilon(1,2,-1,-2)*P(-2,3)*P(-1,2)*P(3,1) + 3*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,3)*P(3,1) - Epsilon(1,2,-1,-2)*P(-2,3)*P(-1,1)*P(3,2) + 3*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,3)*P(3,2) + Epsilon(3,-1,-2,-3)*P(-3,2)*P(-2,3)*P(-1,1)*Metric(1,2) - Epsilon(3,-1,-2,-3)*P(-3,1)*P(-2,3)*P(-1,2)*Metric(1,2) - Epsilon(3,-1,-2,-3)*P(-3,2)*P(-2,1)*P(-1,3)*Metric(1,2) + Epsilon(3,-1,-2,-3)*P(-3,1)*P(-2,2)*P(-1,3)*Metric(1,2) - Epsilon(2,-1,-2,-3)*P(-3,3)*P(-2,2)*P(-1,1)*Metric(1,3) + Epsilon(2,-1,-2,-3)*P(-3,3)*P(-2,1)*P(-1,2)*Metric(1,3) - Epsilon(2,-1,-2,-3)*P(-3,1)*P(-2,3)*P(-1,2)*Metric(1,3) + Epsilon(2,-1,-2,-3)*P(-3,1)*P(-2,2)*P(-1,3)*Metric(1,3) - Epsilon(1,-1,-2,-3)*P(-3,3)*P(-2,2)*P(-1,1)*Metric(2,3) + Epsilon(1,-1,-2,-3)*P(-3,2)*P(-2,3)*P(-1,1)*Metric(2,3) + Epsilon(1,-1,-2,-3)*P(-3,3)*P(-2,1)*P(-1,2)*Metric(2,3) - Epsilon(1,-1,-2,-3)*P(-3,2)*P(-2,1)*P(-1,3)*Metric(2,3)')
...
FFVS7 = Lorentz(name = 'FFVS7',
                spins = [ 2, 2, 3, 1 ],
                structure = '-(P(-1,3)*Gamma(-1,-2,-3)*Gamma(3,2,-2)*ProjP(-3,1)) + P(3,3)*ProjP(2,1)')

FFVS8 = Lorentz(name = 'FFVS8',
                spins = [ 2, 2, 3, 1 ],
                structure = '-(P(-1,3)*Gamma(-1,-3,-2)*Gamma(3,2,-3)*ProjM(-2,1)) + P(3,3)*ProjM(2,1) + P(-1,3)*Gamma(-1,-2,-3)*Gamma(3,2,-2)*ProjP(-3,1) - P(3,3)*ProjP(2,1)')
...
VVVV7 = Lorentz(name = 'VVVV7',
                spins = [ 3, 3, 3, 3 ],
                structure = '4*Epsilon(1,2,3,4)*P(-1,1)*P(-1,2) + 4*Epsilon(1,2,3,4)*P(-1,3)*P(-1,4) + 4*Epsilon(2,3,4,-1)*P(-1,1)*P(1,2) - 4*Epsilon(2,3,4,-1)*P(-1,4)*P(1,3) - 4*Epsilon(2,3,4,-1)*P(-1,3)*P(1,4) - 4*Epsilon(1,3,4,-1)*P(-1,2)*P(2,1) + 4*Epsilon(1,3,4,-1)*P(-1,4)*P(2,3) + 4*Epsilon(1,3,4,-1)*P(-1,3)*P(2,4) - 4*Epsilon(1,2,4,-1)*P(-1,2)*P(3,1) - 4*Epsilon(1,2,4,-1)*P(-1,1)*P(3,2) + 4*Epsilon(1,2,4,-1)*P(-1,3)*P(3,4) + 4*Epsilon(1,2,3,-1)*P(-1,2)*P(4,1) + 4*Epsilon(1,2,3,-1)*P(-1,1)*P(4,2) - 4*Epsilon(1,2,3,-1)*P(-1,4)*P(4,3) + 2*Epsilon(3,4,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,2) - 2*Epsilon(3,4,-1,-2)*P(-2,1)*P(-1,2)*Metric(1,2) + 2*Epsilon(2,4,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,3) - 2*Epsilon(2,4,-1,-2)*P(-2,1)*P(-1,2)*Metric(1,3) - 2*Epsilon(2,4,-1,-2)*P(-2,4)*P(-1,3)*Metric(1,3) + 2*Epsilon(2,4,-1,-2)*P(-2,3)*P(-1,4)*Metric(1,3) - 2*Epsilon(2,3,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,4) + 2*Epsilon(2,3,-1,-2)*P(-2,1)*P(-1,2)*Metric(1,4) - 2*Epsilon(2,3,-1,-2)*P(-2,4)*P(-1,3)*Metric(1,4) + 2*Epsilon(2,3,-1,-2)*P(-2,3)*P(-1,4)*Metric(1,4) + 2*Epsilon(1,4,-1,-2)*P(-2,2)*P(-1,1)*Metric(2,3) - 2*Epsilon(1,4,-1,-2)*P(-2,1)*P(-1,2)*Metric(2,3) + 2*Epsilon(1,4,-1,-2)*P(-2,4)*P(-1,3)*Metric(2,3) - 2*Epsilon(1,4,-1,-2)*P(-2,3)*P(-1,4)*Metric(2,3) - 2*Epsilon(1,3,-1,-2)*P(-2,2)*P(-1,1)*Metric(2,4) + 2*Epsilon(1,3,-1,-2)*P(-2,1)*P(-1,2)*Metric(2,4) + 2*Epsilon(1,3,-1,-2)*P(-2,4)*P(-1,3)*Metric(2,4) - 2*Epsilon(1,3,-1,-2)*P(-2,3)*P(-1,4)*Metric(2,4) + 2*Epsilon(1,2,-1,-2)*P(-2,4)*P(-1,3)*Metric(3,4) - 2*Epsilon(1,2,-1,-2)*P(-2,3)*P(-1,4)*Metric(3,4)')
...
FFVVS2 = Lorentz(name = 'FFVVS2',
                 spins = [ 2, 2, 3, 3, 1 ],
                 structure = 'Gamma(3,2,-1)*Gamma(4,-1,-2)*ProjM(-2,1) - Metric(3,4)*ProjM(2,1)')
...
FFVVS6 = Lorentz(name = 'FFVVS6',
                 spins = [ 2, 2, 3, 3, 1 ],
                 structure = 'Gamma(3,2,-1)*Gamma(4,-1,-2)*ProjM(-2,1) - Metric(3,4)*ProjM(2,1) + Gamma(3,2,-2)*Gamma(4,-2,-1)*ProjP(-1,1) - Metric(3,4)*ProjP(2,1)')
