...
V_71 = Vertex(name = 'V_71',
              particles = [ P.G, P.G, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.VVSS1, L.VVSS3 ],
              couplings = {(0,1):C.GC_22,(0,0):C.GC_25})

V_72 = Vertex(name = 'V_72',
              particles = [ P.b__tilde__, P.b, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_98,(0,2):C.GC_99,(0,3):C.GC_19,(0,0):C.GC_18})

V_73 = Vertex(name = 'V_73',
              particles = [ P.c__tilde__, P.c, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_100,(0,2):C.GC_101,(0,3):C.GC_19,(0,0):C.GC_18})

V_74 = Vertex(name = 'V_74',
              particles = [ P.d__tilde__, P.d, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_102,(0,2):C.GC_103,(0,3):C.GC_19,(0,0):C.GC_18})

V_75 = Vertex(name = 'V_75',
              particles = [ P.s__tilde__, P.s, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_104,(0,2):C.GC_105,(0,3):C.GC_19,(0,0):C.GC_18})

V_76 = Vertex(name = 'V_76',
              particles = [ P.t__tilde__, P.t, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_106,(0,2):C.GC_107,(0,3):C.GC_19,(0,0):C.GC_18})

V_77 = Vertex(name = 'V_77',
              particles = [ P.u__tilde__, P.u, P.chi__tilde__, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS1, L.FFSS2, L.FFSS3, L.FFSS4 ],
              couplings = {(0,1):C.GC_108,(0,2):C.GC_109,(0,3):C.GC_19,(0,0):C.GC_18})

V_78 = Vertex(name = 'V_78',
              particles = [ P.G, P.G, P.G, P.chi__tilde__, P.chi ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VVVSS1, L.VVVSS2 ],
              couplings = {(0,0):C.GC_26,(0,1):C.GC_23})

V_79 = Vertex(name = 'V_79',
              particles = [ P.G, P.G, P.G, P.G, P.chi__tilde__, P.chi ],
              color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVVVSS1, L.VVVVSS2, L.VVVVSS3 ],
              couplings = {(1,1):C.GC_24,(0,0):C.GC_24,(2,2):C.GC_24})
...
V_101 = Vertex(name = 'V_101',
               ...
               couplings = {(0,0):C.GC_126,(0,1):C.GC_87})

V_102 = Vertex(name = 'V_102',
               particles = [ P.d__tilde__, P.c, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_82,(0,1):C.GC_88})

V_103 = Vertex(name = 'V_103',
               particles = [ P.d__tilde__, P.t, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_117,(0,1):C.GC_89})
...
V_105 = Vertex(name = 'V_105',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_83,(0,1):C.GC_113})
...
V_108 = Vertex(name = 'V_108',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_84,(0,1):C.GC_78})

V_109 = Vertex(name = 'V_109',
               particles = [ P.b__tilde__, P.t, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_119,(0,1):C.GC_79})
