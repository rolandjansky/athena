...
Wrho = Parameter(name = 'Wrho',
                 nature = 'external',
                 type = 'real',
                 #value = 5725,   # Mrho = 1TeV and grho = 4pi
                 #value = 911,     # Mrho = 1TeV and grho = sqrt(8pi)
                 value = 0,     # Mrho = inf 
                 #value = 100,     # Mrho = 100TeV and grho = 100*sqrt(8pi)
                 texname = '\\text{Wrho}',
                 lhablock = 'DECAY',
                 lhacode = [ 9000006 ])
