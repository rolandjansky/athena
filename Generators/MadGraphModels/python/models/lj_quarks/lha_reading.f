...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,3000001,bn,zdmass,100d0)
       call set_it(n,ivalue,value,name,3000005,bn,hd1mass,100d0)
       call set_it(n,ivalue,value,name,3000015,bn,nd1mass,100d0)
       call set_it(n,ivalue,value,name,3000016,bn,nd2mass,100d0)
       call set_it(n,ivalue,value,name,3000011,bn,me,100d0)
       call set_it(n,ivalue,value,name,3000013,bn,mmu,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,3000001,bn,zdwid,1d0)
       call set_it(n,ivalue,value,name,3000005,bn,hd1wid,1d0)
       call set_it(n,ivalue,value,name,3000015,bn,nd1wid,1d0)
       call set_it(n,ivalue,value,name,3000016,bn,nd2wid,1d0)
       call set_it(n,ivalue,value,name,3000011,bn,we,1d0)
       call set_it(n,ivalue,value,name,3000013,bn,wmu,1d0)
       bn='mguser'
       ...
       call set_it(n,ivalue,value,name,4,bn,d_cp ,0d0)
       call set_it(n,ivalue,value,name,5,bn,e_cp ,0d0)
       call set_it(n,ivalue,value,name,6,bn,f1_cp ,0d0)
       call set_it(n,ivalue,value,name,7,bn,f2_cp ,0d0)
       call set_it(n,ivalue,value,name,8,bn,g_cp ,0d0)
       call set_it(n,ivalue,value,name,9,bn,h_cp ,0d0)
      return
      end
