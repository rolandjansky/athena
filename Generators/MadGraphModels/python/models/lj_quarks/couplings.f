...
c************************************
      ...
      GHND12(1)=dcmplx(a_cp,Zero)
      GHND12(2)=dcmplx(a_cp,Zero)
      GND12HD1(1)=dcmplx(b_cp,Zero)
      GND12HD1(2)=dcmplx(b_cp,Zero)
      GND12ZD(1)=dcmplx(c_cp,Zero)
      GND12ZD(2)=dcmplx(c_cp,Zero)

      GZDE(1)=dcmplx(d_cp,Zero)
      GZDE(2)=dcmplx(d_cp,Zero)
      GZDMU(1)=dcmplx(e_cp,Zero)
      GZDMU(2)=dcmplx(e_cp,Zero)
      GZDTA(1)=dcmplx(h_cp,Zero)
      GZDTA(2)=dcmplx(h_cp,Zero)

      GZDU(1)=dcmplx(f1_cp,Zero)
      GZDU(2)=dcmplx(f1_cp,Zero)
      GZDD(1)=dcmplx(f2_cp,Zero)
      GZDD(2)=dcmplx(f2_cp,Zero)

      GHD1ZD=dcmplx(g_cp,Zero)
