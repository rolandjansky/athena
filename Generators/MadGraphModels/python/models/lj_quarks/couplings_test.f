...
c
 ...
 25   format( 1x,a10,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(1,20) 'GGH ', GGH
      write(1,11) 'GHND12 ', GHND12(1),' ', GHND12(2)
      write(1,11) 'GND12HD1 ', GND12HD1(1),' ', GND12HD1(2)
      write(1,11) 'GND12ZD ', GND12ZD(1),' ', GND12ZD(2)
      write(1,11) 'GZDE ', GZDE(1),' ', GZDE(2)
      write(1,11) 'GZDMU ', GZDMU(1),' ', GZDMU(2)
      write(1,11) 'GZDTA ', GZDTA(1),' ', GZDTA(2)
      write(1,11) 'GZDU ', GZDU(1),' ', GZDU(2)
      write(1,11) 'GZDD ', GZDD(1),' ', GZDD(2)
      write(1,20) 'GHD1ZD ', GHD1ZD
