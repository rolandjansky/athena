...
V_19 = Vertex(name = 'V_19',
              particles = [ P.Chi, P.e__minus__, P.EtaP ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_14})

V_20 = Vertex(name = 'V_20',
              particles = [ P.Chi, P.ve, P.Eta0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_15})

V_21 = Vertex(name = 'V_21',
              particles = [ P.Chi, P.mu__minus__, P.EtaP ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_16})

V_22 = Vertex(name = 'V_22',
              particles = [ P.Chi, P.vm, P.Eta0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_17})

V_23 = Vertex(name = 'V_23',
              particles = [ P.Chi, P.ta__minus__, P.EtaP ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_18})

V_24 = Vertex(name = 'V_24',
              particles = [ P.Chi, P.vt, P.Eta0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_19})

V_25 = Vertex(name = 'V_25',
              particles = [ P.Chi, P.u, P.EtaUbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_21})

V_26 = Vertex(name = 'V_26',
              particles = [ P.Chi, P.d, P.EtaDbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_21})

V_27 = Vertex(name = 'V_27',
              particles = [ P.Chi, P.c, P.EtaUbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_13})

V_28 = Vertex(name = 'V_28',
              particles = [ P.Chi, P.s, P.EtaDbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_13})

V_29 = Vertex(name = 'V_29',
              particles = [ P.Chi, P.t, P.EtaUbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_20})

V_30 = Vertex(name = 'V_30',
              particles = [ P.Chi, P.b, P.EtaDbar ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_20})
...
V_33 = Vertex(name = 'V_33',
              ...
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_25,(1,0):C.GC_25})
