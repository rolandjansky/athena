...
V_28 = Vertex(name = 'V_28',
              ...
              color = [ '1' ],
              lorentz = [ L.FFV2, L.FFV4 ],
              couplings = {(0,1):C.GC_33,(0,0):C.GC_28})
...
V_47 = Vertex(name = 'V_47',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV2, L.FFV5 ],
              couplings = {(0,1):C.GC_32,(0,0):C.GC_29})
...
V_75 = Vertex(name = 'V_75',
              particles = [ P.Zp, P.n1__tilde__, P.n1 ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_9})

V_76 = Vertex(name = 'V_76',
              particles = [ P.Zp, P.Zp, P.n1__tilde__, P.n1 ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
