...
V_120 = Vertex(name = 'V_120',
               particles = [ P.H, P.H, P.R ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_32})

V_121 = Vertex(name = 'V_121',
               particles = [ P.H, P.H, P.R, P.R ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_28})

V_122 = Vertex(name = 'V_122',
               particles = [ P.H, P.H, P.X, P.X ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_29})

V_123 = Vertex(name = 'V_123',
               particles = [ P.H, P.X, P.X ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_33})

V_124 = Vertex(name = 'V_124',
               particles = [ P.H, P.R, P.X, P.X ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_30})

V_125 = Vertex(name = 'V_125',
               particles = [ P.R, P.X, P.X ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_34})

V_126 = Vertex(name = 'V_126',
               particles = [ P.R, P.R, P.X, P.X ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
