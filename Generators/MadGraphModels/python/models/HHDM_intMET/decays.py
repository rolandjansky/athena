...
Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.a,P.a):'(kHaa**2*MH**6)/(64.*cmath.pi*abs(MH)**3)',
                                  (P.a,P.Z):'((MH**2 - MZ**2)*((kHZa**2*MH**4)/2. - kHZa**2*MH**2*MZ**2 + (kHZa**2*MZ**4)/2.))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.g,P.g):'(kHgg**2*MH**6)/(8.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.X,P.X):'(muHXX**2*cmath.sqrt(MH**4 - 4*MH**2*MX**2))/(32.*cmath.pi*abs(MH)**3)',
...
Decay_R = Decay(name = 'Decay_R',
                particle = P.R,
                partial_widths = {(P.b,P.b__tilde__):'(((-24*btb**2*MB**4)/vev**2 + (6*btb**2*MB**2*MR**2)/vev**2)*cmath.sqrt(-4*MB**2*MR**2 + MR**4))/(16.*cmath.pi*abs(MR)**3)',
                                  (P.g,P.g):'(kRgg**2*MR**6)/(8.*cmath.pi*abs(MR)**3)',
                                  (P.H,P.H):'(muHHR**2*cmath.sqrt(-4*MH**2*MR**2 + MR**4))/(32.*cmath.pi*abs(MR)**3)',
                                  (P.t,P.t__tilde__):'(((6*MR**2*MT**2*tth**2)/vev**2 - (24*MT**4*tth**2)/vev**2)*cmath.sqrt(MR**4 - 4*MR**2*MT**2))/(16.*cmath.pi*abs(MR)**3)',
                                  (P.W__minus__,P.W__plus__):'(((btW**2*MR**4)/vev**2 - (4*btW**2*MR**2*MW**2)/vev**2 + (12*btW**2*MW**4)/vev**2)*cmath.sqrt(MR**4 - 4*MR**2*MW**2))/(16.*cmath.pi*abs(MR)**3)',
                                  (P.X,P.X):'(muRXX**2*cmath.sqrt(MR**4 - 4*MR**2*MX**2))/(32.*cmath.pi*abs(MR)**3)',
                                  (P.Z,P.Z):'(((btZ**2*MR**4)/vev**2 - (4*btZ**2*MR**2*MZ**2)/vev**2 + (12*btZ**2*MZ**4)/vev**2)*cmath.sqrt(MR**4 - 4*MR**2*MZ**2))/(32.*cmath.pi*abs(MR)**3)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.a,P.H):'((-MH**2 + MZ**2)*((kHZa**2*MH**4)/2. - kHZa**2*MH**2*MZ**2 + (kHZa**2*MZ**4)/2.))/(48.*cmath.pi*abs(MZ)**3)',
