...
ymnutaup = Parameter(name = 'ymnutaup',
                     nature = 'external',
                     type = 'real',
                     value = 45,
                     texname = '\\text{ymnutaup}',
                     lhablock = 'YUKAWA',
                     lhacode = [ 18 ])
