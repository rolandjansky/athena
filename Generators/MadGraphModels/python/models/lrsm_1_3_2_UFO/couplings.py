...
GC_44 = Coupling(name = 'GC_44',
                 value = '-(cxi**2*complex(0,1)*gwR**2*cmath.sqrt(2))',
                 order = {'EWR':2})
...
GC_431 = Coupling(name = 'GC_431',
                  value = 'cxi*complex(0,1)*gwR**2*sxi*cmath.sqrt(2)',
                  order = {'EWL':-1,'EWR':3})
...
GC_499 = Coupling(name = 'GC_499',
                  value = '-(complex(0,1)*gwR**2*sxi**2*cmath.sqrt(2))',
                  order = {'EWL':-2,'EWR':4})
...
GC_544 = Coupling(name = 'GC_544',
                  value = '(cxi*complex(0,1)*gwR*k1**2)/(2.*vev**2) - (cxi*complex(0,1)*gwR*k2**2)/(2.*vev**2)',
                  order = {'EWR':1})
...
GC_546 = Coupling(name = 'GC_546',
                  value = '-(cphi*cw*cxi*complex(0,1)*gw*gwR*k1**2)/(2.*vev**2) + (cphi*cw*cxi*complex(0,1)*gw*gwR*k2**2)/(2.*vev**2)',
                  order = {'EWL':1,'EWR':1})

GC_547 = Coupling(name = 'GC_547',
                  value = '(cxi**2*gw*gwR*k1**2)/(2.*vev**2) - (cxi**2*gw*gwR*k2**2)/(2.*vev**2)',
                  order = {'EWL':1,'EWR':1})

GC_548 = Coupling(name = 'GC_548',
                  value = '-(cxi**2*complex(0,1)*gw*gwR*k1**2)/(2.*vev**2) + (cxi**2*complex(0,1)*gw*gwR*k2**2)/(2.*vev**2)',
                  order = {'EWL':1,'EWR':1})
...
GC_550 = Coupling(name = 'GC_550',
                  value = '-(cw*cxi*complex(0,1)*gw*gwR*k1**2*sphi)/(2.*vev**2) + (cw*cxi*complex(0,1)*gw*gwR*k2**2*sphi)/(2.*vev**2)',
                  order = {'EWR':2})
...
GC_618 = Coupling(name = 'GC_618',
                  value = '(complex(0,1)*gwR*k1**2*sxi)/(2.*vev**2) - (complex(0,1)*gwR*k2**2*sxi)/(2.*vev**2)',
                  order = {'EWL':-1,'EWR':2})
...
GC_620 = Coupling(name = 'GC_620',
                  value = '(cphi*cw*complex(0,1)*gw*gwR*k1**2*sxi)/(2.*vev**2) - (cphi*cw*complex(0,1)*gw*gwR*k2**2*sxi)/(2.*vev**2)',
                  order = {'EWR':2})

GC_621 = Coupling(name = 'GC_621',
                  value = '(cxi*complex(0,1)*gw*gwR*k1**2*sxi)/vev**2 - (cxi*complex(0,1)*gw*gwR*k2**2*sxi)/vev**2',
                  order = {'EWR':2})
...
GC_624 = Coupling(name = 'GC_624',
                  value = '(cw*complex(0,1)*gw*gwR*k1**2*sphi*sxi)/(2.*vev**2) - (cw*complex(0,1)*gw*gwR*k2**2*sphi*sxi)/(2.*vev**2)',
                  order = {'EWL':-1,'EWR':3})
...
GC_646 = Coupling(name = 'GC_646',
                  value = '(gw*gwR*k1**2*sxi**2)/(2.*vev**2) - (gw*gwR*k2**2*sxi**2)/(2.*vev**2)',
                  order = {'EWL':-1,'EWR':3})

GC_647 = Coupling(name = 'GC_647',
                  value = '(complex(0,1)*gw*gwR*k1**2*sxi**2)/(2.*vev**2) - (complex(0,1)*gw*gwR*k2**2*sxi**2)/(2.*vev**2)',
                  order = {'EWL':-1,'EWR':3})
...
GC_650 = Coupling(name = 'GC_650',
                  value = '(cphi**2*cw**2*complex(0,1)*gw**2*k1**2)/(2.*vev) + (cphi**2*cw**2*complex(0,1)*gw**2*k2**2)/(2.*vev)',
                  order = {'EWL':1})

GC_651 = Coupling(name = 'GC_651',
                  value = '(cxi**2*complex(0,1)*gw**2*k1**2)/(2.*vev) + (cxi**2*complex(0,1)*gw**2*k2**2)/(2.*vev)',
                  order = {'EWL':1})
...
GC_656 = Coupling(name = 'GC_656',
                  value = '-((complex(0,1)*I10a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_657 = Coupling(name = 'GC_657',
                  value = '-((complex(0,1)*I10a12*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a12*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a12*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_658 = Coupling(name = 'GC_658',
                  value = '-((complex(0,1)*I10a13*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a13*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a13*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_659 = Coupling(name = 'GC_659',
                  value = '-((complex(0,1)*I10a21*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a21*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a21*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_660 = Coupling(name = 'GC_660',
                  value = '-((complex(0,1)*I10a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_661 = Coupling(name = 'GC_661',
                  value = '-((complex(0,1)*I10a23*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a23*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a23*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_662 = Coupling(name = 'GC_662',
                  value = '-((complex(0,1)*I10a31*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a31*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a31*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_663 = Coupling(name = 'GC_663',
                  value = '-((complex(0,1)*I10a32*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a32*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a32*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_664 = Coupling(name = 'GC_664',
                  value = '-((complex(0,1)*I10a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I9a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I10a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_665 = Coupling(name = 'GC_665',
                  value = '(complex(0,1)*I11a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_666 = Coupling(name = 'GC_666',
                  value = '(complex(0,1)*I11a12*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a12*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a12*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_667 = Coupling(name = 'GC_667',
                  value = '(complex(0,1)*I11a13*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a13*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a13*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_668 = Coupling(name = 'GC_668',
                  value = '(complex(0,1)*I11a21*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a21*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a21*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_669 = Coupling(name = 'GC_669',
                  value = '(complex(0,1)*I11a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_670 = Coupling(name = 'GC_670',
                  value = '(complex(0,1)*I11a23*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a23*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a23*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_671 = Coupling(name = 'GC_671',
                  value = '(complex(0,1)*I11a31*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a31*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a31*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_672 = Coupling(name = 'GC_672',
                  value = '(complex(0,1)*I11a32*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a32*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a32*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_673 = Coupling(name = 'GC_673',
                  value = '(complex(0,1)*I11a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I12a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I11a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_674 = Coupling(name = 'GC_674',
                  value = '(complex(0,1)*I1a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_675 = Coupling(name = 'GC_675',
                  value = '(complex(0,1)*I1a12*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a12*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a12*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_676 = Coupling(name = 'GC_676',
                  value = '(complex(0,1)*I1a13*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a13*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a13*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_677 = Coupling(name = 'GC_677',
                  value = '(complex(0,1)*I1a21*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a21*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a21*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_678 = Coupling(name = 'GC_678',
                  value = '(complex(0,1)*I1a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_679 = Coupling(name = 'GC_679',
                  value = '(complex(0,1)*I1a23*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a23*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a23*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_680 = Coupling(name = 'GC_680',
                  value = '(complex(0,1)*I1a31*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a31*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a31*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_681 = Coupling(name = 'GC_681',
                  value = '(complex(0,1)*I1a32*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a32*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a32*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_682 = Coupling(name = 'GC_682',
                  value = '(complex(0,1)*I1a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I2a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I1a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_683 = Coupling(name = 'GC_683',
                  value = '-((complex(0,1)*I22a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_684 = Coupling(name = 'GC_684',
                  value = '-((complex(0,1)*I22a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_685 = Coupling(name = 'GC_685',
                  value = '-((complex(0,1)*I22a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_686 = Coupling(name = 'GC_686',
                  value = '-((complex(0,1)*I22a41*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a41*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a41*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_687 = Coupling(name = 'GC_687',
                  value = '-((complex(0,1)*I22a52*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a52*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a52*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_688 = Coupling(name = 'GC_688',
                  value = '-((complex(0,1)*I22a63*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I21a63*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I22a63*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_689 = Coupling(name = 'GC_689',
                  value = '(complex(0,1)*I23a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_690 = Coupling(name = 'GC_690',
                  value = '(complex(0,1)*I23a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_691 = Coupling(name = 'GC_691',
                  value = '(complex(0,1)*I23a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_692 = Coupling(name = 'GC_692',
                  value = '(complex(0,1)*I23a41*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a41*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a41*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_693 = Coupling(name = 'GC_693',
                  value = '(complex(0,1)*I23a52*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a52*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a52*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_694 = Coupling(name = 'GC_694',
                  value = '(complex(0,1)*I23a63*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I24a63*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I23a63*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_695 = Coupling(name = 'GC_695',
                  value = '(complex(0,1)*I25a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_696 = Coupling(name = 'GC_696',
                  value = '(complex(0,1)*I25a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_697 = Coupling(name = 'GC_697',
                  value = '(complex(0,1)*I25a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_698 = Coupling(name = 'GC_698',
                  value = '(complex(0,1)*I25a41*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a41*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a41*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_699 = Coupling(name = 'GC_699',
                  value = '(complex(0,1)*I25a52*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a52*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a52*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_700 = Coupling(name = 'GC_700',
                  value = '(complex(0,1)*I25a63*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (2*complex(0,1)*I26a63*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) + (complex(0,1)*I25a63*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_701 = Coupling(name = 'GC_701',
                  value = '-((complex(0,1)*I28a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_702 = Coupling(name = 'GC_702',
                  value = '-((complex(0,1)*I28a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_703 = Coupling(name = 'GC_703',
                  value = '-((complex(0,1)*I28a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_704 = Coupling(name = 'GC_704',
                  value = '-((complex(0,1)*I28a41*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a41*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a41*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_705 = Coupling(name = 'GC_705',
                  value = '-((complex(0,1)*I28a52*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a52*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a52*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_706 = Coupling(name = 'GC_706',
                  value = '-((complex(0,1)*I28a63*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I27a63*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I28a63*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_707 = Coupling(name = 'GC_707',
                  value = '-((complex(0,1)*I4a11*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a11*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a11*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_708 = Coupling(name = 'GC_708',
                  value = '-((complex(0,1)*I4a12*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a12*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a12*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_709 = Coupling(name = 'GC_709',
                  value = '-((complex(0,1)*I4a13*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a13*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a13*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_710 = Coupling(name = 'GC_710',
                  value = '-((complex(0,1)*I4a21*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a21*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a21*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_711 = Coupling(name = 'GC_711',
                  value = '-((complex(0,1)*I4a22*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a22*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a22*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_712 = Coupling(name = 'GC_712',
                  value = '-((complex(0,1)*I4a23*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a23*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a23*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_713 = Coupling(name = 'GC_713',
                  value = '-((complex(0,1)*I4a31*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a31*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a31*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_714 = Coupling(name = 'GC_714',
                  value = '-((complex(0,1)*I4a32*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a32*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a32*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_715 = Coupling(name = 'GC_715',
                  value = '-((complex(0,1)*I4a33*k1**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)) + (2*complex(0,1)*I3a33*k1*k2*cmath.sqrt(2))/((k1**2 - k2**2)*vev) - (complex(0,1)*I4a33*k2**2*cmath.sqrt(2))/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_716 = Coupling(name = 'GC_716',
                  value = '-((I5a11*k1**2)/((k1**2 - k2**2)*vev)) - (I5a11*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_717 = Coupling(name = 'GC_717',
                  value = '-((complex(0,1)*I5a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a11*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_718 = Coupling(name = 'GC_718',
                  value = '-((I5a12*k1**2)/((k1**2 - k2**2)*vev)) - (I5a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_719 = Coupling(name = 'GC_719',
                  value = '-((complex(0,1)*I5a12*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_720 = Coupling(name = 'GC_720',
                  value = '-((I5a13*k1**2)/((k1**2 - k2**2)*vev)) - (I5a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_721 = Coupling(name = 'GC_721',
                  value = '-((complex(0,1)*I5a13*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_722 = Coupling(name = 'GC_722',
                  value = '-((I5a21*k1**2)/((k1**2 - k2**2)*vev)) - (I5a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_723 = Coupling(name = 'GC_723',
                  value = '-((complex(0,1)*I5a21*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_724 = Coupling(name = 'GC_724',
                  value = '-((I5a22*k1**2)/((k1**2 - k2**2)*vev)) - (I5a22*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_725 = Coupling(name = 'GC_725',
                  value = '-((complex(0,1)*I5a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a22*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_726 = Coupling(name = 'GC_726',
                  value = '-((I5a23*k1**2)/((k1**2 - k2**2)*vev)) - (I5a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_727 = Coupling(name = 'GC_727',
                  value = '-((complex(0,1)*I5a23*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_728 = Coupling(name = 'GC_728',
                  value = '-((I5a31*k1**2)/((k1**2 - k2**2)*vev)) - (I5a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_729 = Coupling(name = 'GC_729',
                  value = '-((complex(0,1)*I5a31*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_730 = Coupling(name = 'GC_730',
                  value = '-((I5a32*k1**2)/((k1**2 - k2**2)*vev)) - (I5a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_731 = Coupling(name = 'GC_731',
                  value = '-((complex(0,1)*I5a32*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_732 = Coupling(name = 'GC_732',
                  value = '-((I5a33*k1**2)/((k1**2 - k2**2)*vev)) - (I5a33*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_733 = Coupling(name = 'GC_733',
                  value = '-((complex(0,1)*I5a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I5a33*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_734 = Coupling(name = 'GC_734',
                  value = '-((complex(0,1)*I6a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a11*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_735 = Coupling(name = 'GC_735',
                  value = '(I6a11*k1**2)/((k1**2 - k2**2)*vev) + (I6a11*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_736 = Coupling(name = 'GC_736',
                  value = '-((complex(0,1)*I6a12*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_737 = Coupling(name = 'GC_737',
                  value = '(I6a12*k1**2)/((k1**2 - k2**2)*vev) + (I6a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_738 = Coupling(name = 'GC_738',
                  value = '-((complex(0,1)*I6a13*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_739 = Coupling(name = 'GC_739',
                  value = '(I6a13*k1**2)/((k1**2 - k2**2)*vev) + (I6a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_740 = Coupling(name = 'GC_740',
                  value = '-((complex(0,1)*I6a21*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_741 = Coupling(name = 'GC_741',
                  value = '(I6a21*k1**2)/((k1**2 - k2**2)*vev) + (I6a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_742 = Coupling(name = 'GC_742',
                  value = '-((complex(0,1)*I6a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a22*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_743 = Coupling(name = 'GC_743',
                  value = '(I6a22*k1**2)/((k1**2 - k2**2)*vev) + (I6a22*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_744 = Coupling(name = 'GC_744',
                  value = '-((complex(0,1)*I6a23*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_745 = Coupling(name = 'GC_745',
                  value = '(I6a23*k1**2)/((k1**2 - k2**2)*vev) + (I6a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_746 = Coupling(name = 'GC_746',
                  value = '-((complex(0,1)*I6a31*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_747 = Coupling(name = 'GC_747',
                  value = '(I6a31*k1**2)/((k1**2 - k2**2)*vev) + (I6a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_748 = Coupling(name = 'GC_748',
                  value = '-((complex(0,1)*I6a32*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_749 = Coupling(name = 'GC_749',
                  value = '(I6a32*k1**2)/((k1**2 - k2**2)*vev) + (I6a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_750 = Coupling(name = 'GC_750',
                  value = '-((complex(0,1)*I6a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I6a33*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_751 = Coupling(name = 'GC_751',
                  value = '(I6a33*k1**2)/((k1**2 - k2**2)*vev) + (I6a33*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_752 = Coupling(name = 'GC_752',
                  value = '-((complex(0,1)*I7a12*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_753 = Coupling(name = 'GC_753',
                  value = '(I7a12*k1**2)/((k1**2 - k2**2)*vev) + (I7a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_754 = Coupling(name = 'GC_754',
                  value = '-((complex(0,1)*I7a13*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_755 = Coupling(name = 'GC_755',
                  value = '(I7a13*k1**2)/((k1**2 - k2**2)*vev) + (I7a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_756 = Coupling(name = 'GC_756',
                  value = '-((complex(0,1)*I7a21*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_757 = Coupling(name = 'GC_757',
                  value = '(I7a21*k1**2)/((k1**2 - k2**2)*vev) + (I7a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_758 = Coupling(name = 'GC_758',
                  value = '-((complex(0,1)*I7a23*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_759 = Coupling(name = 'GC_759',
                  value = '(I7a23*k1**2)/((k1**2 - k2**2)*vev) + (I7a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_760 = Coupling(name = 'GC_760',
                  value = '-((complex(0,1)*I7a31*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_761 = Coupling(name = 'GC_761',
                  value = '(I7a31*k1**2)/((k1**2 - k2**2)*vev) + (I7a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_762 = Coupling(name = 'GC_762',
                  value = '-((complex(0,1)*I7a32*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_763 = Coupling(name = 'GC_763',
                  value = '(I7a32*k1**2)/((k1**2 - k2**2)*vev) + (I7a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_764 = Coupling(name = 'GC_764',
                  value = '-((I8a12*k1**2)/((k1**2 - k2**2)*vev)) - (I8a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_765 = Coupling(name = 'GC_765',
                  value = '-((complex(0,1)*I8a12*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a12*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_766 = Coupling(name = 'GC_766',
                  value = '-((I8a13*k1**2)/((k1**2 - k2**2)*vev)) - (I8a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_767 = Coupling(name = 'GC_767',
                  value = '-((complex(0,1)*I8a13*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a13*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_768 = Coupling(name = 'GC_768',
                  value = '-((I8a21*k1**2)/((k1**2 - k2**2)*vev)) - (I8a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_769 = Coupling(name = 'GC_769',
                  value = '-((complex(0,1)*I8a21*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a21*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_770 = Coupling(name = 'GC_770',
                  value = '-((I8a23*k1**2)/((k1**2 - k2**2)*vev)) - (I8a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_771 = Coupling(name = 'GC_771',
                  value = '-((complex(0,1)*I8a23*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a23*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_772 = Coupling(name = 'GC_772',
                  value = '-((I8a31*k1**2)/((k1**2 - k2**2)*vev)) - (I8a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_773 = Coupling(name = 'GC_773',
                  value = '-((complex(0,1)*I8a31*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a31*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_774 = Coupling(name = 'GC_774',
                  value = '-((I8a32*k1**2)/((k1**2 - k2**2)*vev)) - (I8a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})

GC_775 = Coupling(name = 'GC_775',
                  value = '-((complex(0,1)*I8a32*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a32*k2**2)/((k1**2 - k2**2)*vev)',
                  order = {'EWL':1})
...
GC_777 = Coupling(name = 'GC_777',
                  value = '(cphi*cw*complex(0,1)*gw**2*k1**2*sw)/(2.*vev) + (cphi*cw*complex(0,1)*gw**2*k2**2*sw)/(2.*vev)',
                  order = {'EWL':1})
...
GC_779 = Coupling(name = 'GC_779',
                  value = '(complex(0,1)*gw**2*k1**2*sw**2)/(2.*vev) + (complex(0,1)*gw**2*k2**2*sw**2)/(2.*vev)',
                  order = {'EWL':1})

GC_780 = Coupling(name = 'GC_780',
                  value = '-((complex(0,1)*gw*gwR*k1**2*sw**2)/vev) - (complex(0,1)*gw*gwR*k2**2*sw**2)/vev',
                  order = {'EWR':1})

GC_781 = Coupling(name = 'GC_781',
                  value = '(cphi**2*complex(0,1)*gw*gwR*k1**2*sw**2)/vev + (cphi**2*complex(0,1)*gw*gwR*k2**2*sw**2)/vev',
                  order = {'EWR':1})

GC_782 = Coupling(name = 'GC_782',
                  value = '(complex(0,1)*gwR**2*k1**2*sw**2)/(2.*vev) + (complex(0,1)*gwR**2*k2**2*sw**2)/(2.*vev)',
                  order = {'EWL':-1,'EWR':2})

GC_783 = Coupling(name = 'GC_783',
                  value = '(complex(0,1)*gwR**2*k1**2*sphi**2)/(2.*cw**2*vev) + (complex(0,1)*gwR**2*k2**2*sphi**2)/(2.*cw**2*vev) - (complex(0,1)*gwR**2*k1**2*sphi**2*sw**2)/(cw**2*vev) - (complex(0,1)*gwR**2*k2**2*sphi**2*sw**2)/(cw**2*vev)',
                  order = {'EWL':-3,'EWR':4})

GC_784 = Coupling(name = 'GC_784',
                  value = '-(cphi*cw*complex(0,1)*gw*gwR*k1**2*sw)/(2.*vev) - (cphi*cw*complex(0,1)*gw*gwR*k2**2*sw)/(2.*vev) + (cphi*complex(0,1)*gw*gwR*k1**2*sw**3)/(2.*cw*vev) + (cphi*complex(0,1)*gw*gwR*k2**2*sw**3)/(2.*cw*vev)',
                  order = {'EWR':1})

GC_785 = Coupling(name = 'GC_785',
                  value = '-(complex(0,1)*gwR**2*k1**2*sphi*sw**3)/(2.*cw*vev) - (complex(0,1)*gwR**2*k2**2*sphi*sw**3)/(2.*cw*vev)',
                  order = {'EWL':-2,'EWR':3})

GC_786 = Coupling(name = 'GC_786',
                  value = '(complex(0,1)*gwR**2*k1**2*sphi**2*sw**4)/(2.*cw**2*vev) + (complex(0,1)*gwR**2*k2**2*sphi**2*sw**4)/(2.*cw**2*vev)',
                  order = {'EWL':-3,'EWR':4})

GC_787 = Coupling(name = 'GC_787',
                  value = '(cphi*cw**2*complex(0,1)*gw**2*k1**2*sphi)/(2.*vev) + (cphi*cw**2*complex(0,1)*gw**2*k2**2*sphi)/(2.*vev) - (cphi**2*complex(0,1)*gw*gwR*k1**2*cmath.sqrt(1 - 2*sw**2))/(2.*vev) - (cphi**2*complex(0,1)*gw*gwR*k2**2*cmath.sqrt(1 - 2*sw**2))/(2.*vev)',
                  order = {'EWR':1})

GC_788 = Coupling(name = 'GC_788',
                  value = '(cphi**2*complex(0,1)*gwR**2*k1**2)/(2.*cw**2*vev) + (cphi**2*complex(0,1)*gwR**2*k2**2)/(2.*cw**2*vev) + (cw**2*complex(0,1)*gw**2*k1**2*sphi**2)/(2.*vev) + (cw**2*complex(0,1)*gw**2*k2**2*sphi**2)/(2.*vev) - (cphi**2*complex(0,1)*gwR**2*k1**2*sw**2)/(cw**2*vev) - (cphi**2*complex(0,1)*gwR**2*k2**2*sw**2)/(cw**2*vev) - (cphi*complex(0,1)*gw*gwR*k1**2*sphi*cmath.sqrt(1 - 2*sw**2))/vev - (cphi*complex(0,1)*gw*gwR*k2**2*sphi*cmath.sqrt(1 - 2*sw**2))/vev',
                  order = {'EWL':-1,'EWR':2})

GC_789 = Coupling(name = 'GC_789',
                  value = '(cphi**2*complex(0,1)*gwR**2*k1**2*sw**4)/(2.*cw**2*vev) + (cphi**2*complex(0,1)*gwR**2*k2**2*sw**4)/(2.*cw**2*vev) + (cphi*complex(0,1)*gw*gwR*k1**2*sphi*cmath.sqrt(1 - 2*sw**2))/vev + (cphi*complex(0,1)*gw*gwR*k2**2*sphi*cmath.sqrt(1 - 2*sw**2))/vev',
                  order = {'EWL':-1,'EWR':2})

GC_790 = Coupling(name = 'GC_790',
                  value = '-(cphi*complex(0,1)*gwR**2*k1**2*sphi)/(2.*cw**2*vev) - (cphi*complex(0,1)*gwR**2*k2**2*sphi)/(2.*cw**2*vev) + (cphi*complex(0,1)*gwR**2*k1**2*sphi*sw**2)/(cw**2*vev) + (cphi*complex(0,1)*gwR**2*k2**2*sphi*sw**2)/(cw**2*vev) + (cphi*complex(0,1)*gwR**2*k1**2*sphi*sw**4)/(2.*cw**2*vev) + (cphi*complex(0,1)*gwR**2*k2**2*sphi*sw**4)/(2.*cw**2*vev) + (complex(0,1)*gw*gwR*k1**2*sphi**2*cmath.sqrt(1 - 2*sw**2))/(2.*vev) + (complex(0,1)*gw*gwR*k2**2*sphi**2*cmath.sqrt(1 - 2*sw**2))/(2.*vev)',
                  order = {'EWL':-2,'EWR':3})

GC_791 = Coupling(name = 'GC_791',
                  value = '(cw*complex(0,1)*gw**2*k1**2*sphi*sw)/(2.*vev) + (cw*complex(0,1)*gw**2*k2**2*sphi*sw)/(2.*vev) - (cphi*complex(0,1)*gw*gwR*k1**2*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev) - (cphi*complex(0,1)*gw*gwR*k2**2*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev)',
                  order = {'EWR':1})

GC_792 = Coupling(name = 'GC_792',
                  value = '-(cw*complex(0,1)*gw*gwR*k1**2*sphi*sw)/(2.*vev) - (cw*complex(0,1)*gw*gwR*k2**2*sphi*sw)/(2.*vev) + (complex(0,1)*gw*gwR*k1**2*sphi*sw**3)/(2.*cw*vev) + (complex(0,1)*gw*gwR*k2**2*sphi*sw**3)/(2.*cw*vev) + (cphi*complex(0,1)*gwR**2*k1**2*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev) + (cphi*complex(0,1)*gwR**2*k2**2*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev)',
                  order = {'EWL':-1,'EWR':2})

GC_793 = Coupling(name = 'GC_793',
                  value = '-(cphi*complex(0,1)*gwR**2*k1**2*sw**3)/(2.*cw*vev) - (cphi*complex(0,1)*gwR**2*k2**2*sw**3)/(2.*cw*vev) + (complex(0,1)*gw*gwR*k1**2*sphi*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev) + (complex(0,1)*gw*gwR*k2**2*sphi*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev)',
                  order = {'EWL':-1,'EWR':2})

GC_794 = Coupling(name = 'GC_794',
                  value = '-(complex(0,1)*gwR**2*k1**2*sphi*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev) - (complex(0,1)*gwR**2*k2**2*sphi*sw*cmath.sqrt(1 - 2*sw**2))/(2.*cw*vev)',
                  order = {'EWL':-2,'EWR':3})

GC_795 = Coupling(name = 'GC_795',
                  value = '(cphi*complex(0,1)*gw*gwR*k1**2*sphi*sw**2)/vev + (cphi*complex(0,1)*gw*gwR*k2**2*sphi*sw**2)/vev - (cphi**2*complex(0,1)*gwR**2*k1**2*sw**2*cmath.sqrt(1 - 2*sw**2))/(2.*cw**2*vev) - (cphi**2*complex(0,1)*gwR**2*k2**2*sw**2*cmath.sqrt(1 - 2*sw**2))/(2.*cw**2*vev)',
                  order = {'EWL':-1,'EWR':2})

GC_796 = Coupling(name = 'GC_796',
                  value = '(complex(0,1)*gw*gwR*k1**2*sphi**2*sw**2)/vev + (complex(0,1)*gw*gwR*k2**2*sphi**2*sw**2)/vev - (cphi*complex(0,1)*gwR**2*k1**2*sphi*sw**2*cmath.sqrt(1 - 2*sw**2))/(cw**2*vev) - (cphi*complex(0,1)*gwR**2*k2**2*sphi*sw**2*cmath.sqrt(1 - 2*sw**2))/(cw**2*vev)',
                  order = {'EWL':-2,'EWR':3})

GC_797 = Coupling(name = 'GC_797',
                  value = '(cphi*complex(0,1)*gwR**2*k1**2*sphi*sw**2*cmath.sqrt(1 - 2*sw**2))/(cw**2*vev) + (cphi*complex(0,1)*gwR**2*k2**2*sphi*sw**2*cmath.sqrt(1 - 2*sw**2))/(cw**2*vev)',
                  order = {'EWL':-2,'EWR':3})

GC_798 = Coupling(name = 'GC_798',
                  value = '(complex(0,1)*gwR**2*k1**2*sphi**2*sw**2*cmath.sqrt(1 - 2*sw**2))/(2.*cw**2*vev) + (complex(0,1)*gwR**2*k2**2*sphi**2*sw**2*cmath.sqrt(1 - 2*sw**2))/(2.*cw**2*vev)',
                  order = {'EWL':-3,'EWR':4})

GC_799 = Coupling(name = 'GC_799',
                  value = '-((cxi**2*complex(0,1)*gw*gwR*k1*k2)/vev) + (cxi*complex(0,1)*gw**2*k1**2*sxi)/(2.*vev) + (cxi*complex(0,1)*gw**2*k2**2*sxi)/(2.*vev)',
                  order = {'EWR':1})
...
GC_805 = Coupling(name = 'GC_805',
                  value = '-(cxi*complex(0,1)*gwR**2*k1**2*sxi)/(2.*vev) - (cxi*complex(0,1)*gwR**2*k2**2*sxi)/(2.*vev) + (complex(0,1)*gw*gwR*k1*k2*sxi**2)/vev',
                  order = {'EWL':-2,'EWR':3})

GC_806 = Coupling(name = 'GC_806',
                  value = '(cxi**2*complex(0,1)*gwR**2*k1**2)/(2.*vev) + (cxi**2*complex(0,1)*gwR**2*k2**2)/(2.*vev) - (2*cxi*complex(0,1)*gw*gwR*k1*k2*sxi)/vev + (complex(0,1)*gw**2*k1**2*sxi**2)/(2.*vev) + (complex(0,1)*gw**2*k2**2*sxi**2)/(2.*vev)',
                  order = {'EWL':-1,'EWR':2})
...
GC_810 = Coupling(name = 'GC_810',
                  value = '(complex(0,1)*gwR**2*k1**2*sxi**2)/(2.*vev) + (complex(0,1)*gwR**2*k2**2*sxi**2)/(2.*vev)',
                  order = {'EWL':-3,'EWR':4})
...
GC_836 = Coupling(name = 'GC_836',
                  value = '(2*cxi*complex(0,1)*gw*gwR*k1*k2*sxi)/vev',
                  order = {'EWL':-1,'EWR':2})

GC_837 = Coupling(name = 'GC_837',
                  value = '(-4*complex(0,1)*I13a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_838 = Coupling(name = 'GC_838',
                  value = '(-4*complex(0,1)*I13a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_839 = Coupling(name = 'GC_839',
                  value = '(-4*complex(0,1)*I13a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_840 = Coupling(name = 'GC_840',
                  value = '(-2*complex(0,1)*I13a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I13a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_841 = Coupling(name = 'GC_841',
                  value = '(-4*complex(0,1)*I13a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_842 = Coupling(name = 'GC_842',
                  value = '(-2*complex(0,1)*I13a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I13a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_843 = Coupling(name = 'GC_843',
                  value = '(-4*complex(0,1)*I13a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_844 = Coupling(name = 'GC_844',
                  value = '(-2*complex(0,1)*I13a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I13a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I14a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I13a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*complex(0,1)*I14a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_845 = Coupling(name = 'GC_845',
                  value = '(-4*complex(0,1)*I13a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I14a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_846 = Coupling(name = 'GC_846',
                  value = '(-4*complex(0,1)*I17a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a11*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a11*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_847 = Coupling(name = 'GC_847',
                  value = '(4*I17a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a11*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a11*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a11*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a11*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_848 = Coupling(name = 'GC_848',
                  value = '(-4*complex(0,1)*I17a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a22*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a22*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_849 = Coupling(name = 'GC_849',
                  value = '(4*I17a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a22*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a22*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a22*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a22*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_850 = Coupling(name = 'GC_850',
                  value = '(-4*complex(0,1)*I17a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a33*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a33*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_851 = Coupling(name = 'GC_851',
                  value = '(4*I17a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a33*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a33*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a33*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a33*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_852 = Coupling(name = 'GC_852',
                  value = '(-2*complex(0,1)*I17a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a14*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a41*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a14*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a41*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_853 = Coupling(name = 'GC_853',
                  value = '(2*I17a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a14*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a41*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a14*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a41*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a14*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a41*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a14*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a41*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_854 = Coupling(name = 'GC_854',
                  value = '(-4*complex(0,1)*I17a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a44*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a44*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_855 = Coupling(name = 'GC_855',
                  value = '(4*I17a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a44*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a44*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a44*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a44*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_856 = Coupling(name = 'GC_856',
                  value = '(-2*complex(0,1)*I17a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a25*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a52*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a25*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a52*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_857 = Coupling(name = 'GC_857',
                  value = '(2*I17a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a25*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a52*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a25*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a52*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a25*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a52*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a25*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a52*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_858 = Coupling(name = 'GC_858',
                  value = '(-4*complex(0,1)*I17a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a55*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a55*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_859 = Coupling(name = 'GC_859',
                  value = '(4*I17a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a55*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a55*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a55*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a55*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_860 = Coupling(name = 'GC_860',
                  value = '(-2*complex(0,1)*I17a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a36*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I13a63*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a36*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*complex(0,1)*I14a63*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I17a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (2*complex(0,1)*I18a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_861 = Coupling(name = 'GC_861',
                  value = '(2*I17a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a36*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a63*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a36*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I13a63*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a36*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*I14a63*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I17a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a36*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (2*I18a63*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_862 = Coupling(name = 'GC_862',
                  value = '(-4*complex(0,1)*I17a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I13a66*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (8*complex(0,1)*I14a66*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I17a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev) - (4*complex(0,1)*I18a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_863 = Coupling(name = 'GC_863',
                  value = '(4*I17a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a66*k1**2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I13a66*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) - (8*I14a66*k1*k2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I17a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev) + (4*I18a66*k2**2)/(4*k1**2*vev - 4*k2**2*vev)',
                  order = {'EWL':1})

GC_864 = Coupling(name = 'GC_864',
                  value = '(-2*complex(0,1)*I15a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_865 = Coupling(name = 'GC_865',
                  value = '(-2*complex(0,1)*I15a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_866 = Coupling(name = 'GC_866',
                  value = '(-2*complex(0,1)*I15a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_867 = Coupling(name = 'GC_867',
                  value = '-((complex(0,1)*I15a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I15a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_868 = Coupling(name = 'GC_868',
                  value = '(-2*complex(0,1)*I15a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_869 = Coupling(name = 'GC_869',
                  value = '-((complex(0,1)*I15a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I15a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_870 = Coupling(name = 'GC_870',
                  value = '(-2*complex(0,1)*I15a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_871 = Coupling(name = 'GC_871',
                  value = '-((complex(0,1)*I15a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I15a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I16a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I15a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (complex(0,1)*I16a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_872 = Coupling(name = 'GC_872',
                  value = '(-2*complex(0,1)*I15a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I16a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_873 = Coupling(name = 'GC_873',
                  value = '(-2*I19a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a11*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a11*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_874 = Coupling(name = 'GC_874',
                  value = '(-2*complex(0,1)*I19a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a11*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a11*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a11*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a11*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_875 = Coupling(name = 'GC_875',
                  value = '(-2*I19a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a22*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a22*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_876 = Coupling(name = 'GC_876',
                  value = '(-2*complex(0,1)*I19a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a22*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a22*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a22*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a22*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_877 = Coupling(name = 'GC_877',
                  value = '(-2*I19a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a33*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a33*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_878 = Coupling(name = 'GC_878',
                  value = '(-2*complex(0,1)*I19a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a33*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a33*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a33*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a33*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_879 = Coupling(name = 'GC_879',
                  value = '-((I19a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (I19a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a14*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a41*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a14*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a41*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_880 = Coupling(name = 'GC_880',
                  value = '-((complex(0,1)*I19a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I19a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a14*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a41*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a14*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a41*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a14*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a41*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a14*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a41*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_881 = Coupling(name = 'GC_881',
                  value = '(-2*I19a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a44*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a44*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_882 = Coupling(name = 'GC_882',
                  value = '(-2*complex(0,1)*I19a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a44*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a44*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a44*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a44*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_883 = Coupling(name = 'GC_883',
                  value = '-((I19a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (I19a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a25*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a52*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a25*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a52*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_884 = Coupling(name = 'GC_884',
                  value = '-((complex(0,1)*I19a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I19a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a25*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a52*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a25*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a52*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a25*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a52*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a25*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a52*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_885 = Coupling(name = 'GC_885',
                  value = '(-2*I19a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a55*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a55*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_886 = Coupling(name = 'GC_886',
                  value = '(-2*complex(0,1)*I19a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a55*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a55*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a55*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a55*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_887 = Coupling(name = 'GC_887',
                  value = '-((I19a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (I19a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a36*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I15a63*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a36*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*I16a63*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I19a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (I20a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_888 = Coupling(name = 'GC_888',
                  value = '-((complex(0,1)*I19a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev)) - (complex(0,1)*I19a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a36*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a63*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a36*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I15a63*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a36*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (2*complex(0,1)*I16a63*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I19a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a36*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (complex(0,1)*I20a63*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_889 = Coupling(name = 'GC_889',
                  value = '(-2*I19a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I15a66*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*I16a66*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I19a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*I20a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})

GC_890 = Coupling(name = 'GC_890',
                  value = '(-2*complex(0,1)*I19a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a66*k1**2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I15a66*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) + (4*complex(0,1)*I16a66*k1*k2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I19a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev) - (2*complex(0,1)*I20a66*k2**2)/(2*k1**2*vev - 2*k2**2*vev)',
                  order = {'EWL':1})
...
GC_1023 = Coupling(name = 'GC_1023',
                   value = 'cxi**2*complex(0,1)*gwR**2*vR',
                   order = {'EWR':1})
...
GC_1025 = Coupling(name = 'GC_1025',
                   value = '(2*cphi**2*complex(0,1)*g1**2*sw**2*vR)/cw**2',
                   order = {'EWR':-1,'QED':2})

GC_1026 = Coupling(name = 'GC_1026',
                   value = '2*complex(0,1)*gwR**2*sw**2*vR',
                   order = {'EWR':1})

GC_1027 = Coupling(name = 'GC_1027',
                   value = '(2*complex(0,1)*g1**2*sphi**2*sw**2*vR)/cw**2',
                   order = {'EWL':-2,'EWR':1,'QED':2})

GC_1028 = Coupling(name = 'GC_1028',
                   value = '(-2*cphi*complex(0,1)*gwR**2*sw**3*vR)/cw',
                   order = {'EWR':1})

GC_1029 = Coupling(name = 'GC_1029',
                   value = '(-2*complex(0,1)*gwR**2*sphi*sw**3*vR)/cw',
                   order = {'EWL':-1,'EWR':2})

GC_1030 = Coupling(name = 'GC_1030',
                   value = '(2*cphi**2*complex(0,1)*gwR**2*sw**4*vR)/cw**2',
                   order = {'EWR':1})

GC_1031 = Coupling(name = 'GC_1031',
                   value = '(-4*cphi*complex(0,1)*g1**2*sphi*sw**4*vR)/cw**2',
                   order = {'EWL':-1,'QED':2})

GC_1032 = Coupling(name = 'GC_1032',
                   value = '(2*complex(0,1)*gwR**2*sphi**2*sw**4*vR)/cw**2',
                   order = {'EWL':-2,'EWR':3})

GC_1033 = Coupling(name = 'GC_1033',
                   value = '(-2*cphi*complex(0,1)*g1**2*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'EWR':-1,'QED':2})

GC_1034 = Coupling(name = 'GC_1034',
                   value = '-4*complex(0,1)*g1*gwR*sw*vR*cmath.sqrt(1 - 2*sw**2)',
                   order = {'QED':1})

GC_1035 = Coupling(name = 'GC_1035',
                   value = '(4*cphi**2*complex(0,1)*g1*gwR*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'QED':1})

GC_1036 = Coupling(name = 'GC_1036',
                   value = '(2*cphi*complex(0,1)*gwR**2*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'EWR':1})

GC_1037 = Coupling(name = 'GC_1037',
                   value = '(2*complex(0,1)*g1**2*sphi*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'EWL':-1,'QED':2})

GC_1038 = Coupling(name = 'GC_1038',
                   value = '(-2*complex(0,1)*gwR**2*sphi*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'EWL':-1,'EWR':2})

GC_1039 = Coupling(name = 'GC_1039',
                   value = '(4*complex(0,1)*g1*gwR*sphi**2*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-2,'EWR':2,'QED':1})

GC_1040 = Coupling(name = 'GC_1040',
                   value = '(2*cphi**2*complex(0,1)*g1**2*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWR':-1,'QED':2})

GC_1041 = Coupling(name = 'GC_1041',
                   value = '(4*cphi*complex(0,1)*g1*gwR*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'QED':1})

GC_1042 = Coupling(name = 'GC_1042',
                   value = '(-2*cphi**2*complex(0,1)*gwR**2*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWR':1})

GC_1043 = Coupling(name = 'GC_1043',
                   value = '(-4*cphi*complex(0,1)*g1**2*sphi*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-1,'QED':2})
...
GC_1045 = Coupling(name = 'GC_1045',
                   value = '(4*complex(0,1)*g1*gwR*sphi*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw',
                   order = {'EWL':-1,'EWR':1,'QED':1})

GC_1046 = Coupling(name = 'GC_1046',
                   value = '(-4*cphi*complex(0,1)*gwR**2*sphi*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-1,'EWR':2})
...
GC_1048 = Coupling(name = 'GC_1048',
                   value = '(-2*complex(0,1)*g1**2*sphi**2*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-2,'EWR':1,'QED':2})

GC_1049 = Coupling(name = 'GC_1049',
                   value = '(2*complex(0,1)*gwR**2*sphi**2*sw**2*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-2,'EWR':3})

GC_1050 = Coupling(name = 'GC_1050',
                   value = '(-4*cphi**2*complex(0,1)*g1*gwR*sw**3*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'QED':1})

GC_1051 = Coupling(name = 'GC_1051',
                   value = '(-4*complex(0,1)*g1*gwR*sphi**2*sw**3*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-2,'EWR':2,'QED':1})

GC_1052 = Coupling(name = 'GC_1052',
                   value = '-(cxi*complex(0,1)*gwR**2*sxi*vR)',
                   order = {'EWL':-1,'EWR':2})
...
GC_1054 = Coupling(name = 'GC_1054',
                   value = 'complex(0,1)*gwR**2*sxi**2*vR',
                   order = {'EWL':-2,'EWR':3})
...
GC_1056 = Coupling(name = 'GC_1056',
                   value = '2*complex(0,1)*g1**2*vR - 4*complex(0,1)*g1**2*sw**2*vR',
                   order = {'EWR':-1,'QED':2})

GC_1057 = Coupling(name = 'GC_1057',
                   value = '(-2*cphi*complex(0,1)*g1*gwR*vR)/cw + (6*cphi*complex(0,1)*g1*gwR*sw**2*vR)/cw',
                   order = {'QED':1})

GC_1058 = Coupling(name = 'GC_1058',
                   value = '(2*cphi**2*complex(0,1)*gwR**2*vR)/cw**2 - (4*cphi**2*complex(0,1)*gwR**2*sw**2*vR)/cw**2',
                   order = {'EWR':1})

GC_1059 = Coupling(name = 'GC_1059',
                   value = '(2*complex(0,1)*g1*gwR*sphi*vR)/cw - (6*complex(0,1)*g1*gwR*sphi*sw**2*vR)/cw',
                   order = {'EWL':-1,'EWR':1,'QED':1})

GC_1060 = Coupling(name = 'GC_1060',
                   value = '(2*complex(0,1)*gwR**2*sphi**2*vR)/cw**2 - (4*complex(0,1)*gwR**2*sphi**2*sw**2*vR)/cw**2',
                   order = {'EWL':-2,'EWR':3})

GC_1061 = Coupling(name = 'GC_1061',
                   value = '(-2*cphi*complex(0,1)*g1**2*sw*vR)/cw + (4*cphi*complex(0,1)*g1**2*sw**3*vR)/cw',
                   order = {'EWR':-1,'QED':2})

GC_1062 = Coupling(name = 'GC_1062',
                   value = '(2*cphi**2*complex(0,1)*g1*gwR*sw*vR)/cw**2 - (6*cphi**2*complex(0,1)*g1*gwR*sw**3*vR)/cw**2',
                   order = {'QED':1})

GC_1063 = Coupling(name = 'GC_1063',
                   value = '(-2*complex(0,1)*g1**2*sphi*sw*vR)/cw + (4*complex(0,1)*g1**2*sphi*sw**3*vR)/cw',
                   order = {'EWL':-1,'QED':2})

GC_1064 = Coupling(name = 'GC_1064',
                   value = '(4*cphi*complex(0,1)*g1*gwR*sphi*sw*vR)/cw**2 - (12*cphi*complex(0,1)*g1*gwR*sphi*sw**3*vR)/cw**2',
                   order = {'EWL':-1,'EWR':1,'QED':1})
...
GC_1066 = Coupling(name = 'GC_1066',
                   value = '(-2*complex(0,1)*g1*gwR*sphi**2*sw*vR)/cw**2 + (6*complex(0,1)*g1*gwR*sphi**2*sw**3*vR)/cw**2',
                   order = {'EWL':-2,'EWR':2,'QED':1})

GC_1067 = Coupling(name = 'GC_1067',
                   value = '(2*cphi**2*complex(0,1)*g1**2*sw**2*vR)/cw**2 - (4*cphi**2*complex(0,1)*g1**2*sw**4*vR)/cw**2',
                   order = {'EWR':-1,'QED':2})

GC_1068 = Coupling(name = 'GC_1068',
                   value = '(-2*cphi*complex(0,1)*gwR**2*sphi*vR)/cw**2 + (4*cphi*complex(0,1)*gwR**2*sphi*sw**2*vR)/cw**2 + (2*cphi*complex(0,1)*gwR**2*sphi*sw**4*vR)/cw**2',
                   order = {'EWL':-1,'EWR':2})

GC_1069 = Coupling(name = 'GC_1069',
                   value = '(2*complex(0,1)*g1**2*sphi**2*sw**2*vR)/cw**2 - (4*complex(0,1)*g1**2*sphi**2*sw**4*vR)/cw**2',
                   order = {'EWL':-2,'EWR':1,'QED':2})

GC_1070 = Coupling(name = 'GC_1070',
                   value = '(-4*cphi*complex(0,1)*g1*gwR*sphi*sw*vR*cmath.sqrt(1 - 2*sw**2))/cw**2 - (4*cphi*complex(0,1)*g1*gwR*sphi*sw**3*vR*cmath.sqrt(1 - 2*sw**2))/cw**2',
                   order = {'EWL':-1,'EWR':1,'QED':1})

GC_1071 = Coupling(name = 'GC_1071',
                   value = '(2*complex(0,1)*k1*k2*yDO1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1072 = Coupling(name = 'GC_1072',
                   value = '(2*k1*k2*yDO1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1073 = Coupling(name = 'GC_1073',
                   value = '-((complex(0,1)*k1**2*yDO1x1)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yDO1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1074 = Coupling(name = 'GC_1074',
                   value = '(2*complex(0,1)*k1*k2*yDO2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1075 = Coupling(name = 'GC_1075',
                   value = '(2*k1*k2*yDO2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1076 = Coupling(name = 'GC_1076',
                   value = '-((complex(0,1)*k1**2*yDO2x2)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yDO2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1077 = Coupling(name = 'GC_1077',
                   value = '(2*complex(0,1)*k1*k2*yDO3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1078 = Coupling(name = 'GC_1078',
                   value = '(2*k1*k2*yDO3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1079 = Coupling(name = 'GC_1079',
                   value = '-((complex(0,1)*k1**2*yDO3x3)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yDO3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1080 = Coupling(name = 'GC_1080',
                   value = '-((complex(0,1)*I29a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I29a11*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1081 = Coupling(name = 'GC_1081',
                   value = '-((complex(0,1)*I30a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I30a11*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1082 = Coupling(name = 'GC_1082',
                   value = '-((complex(0,1)*k1**2*yML1x1)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yML1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1083 = Coupling(name = 'GC_1083',
                   value = '(I30a11*k1**2)/(k1**2*vev - k2**2*vev) + (I30a11*k2**2)/(k1**2*vev - k2**2*vev) - (2*k1*k2*yML1x1)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1084 = Coupling(name = 'GC_1084',
                   value = '-((I29a11*k1**2)/(k1**2*vev - k2**2*vev)) - (I29a11*k2**2)/(k1**2*vev - k2**2*vev) + (2*k1*k2*yML1x1)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1085 = Coupling(name = 'GC_1085',
                   value = '-((complex(0,1)*I29a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I29a22*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1086 = Coupling(name = 'GC_1086',
                   value = '-((complex(0,1)*I30a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I30a22*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1087 = Coupling(name = 'GC_1087',
                   value = '-((complex(0,1)*k1**2*yML2x2)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yML2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1088 = Coupling(name = 'GC_1088',
                   value = '(I30a22*k1**2)/(k1**2*vev - k2**2*vev) + (I30a22*k2**2)/(k1**2*vev - k2**2*vev) - (2*k1*k2*yML2x2)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1089 = Coupling(name = 'GC_1089',
                   value = '-((I29a22*k1**2)/(k1**2*vev - k2**2*vev)) - (I29a22*k2**2)/(k1**2*vev - k2**2*vev) + (2*k1*k2*yML2x2)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1090 = Coupling(name = 'GC_1090',
                   value = '-((complex(0,1)*I29a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I29a33*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1091 = Coupling(name = 'GC_1091',
                   value = '-((complex(0,1)*I30a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I30a33*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yML3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1092 = Coupling(name = 'GC_1092',
                   value = '-((complex(0,1)*k1**2*yML3x3)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yML3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1093 = Coupling(name = 'GC_1093',
                   value = '(I30a33*k1**2)/(k1**2*vev - k2**2*vev) + (I30a33*k2**2)/(k1**2*vev - k2**2*vev) - (2*k1*k2*yML3x3)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1094 = Coupling(name = 'GC_1094',
                   value = '-((I29a33*k1**2)/(k1**2*vev - k2**2*vev)) - (I29a33*k2**2)/(k1**2*vev - k2**2*vev) + (2*k1*k2*yML3x3)/(k1**2*vev - k2**2*vev)',
                   order = {'EWL':1})

GC_1095 = Coupling(name = 'GC_1095',
                   value = '(I7a11*k1**2)/((k1**2 - k2**2)*vev) + (I7a11*k2**2)/((k1**2 - k2**2)*vev) - (2*k1*k2*yMU1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1096 = Coupling(name = 'GC_1096',
                   value = '-((complex(0,1)*I7a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a11*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1097 = Coupling(name = 'GC_1097',
                   value = '-((complex(0,1)*I8a11*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a11*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1098 = Coupling(name = 'GC_1098',
                   value = '-((I8a11*k1**2)/((k1**2 - k2**2)*vev)) - (I8a11*k2**2)/((k1**2 - k2**2)*vev) + (2*k1*k2*yMU1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1099 = Coupling(name = 'GC_1099',
                   value = '-((complex(0,1)*k1**2*yMU1x1)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yMU1x1)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1100 = Coupling(name = 'GC_1100',
                   value = '(I7a22*k1**2)/((k1**2 - k2**2)*vev) + (I7a22*k2**2)/((k1**2 - k2**2)*vev) - (2*k1*k2*yMU2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1101 = Coupling(name = 'GC_1101',
                   value = '-((complex(0,1)*I7a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a22*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1102 = Coupling(name = 'GC_1102',
                   value = '-((complex(0,1)*I8a22*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a22*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1103 = Coupling(name = 'GC_1103',
                   value = '-((I8a22*k1**2)/((k1**2 - k2**2)*vev)) - (I8a22*k2**2)/((k1**2 - k2**2)*vev) + (2*k1*k2*yMU2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1104 = Coupling(name = 'GC_1104',
                   value = '-((complex(0,1)*k1**2*yMU2x2)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yMU2x2)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1105 = Coupling(name = 'GC_1105',
                   value = '(I7a33*k1**2)/((k1**2 - k2**2)*vev) + (I7a33*k2**2)/((k1**2 - k2**2)*vev) - (2*k1*k2*yMU3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1106 = Coupling(name = 'GC_1106',
                   value = '-((complex(0,1)*I7a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I7a33*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1107 = Coupling(name = 'GC_1107',
                   value = '-((complex(0,1)*I8a33*k1**2)/((k1**2 - k2**2)*vev)) - (complex(0,1)*I8a33*k2**2)/((k1**2 - k2**2)*vev) + (2*complex(0,1)*k1*k2*yMU3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1108 = Coupling(name = 'GC_1108',
                   value = '-((I8a33*k1**2)/((k1**2 - k2**2)*vev)) - (I8a33*k2**2)/((k1**2 - k2**2)*vev) + (2*k1*k2*yMU3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})

GC_1109 = Coupling(name = 'GC_1109',
                   value = '-((complex(0,1)*k1**2*yMU3x3)/((k1**2 - k2**2)*vev)) + (complex(0,1)*k2**2*yMU3x3)/((k1**2 - k2**2)*vev)',
                   order = {'EWL':1})
