...
ghdchi1chi2 = Parameter(name = 'ghdchi1chi2',
                        nature = 'external',
                        type = 'real',
                        value = 0.1,
                        texname = '\\text{ghdchi1chi2}',
                        lhablock = 'HIDDEN',
                        lhacode = [ 7 ])

gXmu = Parameter(name = 'gXmu',
                 nature = 'external',
                 type = 'real',
                 value = 0.1,
                 texname = '\\text{gXmu}',
