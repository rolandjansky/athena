...
c        open (25, file = 'ana/zpc.res', status = 'unknown')
cbz1/31/99end
...
c        WRITE (25, *) ' Event ', IAEVT, ', run ', IARUN
c        WRITE (25, *) '    number of operations = ', iopern
c        WRITE (25, *) '    number of collisions between particles = ', 
c     &       icolln
c        WRITE (25, *) '    freezeout time=', t
c        WRITE (25, *) '    ending at the ', number, 'th random number'
c        WRITE (25, *) '    ending collision iff=', iff
