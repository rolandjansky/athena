...
Gen_tf.py --ecmEnergy=13000. --maxEvents=10000 --firstEvent=-1 --randomSeed=123456 --jobConfig=421401 --outputEVNTFile=EVNT.root --outputYODAFile=MyOutput.yoda.gz --postInclude=~/Qualification_task_ART/Herwig_7/MC_JO/MC_test_01_dijet_dipole.py 
