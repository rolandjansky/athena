...
class Hw7ConfigMatchbox(hw7Config.Hw7Config):
  ...
  def __init__(self, genSeq, runArgs, run_name="Herwig", beams="pp"):
    ...
    if not beams in ["pp", "ep", "ee"]:
      raise RuntimeError(hw7Utils.ansi_format_error("Parameter 'beams' must be one of the following ['pp', 'ep', 'ee']!"))
