...
public:
   ...
   * Default constructor.
   */
  powhegLesHouchesFileReader() : neve(0), ieve(0), theQNumbers(false),
...
private:
  ...
  map<string,string> optionalWeightsLabel;
...
private:
   ...
   */
  static ClassDescription<powhegLesHouchesFileReader> initpowhegLesHouchesFileReader;
