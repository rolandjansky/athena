...
#include "TruthUtils/HepMCParticleUtils.h"
#include "TruthUtils/HepMCVertexUtils.h"
...
namespace MC {
  ...
  inline GenParticles children(HepMC::GenParticle* gp) { return MC::children(*gp); }
  ...
  inline GenParticles parents(HepMC::GenParticle* gp) { return MC::parents(*gp); }
  ...
  inline GenParticles descendants(HepMC::GenParticle* gp) { return MC::descendants(*gp); }
  ...
  inline GenParticles ancestors(HepMC::GenParticle* gp) { return MC::ancestors(*gp); }
