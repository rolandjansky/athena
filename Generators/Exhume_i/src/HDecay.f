...
C =====================================================================
      ...
      DIMENSION XX(4),YY(4)
c      DIMENSION AMCHAR(2),AMNEUT(4),XMNEUT(4),
c     .          AC1(2,2),AC2(2,2),AC3(2,2),
c     .          AN1(4,4),AN2(4,4),AN3(4,4),
c     .          ACNL(2,4),ACNR(2,4),
c     .          AMST(2),AMSB(2),AMSL(2),
c     .          AMSU(2),AMSD(2),AMSE(2),AMSN(2),
c     .          GLTT(2,2),GLBB(2,2),GLEE(2,2),
c     .          GHTT(2,2),GHBB(2,2),GHEE(2,2),
c     .          GCTB(2,2),GCEN(2,2)
c      DIMENSION GMST(2),GMSB(2),GMSL(2),GMSU(2),GMSD(2),GMSE(2),
c     .          GMSN(2)
c      DIMENSION HLBRSC(2,2),HLBRSN(4,4),HHBRSC(2,2),
c     .          HHBRSN(4,4),HABRSC(2,2),HABRSN(4,4),HCBRSU(2,4),
c     .          HHBRST(2,2),HHBRSB(2,2),HCBRSTB(2,2) 
      COMPLEX*16 CF,CG,CI1,CI2,CA,CB,CTT,CTB,CTC,CTW,CLT,CLB,CLW,
     .           CAT,CAB,CAC,CAW,CTL,CAL
c     .           CAT,CAB,CAC,CAW,CAH,CTH,CLH,CX1,CX2,CAX1,CAX2,CTL,CAL,
c     .           CSL,CSQ,CSB1,CSB2,CST1,CST2,CSL1,CSL2,
c     .           CXL,CXQ,CXB1,CXB2,CXT1,CXT2,CXL1,CXL2
c      COMPLEX*16 CSEL,CSER,CSUL,CSUR,CSDL,CSDR,
...
C
     ...
     .          -3*(1-4*SS*DABS(QF))**2))
      CF(CA) = (-1)*CDLOG((-(1+CDSQRT(1-CA)))/(1-CDSQRT(1-CA)))**2/4
...
C
      ...
      TGBET = TGBET   ! to avoid compiler warnings
...
C eA      COMPLEX FUNCTION LI2*16(X)
