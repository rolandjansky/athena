...
#include "Exhume_i/hdecay.h"

/////////////////////////////////////////////////////////////////////////////
Exhume::Higgs::Higgs(std::string _ExhumeControlParams)
...
/////////////////////////////////////////////////////////////////////////////
void Exhume::Higgs::SetSubParameters(std::vector<double> _List){
  // to prevent compiler warnings
  std ::vector<double> cos = _List;
  return;
}
...
void Exhume::Higgs::SetHiggsDecay(const int& UNUSED(id_)){
  /*
  pydat3_.mdme[0][209]=0;
  pydat3_.mdme[0][210]=0;
  pydat3_.mdme[0][211]=0;
  pydat3_.mdme[0][212]=0;
  pydat3_.mdme[0][213]=0;
  pydat3_.mdme[0][214]=0;
  pydat3_.mdme[0][215]=0;
  pydat3_.mdme[0][216]=0;
  pydat3_.mdme[0][217]=0;
  pydat3_.mdme[0][218]=0;
  pydat3_.mdme[0][219]=0;
  pydat3_.mdme[0][220]=0;
  pydat3_.mdme[0][221]=0;
  pydat3_.mdme[0][222]=0;
  pydat3_.mdme[0][223]=0;
  pydat3_.mdme[0][224]=0;
  pydat3_.mdme[0][225]=0;
