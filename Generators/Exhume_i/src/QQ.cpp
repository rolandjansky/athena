...
////////////////////////////////////////////////////////////////////////////////
Exhume::QQ::QQ(std::string _ExhumeControlParams):
  TwoSpace( _ExhumeControlParams){
    std::cout<<std::endl<<"   =QQ (v1.3.2) production selected="<<std::endl<<std::endl;
...
double Exhume::QQ::SubProcess(){
  ...
  /*
  double qMassSq=PartonMass*PartonMass;
  double _Sigma = 0.666667*AlphaS(0.5*SqrtsHat)
    *AlphaS(0.5*SqrtsHat)*qMassSq*InvsHat*InvsHat
		*pow((1 - 4*qMassSq*InvsHat),1.5)
