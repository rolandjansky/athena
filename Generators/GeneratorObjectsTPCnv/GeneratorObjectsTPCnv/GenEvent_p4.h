...
{ 
 ...
 public: 
   ...
   */
  GenEvent_p4( int signalProcessId, 
	       int eventNbr,
	       double eventScale,
	       double alphaQCD,
	       double alphaQED,
...
/// Inline methods: 
/////////////////////////////////////////////////////////////////// 
inline GenEvent_p4::GenEvent_p4():
  m_signalProcessId  ( -1 ),
  m_eventNbr         ( -1 ),
  m_eventScale       ( -1 ),
  m_alphaQCD         ( -1 ),
...
inline GenEvent_p4::GenEvent_p4( int signalProcessId, 
				 int eventNbr,
				 double eventScale,
				 double alphaQCD,
				 double alphaQED,
...
#endif //> GENERATOROBJECTSTPCNV_GENEVENT_P4_H
