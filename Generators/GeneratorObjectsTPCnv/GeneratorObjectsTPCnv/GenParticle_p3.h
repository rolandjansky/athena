...
{ 
 ...
 public: 
  ...
  GenParticle_p3( const double px,   const double py, const double pz,
...
inline GenParticle_p3::GenParticle_p3():
  m_px           ( 0 ),
  m_py           ( 0 ),
  m_pz           ( 0 ),
  m_m            ( 0 ),
...
inline GenParticle_p3::GenParticle_p3( const double px,
				       const double py,
				       const double pz,
				       const double m,
				       const int pdgId,
...
#endif //> GENERATOROBJECTSTPCNV_GENPARTICLE_P3_H
