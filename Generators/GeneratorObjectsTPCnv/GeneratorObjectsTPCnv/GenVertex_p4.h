...
{ 
 ...
 public: 
  ...
  GenVertex_p4( const double x, const double y, const double z, const double t,
		const int id, 
...
/// Inline methods: 
/////////////////////////////////////////////////////////////////// 
inline GenVertex_p4::GenVertex_p4():
  m_x           ( 0 ),
  m_y           ( 0 ),
  m_z           ( 0 ),
  m_t           ( 0 ),
...
inline GenVertex_p4::GenVertex_p4( const double x, const double y, 
