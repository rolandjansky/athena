...
/// Dictionary file for persistent representation(s) of GeneratorObjects
/// Author: Davide Costanzo <davide.costanzo@cern.ch>
/// Author: Sebastien Binet <binet@cern.ch>
/// Date:   January 2007

#ifndef GENERATOROBJECTSTPCNV_GENERATOROBJECTSTPCNVDICT_H
...
namespace GeneratorObjectsTPCnvDict_tmp {

struct tmp {
  T_TPCnv<McEventCollection, McEventCollection_p5> m_mceventcoll_p5;
};

} // end namespace GeneratorObjectsTPCnvDict_tmp
