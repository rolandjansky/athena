...
void test1()
{
  ...
  testit (trans1a);
  // By position
  HepMcParticleLink trans1b(particle1->barcode(),0,EBC_MAINEVCOLL,IS_POSITION);
  testit (trans1b);
  ...
  HepMcParticleLink trans5b(deltaRayBarcode,0,EBC_MAINEVCOLL,IS_POSITION);
  testit (trans5b);
