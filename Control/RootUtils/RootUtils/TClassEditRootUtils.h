// Workaround for clang 9 bug with string::compare...
...
/*************************************************************************
 * Copyright (C) 1995-2003, 2020, Rene Brun and Fons Rademakers.               *
 * All rights reserved.                                                  *
 *                                                                       *
...
#ifndef ROOTUTILS_TCLASSEDITROOTUTILS_H
#define ROOTUTILS_TCLASSEDITROOTUTILS_H
...
namespace TClassEdit {
   ...
   inline bool IsUniquePtr(std::string_view name) {return name.substr(0, 11) ==  "unique_ptr<";}
   inline bool IsUniquePtr(ROOT::Internal::TStringView name) {return IsUniquePtr(std::string_view(name)); }
   inline bool IsStdArray(std::string_view name) {return name.substr(0, 6) ==  "array<"; }
