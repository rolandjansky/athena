...
// $Id$
/**
 * @file AthLinks/tools/CachedValue.h
...
#ifndef ATHLINKS_CACHEDVALUE_H
#define ATHLINKS_CACHEDVALUE_H
...
#include "AthLinks/tools/CachedValue.icc"


#endif // not ATHLINKS_CACHEDVALUE_H
