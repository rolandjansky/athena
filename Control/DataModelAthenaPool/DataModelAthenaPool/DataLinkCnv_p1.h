...
class DataLinkCnv_p1
   : public T_AthenaPoolTPCnvConstBase< DLINK_TYPE, DataLink_p1 > {
public:
  using base_class = T_AthenaPoolTPCnvConstBase< DLINK_TYPE, DataLink_p1 >;
...
class DataLinkVectorCnv_p1
   : public T_AthenaPoolTPCnvStdVectorConst< DLINKVector_TYPE,
				     DataLinkVector_p1,
