...
ATHRNG::RNGWrapper::RNGWrapper(factoryFunc& genFact,size_t nSlots):m_evNum(0),m_runNum(0){
...
bool ATHRNG::RNGWrapper::setSeed(const std::string& algName,size_t slot, uint64_t ev,uint64_t run){
