...
ALFA_LocRecEvCollection_PERS* ALFA_LocRecEvCollectionCnv::createPersistent(ALFA_LocRecEvCollection* transCont) {
    ...
    ALFA_LocRecEvCollectionCnv_p1   m_TPConverter;
    ALFA_LocRecEvCollection_PERS *persObj = m_TPConverter.createPersistent( transCont, mlog );
    return persObj;
}
...
ALFA_LocRecEvCollection* ALFA_LocRecEvCollectionCnv::createTransient() {
    ...
    ALFA_LocRecEvCollectionCnv_p1   m_TPConverter_p1;
