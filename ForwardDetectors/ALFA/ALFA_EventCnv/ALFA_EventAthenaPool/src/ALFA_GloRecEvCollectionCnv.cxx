...
ALFA_GloRecEvCollection_PERS* ALFA_GloRecEvCollectionCnv::createPersistent(ALFA_GloRecEvCollection* transCont) {
    ...
    ALFA_GloRecEvCollectionCnv_p1   m_TPConverter;
    ALFA_GloRecEvCollection_PERS *persObj = m_TPConverter.createPersistent( transCont, mlog );
    return persObj;
}
...
ALFA_GloRecEvCollection* ALFA_GloRecEvCollectionCnv::createTransient() {
    ...
    ALFA_GloRecEvCollectionCnv_p1   m_TPConverter_p1;
