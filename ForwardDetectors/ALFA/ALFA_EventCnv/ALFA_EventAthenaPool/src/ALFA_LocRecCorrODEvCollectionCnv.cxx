...
ALFA_LocRecCorrODEvCollection_PERS* ALFA_LocRecCorrODEvCollectionCnv::createPersistent(ALFA_LocRecCorrODEvCollection* transCont) {
    ...
    ALFA_LocRecCorrODEvCollectionCnv_p1   m_TPConverter;
    ALFA_LocRecCorrODEvCollection_PERS *persObj = m_TPConverter.createPersistent( transCont, mlog );
    return persObj;
}
...
ALFA_LocRecCorrODEvCollection* ALFA_LocRecCorrODEvCollectionCnv::createTransient() {
    ...
    ALFA_LocRecCorrODEvCollectionCnv_p1   m_TPConverter_p1;
