...
ALFA_ODHitCollection_PERS* ALFA_ODHitCollectionCnv::createPersistent(ALFA_ODHitCollection* transCont) {
    ...
    ALFA_ODHitCollectionCnv_p1   m_TPConverter;
    ALFA_ODHitCollection_PERS *persObj = m_TPConverter.createPersistent( transCont, mlog );
    return persObj;
}
...
ALFA_ODHitCollection* ALFA_ODHitCollectionCnv::createTransient() {
    ...
    ALFA_ODHitCollectionCnv_p1   m_TPConverter_p1;
