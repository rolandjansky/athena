...
ALFA_DigitCollection_PERS* ALFA_DigitCollectionCnv::createPersistent(ALFA_DigitCollection* transCont) {
    ...
    ALFA_DigitCollectionCnv_p1   m_TPConverter;
    ALFA_DigitCollection_PERS *persObj = m_TPConverter.createPersistent( transCont, mlog );
    return persObj;
}
...
ALFA_DigitCollection* ALFA_DigitCollectionCnv::createTransient() {
    ...
    ALFA_DigitCollectionCnv_p1   m_TPConverter_p1;
