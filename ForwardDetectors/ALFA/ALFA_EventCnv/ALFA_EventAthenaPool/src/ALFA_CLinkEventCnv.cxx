...
ALFA_CLinkEvent_PERS* ALFA_CLinkEventCnv::createPersistent(ALFA_CLinkEvent* transCont)
{
	...
	ALFA_CLinkEventCnv_p1   m_TPConverter;
	ALFA_CLinkEvent_PERS *persObj = m_TPConverter.createPersistent( transCont, LogStream );
...
ALFA_CLinkEvent* ALFA_CLinkEventCnv::createTransient()
{
	...
	ALFA_CLinkEventCnv_p1 m_TPConverter_p1;
	...
	if( this->compareClassGuid(p1_guid)){
		...
		trans_cont = m_TPConverter_p1.createTransient( col_vect.get(), LogStream );
	}
	else {
