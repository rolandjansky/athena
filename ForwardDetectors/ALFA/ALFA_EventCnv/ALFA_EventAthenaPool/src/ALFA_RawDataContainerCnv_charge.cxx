...
ALFA_RawDataContainerCnv_charge_p1 m_TPConverter;
ALFA_RawDataContainer_charge_PERS* persCont = m_TPConverter.createPersistent(transCont, log);
...
if (log.level()<=MSG::DEBUG) log << MSG::DEBUG << "In ALFA_RawDataContainerCnv_charge::createTransient" << endreq;
 ...
 ALFA_RawDataContainerCnv_charge_p1 m_TPConverter_p1;
