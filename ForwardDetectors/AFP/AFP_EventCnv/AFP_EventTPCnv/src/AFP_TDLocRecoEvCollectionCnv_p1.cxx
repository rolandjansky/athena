...
void AFP_TDLocRecoEvCollectionCnv_p1::transToPers(const AFP_TDLocRecoEvCollection* transObj, AFP_TDLocRecoEvCollection_p1* persObj, MsgStream& log) {
...
void AFP_TDLocRecoEvCollectionCnv_p1::persToTrans(const AFP_TDLocRecoEvCollection_p1* persObj, AFP_TDLocRecoEvCollection* transObj, MsgStream& log) {
