...
#ifndef TRIGT1CALOBYTESTREAM_ZDCL1CALOSUBBLOCK_H
#define TRIGT1CALOBYTESTREAM_ZDCL1CALOSUBBLOCK_H
...
// PAS 8/14/15 not needed for compilation
...
inline int ZdcL1CaloSubBlock::dataWords() const
{
  return m_dataWords;
}

inline int ZdcL1CaloSubBlock::wordId() const
{
  return (m_header >> s_wordIdBit) & s_wordIdMask;
}

inline int ZdcL1CaloSubBlock::version() const
{
  return (m_header >> s_versionBit) & s_versionMask;
}

inline int ZdcL1CaloSubBlock::format() const
{
  return (m_header >> s_formatBit) & s_formatMask;
}

inline int ZdcL1CaloSubBlock::seqno() const
{
  return (m_header >> s_seqnoBit) & s_seqnoMask;
}

inline int ZdcL1CaloSubBlock::slice() const
{
  return seqno();
}

inline int ZdcL1CaloSubBlock::crate() const
{
  return (m_header >> s_crateBit) & s_crateMask;
}

inline int ZdcL1CaloSubBlock::module() const
{
  return (m_header >> s_moduleBit) & s_moduleMask;
}

inline int ZdcL1CaloSubBlock::slices2() const
{
  return (m_header >> s_slices2Bit) & s_slices2Mask;
}

inline int ZdcL1CaloSubBlock::slices1() const
{
  return (m_header >> s_slices1Bit) & s_slices1Mask;
}

inline uint32_t ZdcL1CaloSubBlock::failingBCN() const
{
  return (m_trailer >> s_failingBcnBit) & s_failingBcnMask;
}

inline bool ZdcL1CaloSubBlock::glinkTimeout() const
{
  return m_trailer & (0x1 << s_glinkTimeoutBit);
}

inline bool ZdcL1CaloSubBlock::glinkDown() const
{
  return m_trailer & (0x1 << s_glinkDownBit);
}

inline bool ZdcL1CaloSubBlock::upstreamError() const
{
  return m_trailer & (0x1 << s_upstreamErrorBit);
}

inline bool ZdcL1CaloSubBlock::daqOverflow() const
{
  return m_trailer & (0x1 << s_daqOverflowBit);
}

inline bool ZdcL1CaloSubBlock::bcnMismatch() const
{
  return m_trailer & (0x1 << s_bcnMismatchBit);
}

inline bool ZdcL1CaloSubBlock::glinkProtocol() const
{
  return m_trailer & (0x1 << s_glinkProtocolBit);
}

inline bool ZdcL1CaloSubBlock::glinkParity() const
{
  return m_trailer & (0x1 << s_glinkParityBit);
}

inline uint32_t ZdcL1CaloSubBlock::subStatus() const
{
  return m_trailer;
}

inline void ZdcL1CaloSubBlock::setBunchCrossing(const int bc)
{
  if (bc) m_bunchCrossing = bc;
}

inline int ZdcL1CaloSubBlock::bunchCrossing() const
{
  return m_bunchCrossing;
}

inline void ZdcL1CaloSubBlock::setUnpackErrorCode(const int code)
{
  m_unpackError = code;
}

inline int ZdcL1CaloSubBlock::unpackErrorCode() const
{
  return m_unpackError;
}

inline void ZdcL1CaloSubBlock::setStreamed()
{
  m_maxBits = s_maxStreamedBits;
  m_maxMask = s_maxStreamedMask;
}

inline bool ZdcL1CaloSubBlock::unpackerSuccess() const
{
  return m_unpackerFlag;
}

inline int ZdcL1CaloSubBlock::currentPinBit(int pin) const
{
