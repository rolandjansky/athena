...
namespace HLTTestApps {
  ...
  /**
   * Loads either an HLTInterface from libriares.
   */
   ...
   * context. When the file ends, execution of athena*T resumes.
   *
   * @param command A python command as in "python -c <args>" to execute
   */
