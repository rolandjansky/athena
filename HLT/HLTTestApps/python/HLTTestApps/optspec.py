...
common['info-service'] = \
  {'short': 'x',
   ...
   'group': 'Monitoring',
   'description': 'The InfoService that should be used as TrigMonTHistSvc back-end. This option can only be used together with --oh-monitoring'}  
common['user-ipc'] = \
  {'short': 'I', 
   'arg': False, 
   'default': None,
