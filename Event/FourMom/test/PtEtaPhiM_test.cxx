...
void testConstructors()
{
  ...
  testNativeConstructor<I4Mom1_t, I4Mom2_t>( 10.*CLHEP::GeV, 1., M_PI, 10.*CLHEP::GeV );
		  ...
		  const double pz, const double e )
{
  ...
  {
    I4Mom1_t p;
    p4assert( p.pt() != hlv.perp() );
    p.setPt( hlv.perp() );
    p4assert( std::abs( p.pt() - hlv.perp() ) < epsilon );
...
void tests()
{
  ...
  std::cout << "PtEtaPhiM tests... [epsilon = " << epsilon << "]" 
	    << std::endl;
