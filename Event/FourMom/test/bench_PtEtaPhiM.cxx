...
{
  boost::timer::auto_cpu_timer chrono;
...
int main()
{
  std::cout << "## Benchmark [PtEtaPhiM]..." << std::endl;

  const unsigned int iMax = 10000000;
  std::cout << "## Configured to loop #" << iMax << " times..." << std::endl;

  test<P4ImplPtEtaPhiM>         ( iMax, "P4ImplPtEtaPhiM" );
  test<P4Impl<P4ImplPtEtaPhiM> >( iMax, "P4Impl<PtEtaPhiM>" );
  test<P4PtEtaPhiM>             ( iMax, "P4PtEtaPhiM" );
