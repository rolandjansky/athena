...
conddb.addFolderWithTag("TRT_OFL","/TRT/Calib/MC/RT","TrtCalibRt-R2-MC-run2-scenario1_02-03",force=True,forceData=True)
conddb.addMarkup("/TRT/Calib/MC/RT","<forceRunNumber>226000</forceRunNumber>")
conddb.blockFolder("/TRT/Calib/MC/T0")
conddb.addFolderWithTag("TRT_OFL","/TRT/Calib/MC/T0","TrtCalibT0-R2-MC-run2-scenario1_02-03",force=True,forceData=True)
conddb.addMarkup("/TRT/Calib/MC/T0","<forceRunNumber>226000</forceRunNumber>")
