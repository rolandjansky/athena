...
conddb.addFolderWithTag("TRT_OFL","/TRT/Calib/MC/RT","TrtCalibMCRt-R2-MC-run2-scenario1_01-00",force=True,forceData=True)
conddb.blockFolder("/TRT/Calib/MC/T0")
conddb.addFolderWithTag("TRT_OFL","/TRT/Calib/MC/T0","TrtCalibMCT0-R2-MC-run2-scenario1_01-00",force=True,forceData=True)
...
#TRTMCCalibDBSvc=TRT_CalDbSvc(name="TRTMCCalibDBSvc",RtFolderName="/TRT/Calib/MCRT",T0FolderName="/TRT/Calib/MCT0",ErrorSlopeFolderName="/TRT/Calib/MCslopes",ErrorFolderName ="/TRT/Calib/MCerrors2d")
