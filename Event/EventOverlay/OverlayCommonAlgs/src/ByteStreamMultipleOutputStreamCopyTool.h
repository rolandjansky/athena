...
#ifndef  OVERLAYCOMMONALGS_BYTESTREAMMULTIPLEOUTPUTSTREAMCOPYTOOL_H
# define OVERLAYCOMMONALGS_BYTESTREAMMULTIPLEOUTPUTSTREAMCOPYTOOL_H
/**
...
#endif // OVERLAYCOMMONALGS_BYTESTREAMMULTIPLEOUTPUTSTREAMCOPYTOOL_H
