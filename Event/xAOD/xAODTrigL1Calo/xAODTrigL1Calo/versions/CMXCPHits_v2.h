...
// $Id: CMXCPHits_v2.h 646335 2015-02-12 01:16:10Z morrisj $
#ifndef XAODTRIGL1CALO_VERSIONS_CMXCPHITS_V2_H
#define XAODTRIGL1CALO_VERSIONS_CMXCPHITS_V2_H
...
namespace xAOD{
  ...
  class CMXCPHits_v2 : public SG::AuxElement {
    public:
      /// Default constructor
      CMXCPHits_v2();
      /// Default desturctor
      virtual ~CMXCPHits_v2(){}
      
      /// initialize
      virtual void initialize(const uint_least8_t crate,const uint_least8_t cmx,const uint_least8_t source);
