...
// $Id: CMXCPTobAuxContainer_v2.h 646335 2015-02-12 01:16:10Z morrisj $
...
namespace xAOD{
  ...
  class CMXCPTobAuxContainer_v2 : public AuxContainerBase {
    ...
    private:
      ...
      std::vector<uint_least8_t> cmx;
      std::vector<uint_least8_t> cpm;
      std::vector<uint_least8_t> chip;
      std::vector<uint_least8_t> location;
      std::vector<uint_least8_t> peak;
      std::vector<std::vector<uint_least8_t> > energyVec;
      std::vector<std::vector<uint_least8_t> > isolationVec;
