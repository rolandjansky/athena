...
// $Id: JetElement_v2.cxx 642659 2015-01-29 12:41:06Z morrisj $
...
namespace xAOD{ 
  ...
  AUXSTORE_OBJECT_SETTER_AND_GETTER( JetElement_v2 , std::vector<int> , emEnergyVec , setEmEnergyVec )  
  AUXSTORE_OBJECT_SETTER_AND_GETTER( JetElement_v2 , std::vector<int> , hadEnergyVec , setHadEnergyVec )
  AUXSTORE_OBJECT_SETTER_AND_GETTER( JetElement_v2 , std::vector<int> , emErrorVec , setEmErrorVec )  
  AUXSTORE_OBJECT_SETTER_AND_GETTER( JetElement_v2 , std::vector<int> , hadErrorVec , setHadErrorVec )
  AUXSTORE_OBJECT_SETTER_AND_GETTER( JetElement_v2 , std::vector<int> , linkErrorVec , setLinkErrorVec )    
 
  void JetElement_v2::addEnergy(int emEnergyIn, int hadEnergyIn)
  {
    /// EM Section
  ...
  void JetElement_v2::addSlice(int slice, int emEnergyIn, int hadEnergyIn,int emErrorIn, int hadErrorIn, int linkErrorIn)
  {
  ...
  int JetElement_v2::emEnergy()  const
  {
  ...
  int JetElement_v2::hadEnergy() const
  {
  ...
  int JetElement_v2::energy()    const
  {
  ...
  int JetElement_v2::emSliceEnergy(int slice) const
  {
  ...
  int JetElement_v2::hadSliceEnergy(int slice) const
  {
  ...
  int JetElement_v2::sliceEnergy(int slice) const
  {
  ...
  int JetElement_v2::emError()   const
  {
    return emErrorVec()[ peak() ];
  }
  
  int JetElement_v2::hadError()  const
  {
    return hadErrorVec()[ peak() ];
  }
  
  int JetElement_v2::linkError() const
  {
