...
StatusCode xAODCMXJetHitsContainerCnv::createObj( IOpaqueAddress* pAddr, DataObject*& pObj ) {
...
xAOD::CMXJetHitsContainer* xAODCMXJetHitsContainerCnv::createTransient()
{
  ...
  if( compareClassGuid( v1_guid ) ) {
    xAOD::CMXJetHitsContainer* c = poolReadObject< xAOD::CMXJetHitsContainer >();
