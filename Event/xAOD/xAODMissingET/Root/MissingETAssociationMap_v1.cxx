...
const xAOD::IParticleContainer* MissingETAssociationMap_v1::getOverlapRemovedSignals(MissingETAssociationHelper* helper, const xAOD::IParticleContainer* signals,MissingETBase::UsageHandler::Policy p) const
{
  MissingETBase::Types::const_signal_vector_t* uniques = new MissingETBase::Types::const_signal_vector_t(SG::VIEW_ELEMENTS);
