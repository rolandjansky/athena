...
// $Id: xAODPhotonTrigAuxContainerOfflineCnv_v2.cxx 705790 2015-11-04 13:09:23Z krasznaa $
...
void xAODPhotonTrigAuxContainerOfflineCnv_v2::
persToTrans( const xAOD::PhotonAuxContainer_v2* oldObj,
             xAOD::PhotonTrigAuxContainer* newObj,
             MsgStream& log ) {

   // Greet the user:
   ATH_MSG( "Converting xAOD::PhotonAuxContainer_v2 to "
...
transToPers( const xAOD::PhotonTrigAuxContainer*,
   ...
   log << MSG::ERROR
       << "Somebody called xAODPhotonTrigAuxContainerOfflineCnv_v2::"
       << "transToPers" << endmsg;
