...
// $Id: xAODRingerRNNOutputAuxContainerCnv.h
...
typedef T_AthenaPoolCustomCnv< xAOD::TrigRNNOutputAuxContainer, xAOD::TrigRNNOutputAuxContainer > xAODTrigRNNOutputAuxContainerCnvBase;
/**
...
protected:
  ...
  xAODTrigRNNOutputAuxContainerCnv( ISvcLocator* svcLoc );
   ...
   virtual xAOD::TrigRNNOutputAuxContainer* createPersistent( xAOD::TrigRNNOutputAuxContainer* trans );
