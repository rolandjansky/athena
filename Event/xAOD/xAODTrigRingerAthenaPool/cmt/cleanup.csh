...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=xAODTrigRingerAthenaPool -version=xAODTrigRingerAthenaPool-00-00-01 -path=/tmp/jodafons/testRinger/test2/Event/xAOD  $* >${cmtxAODTrigRingerAthenaPooltempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=xAODTrigRingerAthenaPool -version=xAODTrigRingerAthenaPool-00-00-01 -path=/tmp/jodafons/testRinger/test2/Event/xAOD  $* >${cmtxAODTrigRingerAthenaPooltempfile}"
