...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=xAODTrigRingerAthenaPool -version=xAODTrigRingerAthenaPool-00-00-01 -path=/tmp/jodafons/testRinger/test2/Event/xAOD  -no_cleanup $* >${cmtxAODTrigRingerAthenaPooltempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=xAODTrigRingerAthenaPool -version=xAODTrigRingerAthenaPool-00-00-01 -path=/tmp/jodafons/testRinger/test2/Event/xAOD  -no_cleanup $* >${cmtxAODTrigRingerAthenaPooltempfile}"
  cmtsetupstatus=2
