...
/// possibly differ from the 4-vector used in the jet finding procedure (ex: when find jets with 
/// non calibrated "EM scale" clusters).
/// This classes allow to retrieve the expected scale of the constituents automatically.
/// 2 classes are defined for this.
/// JetConstituentVector : an object behaving like a vector<const IParticle*>. It "contains" actually
...
namespace xAOD {
  ...
  /// 
  /// Beside being a 4-vector this object also provides a few methods so 
  /// its interface is similar to IParticle.
  ...
  /// It provides iterator, and the usual function of vector<>
  /// 
  class JetConstituentVector {
