    ...
    struct AccessorMap_v1 {
      ...
      accessor( xAOD::JetAttribute::AttributeID moment ) {
        switch( moment ) {
          ...
          //JET_DEFINE_ATT_ACCESSOR( DRtoReco );
          ...
          //          JET_DEFINE_ATT_ACCESSOR( LowEtConstituentsFrac );
          JET_DEFINE_ATT_ACCESSOR( NegativeE );
          JET_DEFINE_ATT_ACCESSOR( NumTowers );
          //JET_DEFINE_ATT_ACCESSOR( Offset );
          //JET_DEFINE_ATT_ACCESSOR(OriginIndex);
          JET_DEFINE_ATT_ACCESSOR( SamplingMax );
          JET_DEFINE_ATT_ACCESSOR( Timing );
          // JET_DEFINE_ATT_ACCESSOR( TrackMF );
          // JET_DEFINE_ATT_ACCESSOR( TrackMFindex );
          // JET_DEFINE_ATT_ACCESSOR( TruthMF );
          // JET_DEFINE_ATT_ACCESSOR( TruthMFindex );
