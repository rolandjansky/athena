...
// $Id: TauJetAuxContainer_v1.h 602664 2014-06-19 14:20:50Z janus $
...
namespace xAOD {
  ...
  private:
    ...
    //std::vector< float > eIntermediateAxis;
    ...
    //std::vector< float > eTauEnergyScale;
    ...
    //std::vector< float > ePanTauEFlowRecProto;
    ...
    //std::vector< float > ePanTauEFlowRec;
    ...
    //std::vector< float > ePanTauCellBasedProto;
    ...
    //std::vector< float > ePanTauCellBased;
    ...
    //add the full set of common details variables
    ...
    // std::vector< float > ipSigLeadLooseTrk;
    // std::vector< float > etOverPtLeadLooseTrk;
    // std::vector< float > leadLooseTrkPt;
    // std::vector< float > chrgLooseTrk;
    ...
    // std::vector< float > nIsolLooseTrk;
...
CLASS_DEF( xAOD::TauJetAuxContainer_v1 , 1307768555 , 1 )
