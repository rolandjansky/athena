...
#ifndef XAODMUON_VERSIONS_MUONAUXCONTAINER_V4_H
#define XAODMUON_VERSIONS_MUONAUXCONTAINER_V4_H
...
namespace xAOD {
   ...
   /// @author Edward Moyse
   ///
   class MuonAuxContainer_v4 : public AuxContainerBase {
...
SG_BASE( xAOD::MuonAuxContainer_v4, xAOD::AuxContainerBase ); 
