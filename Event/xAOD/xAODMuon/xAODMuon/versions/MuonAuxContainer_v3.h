...
#ifndef XAODMUON_VERSIONS_MUONAUXCONTAINER_V3_H
#define XAODMUON_VERSIONS_MUONAUXCONTAINER_V3_H
...
namespace xAOD {
   ...
   /// @author Edward Moyse
   ///
   class MuonAuxContainer_v3 : public AuxContainerBase {
...
SG_BASE( xAOD::MuonAuxContainer_v3, xAOD::AuxContainerBase ); 
