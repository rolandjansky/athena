...
#ifndef XAODMUON_VERSIONS_MUONAUXCONTAINER_V2_H
#define XAODMUON_VERSIONS_MUONAUXCONTAINER_V2_H
...
namespace xAOD {
   ...
   /// @author Edward Moyse
   ///
   class MuonAuxContainer_v2 : public AuxContainerBase {
...
SG_BASE( xAOD::MuonAuxContainer_v2, xAOD::AuxContainerBase ); 
