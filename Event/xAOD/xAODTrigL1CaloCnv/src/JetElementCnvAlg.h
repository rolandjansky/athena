...
// $Id: JetElementCnvAlg.h 576328 2013-12-19 16:09:32Z morrisj $
...
namespace xAODMaker {
   /**
    *  @short Algorithm for creating xAOD::JetElement from an ESD
    *
    *         This algorithm can be used to create an xAOD JetElement container
    ...
    */
   class JetElementCnvAlg : public AthAlgorithm {
