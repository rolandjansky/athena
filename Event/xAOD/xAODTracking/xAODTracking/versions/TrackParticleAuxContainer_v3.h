...
// $Id: TrackParticleAuxContainer_v3.h 576255 2013-12-19 12:54:41Z emoyse $
#ifndef XAODTRACKING_VERSIONS_TRACKPARTICLEAUXCONTAINER_V3_H
#define XAODTRACKING_VERSIONS_TRACKPARTICLEAUXCONTAINER_V3_H
...
namespace xAOD {
   ...
   /// @author Edward Moyse
   ///
   class TrackParticleAuxContainer_v3 : public AuxContainerBase {
...
SG_BASE( xAOD::TrackParticleAuxContainer_v3, xAOD::AuxContainerBase );
