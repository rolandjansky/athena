...
// $Id: TrackParticleAuxContainer_v4.cxx  $
...
namespace xAOD {
   ...
   TrackParticleAuxContainer_v4::TrackParticleAuxContainer_v4()
      : AuxContainerBase() {
   ...
   void TrackParticleAuxContainer_v4::dump() const {
     std::cout<<" Dumping TrackParticleAuxContainer_v4"<<std::endl;
     std::cout<<"d0:";
   ...
   /// don't warrant creating a _v5 class yet.
   void TrackParticleAuxContainer_v4::toTransient() {
