#!/bin/sh
#
# art-description: Run NSW pile-up pre-mixing with Run 3 symmetric geometry, 25ns pile-up, MT output containers
# art-type: grid
# art-include: 21.0/Athena
# art-include: 21.3/Athena
# art-include: 21.9/Athena
# art-include: master/Athena
# art-output: NSW_premixing_MT.RDO.pool.root

DigiOutFileName="NSW_premixing_MT.RDO.pool.root"
