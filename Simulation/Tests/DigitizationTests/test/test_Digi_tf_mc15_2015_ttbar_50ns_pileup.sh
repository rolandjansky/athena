...
# art-type: grid
# art-output: mc15_2015_ttbar_50ns_pileup.RDO.pool.root

DigiOutFileName="mc15_2015_ttbar_50ns_pileup.RDO.pool.root"
...
--preInclude 'all:LArConfiguration/LArConfigRun2Old.py' 'HITtoRDO:Digitization/ForceUseOfPileUpTools.py,SimulationJobOptions/preInclude.PileUpBunchTrainsMC15_2015_50ns_Config1.py,RunDependentSimData/configLumi_run222510.py' \
--skipEvents 0
