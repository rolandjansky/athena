#!/bin/bash
#
# art-description: Run MC16 pile-up pre-mixing with 2016d geometry and conditions, 25ns pile-up
# art-type: grid
# art-include: 21.0/Athena
# art-include: 21.3/Athena
# art-include: 21.9/Athena
# art-include: master/Athena
# art-output: mc16d_premixing.RDO.pool.root

DigiOutFileName="mc16d_premixing.RDO.pool.root"
