...
StatusCode PixelRDOAnalysis::initialize() {
  ...
  CHECK(m_thistSvc->regHist(m_path + h_LVL1A->GetName(), h_LVL1A));
...
StatusCode PixelRDOAnalysis::execute() {
  ...
  // Sim Data
  const InDetSimDataCollection* simDataMapPixel(NULL);
