...
def addPileUpTrfArgs(parser):
    ...
    parser.add_argument('--inputLowPtMinbiasHitsFile', nargs='+', action='append',
    ...
    parser.add_argument('--inputHighPtMinbiasHitsFile', nargs='+', action='append',
                        type=argFactory(argHITSFile, io='input', executor=['EVNTtoRDO','HITtoRDO'], auxiliaryFile=True),
                        help='Input HITS file for high pT minimum bias pile-up sub-events', group='PileUp')
    parser.add_argument('--inputCavernHitsFile', nargs='+', action='append',
                        type=argFactory(argHITSFile, io='input', executor=['EVNTtoRDO','HITtoRDO'], auxiliaryFile=True),
