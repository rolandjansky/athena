...
void test(iFatras::IMultipleScatteringSampler& tool)
{
  ...
  assert ( (simtheta - 0.00244) < 0.0001 );
}

int main()
{

   std::cout << "ISF_FatrasTools/MultipleScatteringSamplerHighland_test.cxx \n";
   ISvcLocator* pSvcLoc;
   ...
   ToolHandle<iFatras::IMultipleScatteringSampler> tool("iFatras::MultipleScatteringSamplerHighland/TestMultipleScatteringSamplerHighland");
