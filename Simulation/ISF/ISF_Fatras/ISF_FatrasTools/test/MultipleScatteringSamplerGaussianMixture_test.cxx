...
void test(iFatras::IMultipleScatteringSampler& tool)
{
  ...
  assert ( (simtheta - (-0.000012)) < 0.0001 );
}

int main()
{

   std::cout << "ISF_FatrasTools/MultipleScatteringSamplerGaussianMixture_test.cxx \n";
   ISvcLocator* pSvcLoc;
   ...
   ToolHandle<iFatras::IMultipleScatteringSampler> tool("iFatras::MultipleScatteringSamplerGaussianMixture/TestMultipleScatteringSamplerGaussianMixture");
