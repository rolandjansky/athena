...
// $Id$
/**
 * @file ISF_FatrasEventTPCnv/test/PlanarClusterCnv_p1_test.cxx
             ...
             const iFatras::PlanarCluster& trans1)
{
  ...
  PlanarClusterCnv_p1 cnv (helpers.m_pix_id);
  iFatras::PlanarCluster_p1 pers;
  cnv.transToPers (&trans1, &pers, log);
  iFatras::PlanarCluster trans2 (helpers.m_pixel_ids[0],
                                 Amg::Vector2D(),
