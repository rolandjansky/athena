...
DECLARE_FACTORY_ENTRIES( ISF_Geant4Tools ) {
  ...
  DECLARE_NAMESPACE_TOOL ( G4UA::iGeant4 , TrackProcessorUserActionPassBackTool )
  DECLARE_NAMESPACE_TOOL ( G4UA::iGeant4 , TrackProcessorUserActionFullG4Tool   )
  DECLARE_NAMESPACE_TOOL ( iGeant4 , MCTruthUserAction        )
  DECLARE_NAMESPACE_TOOL ( G4UA::iGeant4 , MCTruthUserActionTool        )
