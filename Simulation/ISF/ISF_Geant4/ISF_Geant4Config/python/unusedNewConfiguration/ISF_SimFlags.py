...
class SimLayout(JobProperty):
    ...
    statusOn = True
    allowedTypes = ['str']
    StoredValue = 'ATLAS-GEO-18-01-00'
...
class RandomSvc(JobProperty):
    """Name of the Athena random number service to use, e.g. 'AtRanluxGenSvc' or 'AtRndmGenSvc'."""
    statusOn=True
    allowedTypes=['str']
    StoredValue = 'AtRndmGenSvc' #'AtRanluxGenSvc' #
