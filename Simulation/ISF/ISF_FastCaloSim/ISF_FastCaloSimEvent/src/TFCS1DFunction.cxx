...
void TFCS1DFunction::tmvaregression_training(int neurons, TTree *regTree, std::string weightfile, std::string outfilename)
{
  ...
  if(Use["MLP"])
    ...
    factory->BookMethod( TMVA::Types::kMLP, "MLP", Form("!H:!V:VerbosityLevel=Info:NeuronType=tanh:NCycles=20000:HiddenLayers=%i:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator",neurons) ); 
