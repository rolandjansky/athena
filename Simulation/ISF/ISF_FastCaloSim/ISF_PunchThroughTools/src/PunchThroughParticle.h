...
namespace ISF
{
  ...
  */
  ...
  public:
    ...
    void setNumParticlesPDF(std::shared_ptr<PDFcreator> pdf);                     //!< set the PDFcreator for the number of exit particles distribution
    ...
    void setExitEnergyPDF(std::shared_ptr<PDFcreator> pdf);                       //!< set the PDFcreator for the energy distribution
    void setExitDeltaThetaPDF(std::shared_ptr<PDFcreator> pdf);                   //!< set the PDFcreator for the deltaTheta distribution
    void setExitDeltaPhiPDF(std::shared_ptr<PDFcreator> pdf);                     //!< set the PDFcreator for the deltaPhi distribution
    void setMomDeltaThetaPDF(std::shared_ptr<PDFcreator> pdf);                    //!< set the PDFcreator for the momentumDeltaTheta distribution
    void setMomDeltaPhiPDF(std::shared_ptr<PDFcreator> pdf);                      //!< set the PDFcreator for the momentumDeltaPhi distribution
    ...
    inline std::shared_ptr<PDFcreator> getNumParticlesPDF()   { return move(m_pdfNumParticles); };    //!< distribution parameters for the number of particles
    inline std::shared_ptr<PDFcreator> getExitEnergyPDF()     { return move(m_pdfExitEnergy); };      //!< distribution parameters for the exit energy
    inline std::shared_ptr<PDFcreator> getExitDeltaThetaPDF() { return move(m_pdfExitDeltaTheta); };  //!< distribution parameters for the exit delta theta
    inline std::shared_ptr<PDFcreator> getExitDeltaPhiPDF()   { return move(m_pdfExitDeltaPhi); };    //!< distribution parameters for the exit delta phi
    inline std::shared_ptr<PDFcreator> getMomDeltaThetaPDF()  { return move(m_pdfMomDeltaTheta); };  //!< distribution parameters for the momentum delta theta
    inline std::shared_ptr<PDFcreator> getMomDeltaPhiPDF()    { return move(m_pdfMomDeltaPhi); };     //!< distribution parameters for the momentum delta phi
  ...
  private:
    ...
    std::shared_ptr<PDFcreator>                  m_pdfNumParticles;           //!< number of punch-through particles
    std::shared_ptr<PDFcreator>                  m_pdfExitEnergy;             //!< energy of punch-through particles
    std::shared_ptr<PDFcreator>                  m_pdfExitDeltaTheta;         //!< theta deviation of punch-through particles
    std::shared_ptr<PDFcreator>                  m_pdfExitDeltaPhi;           //!< phi deviation of punch-through particles
    std::shared_ptr<PDFcreator>                  m_pdfMomDeltaTheta;          //!< delta theta angle of punch-through particle momentum
    std::shared_ptr<PDFcreator>                  m_pdfMomDeltaPhi;            //!< delta phi angle of punch-through particle momentum
  };
}
