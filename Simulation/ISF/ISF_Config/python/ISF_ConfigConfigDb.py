...
addAlgorithm("ISF_Config.ISF_MainConfig.getKernel_ATLFASTIIF_newExtrapolation_ID",          "ISF_Kernel_ATLFASTIIF_newExtrapolation_ID")
...
addAlgorithm("ISF_Config.ISF_MainConfig.getKernel_ATLFASTIIHS_FastPileup",     "ISF_Kernel_ATLFASTIIHS_FastPileup")
