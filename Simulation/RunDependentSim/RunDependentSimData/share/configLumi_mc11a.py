####################
## File configLumi_mc11a.py MERGED FROM runs 180164,183003,185649,(185731==DUMMY FOR PERIOD X)
## Represents runs from period A-D,E-H,I, and X
## Created on Wed Jul 27 16:58:43 2011
####################
...
JobMaker=[
   {'run':180164, 'lb':67, 'starttstamp':1303554669, 'dt':0.000, 'evts':_evts(80), 'mu':6.750, 'force_new':False},
   {'run':180164, 'lb':68, 'starttstamp':1303554730, 'dt':0.000, 'evts':_evts(137), 'mu':4.250, 'force_new':False},
   {'run':180164, 'lb':69, 'starttstamp':1303554791, 'dt':0.000, 'evts':_evts(185), 'mu':4.750, 'force_new':False},
   {'run':180164, 'lb':70, 'starttstamp':1303554852, 'dt':0.000, 'evts':_evts(30), 'mu':3.750, 'force_new':False},
   {'run':180164, 'lb':71, 'starttstamp':1303554913, 'dt':0.000, 'evts':_evts(249), 'mu':5.250, 'force_new':False},
   {'run':180164, 'lb':73, 'starttstamp':1303555035, 'dt':0.000, 'evts':_evts(228), 'mu':5.750, 'force_new':False},
   {'run':180164, 'lb':74, 'starttstamp':1303555062, 'dt':0.000, 'evts':_evts(5), 'mu':7.750, 'force_new':False},
   {'run':180164, 'lb':75, 'starttstamp':1303555090, 'dt':0.000, 'evts':_evts(169), 'mu':6.250, 'force_new':False},
   {'run':180164, 'lb':76, 'starttstamp':1303555151, 'dt':0.000, 'evts':_evts(17), 'mu':7.250, 'force_new':False},
   {'run':183003, 'lb':177, 'starttstamp':1306973316, 'dt':0.000, 'evts':_evts(713), 'mu':6.750, 'force_new':False},
   {'run':183003, 'lb':178, 'starttstamp':1306973377, 'dt':0.000, 'evts':_evts(662), 'mu':4.250, 'force_new':False},
   {'run':183003, 'lb':179, 'starttstamp':1306973438, 'dt':0.000, 'evts':_evts(834), 'mu':4.750, 'force_new':False},
   {'run':183003, 'lb':180, 'starttstamp':1306973499, 'dt':0.000, 'evts':_evts(225), 'mu':3.750, 'force_new':False},
   {'run':183003, 'lb':181, 'starttstamp':1306973560, 'dt':0.000, 'evts':_evts(1181), 'mu':5.750, 'force_new':False},
   {'run':183003, 'lb':182, 'starttstamp':1306973621, 'dt':0.000, 'evts':_evts(1032), 'mu':6.250, 'force_new':False},
   {'run':183003, 'lb':183, 'starttstamp':1306973682, 'dt':0.000, 'evts':_evts(43), 'mu':3.250, 'force_new':False},
   {'run':183003, 'lb':184, 'starttstamp':1306973743, 'dt':0.000, 'evts':_evts(5), 'mu':8.250, 'force_new':False},
   {'run':183003, 'lb':185, 'starttstamp':1306973779, 'dt':0.000, 'evts':_evts(100), 'mu':7.750, 'force_new':False},
   {'run':183003, 'lb':186, 'starttstamp':1306973840, 'dt':0.000, 'evts':_evts(317), 'mu':7.250, 'force_new':False},
   {'run':183003, 'lb':187, 'starttstamp':1306973901, 'dt':0.000, 'evts':_evts(1087), 'mu':5.250, 'force_new':False},
   {'run':185649, 'lb':52, 'starttstamp':1310870414, 'dt':0.000, 'evts':_evts(3), 'mu':2.250, 'force_new':False},
   {'run':185649, 'lb':55, 'starttstamp':1310870574, 'dt':0.000, 'evts':_evts(27), 'mu':2.750, 'force_new':False},
   {'run':185649, 'lb':56, 'starttstamp':1310870635, 'dt':0.000, 'evts':_evts(150), 'mu':6.750, 'force_new':False},
   {'run':185649, 'lb':57, 'starttstamp':1310870696, 'dt':0.000, 'evts':_evts(222), 'mu':4.250, 'force_new':False},
   {'run':185649, 'lb':58, 'starttstamp':1310870757, 'dt':0.000, 'evts':_evts(110), 'mu':3.750, 'force_new':False},
   {'run':185649, 'lb':59, 'starttstamp':1310870818, 'dt':0.000, 'evts':_evts(251), 'mu':5.750, 'force_new':False},
   {'run':185649, 'lb':63, 'starttstamp':1310871062, 'dt':0.000, 'evts':_evts(209), 'mu':6.250, 'force_new':False},
   {'run':185649, 'lb':64, 'starttstamp':1310871123, 'dt':0.000, 'evts':_evts(63), 'mu':3.250, 'force_new':False},
   {'run':185649, 'lb':65, 'starttstamp':1310871184, 'dt':0.000, 'evts':_evts(26), 'mu':8.250, 'force_new':False},
   {'run':185649, 'lb':66, 'starttstamp':1310871245, 'dt':0.000, 'evts':_evts(113), 'mu':7.750, 'force_new':False},
   {'run':185649, 'lb':67, 'starttstamp':1310871306, 'dt':0.000, 'evts':_evts(184), 'mu':5.250, 'force_new':False},
   {'run':185649, 'lb':68, 'starttstamp':1310871349, 'dt':0.000, 'evts':_evts(101), 'mu':7.250, 'force_new':False},
   {'run':185649, 'lb':69, 'starttstamp':1310871410, 'dt':0.000, 'evts':_evts(242), 'mu':4.750, 'force_new':False},
