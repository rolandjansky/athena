...
G4CosmicFilter::G4CosmicFilter(const std::string& type, const std::string& name, const IInterface* parent): UserActionBase(type,name,parent),m_storeGate(0),m_ntot(0),m_npass(0),m_PDGId(0),m_volumeName("CaloEntryLayer"),m_ptMin(-1),m_ptMax(-1){
