...
# Gluino R-glueball
        1000993 : [ 1000021 , False , '~g_glueball ' ,  0 , 0.700 , 0.699 , 0.699 , 0.699 , 0.699 , 0.699 , 0.699 , 0.699 , 0.699 ] ,
...
# Charm Gluino R-mesons
        ...
        1009423 : [ 1000021 ,  True , '~g_D*0      ' ,  0 , 2.000 , 1.954 , 1.863 , 2.078 , 0.000 , 2.073 , 1.863 , 2.078 , 0.000 ] ,
        1009433 : [ 1000021 ,  True , '~g_D*s+     ' ,  1 , 2.200 , 2.103 , 2.043 , 2.255 , 0.000 , 2.235 , 2.043 , 2.255 , 0.000 ] ,
# Bottom Gluino R-mesons
        1009513 : [ 1000021 ,  True , '~g_B*0      ' ,  0 , 2.000 , 5.317 , 5.224 , 5.367 , 0.000 , 5.367 , 5.224 , 5.367 , 0.000 ] ,
        1009523 : [ 1000021 ,  True , '~g_B*+      ' ,  1 , 2.000 , 5.317 , 5.224 , 5.367 , 0.000 , 5.367 , 5.224 , 5.367 , 0.000 ] ,
        1009533 : [ 1000021 ,  True , '~g_B*s0     ' ,  0 , 2.200 , 5.465 , 5.421 , 5.541 , 0.000 , 5.532 , 5.421 , 5.541 , 0.000 ] ,
        1009543 : [ 1000021 ,  True , '~g_B*c+     ' ,  1 , 2.200 , 6.630 , 6.550 , 6.710 , 0.000 , 6.700 , 6.550 , 6.710 , 0.000 ] ,
...
# Sbottom R-mesons
         : [ 1000005 , True , "$R^{0}_{#tilde{b}#bar{d}}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{-}_{#tilde{b}#bar{u}}$" , -1 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{0}_{#tilde{b}#bar{s}}$" ,  0 , 0.465 , 0.418 , 0.539 , 0.000 , 0.530 , 0.418 , 0.539 , 0.000 ] ,
         : [ 1000005 , True , "$R^{-}_{#tilde{b}#bar{c}}$" , -1 , 1.630 , 1.550 , 1.710 , 0.000 , 1.699 , 1.550 , 1.710 , 0.000 ] ,
         : [ 1000005 , True , "$R^{0}_{#tilde{b}#bar{b}}$" ,  0 , 5.000 , 5.000 , 5.000 , 0.000 , 5.000 , 5.000 , 5.000 , 0.000 ] ,
# Sbottom R-baryons
         : [ 1000005 , True , "$R^{-}_{#tilde{b}dd}$" , -1 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{0}_{#tilde{b}ud}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{+}_{#tilde{b}uu}$" ,  1 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{-}_{#tilde{b}ds}$" , -1 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{0}_{#tilde{b}us}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000005 , True , "$R^{-}_{#tilde{b}ss}$" , -1 , 0.465 , 0.418 , 0.539 , 0.000 , 0.530 , 0.418 , 0.539 , 0.000 ] ,
# Stop R-mesons
         : [ 1000006 , True , "$R^{+}_{#tilde{t}#bar{d}}$" ,  1 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{0}_{#tilde{t}#bar{u}}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.000 , 0.364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{+}_{#tilde{t}#bar{s}}$" ,  1 , 0.465 , 0.418 , 0.539 , 0.000 , 0.530 , 0.418 , 0.539 , 0.000 ] ,
         : [ 1000006 , True , "$R^{0}_{#tilde{t}#bar{c}}$" ,  0 , 1.630 , 1.550 , 1.710 , 0.000 , 1.699 , 1.550 , 1.710 , 0.000 ] ,
         : [ 1000006 , True , "$R^{+}_{#tilde{t}#bar{b}}$" ,  1 , 5.000 , 5.000 , 5.000 , 0.000 , 5.000 , 5.000 , 5.000 , 0.000 ] ,
# Stop R-baryons
         : [ 1000006 , True , "$R^{0}_{#tilde{t}dd}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.0 , 364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{+}_{#tilde{t}ud}$" ,  1 , 0.313 , 0.219 , 0.364 , 0.0 , 364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{++}_{#tilde{t}uu}$" ,  2 , 0.313 , 0.219 , 0.364 , 0.0 , 364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{0}_{#tilde{t}sd}$" ,  0 , 0.313 , 0.219 , 0.364 , 0.0 , 364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{+}_{#tilde{t}su}$" ,  1 , 0.313 , 0.219 , 0.364 , 0.0 , 364 , 0.219 , 0.364 , 0.000 ] ,
         : [ 1000006 , True , "$R^{0}_{#tilde{t}ss}$" ,  0 , 0.465 , 0.418 , 0.539 , 0.0 , 530 , 0.418 , 0.539 , 0.000 ] ,
