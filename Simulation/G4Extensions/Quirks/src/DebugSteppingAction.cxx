...
#else
    FADS::UserAction("DebugSteppingAction"),
#endif
...
void DebugSteppingAction::SteppingAction(const G4Step* step) {
    ...
    m_xprev[i] = m_x[i];
    m_x[i] = G4LorentzVector(ps->GetPosition(), c_light * ps->GetGlobalTime());
