  ...
  m_truthCollKey("TruthEvent")
{
  ...
  declareProperty("McEventCollectionKey", m_outputMcEventCollectionKey);
...
StatusCode NewMergeMcEventCollTool::initialize()
{
  ...
  ATH_CHECK( m_outputMcEventCollectionKey.initialize() );
...
StatusCode NewMergeMcEventCollTool::prepareEvent(unsigned int nInputEvents)
{
  ...
  if (!m_outputMcEventCollection.isValid()) {
    ...
    m_outputMcEventCollection = SG::makeHandle(m_outputMcEventCollectionKey);
...
StatusCode NewMergeMcEventCollTool::processAllSubEvents()
{
  ...
  SG::WriteHandle<McEventCollection> outputMcEventCollection(m_outputMcEventCollectionKey);
