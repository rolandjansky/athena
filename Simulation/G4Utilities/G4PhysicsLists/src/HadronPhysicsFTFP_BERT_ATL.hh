...
//----------------------------------------------------------------------------
//
#ifndef HadronPhysicsFTFP_BERT_ATL_h
#define HadronPhysicsFTFP_BERT_ATL_h 1
...
class HadronPhysicsFTFP_BERT_ATL : public G4VPhysicsConstructor
{
  public: 
    HadronPhysicsFTFP_BERT_ATL(G4int verbose =1);
    HadronPhysicsFTFP_BERT_ATL(const G4String& name, G4bool quasiElastic=false);
    virtual ~HadronPhysicsFTFP_BERT_ATL();
