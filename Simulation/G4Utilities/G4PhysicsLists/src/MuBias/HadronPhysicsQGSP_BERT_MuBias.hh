...
//----------------------------------------------------------------------------
//
#ifndef HadronPhysicsQGSP_BERT_MuBias_h
#define HadronPhysicsQGSP_BERT_MuBias_h 1
...
class HadronPhysicsQGSP_BERT_MuBias : public G4VPhysicsConstructor
{
  public: 
    HadronPhysicsQGSP_BERT_MuBias(G4int verbose =1);
    HadronPhysicsQGSP_BERT_MuBias(const G4String& name, G4bool quasiElastic=true);
    virtual ~HadronPhysicsQGSP_BERT_MuBias();
