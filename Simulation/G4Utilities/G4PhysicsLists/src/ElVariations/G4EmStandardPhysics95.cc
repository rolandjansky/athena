...
// ********************************************************************
//
// $Id: G4EmStandardPhysics95.cc,v 1.24 2010-10-10 15:18:34 vnivanch Exp $
...
#include "G4EmStandardPhysics95.hh"
...
G4EmStandardPhysics95::G4EmStandardPhysics95(G4int ver)
...
G4EmStandardPhysics95::G4EmStandardPhysics95(G4int ver, const G4String&)
  : G4VPhysicsConstructor("G4EmStandard"), verbose(ver)
{
  G4LossTableManager::Instance();
}
...
G4EmStandardPhysics95::~G4EmStandardPhysics95()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardPhysics95::ConstructParticle()
{
// gamma
  G4Gamma::Gamma();
...
void G4EmStandardPhysics95::ConstructProcess()
{
