...
// ********************************************************************
//
// $Id: G4HadronPhysicsFTFP_BERP_ATL.cc 83699 2014-09-10 07:18:25Z gcosmo $
//
//---------------------------------------------------------------------------
...
#include "G4HadronPhysicsFTFP_BERP_ATL.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsFTFP_BERP_ATL);

G4HadronPhysicsFTFP_BERP_ATL::G4HadronPhysicsFTFP_BERP_ATL(G4int)
...
G4HadronPhysicsFTFP_BERP_ATL::G4HadronPhysicsFTFP_BERP_ATL(const G4String& name, G4bool quasiElastic)
...
void G4HadronPhysicsFTFP_BERP_ATL::CreateModels()
{
...
G4HadronPhysicsFTFP_BERP_ATL::~G4HadronPhysicsFTFP_BERP_ATL()
{
...
void G4HadronPhysicsFTFP_BERP_ATL::ConstructParticle()
{
