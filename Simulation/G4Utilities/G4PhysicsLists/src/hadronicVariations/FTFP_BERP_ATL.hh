...
//----------------------------------------------------------------------------
//
#ifndef TFTFP_BERP_ATL_h
#define TFTFP_BERP_ATL_h 1
...
template<class T>
class TFTFP_BERP_ATL: public T
{
public:
  TFTFP_BERP_ATL(G4int ver = 1);
  virtual ~TFTFP_BERP_ATL();
...
#include "FTFP_BERP_ATL.icc"
typedef TFTFP_BERP_ATL<G4VModularPhysicsList> FTFP_BERP_ATL;
