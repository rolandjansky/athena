...
//----------------------------------------------------------------------------
//
#ifndef TFTFP_BERT_ATL_HP_h
#define TFTFP_BERT_ATL_HP_h 1
...
template<class T>
class TFTFP_BERT_ATL_HP: public T
{
public:
  TFTFP_BERT_ATL_HP(G4int ver = 1);
  virtual ~TFTFP_BERT_ATL_HP();
...
#include "FTFP_BERT_ATL_HP.icc"
typedef TFTFP_BERT_ATL_HP<G4VModularPhysicsList> FTFP_BERT_ATL_HP;
