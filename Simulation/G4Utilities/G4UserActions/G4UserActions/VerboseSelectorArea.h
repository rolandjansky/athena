...
class VerboseSelectorArea: public FADS::ActionsBase , public FADS::UserAction {

  public:
   VerboseSelectorArea(std::string s): FADS::ActionsBase(s), FADS::UserAction(s), m_Event(0),m_verb(0),
