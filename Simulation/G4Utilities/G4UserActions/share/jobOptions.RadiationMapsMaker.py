...
# radmaptool.Materials          = [] # if left empty all materials are used (default)
# radmaptool.ActivationFileName = "" # name of ASCII file to write activations too (if left empty no activations are written)
