...
digitizationFlags.numberOfCavern=1 # added every bunch crossing
digitizationFlags.numberOfLowPtMinBias=3.45 # only added for filled bunch crossings
...
digitizationFlags.BeamIntensityPattern = [0.0,1.0,0.0]
