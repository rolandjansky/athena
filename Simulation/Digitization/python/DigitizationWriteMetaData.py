...
def ModifyingEventIdBySvc():
    ...
    if digitizationFlags.RunAndLumiOverrideList.statusOn or digitizationFlags.dataRunNumber.statusOn:
        ...
        logDigitizationWriteMetadata.debug('digitizationFlags.RunAndLumiOverrideList not set, \
...
def writeDigitizationMetadata():
    ...
    conddb.addFolder("",folder+"<db>sqlite://;schema=DigitParams.db;dbname=DIGPARAM</db>", className = 'AthenaAttributeList')
    from AthenaCommon.AppMgr import ServiceMgr
