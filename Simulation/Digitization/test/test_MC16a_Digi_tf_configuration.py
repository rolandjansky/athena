...
class TestDigitizationMC16a(unittest.TestCase):
    ...
    def test___MergeTruthJetsTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'LastXing', 'UserStore']
    ...
    def test___BCM_DigitizationTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'EffDistanceParam', 'EffSharpnessParam', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'HitCollName', 'LastXing', 'MIPDeposit', 'ModNoise', 'ModSignal', 'NinoThr', 'RndmSvc', 'TimeDelay', 'UseMcEventCollectionHelper', 'UserStore']
    ...
    def test___SignalOnlyMcEventCollTool_properties(self):
        ...
        expected_property_list = ['KeepUnstable', 'SaveInTimeMinBias', 'AddBackgroundCollisionVertices', 'zRange', 'TruthCollKey', 'UserStore', 'OnlySaveSignalTruth', 'OutOfTimeAbsEtaMax', 'rRange', 'CompressOutputCollection', 'ExtraOutputs', 'AbsEtaMax', 'LastXing', 'SaveOutOfTimeMinBias', 'ExtraInputs', 'DetStore', 'SaveCavernBackground', 'FirstXing', 'SaveRestOfMinBias', 'EvtStore', 'HighTimeToKeep', 'LowTimeToKeep']
    ...
    def test___PixelDigitizationTool_properties(self):
        ...
        expected_property_list = ['ApplyDupli', 'DetStore', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'HardScatterSplittingMode', 'InputObjectName', 'LVL1Latency', 'LastXing', 'LowTOTduplication', 'MergeSvc', 'OfflineCalibSvc', 'PixelCablingSvc', 'PixelCalibSvc', 'PixelConditionsSummarySvc', 'PixelTools', 'RndmEngine', 'RndmSvc', 'SpecialPixelMapSvc', 'SurfaceChargesTool', 'TimeSvc', 'ToTMinCut', 'UserStore']
    ...
    def test___SCT_DigitizationTool_properties(self):
        ...
        expected_property_list = ['BarrelOnly', 'DetStore', 'EnableHits', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'FrontEnd', 'HardScatterSplittingMode', 'InputObjectName', 'LastXing', 'MergeSvc', 'OutputObjectName', 'OutputSDOName', 'RndmSvc', 'SurfaceChargesGenerator', 'UserStore']
    ...
    def test___LArPileUpTool_properties(self):
        ...
        expected_property_list = ['ADC2MeVTool', 'AutoCorrNoiseTool', 'BadChannelTool', 'DetStore', 'DigitContainer', 'DoDigiTruthReconstruction', 'EmBarrelHitContainerName', 'EmEndCapHitContainerName', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'ForWardHitContainerName', 'HecHitContainerName', 'HighGainThreshFCAL', 'LastXing', 'MaskingTool', 'NoiseOnOff', 'Nsamples', 'RndmEvtOverlay', 'RndmSvc', 'TriggerTimeToolName', 'UserStore', 'firstSample', 'useLArFloat']
    ...
    def test___TileHitVecToCntTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'DoHSTruthReconstruction', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'LastXing', 'PileUp', 'RndmSvc', 'TileHitContainer', 'TileHitContainer_DigiHSTruth', 'TileHitVectors', 'TileInfoName', 'TriggerTimeTool', 'UserStore']
    ...
    def test___CscDigitizationTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'DriftVelocity', 'ElectronEnergy', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'InputObjectName', 'LastXing', 'NewDigitEDM', 'OutputObjectName', 'RndmEngine', 'RndmSvc', 'UseMcEventCollectionHelper', 'UserStore', 'WindowLowerOffset', 'WindowUpperOffset', 'amplification', 'cscCalibTool', 'isPileUp', 'pedestal']
    ...
    def test___MdtDigitizationTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'DigitizationTool', 'DiscardEarlyHits', 'DoQballCharge', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'LastXing', 'MDTCondSummarySvc', 'MaskedStations', 'MdtCalibrationDbSvc', 'RndmEngine', 'RndmSvc', 'TwinRndmEngine', 'TwinRndmSvc', 'UseDeadChamberSvc', 'UseMcEventCollectionHelper', 'UseTof', 'UserStore']
    ...
    def test___TgcDigitizationTool_properties(self):
        ...
        expected_property_list = ['DetStore', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FirstXing', 'LastXing', 'RndmEngine', 'RndmSvc', 'UseMcEventCollectionHelper', 'UserStore']
