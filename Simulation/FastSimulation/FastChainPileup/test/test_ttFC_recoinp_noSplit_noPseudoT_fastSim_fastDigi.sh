...
# RDO input from test_ttFC_reco_noSplit_noPseudoT_fastSim_fastDigi.sh
FastChain_tf.py --maxEvents 500 \
    --skipEvents 0 \
    --geometryVersion ATLAS-R2-2015-03-01-00 \
    --conditionsTag OFLCOND-RUN12-SDR-31 \
    --inputRDOFile '/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/FastChainPileup/RDO_pileup_fastsim_fastdigi.pool.root' \
