# Minimal configuration file to describe dark sector LSP (2TeV mass) to G4
...
# patching PDGTABLE
get_and_fix_PDGTABLE([ (3000015, 2000., 'DarkSector_LSP', '0') ])

if doG4SimConfig:
    from G4AtlasApps.SimFlags import simFlags
    simFlags.PhysicsOptions += ['DarkSectorPhysicsTool']
