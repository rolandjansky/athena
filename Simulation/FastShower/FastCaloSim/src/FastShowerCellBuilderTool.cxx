...
bool FastShowerCellBuilderTool::Is_EM_Vertex(HepMC::ConstGenVertexPtr ver) 
{
  if(ver) {
#ifdef HEPMC3
...
FastShowerCellBuilderTool::flag_simul_sate FastShowerCellBuilderTool::Is_below_v14_truth_cuts_Vertex(HepMC::ConstGenVertexPtr ver) 
{
  if(ver) {
    int nin=0;
    int id_in=0;
