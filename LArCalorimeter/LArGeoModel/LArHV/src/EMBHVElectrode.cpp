...
EMBHVElectrode::EMBHVElectrode(EMBHVModuleConstLink module, unsigned int iElectrode) :c(new Clockwork) 
{
  c->module=&*module;
...
{
  return c->module->getPhiMin()+c->iElectrode*2.0*M_PI/1024.0;
}

//##ModelId=47AB8993017C
bool EMBHVElectrode::hvOn(int iGap) const
{
  EMBHVPayload *payload = c->module->getManager()->getPayload(*this);
