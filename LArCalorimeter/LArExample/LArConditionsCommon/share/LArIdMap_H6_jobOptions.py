include.block("LArConditionsCommon/LArIdMap_H6_jobOptions.py")

#####################################################################
# Job options file to read Id mapping for LAr H6 2004 Beam test setup
...
ServiceMgr.CondProxyProvider.InputCollections += ["LFN:tbcond.000004.conditions.recon.pool.v0000._0001.pool.root"]
