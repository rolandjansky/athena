...
larRODFlags.NumberOfCollisions.set_Value_and_Lock(60) # Run-2 default
...
if jobproperties.Beam.numberOfCollisions() != 60:
   from AthenaCommon.Logging import logging
   mlog = logging.getLogger ('SetLArConfigRun3')
   mlog.error("Beam.numberOfCollisions %f different from what is expected for Run3 digi/reco ", jobproperties.Beam.numberOfCollisions) 
