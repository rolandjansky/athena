...
#ifndef FCALFastShower_h
#define FCALFastShower_h
...
class FCALFastShower: public LArFastShower
{
 public:

  FCALFastShower(G4String);                    //!< Default constructor
  virtual ~FCALFastShower() {}
