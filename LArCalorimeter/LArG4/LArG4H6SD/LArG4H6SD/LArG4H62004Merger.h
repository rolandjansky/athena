...
// LArG4H62004Merger class used by LArG4SD and FastSimulation to merge
// LArHits in the same time bins

#ifndef __LArG4H62004Merger_H__
#define __LArG4H62004Merger_H__
...
class LArG4H62004Merger : public LArVHitMerger
{
public:

  // Constructors and destructors.
  LArG4H62004Merger(StoreGateSvc* detStore,
	       G4float timeBinWidth);

  virtual ~LArG4H62004Merger();
