...
//   unsigned int totNbOfSweet2 = 0;
  ...
  //sweets cell only for raw data, not calibrations
...
unsigned int LArCalibPedMonAlgREN::returnPartition(int be,int pn,int ft,int sl) const {
...
void LArCalibPedMonAlgREN::fillErrorsSummary(unsigned int partitNb_2,int ft,int slot,uint16_t error, bool lar_inerror, std::bitset<13> &rejectionBits, bool &currentFebStatus, bool &eventRejected) const
{    
