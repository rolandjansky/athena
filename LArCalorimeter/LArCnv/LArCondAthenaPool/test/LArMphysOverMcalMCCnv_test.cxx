...
*/
/**
 * @file LArCondAthenaPool/test/LArMphysOverMcalMCCnv_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArMphysOverMcalMCCnv (partial).
 */


#undef NDEBUG
#include "../src/LArMphysOverMcalMCCnv.cxx"
...
typedef LArConditionsSubset<LArMphysOverMcalP>      OldType;
typedef LArConditionsSubset<LArSingleFloatP> NewType;
const size_t nfeb = 10;


class TestCnv
  : public LArMphysOverMcalMCCnv
{
public:
  using LArMphysOverMcalMCCnv::LArMphysOverMcalMCCnv;
  using LArMphysOverMcalMCCnv::createTransient;
};
...
void checkPayload (int x, const NewType::Payload& newPayload)
{
  ...
  assert (oldPayload.m_MphysOverMcal == newPayload.m_data);
}
...
int main()
{
  ...
  std::cout << "LArCondAthenaPool/LArMphysOverMcalMCCnv_test\n";
  test1 (svcloc);
  return 0;
}
