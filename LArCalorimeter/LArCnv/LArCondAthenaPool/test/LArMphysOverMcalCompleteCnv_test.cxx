...
*/
/**
 * @file LArCondAthenaPool/test/LArMphysOverMcalCompleteCnv_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArMphysOverMcalCompleteCnv (partial).
 */


#undef NDEBUG
#include "../src/LArMphysOverMcalCompleteCnv.cxx"
...
class TestCnv
  : public LArMphysOverMcalCompleteCnv
{
public:
  using LArMphysOverMcalCompleteCnv::LArMphysOverMcalCompleteCnv;
  using LArMphysOverMcalCompleteCnv::createTransient;
};
...
int main()
{
  ...
  std::cout << "LArCondAthenaPool/LArMphysOverMcalCompleteCnv_test\n";
  test1 (svcloc);
  return 0;
}
