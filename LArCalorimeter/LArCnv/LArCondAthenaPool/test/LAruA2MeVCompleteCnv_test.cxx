...
*/
/**
 * @file LArCondAthenaPool/test/LAruA2MeVCompleteCnv_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LAruA2MeVCompleteCnv (partial).
 */


#undef NDEBUG
#include "../src/LAruA2MeVCompleteCnv.cxx"
...
typedef LArConditionsSubset<LAruA2MeVP>      OldType;
typedef LArConditionsSubset<LArSingleFloatP> NewType;
const size_t nfeb = 10;


class TestCnv
  : public LAruA2MeVCompleteCnv
{
public:
  using LAruA2MeVCompleteCnv::LAruA2MeVCompleteCnv;
  using LAruA2MeVCompleteCnv::createTransient;
};
...
void checkPayload (int x, const NewType::Payload& newPayload)
{
  ...
  assert (oldPayload.m_uA2MeV == newPayload.m_data);
}
...
int main()
{
  ...
  std::cout << "LArCondAthenaPool/LAruA2MeVCompleteCnv_test\n";
  test1 (svcloc);
  return 0;
}
