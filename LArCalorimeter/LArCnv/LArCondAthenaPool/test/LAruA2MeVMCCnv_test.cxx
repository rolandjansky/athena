...
*/
/**
 * @file LArCondAthenaPool/test/LAruA2MeVMCCnv_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LAruA2MeVMCCnv (partial).
 */


#undef NDEBUG
#include "../src/LAruA2MeVMCCnv.cxx"
...
class TestCnv
  : public LAruA2MeVMCCnv
{
public:
  using LAruA2MeVMCCnv::LAruA2MeVMCCnv;
  using LAruA2MeVMCCnv::createTransient;
};
...
int main()
{
  ...
  std::cout << "LArCondAthenaPool/LAruA2MeVMCCnv_test\n";
  test1 (svcloc);
  return 0;
}
