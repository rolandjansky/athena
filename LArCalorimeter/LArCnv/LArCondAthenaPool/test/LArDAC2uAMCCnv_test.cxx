...
*/
/**
 * @file LArCondAthenaPool/test/LArDAC2uAMCCnv_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArDAC2uAMCCnv (partial).
 */


#undef NDEBUG
#include "../src/LArDAC2uAMCCnv.cxx"
...
class TestCnv
  : public LArDAC2uAMCCnv
{
public:
  using LArDAC2uAMCCnv::LArDAC2uAMCCnv;
  using LArDAC2uAMCCnv::createTransient;
};
...
int main()
{
  ...
  std::cout << "LArCondAthenaPool/LArDAC2uAMCCnv_test\n";
  test1 (svcloc);
  return 0;
}
