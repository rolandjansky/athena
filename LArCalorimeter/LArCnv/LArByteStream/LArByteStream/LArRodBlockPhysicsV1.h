...
class LArRodBlockPhysicsV1 : public LArRodBlockStructure
{
public:
  // constructor
...
inline int LArRodBlockPhysicsV1::getNextEnergy(int& channelNumber,int32_t& energy,int32_t& time,int32_t& quality, uint32_t& gain)
{
