...
*/
/**
 * @file LArCondTPCnv/test/LArOFCBinSubsetCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArOFCBinSubsetCnv_p1.
 */
...
typedef LArConditionsSubset<LArOFCBinP> TransType;


void compare (const LArOFCBinP& p1,
              const LArOFCBinP& p2)
{
  assert (p1.m_bin == p2.m_bin);
}
...
void testit (const TransType& trans1)
{
  ...
  LArOFCBinSubsetCnv_p1 cnv;
  LArSingleIntSubset_p1 pers;
...
LArOFCBinP makePayload (int x)
{
  return LArOFCBinP (x);
}


typedef LArOFCBinP payloadMaker_t (int x);
...
{
  std::cout << "LArCondTPCnv/LArOFCBinSubsetCnv_p1_test\n";
  test1();
  return 0;
}
