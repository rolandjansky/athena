...
*/
/**
 * @file LArCondTPCnv/test/LArShapeSubsetCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArShapeSubsetCnv_p1.
 */
...
typedef LArConditionsSubset<LArShapeP1> TransType;


void compare (const LArShapeP1& p1,
              const LArShapeP1& p2)
{
  assert (p1.m_vShape == p2.m_vShape);
  assert (p1.m_vShapeDer == p2.m_vShapeDer);
}
...
void testit (const TransType& trans1)
{
  ...
  LArShapeSubsetCnv_p1 cnv;
  LArShapeSubset_p1 pers;
...
LArShapeP1 makePayload (int x)
{
  ...
  return LArShapeP1 (v1, v2);
}


LArShapeP1 makeEmpty (int)
{
  return LArShapeP1();
}


typedef LArShapeP1 payloadMaker_t (int x);
...
{
  std::cout << "LArCondTPCnv/LArShapeSubsetCnv_p1_test\n";
  test1();
  return 0;
}
