...
*/
/**
 * @file LArCondTPCnv/test/LArSingleFloatSubsetCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArSingleFloatSubsetCnv_p1.
 */
...
void testit (const TransType& trans1)
{
  ...
  LArSingleFloatSubsetCnv_p1 cnv;
  LArSingleFloatSubset_p1 pers;
...
{
  std::cout << "LArCondTPCnv/LArSingleFloatSubsetCnv_p1_test\n";
  test1();
  return 0;
}
