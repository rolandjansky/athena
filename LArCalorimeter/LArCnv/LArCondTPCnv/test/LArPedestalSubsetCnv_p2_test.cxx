...
*/
/**
 * @file LArCondTPCnv/test/LArPedestalSubsetCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArPedestalSubsetCnv_p2.
 */
...
void testit (const TransType& trans1)
{
  ...
  LArPedestalSubsetCnv_p2 cnv;
  LArPedestalSubset_p2 pers;
...
typedef LArPedestalP1 payloadMaker_t (int x);
...
{
  std::cout << "LArCondTPCnv/LArPedestalSubsetCnv_p2_test\n";
  test1();
  return 0;
}
