...
class HECNoiseD3PDMaker(PyAthena.Alg):
    ...
    def initialize(self):
        ...
        self.detStore = PyAthena.StoreGate.pointer("DetectorStore")
        self.LArOID = self.detStore.retrieve("LArOnlineID","LArOnlineID")
        ...
        self.hectree.Branch("iOID",self.iOID,"iOID/I");
