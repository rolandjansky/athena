...
LArShapeCompleteMakerAlg::LArShapeCompleteMakerAlg(const std::string & name, ISvcLocator * pSvcLocator) : 
...
StatusCode LArShapeCompleteMakerAlg::finalize()
{
  ...
  m_template->writeTrees(((std::string)m_outputTemplateFileName).c_str());
  ATH_MSG_INFO("done..." );
  return StatusCode::SUCCESS;
}
