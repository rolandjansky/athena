...
OutputPOOLFileName = "LArFCalNoise_13.0.30_v2.pool.root" 
...
if len(ObjectList)>0 : 
 ...
 IOVDbSvc.dbConnection="impl=cool;techno=sqlite;schema=LArElecCalib_FCalNoise.db;X:OFLP200"
