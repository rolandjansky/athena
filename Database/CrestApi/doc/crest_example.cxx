...
int main() {
  ...
  //
  std::string url35 = "http://mvg-pc-04.cern.ch:8080";
  ...
  /*
     ...
     //curl --header "Content-Type: application/json" --request GET
        http://crest-undertow.web.cern.ch/crestapi/runinfo?from=2018010101&to=2019050500&format=Time&page=0&size=10
  ...
  /*
     ...
     // Payload Example: {"hash": "ABRACADABRA","version": "string","objectType": "string","data":
        "none","streamerInfo": "none","insertionTime": "2019-03-14T13:29:25.286Z"}
     // curl --header "Content-Type: application/json" --request POST --data '{"hash": "ABRACADABRA","version":
        "string","objectType": "string","data": "none","streamerInfo": "none","insertionTime":
        "2019-03-14T13:29:25.286Z"}' http://mvg-test-pc-03.cern.ch:8090/crestapi/payloads
     // curl --header "Content-Type: application/json" --request POST --data
        '{"tagName":"test_MvG5","since":100,"insertionTime":"2018-12-18T11:32:58.329+0000","payloadHash":"ABRACADABRA3"}'
        http://mvg-test-pc-03.cern.ch:8090/crestapi/iovs
  ...
  /*
     ...
     std::string str40 =  "{\"niovs\": 2,\"format\":
        \"PYLD_JSON\",\"iovsList\":[{\"since\":800,\"payload\":\"vv1\"},{\"since\":900,\"payload\":\"ww1\"}]}";
  ...
  /*
     ...
     std::string str56 =  "{\"niovs\": 2,\"format\":
        \"PYLD_JSON\",\"iovsList\":[{\"since\":800,\"payload\":\"vv1\"},{\"since\":900,\"payload\":\"ww1\"}]}";
  ...
  /*
     ...
     std::string str57 =  "{\"niovs\": 2,\"format\":
        \"PYLD_JSON\",\"iovsList\":[{\"since\":800,\"payload\":\"vv1\"},{\"since\":900,\"payload\":\"ww1\"}]}";
