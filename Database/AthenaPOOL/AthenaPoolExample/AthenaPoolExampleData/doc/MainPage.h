...
ExampleHit and ExampleTrack and their container ExampleHitContainer and ExampleTrackContainer.

ExampleHit will be used for Toy ESD and contains a position and a string.

ExampleTrack will be used for Toy AOD and contains some data plus various links, ElementLinks, ElementLinkVector
