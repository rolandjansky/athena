...
class CalibNtupleMaker:
    ...
    def __init__(self):
        ...
        self.lumiChanList2011Limited = [101, 102, 201, 202, 211, 212]
        self.lumiChanList2012 = [101,102,103,104,105,106,201,202,206,207,211,212,216,217,221,222,226,1001,1002,1004,1011,1012,1014]

        self.chan2012 = False # Use 2011 (False) or 2012 (True) channel list
        
        # Process limited channel listing (2011 only)
        self.limited = False
    ...
    def parseOpts(self):
        ...
        parser.add_option("--2012",
                          action="store_true", default=self.chan2012, dest='chan2012',
                          help="Use 2012 channels (default: use 2011 channels)")

        parser.add_option("--limited",
                          action="store_true", default=self.limited, dest='limited',
                          help="Use limited channel list: BCM/Lucid AND/OR only (default: false)")
        ...
        if self.chan2012:
            ...
            if self.limited:
                self.lumiChanList = self.lumiChanList2011Limited
            else:
