...
BOOST_AUTO_TEST_SUITE(IOVDbSvc_test)
  //
  ...
  BOOST_AUTO_TEST_CASE(getRange){
    ...
    //wrong key
    BOOST_TEST( iovdbsvc->getRange (1238547719, db.invalidFoldername, IOVTime (101, 200),range, tag, addr).isFailure() );
