...
from EventTagUtils.EventTagUtilsConf import EventInfoTagTool
...
tagTool = GlobalEventTagTool("GlobalEventTagTool")
tagTool.IncludeVertexFlag = False
tagTool.IncludeExtras = False
tagTool.IncludeEventFlag = True

tagBuilder = GlobalEventTagBuilder("GlobalEventTagBuilder")
tagBuilder.CheckAttribute = True
tagBuilder.AttributeList = EventTagGlobal.AttributeList
tagBuilder.GlobalEventTagTool = tagTool

topSequence += tagBuilder
