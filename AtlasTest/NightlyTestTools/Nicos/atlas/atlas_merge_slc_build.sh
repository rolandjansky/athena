...
/afs/cern.ch/user/a/alibrari/scripts/copy_release.sh -R -v -f $NICOS_PROJECT_HOME -f_r atlrel_0 -p i686-slc3-gcc323-opt -t /afs/cern.ch/atlas/software/dist/nightlies/rel -r ${PROJECT_RELNAME}
