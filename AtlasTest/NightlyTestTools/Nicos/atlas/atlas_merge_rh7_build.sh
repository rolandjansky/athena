...
echo "copy is performed for platform i686-rh73-gcc32-opt to release ${PROJECT_RELNAME}"

/afs/cern.ch/user/a/alibrari/scripts/copy_release.sh -R -v -f $NICOS_PROJECT_HOME -f_r atlrel_0 -p i686-rh73-gcc32-opt -t /afs/cern.ch/atlas/software/dist/nightlies/rel -r ${PROJECT_RELNAME}
