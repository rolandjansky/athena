...
ToolSvc.TBByteStreamCnvTool.Keys += ["TBLArCalibDigitContainer/FREE"]
ToolSvc.TBByteStreamCnvTool.Keys += ["TBLArCalibDigitContainer/LOW"]
ToolSvc.TBByteStreamCnvTool.Keys += ["TBLArCalibDigitContainer/HIGH"]
ToolSvc.TBByteStreamCnvTool.Keys += ["TBLArCalibDigitContainer/MEDIUM"]
