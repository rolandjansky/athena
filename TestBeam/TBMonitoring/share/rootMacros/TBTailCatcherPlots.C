...
void TBTailCatcherPlots(TString path, TString canvasTitle, TString canvasNameBase, int minIndex=0, int maxIndex=99) {
  ...
  while (key = (TKey*)myIter.Next()) {
	...
	TCanvas* oneCanvas = new TCanvas(canvasName, canvasTitle+" - "+canvasName, 350+20*canvasIndex, 10+20*canvasIndex, 600, 720);
