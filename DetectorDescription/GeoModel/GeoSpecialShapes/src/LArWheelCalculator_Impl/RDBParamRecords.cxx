...
const RDBParamRecords::self_t & RDBParamRecords::param(int &outval, const std::string& name,unsigned int index) const {
	outval = (*m_RecSet)[index]->getInt(name);
	return *this;
}

const RDBParamRecords::self_t & RDBParamRecords::param(unsigned int &outval, const std::string& name,unsigned int index) const {
	outval = (unsigned int)(*m_RecSet)[index]->getInt(name);
	return *this;
}

const RDBParamRecords::self_t & RDBParamRecords::param(double &outval,     const std::string& name, const double units, unsigned int index) const {
	outval = (*m_RecSet)[index]->getDouble(name)*units;
	return *this;
}

const RDBParamRecords::self_t & RDBParamRecords::param(std::string &outval, const std::string& name, unsigned int index) const {
