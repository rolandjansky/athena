...
class GeoPhysVol;
namespace xercesc_3_1 {class DOMDocument;}
namespace xercesc_3_1 {class DOMNode;}
...
// Disallow copying
    ...
    int doDefines(xercesc_3_1::DOMDocument *doc, HepTool::Evaluator &eval);
    int doPositionIndex(xercesc_3_1::DOMDocument *doc, GmxUtil &gmxUtil);
    int doReadoutGeometry(xercesc_3_1::DOMDocument *doc, GmxUtil &gmxUtil);
    void addParam(xercesc_3_1::DOMNode *node, std::map<std::string, std::string> &params);
};
#endif // GMX2GEO_H
