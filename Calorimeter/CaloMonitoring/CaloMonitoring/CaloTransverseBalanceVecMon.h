...
/// The missing ET object
 ...
 std::string m_missingEtObjectName;
  MonGroup * TheTransverseBalance_shift;
// variables
  long m_cutflow_j_1;
  long m_cutflow_j_2;
  long m_cutflow_j_3;
...
//histos
  ...
  TH1F* h_photon_eta;
  TH1F* h_photon_phi;
  TH1F* h_jet_pt_beforeoverlap;
  TH1F* h_jet_eta_beforeoverlap;
  TH1F* h_jet_phi_beforeoverlap;
  TH1F* h_jet_pt_afteroverlap;
  TH1F* h_jet_eta_afteroverlap;
  TH1F* h_jet_phi_afteroverlap;
  TH1I* h_njet_beforeoverlap;
  TH1I* h_njet_afteroverlap;
  TH1F* h_leadingJet_pt;
  TH1F* h_leadingJet_eta;
  TH1F* h_leadingJet_phi;
  TH1F* h_deltaPhi;
  TH2F* h2_ph_leadingJet_eta;
  TProfile* p_ptratioVsPhi_Barrel;
  TProfile* p_ptratioVsPhi_ECC;
  TProfile* p_ptratioVsPhi_ECA;
  TProfile* p_ptratioVsEta;
  TH2F* h2_ptratioVsPhi_Barrel; 
  TH2F* h2_ptratioVsPhi_ECC;
  TH2F* h2_ptratioVsPhi_ECA;
  TH2F* h2_ptratioVsEta;
  TH1F* h_overlapped_ph_jet_ptratio;
  TH1F* h_pt_ratio;
//photon-MET
  TH1F* h_leadingPh_MET_deltaPhi;
  TH2F* h2_leadingPh_MET_deltaPhiVsPt;
};
