...
#ifndef CALOTRIGGERTOOL_JTOWERSCMAP_H
#define CALOTRIGGERTOOL_JTOWERSCMAP_H
...
/**
   ...
   Its persistifiable version is the JTowerSCMap_P class
...
CLASS_DEF( JTowerSCMap,178971834,1)
