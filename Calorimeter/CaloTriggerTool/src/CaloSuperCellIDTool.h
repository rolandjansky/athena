...
// $Id$
/**
 * @file CaloTriggerTool/src/CaloSuperCellIDTool.h
...
#ifndef CALOTRIGGERTOOL_CALOSUPERCELLIDTOOL_H
#define CALOTRIGGERTOOL_CALOSUPERCELLIDTOOL_H
...
#endif // not CALOTRIGGERTOOL_CALOSUPERCELLIDTOOL_H
