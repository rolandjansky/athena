...
class CaloClusterContainerCnv_p6
  : public T_AthenaPoolTPCnvConstBase<CaloClusterContainer, CaloClusterContainer_p6>
{
public:
  ...
  virtual
  void persToTrans (const CaloClusterContainer_p6* pers,
...
private:
  ...
  void persToTrans (const CaloClusterContainer_p6::CaloCluster_p* pers,
                    CaloCluster* trans,
                    ShowerLinkState& showerLinkState,
                    CellLinkState& cellLinkState,
                    MsgStream &) const;
  void transToPers (const CaloCluster* trans,
                    CaloClusterContainer_p6::CaloCluster_p* pers,
                    ShowerLinkState& showerLinkState,
                    CellLinkState& cellLinkState,
                    MsgStream &) const;
