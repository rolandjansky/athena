...
public:                                     
  ...
  void transToPers(const CaloClusterMomentStore*, CaloClusterMomentStore_p1*/*, MsgStream&*/) const;
  void persToTrans(const CaloClusterMomentStore_p1*, CaloClusterMomentStore*/*, MsgStream&*/) const;
