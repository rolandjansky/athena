...
if not 'inFileName' in dir():
  #inFileName=["h6prod.100002.piminus_logE.simul.qgspbert.ESD.v15520._00213.pool.root"]
...
lcPerf.etamax = 5.0
lcPerf.netabin = 25
lcPerf.phimin = pi*3./4. - 0.25
lcPerf.phimax = pi*3./4. + 0.25
lcPerf.nphibin = 1
...
lcPerf.ClusterCollectionNames = ["CaloTopoCluster", "CaloWeightTopoCluster", "CaloOOCTopoCluster", "CaloCalTopoCluster"]
#lcPerf.ClusterCollectionNames = ["CaloTopoCluster_HadAll", "CaloWeightTopoCluster_HadAll", "CaloOOCTopoCluster_HadAll", "CaloCalTopoCluster_HadAll"]
#lcPerf.ClusterCollectionNames = ["CaloTopoCluster_EMAll", "CaloWeightTopoCluster_EMAll", "CaloOOCTopoCluster_EMAll", "CaloCalTopoCluster_EMAll"]
