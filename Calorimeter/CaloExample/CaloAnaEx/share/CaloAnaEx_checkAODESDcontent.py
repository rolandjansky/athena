...
class CaloAnaEx_checkAODESDcontent:
    def __init__(self,log,logLevel,cAOD,cESD):
        if log=='':
...
# Helenka 18.08.2009
        try:
            file = open('ESDAOD.log','r')
            file.close()
        except:
            self.logger.error('Opening ESDAOD.log fails')
            return -1
