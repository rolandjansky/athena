...
#ifndef CALOCLUSTERMOMENTSMAKER_Truth_H
#define CALOCLUSTERMOMENTSMAKER_Truth_H
/**
...
class CaloClusterMomentsMaker_Truth: public AthAlgTool, virtual public CaloClusterCollectionProcessor
{
 public:    
  CaloClusterMomentsMaker_Truth(const std::string& type, const std::string& name,
