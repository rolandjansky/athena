...
WATCH_LIST['IsolationSelection'] = set(['maklein','jojungge', 'schaffer', 'oducu'])
...
WATCH_LIST['DerivationFrameworkSUSY'] = set(['zmarshal','martindl','whopkins','ykeisuke'])
WATCH_LIST['BoostedJetTaggers'] = set(['meehan','sschramm','cdelitzs','rnewhous'])
WATCH_LIST['MuonAnalysisInterfaces'] = set(['jojungge','szambito','nkoehler','gabarone' ,'rosati', 'fsforza', 'dellasta', 'morgens'])
WATCH_LIST['MuonMomentumCorrections'] = set(['gabarone','rosati', 'fsforza'])
