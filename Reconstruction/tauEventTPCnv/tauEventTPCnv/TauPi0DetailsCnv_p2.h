...
#ifndef TAUEVENTTPCNV_TAUPI0DETAILSCNV_P2_H
#define TAUEVENTTPCNV_TAUPI0DETAILSCNV_P2_H
...
#include "tauEvent/TauShot.h"  //forward declartion possible?

/// forward declarations
class MsgStream;
//class TauPi0Candidate;

class TauPi0DetailsCnv_p2 : public T_AthenaPoolTPPolyCnvBase<Analysis::TauDetails, Analysis::TauPi0Details, TauPi0Details_p2 >
{
public:
  TauPi0DetailsCnv_p2() {};
