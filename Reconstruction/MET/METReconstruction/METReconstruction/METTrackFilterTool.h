...
namespace met{
  ...
  private:
    ...
    ToolHandle<CP::ITrackVertexAssociationTool> m_trkToVertexTool{this,""};
    ToolHandle<xAOD::ITrackIsolationTool> m_trkIsolationTool{this,""};
    ToolHandle<xAOD::ICaloTopoClusterIsolationTool> m_caloIsolationTool{this,""};
