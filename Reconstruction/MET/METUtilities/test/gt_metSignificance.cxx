...
namespace met {
  ...
  const static std::string toolname = "METSignificance";

  class METSignificanceTest : public ::testing::Test
  {
  public:
...
// #endif
  ...
  TEST_F( METSignificanceTest, TestInitialize ){
  ...
  // TEST_F( METSignificanceTest, TestSourceTrackMet ){
  //   SetUpFileInput();
