...
void eflowObjectContainerCnv_p2::persToTrans( const eflowObjectContainer_p2 *persObj, eflowObjectContainer *transObj, MsgStream &eflowStream ){
...
void eflowObjectContainerCnv_p2::transToPers( const eflowObjectContainer *transObj,eflowObjectContainer_p2 *persObj, MsgStream &eflowStream ){
