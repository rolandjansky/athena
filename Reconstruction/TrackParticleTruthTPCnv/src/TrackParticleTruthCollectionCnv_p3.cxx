...
void TrackParticleTruthCollectionCnv_p3::persToTrans( const Rec::TrackParticleTruthCollection_p3* pers,
                                                      TrackParticleTruthCollection* trans, 
                                                      MsgStream& msg ) 
{
    trans->clear();

    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p3::persToTrans(): PERS size = " << pers->m_entries.size() << endreq;
    ...
    for(Rec::TrackParticleTruthCollection_p3::CollectionType::const_iterator i=pers->m_entries.begin(); i!=pers->m_entries.end(); ++i) {
    ...
    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p3::persToTrans() DONE" << endreq;
}

void TrackParticleTruthCollectionCnv_p3::transToPers( const TrackParticleTruthCollection* trans, 
                                                      Rec::TrackParticleTruthCollection_p3* pers, 
                                                      MsgStream& msg ) 
{
    if (msg.level() <= MSG::DEBUG) {
        msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p3::transToPers()" << endreq;
        msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p3::transToPers(): input size = " << trans->size() << endreq;
    }
    ...
    Rec::TrackParticleTruthCollection_p3::CollectionType::size_type ipers(0);
    TrackParticleTruthCollection::const_iterator itrans = trans->begin(); 
    for( ; itrans!=trans->end(); itrans++, ipers++) {
        Rec::TrackParticleTruthCollection_p3::Entry entry;
    ...
    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p3::transToPers() DONE" << endreq;
}
