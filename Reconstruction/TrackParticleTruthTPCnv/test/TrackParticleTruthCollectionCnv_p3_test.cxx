...
// $Id$
/**
 * @file InDetSimEventTPCnv/test/TrackParticleTruthCollectionCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Feb, 2016
 * @brief Tests for TrackParticleTruthCollectionCnv_p3.
 */
...
void testit (const TrackParticleTruthCollection& trans1)
{
  ...
  TrackParticleTruthCollectionCnv_p3 cnv;
