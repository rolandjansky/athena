...
struct GCCXML_DUMMY_INSTANTIATION_TRACKPARTICLETRUTHTPCNV {
  ...
  T_TPCnv<TrackParticleTruthCollection, Rec::TrackParticleTruthCollection_p3> dummy2c;
  std::vector<Rec::TrackParticleTruthCollection_p3> aac;
  ...
  T_TPCnv<TrackParticleTruthCollectionContainer, TrackParticleTruthCollectionContainer_tlp3> dummy3c;
  std::vector<TrackParticleTruthCollectionContainer_p3> abd;
};
