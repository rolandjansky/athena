...
TauPi0CreateROI::TauPi0CreateROI(   const string& type,
                                            const string& name,
...
StatusCode TauPi0CreateROI::eventInitialize(TauCandidateData * /*data*/) {
...
StatusCode TauPi0CreateROI::execute(TauCandidateData *data) {
...
StatusCode TauPi0CreateROI::eventFinalize(TauCandidateData* /* data */) {
