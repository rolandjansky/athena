...
StatusCode METMonTool::bookHistograms()
{
	...
	MonGroup met_calos(this, "MET/Calos" + suffix, run, ATTRIB_MANAGED);
	MonGroup met_regions(this, "MET/Regions" + suffix, run, ATTRIB_MANAGED);
	MonGroup met_jets(this, "MET/Jets" + suffix, run, ATTRIB_MANAGED);
	MonGroup met_electrons(this, "MET/Electrons" + suffix, run, ATTRIB_MANAGED);
	MonGroup met_muons(this, "MET/Muons" + suffix, run, ATTRIB_MANAGED);
	MonGroup met_summary(this, "MET/Summary" + suffix, run, ATTRIB_MANAGED);
				...
				if (m_doJetcleaning && !m_badJets){
					...
					for (; jetItr != jetItrE; ++jetItr){
						...
						double jetTime = xjet_->getAttribute<float>(xAOD::JetAttribute::Timing);
                                                ...
                                                double chf = ((xjet_->getAttribute<std::vector<float> >(xAOD::JetAttribute::SumPtTrkPt500))[0]) / ptjet;// suneet 500 or 1000?
