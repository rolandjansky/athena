...
public:
    ...
    virtual Track*		extrapolate_inwards (const Track&) = 0;
    virtual Track*		extrapolate_outwards (const Track&) = 0;
    
    /**ITrackFollower interface: create a track after interpolation (various possibilities) */
    virtual Track*		fast_interpolate_outwards (const Track&) = 0;
    virtual Track*		interpolate (const Track&) = 0;
    virtual Track*		interpolate_from_beam_spot (const Track&) = 0;
