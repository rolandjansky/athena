    ...
    if( container ){
      ...
      for( unsigned int i=0;i<container->size();++i ){
        ...
        if(m_useCovariance) {
          ...
          if(dr2<dr2Cut && dr2 < dr2CutTmp)  ATH_MSG_DEBUG("1. selections match! dR " << sqrt(dr2) << " new cut value " << sqrt(dr2CutTmp) << " pt trk " << pars->pT() << " sigma(phi) trk " << uncertPhi << " sigma(eta) trk " << uncertEta << " energy cluster " << cl->e() << " sigma width " << sigmaWidth);
          if(dr2<dr2Cut && dr2 > dr2CutTmp) ATH_MSG_DEBUG("2. only  dR matches! dR " << sqrt(dr2) << " new cut value " << sqrt(dr2CutTmp) << " pt trk " << pars->pT() << " sigma(phi) trk " << uncertPhi << " sigma(eta) trk " << uncertEta << " energy cluster " << cl->e() << " sigma width " << sigmaWidth);
          if(dr2>dr2Cut && dr2 < dr2CutTmp) ATH_MSG_DEBUG("3. only new matches! dR " << sqrt(dr2) << " new cut value " << sqrt(dr2CutTmp) << " pt trk " << pars->pT() << " sigma(phi) trk " << uncertPhi << " sigma(eta) trk " << uncertEta << " energy cluster " << cl->e() << " sigma width " << sigmaWidth );           
