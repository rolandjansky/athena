...
*/
/**
 * @file RecTPCnv/test/MissingETCompositionCnv_p1_test.cxx
...
void testit (const MissingETComposition& trans1)
{
  ...
  MissingETCompositionCnv_p1 cnv;
  MissingETComposition_p1 pers;
...
int main()
{
  std::cout << "RecTPCnv/MissingETCompositionCnv_p1\n";
