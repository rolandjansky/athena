...
/*	
	...
	*/
	for(int k = 0; k<Nside; k++){
		...
		m_hEM_HAD1[k] = TH2D_LW::create(nameEM_HAD1.str().c_str(),nameEM_HAD1.str().c_str(), 1025, -5, 10245, 1025, -5, 10245);
		regHist(m_hEM_HAD1[k], path, run).ignore();
/*
		nameEM_HAD1.str("");
		nameEM_HAD1<<"h_NEW_EM_HAD1_side"<<k;
		m_hEM_HAD1_NEW[k] = TH2D_LW::create(nameEM_HAD1.str().c_str(),nameEM_HAD1.str().c_str(),10241,-0.5,10240.5,10241,-0.5,10240.5);
		regHist(m_hEM_HAD1_NEW[k], path, run).ignore();
*/
		nameHAD1_HAD2.str("");
		nameHAD1_HAD2<<"hHAD1_HAD2_side"<<k;
		m_hHAD1_HAD2[k] = TH2D_LW::create(nameHAD1_HAD2.str().c_str(),nameHAD1_HAD2.str().c_str(), 1025, -5, 10245, 1025, -5, 10245);
		regHist(m_hHAD1_HAD2[k], path, run).ignore();
/*
		nameHAD1_HAD2.str("");
		nameHAD1_HAD2<<"h_NEW_HAD1_HAD2_side"<<k;
		m_hHAD1_HAD2_NEW[k] = TH2D_LW::create(nameHAD1_HAD2.str().c_str(),nameHAD1_HAD2.str().c_str(),10241,-0.5,10240.5,10241,-0.5,10240.5);
		regHist(m_hHAD1_HAD2_NEW[k], path, run).ignore();
	*/		
		nameHAD2_HAD3.str("");
		nameHAD2_HAD3<<"hHAD2_HAD3_side"<<k;
		m_hHAD2_HAD3[k] = TH2D_LW::create(nameHAD2_HAD3.str().c_str(),nameHAD2_HAD3.str().c_str(), 1025, -5, 10245, 1025, -5, 10245);
		regHist(m_hHAD2_HAD3[k], path, run).ignore();
/*
		nameHAD2_HAD3.str("");
		nameHAD2_HAD3<<"h_NEW_HAD2_HAD3_side"<<k;
		m_hHAD2_HAD3_NEW[k] = TH2D_LW::create(nameHAD2_HAD3.str().c_str(),nameHAD2_HAD3.str().c_str(),10241,-0.5,10240.5,10241,-0.5,10240.5);
