...
double egammaEnergyPositionAllSamples::e(const xAOD::CaloCluster& cluster)  const {
...
bool egammaEnergyPositionAllSamples::inBarrel(const xAOD::CaloCluster& cluster,const int is) const { 
