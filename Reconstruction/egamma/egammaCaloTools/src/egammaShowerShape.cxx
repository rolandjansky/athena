...
egammaShowerShape::egammaShowerShape(const std::string& type,
  ...
  : AthAlgTool(type, name, parent),
    m_cluster(0), 
    m_cellContainer(0),
    m_egammaPreSamplerShape("egammaPreSamplerShape/egammapresamplershape", this),
    m_egammaStripsShape("egammaStripsShape/egammastripsshape", this),
    m_egammaMiddleShape("egammaMiddleShape/egammamiddleshape", this),
    m_egammaBackShape("egammaBackShape/egammabackshape", this),
    m_enecell(0), 
    m_etacell(0),
    m_gracell(0),
    m_ncell(0)
