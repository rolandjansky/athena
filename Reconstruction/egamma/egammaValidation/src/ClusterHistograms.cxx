...
StatusCode ClusterHistograms::initializePlots() {
  ...
  histo2DMap["number_topocluster_vs_et_2D"] = (new TH2D(Form("%s_%s",m_name.c_str(),"number_topocluster_vs_et_2D"), "Number of topocluster;E_{T}", 60,0,300, 15,0,15));
  histo2DMap["number_topocluster_vs_eta_2D"] = (new TH2D(Form("%s_%s",m_name.c_str(),"number_topocluster_vs_eta_2D"), "Number of topocluster;truth #eta", 40,-3,3, 15,0,15));
