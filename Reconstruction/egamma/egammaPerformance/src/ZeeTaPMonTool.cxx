...
StatusCode ZeeTaPMonTool::bookHistograms()
{
  ...
  m_electronEffGroup = new MonGroup(this,"egamma/tagandprobe/EfficienciesIDISO", run, ManagedMonitorToolBase::ATTRIB_MANAGED , "", "merge_effAsPerCent"); // to be re-booked every new run
