...
EL::StatusCode JetReclusteringAlgo :: initialize ()
{
  ...
  ANA_CHECK(m_jetReclusteringTool.setProperty("ECFDoDichroic",             m_ecf_doDichroic));
  ANA_CHECK(m_jetReclusteringTool.setProperty("ECFDoC3",                   m_ecf_doC3));
  ANA_CHECK(m_jetReclusteringTool.setProperty("ECFGDoN3",                  m_ecfg_doN3));
  ANA_CHECK(m_jetReclusteringTool.setProperty("ECFGDoLSeries",             m_ecfg_doLSeries));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTracksInputContainer",         m_ghostTracksInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTracksVertexAssociationName",  m_ghostTracksVertexAssociationName));
  ...
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthBHadronsInputContainer",  m_ghostTruthBHadronsInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthBHadronsLabel",           m_ghostTruthBHadronsLabel));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthCHadronsInputContainer",  m_ghostTruthCHadronsInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthCHadronsLabel",           m_ghostTruthCHadronsLabel));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthTopQuarksInputContainer", m_ghostTruthTQuarksInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthTopQuarksLabel",          m_ghostTruthTQuarksLabel));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthWBosonsInputContainer",   m_ghostTruthWBosonsInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthWBosonsLabel",            m_ghostTruthWBosonsLabel));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthZBosonsInputContainer",   m_ghostTruthZBosonsInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthZBosonsLabel",            m_ghostTruthZBosonsLabel));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthHBosonsInputContainer",   m_ghostTruthHBosonsInputContainer));
  ANA_CHECK(m_jetReclusteringTool.setProperty("GhostTruthHBosonsLabel",            m_ghostTruthHBosonsLabel));
