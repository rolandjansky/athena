...
#include "JetInterface/IJetBuilder.h"
...
class JetClusterer
: public asg::AsgTool,
  virtual public IJetBuilder {
ASG_TOOL_CLASS(JetClusterer, IJetBuilder)
...
protected:
  ...
  SG::ReadHandleKey<PseudoJetContainer> m_inputPseudoJets= {this, "InputPseudoJets", {}, "input constituents"};
