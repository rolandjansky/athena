...
#ifndef JetFinderMT_H
#define JetFinderMT_H
...
class JetFinderMT
: public asg::AsgTool,
  virtual public IJetFinderMT {
ASG_TOOL_CLASS(JetFinderMT, IJetFinderMT)

public:

  JetFinderMT(std::string name);
...
private:  //data
  ...
  ToolHandle<IJetFromPseudojetMT> m_bld;  
