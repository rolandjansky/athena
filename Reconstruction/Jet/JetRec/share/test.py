...
doEMPFlowJets = True
doEMPFlowSeqJets = False
doEMCPFlowJets = False
doLCPFlowJets = False
findJets = True
...
if doEMPFlowJets and findJets:
  jtm.addJetFinder("MyAntiKt4EMPFlowJets",  "AntiKt", 0.4,  "empflow", "pflow_ungroomed",
                   ghostArea=0.01 , ptmin=2000, ptminFilter=5000, calibOpt="a:pflow")
if doEMCPFlowJets and findJets:
  jtm.addJetFinder("MyAntiKt4EMCPFlowJets", "AntiKt", 0.4, "emcpflow", "pflow_ungroomed",
                   ghostArea=0.01 , ptmin=2000, ptminFilter=7000, calibOpt="a:pflow")
if doLCPFlowJets and findJets:
  jtm.addJetFinder("MyAntiKt4LCPFlowJets",  "AntiKt", 0.4,  "lcpflow", "pflow_ungroomed",
                   ghostArea=0.01 , ptmin=2000, ptminFilter=7000, calibOpt="a:pflow")
...
if doEMCPFlowJets:
  ...
  addJetRecoToAlgSequence(topSequence)
