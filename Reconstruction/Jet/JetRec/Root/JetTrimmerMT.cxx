...
JetTrimmerMT::JetTrimmerMT(std::string name)
: AsgTool(name), m_bld("") {
...
JetTrimmerMT::~JetTrimmerMT() {
}

//**********************************************************************

StatusCode JetTrimmerMT::initialize() {
...
int JetTrimmerMT::groom(const xAOD::Jet& jin,
