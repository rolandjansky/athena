...
double Helpers::Interpolate(const TH1* histo, const double x) const
{
...
double Helpers::Interpolate(const TH1* histo, const double x, const double y) const
{
    // Call the unified method for consistency
    return Interpolate2D(histo,x,y);
}

double Helpers::Interpolate2D(const TH1* histo, const double x, const double y, const int xAxis, const int yAxis, const int otherDimBin) const
{
    // Copied from ROOT directly and trivially modified, all credit to ROOT authors of TH1, TH2, and TH3 Interpolate methods
    // This is done because I want a const version of interpolation, and none of the methods require modification of the histogram
    // Probable reason is that FindBin isn't const, but there should be a const version...
...
double Helpers::Interpolate(const TH1* histo, const double x, const double y, const double z) const
{
    // Copied from ROOT directly and trivially modified, all credit to ROOT authors of TH1, TH2, and TH3 Interpolate methods
    // This is done because I want a const version of interpolation, and none of the methods require modification of the histogram
    // Probable reason is that FindBin isn't const, but there should be a const version...
...
Int_t Helpers::FindBin(const TAxis* axis, const double x) const
{
