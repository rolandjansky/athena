...
jetreplacements = {"AntiKt4EMTopo":"AntiKt4Topo_EMJES","AntiKt4LCTopo":"AntiKt4Topo_LCJES"}
replacements = {}
#replacements["/cluster/warehouse/kpachal/JetCalibration/JetUncertainties/JetUncertainties/inputs/EtaIntercalibration/Aug_11_EtaIntercalibration13TeV50ns_MM_nominal_AntiKt4EMTopo_Uncertainties.root"] = {
#      "EtaIntercalibration_Modelling" : "EtaIntercalibration_TotalSyst",
#      "EtaIntercalibration_TotalStat" : "EtaIntercalibration_TotalStat"
#    }
#replacements["/cluster/warehouse/kpachal/JetCalibration/JetUncertainties/JetUncertainties/inputs/Flavour/flavorUncertaintiesMC15_v01.root"] = {
#     "flavorCompGlu" : "flavorCompGlu",
#     "flavorCompLight" : "flavorCompLight",
#     "FlavorResponse" : "FlavorResponse"
#}
replacements["/cluster/warehouse/kpachal/JetCalibration/JetUncertainties/JetUncertainties/inputs/AFII/AFII_Uncertainty_4EM.root"] = {
     "RelativeNonClosure_AFII" : "RelativeNonClosure_AFII",
}

# Here, specify histograms you want to get rid of altogether
deletions = ["Xcalib_5Vs4sample","Xcalib_50nsVs25ns",
"Xcalib_50nsVs25ns_Central",
"Xcalib_50nsVs25ns_Forward",
"Xcalib_EarlyData",
"Xcalib_EarlyData_Forward",
...
theCurrentHistos = ReadCurrentHistograms(inputFile,jetreplacements.keys()) # First true activates eta-intercalibration scaling. Second true turns off relative in situ components at large eta
