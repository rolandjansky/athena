...
namespace KtJet{
   ...
   *
   *  Usage example:
   *    CLHEPNAMESPACE HepLorentzVector eScheme(const CLHEPNAMESPACE HepLorentzVector &,
   const CLHEPNAMESPACE HepLorentzVector &); // function to merge jets
  ...
  */
  ...
  private:
    ...
    KtRecom *m_ktRecom;
    //  CLHEPNAMESPACE HepLorentzVector (*m_frecom)(const CLHEPNAMESPACE HepLorentzVector &, const CLHEPNAMESPACE HepLorentzVector &);
