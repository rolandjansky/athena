...
TGraphErrors* gr = new TGraphErrors(nbinplot++,nxbin,Htail,ex,ertail);
gr->SetTitle();
...
//second
TGraphErrors* gr = new TGraphErrors(nbinplot2++,nxbin,Htail2,ex2,ertail2);
...
//third
TGraphErrors* gr = new TGraphErrors(nbinplot3++,nxbin,Htail3,ex3,ertail3);
...
//fourth
TGraphErrors* gr = new TGraphErrors(nbinplot4++,nxbin,Htail4,ex4,ertail4);
...
//fifth
TGraphErrors* gr = new TGraphErrors(nbinplot5++,nxbin,Htail5,ex5,ertail5);
...
//sixth
TGraphErrors* gr = new TGraphErrors(nbinplot6++,nxbin,Htail6,ex6,ertail6);
...
//seventh
TGraphErrors* gr = new TGraphErrors(nbinplot7++,nxbin,Htail7,ex7,ertail7);
