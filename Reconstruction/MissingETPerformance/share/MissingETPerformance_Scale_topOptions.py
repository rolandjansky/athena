...
# the POOL converters
include( "/users2/pizio/Athena/15.6.1/PhysicsAnalysis/StandardModelPhys/WZBenchmarks/ZToTwoTaus/share/ZToTwoTaus_METScale_topOptions.py")
...
MissingETPerformance.doZeeTool                          = False #True
...
MissingETPerformance.doMissingETScaleTool               = True

#configure event selection
MissingETEventSelector.ElecPtCut              = 0.*GeV
MissingETEventSelector.MuonPtCut              = 0.*GeV
...
MissingETEventSelector.SelectionType          = "hasgoodZ_tautau"
MissingETEventSelector.SelectionZtautau       = "PassedInvMassAnalysis"
                                                #Options are "PassedInvMassAnalysis" or "PassedLooseSelection"
...
ServiceMgr += THistSvc()
ServiceMgr.THistSvc.Output = [ "AANT DATAFILE='METPerformance_Scale.%s.root' OPT='RECREATE'" % DATE]
from AnalysisTools.AthAnalysisToolsConf import AANTupleStream
topSequence += AANTupleStream()
AANTupleStream = AANTupleStream()
AANTupleStream.OutputName = 'METScalePerformance.root'
