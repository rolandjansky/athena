...
void track_pixel_res_modules(int SaveOpt=0) {
  ...
  if (SaveOpt==1) { sprintf(sname,"Track_Pixels_Res_Pulls_mod.ps("); }
  else if(SaveOpt==2) { sprintf(sname,"Track_Pixels_Res_Pulls_mod.gif(");}
