...
if isHI_mode:
    ### To test data 15 HI run
    ### DetDescrVersion = 'ATLAS-R2-2015-04-00-00'
    ### For data 18 HI run
    DetDescrVersion = 'ATLAS-R2-2016-01-00-01'
    if isOnline:
        ### ConditionsTag = 'CONDBR2-HLTP-2016-01' # for old ID alignment to test 2015 HI run
        ConditionsTag = 'CONDBR2-HLTP-2018-01' # for new ID alignment 26 May 2017
else:
...
if isHI_mode:
    ...
    jobproperties.HIRecExampleFlags.doHIegamma.set_Value_and_Lock(True)
...
if athenaCommonFlags.isOnline:
    ...
    InDetFlags.useDCS.set_Value_and_Lock(True)
