...
Reco_tf.py --athenaopts="--threads=1" --maxEvents=1000 --steering "no" --AMI=q431 --preExec "${preExecStringOne}" "${preExecStringTwo}" --conditionsTag="CONDBR2-BLKPA-RUN2-09" --outputAODFile=myAOD.pool.root --outputESDFile=myESD.pool.root | tee athenarunOne.log
rc1=${PIPESTATUS[0]}
...
Reco_tf.py --athenaopts="--threads=8" --maxEvents=1000 --steering "no" --AMI=q431 --preExec "${preExecStringOne}" "${preExecStringTwo}" --conditionsTag="CONDBR2-BLKPA-RUN2-09" --outputAODFile=myAOD.pool.root --outputESDFile=myESD.pool.root | tee athenarunTwo.log
rc2=${PIPESTATUS[0]}
