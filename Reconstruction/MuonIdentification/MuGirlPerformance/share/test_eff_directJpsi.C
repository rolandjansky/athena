...
void test_eff_directJpsi( )
{
    ...
    chain->Add("directJpsi.root/MUGIRL");
  ...
  //  chain->Add("pileup_4.mugirl.root/MUGIRL");
    ...
    chain2->Add("directJpsi.root/AOD");
...
int nHitsTGCEta = 0,
    ...
    if (typeOfRun == 2)
    {
        ...
        leg->Draw("same");
        c1->SaveAs("FakePt_directJpsi.gif");
	...
	h_muon_NN_eff->GetXaxis()->SetTitle("p_{T}(MeV)");
        ...
        leg1->Draw("same");
	c4->SaveAs("EffPt_directJpsi.gif");
	c4->SaveAs("EffPt_directJpsi.eps");
...
///////////////////////// eta ////////////////////////////////////
	...
	c2->SaveAs("EffEta_directJpsi.gif");
	c2->SaveAs("EffEta_directJpsi.eps");
...
///////////////////////// phi ////////////////////////////////////
	...
	c3->SaveAs("EffPhi_directJpsi.gif");
	c3->SaveAs("EffPhi_directJpsi.eps");
    ...
    string name="GlobalFitPerformance_directJpsi.ps";
   ...
   TH1D * h_MSRefittedz0 = new TH1D("h_MSRefittedz0", " MSRefittedz0 - truthz0 ", 50, -250, 250);
   ...
   TH1D * h_IDpt_nofit = new TH1D("h_IDpt_nofit", " IDTrk pT for candidates without refit ", 50, 0,25000);
   TH1D * h_IDeta_nofit = new TH1D("h_IDeta_nofit", " IDTrk Eta for candidates without refit ", 60, -3.,3.);
   TH1D * h_IDpt_MSnofit = new TH1D("h_IDpt_MSnofit", " IDTrk pT for candidates without MS refit ", 50, 0,25000);
