...
// Mon Jul 28 11:05:41 2008 by ROOT version 5.18/00d
...
#ifdef DataMuGirl_cxx
DataMuGirl::DataMuGirl(TTree *tree)
{
...
DataMuGirl::~DataMuGirl()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DataMuGirl::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataMuGirl::LoadTree(Long64_t entry)
{
...
void DataMuGirl::Init(TTree *tree)
{
...
void DataMuGirl::Show(Long64_t entry)
{
...
Int_t DataMuGirl::Cut(Long64_t entry)
{
