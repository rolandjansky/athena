...
MuGirlNTupleFile = "directJpsi.root"
...
#ToolSvc += Rec__CombinedMuonTrackBuilder(name = 'CombinedMuonTrackBuilder', OutputLevel  = VERBOSE)

#from TrkiPatFitter.TrkiPatFitterConf import Trk__iPatFitter
#ToolSvc += Trk__iPatFitter(name = 'iPatFitter', OutputLevel  = VERBOSE)
