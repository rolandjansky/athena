...
void test_eff_SingleMuonsPt100( )
{
    int typeOfRun=2;
  ...
  //  chain->Add("pileup_4.mugirl.root/MUGIRL");
    ...
    chain2->Add("singleMuonsPt100.root/AOD");
...
int nHitsTGCEta = 0,
    ...
    if (typeOfRun == 2)
    {
        ...
        leg->Draw("same");
        c1->SaveAs("FakePt_SingleMuonsPt100.gif");
	...
	h_muon_NN_eff->GetXaxis()->SetTitle("p_{T}(MeV)");
        ...
        leg1->Draw("same");
	c4->SaveAs("EffPt_SingleMuonsPt100.gif");
	c4->SaveAs("EffPt_SingleMuonsPt100.eps");
...
///////////////////////// eta ////////////////////////////////////
	...
	c2->SaveAs("EffEta_SingleMuonsPt100.gif");
	c2->SaveAs("EffEta_SingleMuonsPt100.eps");
...
///////////////////////// phi ////////////////////////////////////
	...
	c3->SaveAs("EffPhi_SingleMuonsPt100.gif");
	c3->SaveAs("EffPhi_SingleMuonsPt100.eps");
    ...
    string name="GlobalFitPerformance_SingleMuonsPt100.ps";
   ...
   TH1D * h_MSRefittedTheta = new TH1D("h_MSRefittedTheta", " MSRefittedcotTheta - truthcotTheta ", 50, -0.04, 0.04); 
   TH1D * h_MSRefittedPullTheta = new TH1D("h_MSRefittedPullTheta", " MSRefitted Pull cotTheta ", 50, -10,10); 

   TH1D * h_MSRefittedd0 = new TH1D("h_MSRefittedd0", " MSRefittedd0 - truthd0 ", 100, -150, 150);
   TH1D * h_MSRefittedpulld0 = new TH1D("h_MSRefittedpulld0", " (MSRefittedd0 - truthd0)/sqrt(MSRefittedTrkCov11) ", 50, -10, 10);

   TH1D * h_MSRefittedz0 = new TH1D("h_MSRefittedz0", " MSRefittedz0 - truthz0 ", 50, -150, 150);
   ...
   TH1D * h_IDpt_nofit = new TH1D("h_IDpt_nofit", " IDTrk pT for candidates without refit ", 200, 0,200000);
   TH1D * h_IDeta_nofit = new TH1D("h_IDeta_nofit", " IDTrk Eta for candidates without refit ", 60, -3.,3.);
   TH1D * h_IDpt_MSnofit = new TH1D("h_IDpt_MSnofit", " IDTrk pT for candidates without MS refit ", 200, 0,200000);
