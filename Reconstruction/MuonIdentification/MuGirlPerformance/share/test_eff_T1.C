...
///////////////////////// eta ////////////////////////////////////
	...
	c2->SaveAs("EffEta_T1.gif");
	c2->SaveAs("EffEta_T1.eps");
...
///////////////////////// phi ////////////////////////////////////
    ...
    string name="GlobalFitPerformance_T1.ps";
   ...
   TH1D * h_MSRefittedTheta = new TH1D("h_MSRefittedTheta", " MSRefittedcotTheta - truthcotTheta ", 50, -0.1, 0.1); 
   ...
   TH1D * h_MSRefittedz0 = new TH1D("h_MSRefittedz0", " MSRefittedz0 - truthz0 ", 50, -175, 175);
