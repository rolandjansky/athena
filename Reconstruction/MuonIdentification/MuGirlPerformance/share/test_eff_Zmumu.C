...
void test_eff_Zmumu( )
{
  ...
  //  chain->Add("pileup_4.mugirl.root/MUGIRL");
    ...
    chain2->Add("single100_noms.root/AOD");
...
///////////////////////// eta ////////////////////////////////////
	...
	c2->SaveAs("EffEta_Zmumu.gif");
	c2->SaveAs("EffEta_Zmumu.eps");
...
///////////////////////// phi ////////////////////////////////////
    ...
    string name="GlobalFitPerformance_Zmumu.ps";
   ...
   TH1D * h_MSRefittedTheta = new TH1D("h_MSRefittedTheta", " MSRefittedcotTheta - truthcotTheta ", 50, -0.08, 0.08); 
   ...
   TH1D * h_IDpt_nofit = new TH1D("h_IDpt_nofit", " IDTrk pT for candidates without refit ", 100, 0,100000);
   TH1D * h_IDeta_nofit = new TH1D("h_IDeta_nofit", " IDTrk Eta for candidates without refit ", 60, -3.,3.);
   TH1D * h_IDpt_MSnofit = new TH1D("h_IDpt_MSnofit", " IDTrk pT for candidates without MS refit ", 100, 0,100000);
