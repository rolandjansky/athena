    ...
    */
    ...
    public:
        ...
        /**IMuidCaloTrackStateOnSurface interface:
           ...
           The input TrackParameters may be anywhere along the track. */
        virtual std::unique_ptr<const Trk::TrackStateOnSurface> innerTSOS(const EventContext& ctx,
                                                                          const Trk::TrackParameters& parameters) const = 0;
        virtual std::unique_ptr<const Trk::TrackStateOnSurface> outerTSOS(const EventContext& ctx,
                                                                          const Trk::TrackParameters& parameters) const = 0;
        ...
        virtual std::unique_ptr<const Trk::TrackStateOnSurface> middleTSOS(const EventContext& ctx,
