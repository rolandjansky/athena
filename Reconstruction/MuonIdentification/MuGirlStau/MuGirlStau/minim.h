...
namespace MuGirlNS
{
    ...
    public:
         ...
         */
        double minimize(IObjective& obj, StauTechnology eTech, double& amin, double& amax, double tolerance = 0.0001);
	void createGrid(IObjective& obj, StauTechnology eTech, double& amin, double& amax, double tolerance);
	double minF;    /**< The last value of the objective funtion */
    }; // class Minimizer
}  // namespace MuGirlNS
