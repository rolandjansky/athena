...
namespace MuGirlNS
{
  ...
  class StauRPC
    {
    public:
      StauRPC(StauTool* pStau, MsgStream& log, const MuGirlNS::RIO_OnTrackLists& rpcHitsInSegments);
    ...
    private:
      ...
      double rpcStationChi2(double currentBeta, StauRpcHitsList* pHitsList, int& dof, double tTrack = 0);
      ...
      std::map<int, StauCalibrationParameters >* m_pNewCalibration;
    };
