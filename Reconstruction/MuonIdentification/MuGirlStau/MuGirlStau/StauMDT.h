...
namespace MuGirlNS
{
  ...
  class StauMDT
    {
    public:
      StauMDT(StauTool* pStau, MsgStream& log, const MuGirlNS::MdtSegmentMakerInfoList& mdtSegmentMakerInfoList);
    ...
    private:
      ...
      void bestMdtSegment(MdtSegments* pSegments, const Muon::MuonSegment*& pBestSegment,bool ignoreNumHits = false);
