...
namespace MuonCombined {
    ...
    MuGirlLowBetaTag::MuGirlLowBetaTag(const ElementLink<TrackCollection>& combLink,
        ...
        TagBase(TagBase::Author::MuGirlLowBeta, TagBase::Type::Combined),
        m_combLink(combLink),
        m_meLink(ElementLink<TrackCollection>()),
        m_segments(segments),
        m_muBeta(-9999.),
        m_stauSummary(nullptr),
        m_stauExtras(nullptr),
        m_rhExtras(nullptr) {}

    MuGirlLowBetaTag::MuGirlLowBetaTag(const std::vector<ElementLink<Trk::SegmentCollection> >& segments) :
        TagBase(TagBase::Author::MuGirlLowBeta, TagBase::Type::SegmentTagged),
