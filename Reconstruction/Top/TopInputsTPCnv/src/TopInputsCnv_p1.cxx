...
void TopInputsCnv_p1::transToPers( const TopRec::TopInputs* transObj,
...
void TopInputsCnv_p1::persToTrans( const TopInputs_p1* persObj,
				   TopRec::TopInputs* transObj,
				   MsgStream &msg ) {
  msg << MSG::DEBUG << "In TopInputsCnv_p1::persToTrans()" << endreq;

  TopRec::TopMuonMap muonmap;
  TopInputMap_p1 muonmap_p1 = persObj->m_muonMap_p1;
  m_mu_cnv.persToTrans(&muonmap_p1,&muonmap,msg);
  transObj->setMuonMap(muonmap);

  TopRec::TopElectronMap electronmap;
  TopInputMap_p1 electronmap_p1 = persObj->m_electronMap_p1;
