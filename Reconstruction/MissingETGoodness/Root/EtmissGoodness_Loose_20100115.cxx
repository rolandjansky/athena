...
#include "MissingETGoodness/EtmissGoodness_Loose_20100115.h"
#include "MissingETGoodness/TSelectionSetArchive.h"
#include "CxxUtils/unused.h"

ClassImp(MET::EtmissGoodness_Loose_20100115)


MET::EtmissGoodness_Loose_20100115::EtmissGoodness_Loose_20100115()
 : TSelectionSet(MET::Loose,20100115)
{
}


Bool_t
MET::EtmissGoodness_Loose_20100115::CreateSelection() 
{
  Bool_t status(kTRUE);
  ...
  MET::TSelection sel;
  sel.AddCut("N90Cells_Jet0<0 || N90Cells_Jet0>=5");
  sel.AddCut("N90Cells_Jet1<0 || N90Cells_Jet1>=5");
...
*/
  ...
  this->SetJetKey("AntiKt6H1TopoJets");
...
namespace
{
  const bool UNUSED(dummy) =
    MET::TSelectionSetArchive::instance().RegisterSelectionSetClass(MET::Loose,20100115,"MET::EtmissGoodness_Loose_20100115");
}
