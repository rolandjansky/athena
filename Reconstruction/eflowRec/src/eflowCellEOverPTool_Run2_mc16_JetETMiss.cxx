...
eflowCellEOverPTool_Run2_mc16_JetETMiss::eflowCellEOverPTool_Run2_mc16_JetETMiss(const std::string& type,const std::string& name,const IInterface* parent) : IEFlowCellEOverPTool( type, name, parent) {
...
StatusCode eflowCellEOverPTool_Run2_mc16_JetETMiss::initialize(){

  return StatusCode::SUCCESS;
}

StatusCode eflowCellEOverPTool_Run2_mc16_JetETMiss::fillBinnedParameters(eflowEEtaBinnedParameters *binnedParameters) const {
...
StatusCode eflowCellEOverPTool_Run2_mc16_JetETMiss::finalize(){
  return StatusCode::SUCCESS;
}
