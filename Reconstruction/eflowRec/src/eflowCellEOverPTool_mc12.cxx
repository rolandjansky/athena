...
eflowCellEOverPTool_mc12::eflowCellEOverPTool_mc12(const std::string& type,const std::string& name,const IInterface* parent) : IEFlowCellEOverPTool( type, name, parent) {
...
StatusCode eflowCellEOverPTool_mc12::execute(eflowEEtaBinnedParameters *binnedParameters){
