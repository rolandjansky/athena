...
#Disable masking of electron and muon tracks
jobproperties.eflowRecFlags.useElectrons.set_Value_and_Lock(False)
jobproperties.eflowRecFlags.useMuons.set_Value_and_Lock(False)
