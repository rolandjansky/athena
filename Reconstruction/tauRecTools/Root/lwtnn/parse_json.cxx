...
namespace {
  ...
  lwtDev::Input get_input(const ptree::value_type& v) {
  ...
  lwtDev::Activation get_activation_function(const std::string& str) {
    using namespace lwtDev;
  ...
  lwtDev::Architecture get_architecture(const std::string& str) {
    using namespace lwtDev;
  ...
  const std::map<std::string, lwtDev::Component> component_map {
    {"i", Component::I},
    {"o", Component::O},
    {"c", Component::C},
    {"f", Component::F},
