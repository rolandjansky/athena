...
StatusCode MvaTESEvaluator::initialize(){
  ...
  if(!inTrigger()) {
    ...
    m_availableVars.insert( std::make_pair("TrigTauJetsAuxDyn.lead_cluster_Efrac", &m_lead_cluster_frac) );
    m_availableVars.insert( std::make_pair("TrigTauJetsAuxDyn.upsilon_clusters", &m_upsilon_cluster) );
