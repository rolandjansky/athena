...
namespace Muon {
  ...
  public:
    ...
    private:
      ...
      const std::vector<std::vector<std::pair<const Trk::DetachedTrackingVolume*,const Span*> >* >* findVolumesSpan(const std::vector<std::unique_ptr<const Trk::DetachedTrackingVolume> >* objs, double zTol, double phiTol, LocalVariablesContainer &aLVC) const;
      /** Private methods to define subvolumes and fill them with detached volumes */
      const Trk::TrackingVolume* processVolume( const Trk::Volume*, int, int, std::string, LocalVariablesContainer &aLVC, bool hasStations) const; 
      const Trk::TrackingVolume* processVolume( const Trk::Volume*, int, std::string, LocalVariablesContainer &aLVC, bool hasStations) const; 
      const Trk::TrackingVolume* processShield( const Trk::Volume*, int, std::string, LocalVariablesContainer &aLVC, bool hasStations) const; 
      ...
      ToolHandle<Trk::IDetachedTrackingVolumeBuilderCond>  m_stationBuilder{this,"MuonStationBuilder","Muon::MuonStationBuilderCond/MuonStationBuilderCond"};                //!< A Tool for station type creation

      ToolHandle<Muon::MuonInertMaterialBuilderCond>       m_inertBuilder{this,"InertMaterialBuilder","Muon::MuonInertMaterialBuilderCond/MuonInertMaterialBuilderCond"};      //!< A Tool for inert object  creation
