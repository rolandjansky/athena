...
job.PileUpToolsAlg.PileUpTools += [ RpcDigitizationTool("RpcDigitizationTool") ]
RpcDigitizationTool = job.PileUpToolsAlg.PileUpTools[ "RpcDigitizationTool" ]
RpcDigitizationTool.DeadTime    = 100
RpcDigitizationTool.RndmSvc     = jobproperties.Digitization.rndmSvc.get_Value()
RpcDigitizationTool.RndmEngine  = "RPC_Digitization"
RpcDigitizationTool.FirstXing = -100
RpcDigitizationTool.LastXing = 100
...
#dbConn_Rpc="oracle://ATLAS_COOLPROD;schema=ATLAS_COOLOFL_RPC;dbname=OFLP200"
dbConn_Rpc="COOLOFL_RPC/OFLP200"
#dbConn_Rpc="oracle://intr;schema=ATLAS_COOL_RPCDQ;dbname=RPC_DQA"
#dbConn_Rpc="sqlite://;schema=RPCConditionDB_MC.db;dbname=RPC_DQA"
#dbConn_Rpc="sqlite://;schema=RPCConditionDB_gab2.db;dbname=RPC_DQA"
#dbConn_Rpc="sqlite://;schema=RPCConditionDB_gab3.db;dbname=RPC_DQA"
#dbConn_Rpc="sqlite://;schema=RPCConditionDB_2010_Aug_20.db;dbname=RPC_DQA"
#folder_Rpc="/OFFLINE/FINAL"
folder_Rpc="/RPC/DQMF/ELEMENT_STATUS"

ServiceMgr.IOVDbSvc.dbConnection=dbConn_Rpc
#ServiceMgr.IOVDbSvc.Folders+=[folder_Rpc+" <tag>MC</tag> <dbConnection>"+dbConn_Rpc+"</dbConnection>"]
