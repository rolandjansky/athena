...
#dbConn_Rpc="COOLOFL_RPC/OFLP200"
#ServiceMgr.IOVDbSvc.dbConnection=dbConn_Rpc
#ServiceMgr.IOVDbSvc.Folders+=[folder_Rpc+" <tag>RPCConditionDB_2010_Aug_20</tag> <dbConnection>"+dbConn_Rpc+"</dbConnection>"]
#
...
##
#try:
#    jobproperties.Digitization.rndmSeedList.addSeed(RpcDigitizationTool.RndmEngine, 49261510, 105132394 )
#except AttributeError:
#    jobproperties.Digitization.rndmSeedList.addSeed(RpcDigitizationTool.getDefaultProperty('RndmEngine'), 49261510, 105132394 )
