...
namespace MuonGM {
    ...
    void MuonDetectorFactory001::create(GeoPhysVol *world) {
        ...
        if (sc.isFailure())
            log << MSG::ERROR << " not found MDT " << endmsg;
        else
        ...
        if (sc.isFailure())
            log << MSG::ERROR << " not found RPC " << endmsg;
        else
        ...
        if (sc.isFailure())
            log << MSG::ERROR << " not found TGC " << endmsg;
        else
        ...
        if (m_hasCSC) {
            ...
            if (sc.isFailure())
                log << MSG::ERROR << " not found CSC " << endmsg;
            else
        ...
        if (m_hasSTgc) {
            ...
            if (sc.isFailure())
                log << MSG::ERROR << " not found sTGC " << endmsg;
            else
        ...
        if (m_hasMM) {
            ...
            if (sc.isFailure())
                log << MSG::ERROR << " not found MicroMegas " << endmsg;
            else
