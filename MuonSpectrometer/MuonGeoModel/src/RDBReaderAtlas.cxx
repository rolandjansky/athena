  ...
  m_useICSCAlines(useCscInternalAlinesFromOracle)
{
  ...
  if (asciiFileDBMap!=0 &&
    ...
    log << MSG::INFO
        << "getting aszt from ascii file - named <" << asciiFileDBMap->find("ASZT")->second << ">"
        << endmsg;
    log << MSG::INFO
  ...
  if (asciiFileDBMap!=0 &&
    ...
    log << MSG::INFO
        << "getting iacsc from ascii file - named <" << asciiFileDBMap->find("IACSC")->second << ">"
        << endmsg;
    log << MSG::INFO
