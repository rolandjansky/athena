    ...
    */
    ...
    public:
        ...
        void findSegments(const std::vector<const MdtPrepDataCollection*>& mdtCols,
                          ...
                          const std::vector<const RpcPrepDataCollection*>& rpcCols, IMooSegmentCombinationFinder::Output& output,
    ...
    private:
        ...
        ToolHandle<IMuonCurvedSegmentCombiner> m_curvedSegmentCombiner{this, "SegmentCombiner",
