...
- by the Deterministic Annealing Filter to handle several MuonClusterOnTrack in
one detector element, which compete against each other in being assigned to a
track.
...
public:
  /** Muon::CompetingMuonClustersOnTrackTool is a friend to allow for updates of
  ...
  */
   ...
   * MeasurementBase/CompetingMuonClustersOnTrack. */
...
inline CompetingMuonClustersOnTrack*
CompetingMuonClustersOnTrack::clone() const
{
...
CompetingMuonClustersOnTrack::associatedSurface() const
{
...
inline const Trk::Surface*
CompetingMuonClustersOnTrack::associatedSurfaceRaw() const
{
  return m_associatedSurface;
}
...
CompetingMuonClustersOnTrack::globalPosition() const
{
