...
//-----------------------------------------------------------------------------------------------------------
  ...
  TrackCollection* MuonTrackSteering::findTracks() const {
	...
	//std::cout << "Tracks before refine: " << std::endl << " --- " <<  m_candidateTool->print(*result) <<std::endl;
	...
	//std::cout << "Tracks after refine: " << std::endl << " --- " <<  m_candidateTool->print(*result) <<std::endl;
