...
namespace Muon {
  ...
  */
  ...
  private:
    ...
    /** actual find method */
    TrackCollection* findTracks( SegColVec& chamberSegments, SegColVec& stationSegments,
                                 HitGarbage& hitsToBeDeleted,
                                 MeasGarbage& measurementsToBeDeleted ) const;
    bool extractSegments( const MuonSegmentCollection& coll, SegColVec& chamberSegments, SegColVec& stationSegments, ChSet&  chambersWithSegments, StSet& stationsWithSegments,
                          HitGarbage& hitsToBeDeleted,
                          MeasGarbage& measurementsToBeDeleted ) const;
    ...
    std::vector<std::unique_ptr<MuPatTrack> > extendWithLayer(MuPatTrack& candidate, const SegColVec& segcol, unsigned int nextlayer, const unsigned int endlayer,
                                                              HitGarbage& hitsToBeDeleted,
    ...
    */
    std::vector< std::unique_ptr<MuPatTrack> > findTrackFromSeed( MuPatSegment& seedSeg , const MuonTrackSteeringStrategy & strat , const unsigned int layer , const SegColVec& segs,
                                                                  HitGarbage& hitsToBeDeleted,
                                                                  MeasGarbage& measurementsToBeDeleted ) const;

    void refineTracks(std::vector<std::unique_ptr<MuPatTrack> >& candidates,
                      HitGarbage& hitsToBeDeleted,
                      MeasGarbage& measurementsToBeDeleted) const;
