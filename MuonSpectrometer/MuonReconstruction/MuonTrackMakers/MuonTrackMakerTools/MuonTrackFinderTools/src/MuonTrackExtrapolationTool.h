...
namespace Muon {
    ...
    private:
        /// Need to check whether this method can be removed eventually as it is not in use for the moment
        ...
        const Trk::TrackParameters *findClosestParametersToMuonEntry(const Trk::Track &track, const EventContext &ctx) const;

        const Trk::Perigee *createPerigee(const EventContext &ctx, const Trk::TrackParameters &pars) const;
        ...
        std::unique_ptr<const Trk::TrackParameters> extrapolateToMuonEntryRecord(const EventContext &ctx, const Trk::TrackParameters &pars,
                                                                                 Trk::ParticleHypothesis particleHypo = Trk::muon) const;

        /** extrapolates track parameters to muon entry record, will return a zero pointer if the extrapolation fails. The caller gets
         * ownership of the new parameters */
        std::unique_ptr<const Trk::TrackParameters> extrapolateToIP(const EventContext &ctx, const Trk::TrackParameters &pars,
                                                                    Trk::ParticleHypothesis particleHypo = Trk::muon) const;
