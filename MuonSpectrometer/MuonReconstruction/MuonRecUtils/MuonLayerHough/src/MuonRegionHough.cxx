...
namespace MuonHough {
  ...
  void MuonDetectorHough::init() {
    MuonDetectorDescription detectorDescription;
  ...
  void MuonDetectorDescription::initDefaultRegions() {
    ...
    m_regionDescriptions[Muon::MuonStationIndex::BIS] = RegionDescriptor( 1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BIS,  4560,  -7500,  7500, 30, 0.1, 3 );
    m_regionDescriptions[Muon::MuonStationIndex::BIL] = RegionDescriptor(  1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BIL,  4950,  -7000,  7000, 30, 0.1, 3 );
    m_regionDescriptions[Muon::MuonStationIndex::BMS] = RegionDescriptor(  1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BMS,  8096,  -9500,  9500, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::BML] = RegionDescriptor(  1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BML,  7153,  -9500,  9500, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::BOS] = RegionDescriptor(  1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BOS, 10570, -13500, 13500, 30, 0.1, 7 );
    m_regionDescriptions[Muon::MuonStationIndex::BOL] = RegionDescriptor(  1, Muon::MuonStationIndex::Barrel, Muon::MuonStationIndex::BOL,  9500, -13500, 13500, 30, 0.1, 7 );
    m_regionDescriptions[Muon::MuonStationIndex::BEE] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::BEE,  4415,  7500, 13000, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::EIS] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EIS,  7270,  1000,  7000, 30, .05, 3 );
    m_regionDescriptions[Muon::MuonStationIndex::EIL] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EIL,  7675,  1000,  8000, 30, .05, 3 );
    m_regionDescriptions[Muon::MuonStationIndex::EES] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EES, 10800,  4000, 10000, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::EEL] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EEL, 11330,  4000, 10000, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::EMS] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EMS, 13872,  1500, 13000, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::EML] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EML, 14310,  1500, 13000, 30, 0.1, 5 );
    m_regionDescriptions[Muon::MuonStationIndex::EOS] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EOS, 21841,  2000, 13500, 30, 0.1, 7 );
    m_regionDescriptions[Muon::MuonStationIndex::EOL] = RegionDescriptor(  1, Muon::MuonStationIndex::EndcapA, Muon::MuonStationIndex::EOL, 21421,  2000, 13500, 30, 0.1, 7 );
  }
