...
Shared hits are allowed within certain constraints. For the book keeping which hits are alreasy used.
Some inline methods of the selection tool allow the client to use some functionality of the association tool via the
selection tool.
