...
This tool also makes use of the Muon::MuonHolesOnTrackTool to count the missing measurements.


@see Trk::ITrackSummaryHelperTool
@see Trk::TrackSummaryTool
@see InDet::InDetTrackSummaryHelperTool
