...
#include "MuonG4SD/TGCSensitiveDetector.h"
...
static FADS::SensitiveDetectorEntryT<TGCSensitiveDetector> tgcsd("TGCSens");


// construction/destruction
TGCSensitiveDetector::TGCSensitiveDetector(std::string s):FadsSensitiveDetector(s), myTGCHitColl(0)
{
...
{
        //myTGCHitColl = new TGCSimHitCollection("TGC_Hits");
...
void TGCSensitiveDetector::EndOfEvent(G4HCofThisEvent* /*HCE*/) {
        if (!m_allowMods)
