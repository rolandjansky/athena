...
#include "MuonG4SD/CSCSensitiveDetector.h"
...
static FADS::SensitiveDetectorEntryT<CSCSensitiveDetector> cscsd("CSCSens");


// construction/destruction

CSCSensitiveDetector::CSCSensitiveDetector(std::string name)
...
// S.Spagnolo
      ...
      CSCSimHit* newHit = new CSCSimHit(CSCid, globalTime, energyDeposit,
...
void CSCSensitiveDetector::EndOfEvent(G4HCofThisEvent* /*HCE*/) {
        if (!m_allowMods)
