...
#include "src/MDTSensitiveDetector.h"
...
class MDTSensitiveDetectortest : public ::testing::Test {	
  protected:
    virtual void SetUp() override {
    }
...
TEST_F ( MDTSensitiveDetectortest, ProcessHits )
{
  G4Step sp;
...
TEST_F ( MDTSensitiveDetectortest, GetIdentifier )
{
