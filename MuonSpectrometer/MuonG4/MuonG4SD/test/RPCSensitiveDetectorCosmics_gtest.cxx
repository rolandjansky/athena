...
#include "src/RPCSensitiveDetectorCosmics.h"
...
class RPCSensitiveDetectorCosmicstest : public ::testing::Test {	
  protected:
    virtual void SetUp() override {
    }
...
{
  G4HCofThisEvent hce;
  RPCSensitiveDetectorCosmics sd1("name1", "name1", 2); // name, hitCollectionName, nGasGaps
  sd1.Initialize( &hce );
  ASSERT_TRUE(sd1.m_myRPCHitColl.isValid()); //check if initialization of m_myRPCHitColl is successful
}

TEST_F ( RPCSensitiveDetectorCosmicstest, ProcessHits )
{
  G4Step sp;
  ...
  RPCSensitiveDetectorCosmics sd2("name2", "name2", 2);
