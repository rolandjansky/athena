...
namespace Muon {
    ...
    private:
        void addTrackRecords(xAOD::TruthParticle& truthParticle,
        ...
        void createSegments(const ElementLink<xAOD::TruthParticleContainer>& truthLink, const MuonTruthDecorationAlg::ChamberIdMap& ids,
                            xAOD::MuonSegmentContainer& segmentContainer, const std::vector<const MuonSimDataCollection*>& sdoCollections,
