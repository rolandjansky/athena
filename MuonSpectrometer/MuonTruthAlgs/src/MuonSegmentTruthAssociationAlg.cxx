...
namespace Muon {
    ...
    // Finalize method:
    StatusCode MuonSegmentTruthAssociationAlg::finalize() { return StatusCode::SUCCESS; }
        ...
        for (const auto& result : segmentMatchResult) {
            ...
            for (auto& truthSegLink : truthPos->second) {
                ...
                if (barcode % m_barcodeOffset == truthParticle->barcode()) {
                    ...
                    const_cast<xAOD::MuonSegment*>(truthSegment)->auxdata<ElementLink<xAOD::MuonSegmentContainer> >("recoSegmentLink") =
                        recoLink;
                    const_cast<xAOD::MuonSegment*>(recoSegment)->auxdata<ElementLink<xAOD::MuonSegmentContainer> >("truthSegmentLink") =
                        truthSegLink;
                } else {
