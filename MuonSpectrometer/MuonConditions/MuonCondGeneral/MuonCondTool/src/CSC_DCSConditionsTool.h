...
public:
    CSC_DCSConditionsTool(const std::string& type, const std::string& name, const IInterface* parent);
    ...
    virtual std::string ChamberFolder() const override { return m_chamberFolder; }
    virtual const std::map<Identifier, int>& CSC_ChamberId() const { return m_CSC_LayerMap; }

    virtual const std::vector<std::string>& deadStationsStr() const { return m_cachedDeadStationsStr; }
    virtual const std::vector<Identifier>& deadStationsId() const override { return m_cachedDeadStationsId; }
    virtual const std::vector<Identifier>& deadWireLayersId() const override { return m_cachedDeadWireLayersId; }

    virtual const std::vector<std::string>& deadStations() const override { return m_cachedDeadStationsStr; }
    virtual const std::vector<std::string>& deadWireLayers() const override { return m_cachedDeadWireLayers; }
