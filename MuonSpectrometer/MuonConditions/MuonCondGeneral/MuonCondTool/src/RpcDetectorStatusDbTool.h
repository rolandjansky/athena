...
class RpcDetectorStatusDbTool : public AthAlgTool, virtual public IRpcDetectorStatusDbTool {
public:
    RpcDetectorStatusDbTool(const std::string& type, const std::string& name, const IInterface* parent);
