...
if useAlign:
    ...
    MuonAlignmentCondAlg.ParlineFolders = ["/MUONALIGN/MDT/BARRELJSONS",
                                         "/MUONALIGN/MDT/ENDCAP/SIDEAJSONS",
                                         "/MUONALIGN/MDT/ENDCAP/SIDECJSONS",
                                         "/MUONALIGN/CSC/ILINESJSONS",
                                         "/MUONALIGN/TGC/SIDEAJSONS",
                                         "/MUONALIGN/TGC/SIDECJSONS"
                                         ]
    MuonAlignmentCondAlg.ReadMdtBarrelKey      = "/MUONALIGN/MDT/BARRELJSONS"
    MuonAlignmentCondAlg.ReadMdtEndcapSideAKey = "/MUONALIGN/MDT/ENDCAP/SIDEAJSONS"
    MuonAlignmentCondAlg.ReadMdtEndcapSideCKey = "/MUONALIGN/MDT/ENDCAP/SIDECJSONS"
    MuonAlignmentCondAlg.ReadTgcSideAKey       = "/MUONALIGN/TGC/SIDEAJSONS"
    MuonAlignmentCondAlg.ReadTgcSideCKey       = "/MUONALIGN/TGC/SIDECJSONS"
    MuonAlignmentCondAlg.ReadCscILinesKey      = "/MUONALIGN/CSC/ILINESJSONS"
    MuonAlignmentCondAlg.NewFormat2020 = True
