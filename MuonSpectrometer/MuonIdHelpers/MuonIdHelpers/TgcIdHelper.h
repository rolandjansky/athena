...
inline Identifier TgcIdHelper::elementID(int stationName, int stationEta, int stationPhi, bool check, bool* isValid) const {
...
inline Identifier TgcIdHelper::elementID(const std::string& stationNameStr, int stationEta, int stationPhi, bool check,
                                         bool* isValid) const {
    Identifier id;
...
inline Identifier TgcIdHelper::elementID(const Identifier& id) const { return parentID(id); }

inline Identifier TgcIdHelper::channelID(int stationName, int stationEta, int stationPhi, int gasGap, int isStrip, int channel, bool check,
                                         bool* isValid) const {
    // pack fields independently
    Identifier result((Identifier::value_type)0);
    bool val = false;
...
inline Identifier TgcIdHelper::channelID(const std::string& stationNameStr, int stationEta, int stationPhi, int gasGap, int isStrip,
...
inline Identifier TgcIdHelper::channelID(const Identifier& id, int gasGap, int isStrip, int channel, bool check, bool* isValid) const {
...
inline int TgcIdHelper::gasGap(const Identifier& id) const { return m_gap_impl.unpack(id); }

/** returns measuresPhi */
inline int TgcIdHelper::isStrip(const Identifier& id) const { return m_ist_impl.unpack(id); }

inline bool TgcIdHelper::measuresPhi(const Identifier& id) const { return isStrip(id); }

inline int TgcIdHelper::channel(const Identifier& id) const { return m_cha_impl.unpack(id); }

// Access to min and max of level ranges

inline int TgcIdHelper::stationEtaMin() const { return StationEtaMin; }

inline int TgcIdHelper::stationEtaMax() const { return StationEtaMax; }
...
inline int TgcIdHelper::gasGapMin() const { return GasGapMin; }
...
inline int TgcIdHelper::isStripMin() const { return IsStripMin; }

inline int TgcIdHelper::isStripMax() const { return IsStripMax; }

inline int TgcIdHelper::channelMin() const { return ChannelMin; }

inline int TgcIdHelper::channelMax() const { return ChannelMax; }
/// Utility methods
