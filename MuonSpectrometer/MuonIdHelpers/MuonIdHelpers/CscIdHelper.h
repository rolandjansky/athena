...
inline Identifier CscIdHelper::elementID(int stationName, int stationEta, int stationPhi, bool check, bool* isValid) const {
...
inline Identifier CscIdHelper::elementID(const std::string& stationNameStr, int stationEta, int stationPhi, bool check,
                                         bool* isValid) const {
    Identifier id;
...
inline Identifier CscIdHelper::elementID(const Identifier& id) const { return parentID(id); }

inline Identifier CscIdHelper::channelID(int stationName, int stationEta, int stationPhi, int chamberLayer, int wireLayer, int measuresPhi,
...
inline Identifier CscIdHelper::channelID(const std::string& stationNameStr, int stationEta, int stationPhi, int chamberLayer, int wireLayer,
...
inline Identifier CscIdHelper::channelID(const Identifier& id, int chamberLayer, int wireLayer, int measuresPhi, int strip, bool check,
                                         bool* isValid) const {
...
inline int CscIdHelper::chamberLayer(const Identifier& id) const { return m_cla_impl.unpack(id); }

inline int CscIdHelper::wireLayer(const Identifier& id) const { return m_lay_impl.unpack(id); }

inline bool CscIdHelper::measuresPhi(const Identifier& id) const { return m_mea_impl.unpack(id); }

inline int CscIdHelper::strip(const Identifier& id) const { return m_str_impl.unpack(id); }

inline int CscIdHelper::channel(const Identifier& id) const { return strip(id); }

/// Access to min and max of level ranges

inline int CscIdHelper::stationEtaMin() const { return StationEtaMin; }

inline int CscIdHelper::stationEtaMax() const { return StationEtaMax; }

inline int CscIdHelper::stationPhiMin() const { return StationPhiMin; }

inline int CscIdHelper::stationPhiMax() const { return StationPhiMax; }

inline int CscIdHelper::chamberLayerMin() const { return ChamberLayerMin; }

inline int CscIdHelper::chamberLayerMax() const { return ChamberLayerMax; }

inline int CscIdHelper::wireLayerMin() const { return WireLayerMin; }

inline int CscIdHelper::wireLayerMax() const { return WireLayerMax; }

inline int CscIdHelper::measuresPhiMin() const { return MeasuresPhiMin; }

inline int CscIdHelper::measuresPhiMax() const { return MeasuresPhiMax; }

inline int CscIdHelper::stripMin() const { return StripMin; }

inline int CscIdHelper::stripMax() const { return StripMax; }
...
inline int CscIdHelper::sector(const Identifier& id) const { return stationEta(id) * (2 * stationPhi(id) - (stationName(id) - 49) + 1); }

inline int CscIdHelper::gasGap(const Identifier& id) const { return chamberLayer(id); }
