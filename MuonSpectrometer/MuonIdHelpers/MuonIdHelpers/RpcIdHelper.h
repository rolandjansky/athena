...
public:
    ...
    Identifier elementID(int stationName, int stationEta, int stationPhi, int doubletR, bool check = false, bool* isValid = 0,
                         bool noPrint = false) const;
    Identifier elementID(const std::string& stationNameStr, int stationEta, int stationPhi, int doubletR, bool check = false,
    ...
    Identifier channelID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi, int gasGap,
                         int measuresPhi, int strip, bool check = false, bool* isValid = 0, bool noPrint = false) const;
    ...
    Identifier channelID(const Identifier& id, int doubletZ, int doubletPhi, int gasGap, int measuresPhi, int strip, bool check = false,
                         bool* isValid = 0) const;
    ...
    Identifier padID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi, bool check = false,
                     bool* isValid = 0) const;
    ...
    Identifier panelID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi, int gasGap,
                       int measuresPhi, bool check = false, bool* isValid = 0) const;
...
inline Identifier RpcIdHelper::elementID(int stationName, int stationEta, int stationPhi, int doubletR, bool check, bool* isValid,
                                         bool noPrint) const {
...
inline Identifier RpcIdHelper::elementID(const std::string& stationNameStr, int stationEta, int stationPhi, int doubletR, bool check,
                                         bool* isValid) const {
    Identifier id;
...
inline Identifier RpcIdHelper::elementID(const Identifier& id) const { return parentID(id); }
...
inline Identifier RpcIdHelper::panelID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi,
                                       int gasGap, int measuresPhi, bool check, bool* isValid) const {
    // pack fields independently
    Identifier result((Identifier::value_type)0);
    bool val = false;
    m_muon_impl.pack(muon_field_value(), result);
...
inline Identifier RpcIdHelper::gapID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi,
                                     int gasGap, bool check, bool* isValid) const {
    // pack fields independently
    Identifier result((Identifier::value_type)0);
    bool val = false;
    m_muon_impl.pack(muon_field_value(), result);
...
inline Identifier RpcIdHelper::channelID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi,
                                         int gasGap, int measuresPhi, int strip, bool check, bool* isValid, bool noPrint) const {
    // pack fields independently
    Identifier result((Identifier::value_type)0);
    bool val = false;
    m_muon_impl.pack(muon_field_value(), result);
...
inline Identifier RpcIdHelper::channelID(const std::string& stationNameStr, int stationEta, int stationPhi, int doubletR, int doubletZ,
...
inline Identifier RpcIdHelper::channelID(const Identifier& id, int doubletZ, int doubletPhi, int gasGap, int measuresPhi, int strip,
...
inline Identifier RpcIdHelper::padID(int stationName, int stationEta, int stationPhi, int doubletR, int doubletZ, int doubletPhi,
                                     bool check, bool* isValid) const {
    // pack fields independently
    Identifier result((Identifier::value_type)0);
    bool val = false;
...
inline Identifier RpcIdHelper::padID(const Identifier& id, int doubletZ, int doubletPhi, bool check, bool* isValid) const {
    // pack fields independently
    Identifier result(id);
    bool val = false;
    m_dbz_impl.pack(doubletZ, result);
...
inline int RpcIdHelper::doubletR(const Identifier& id) const { return m_dbr_impl.unpack(id); }

inline int RpcIdHelper::doubletZ(const Identifier& id) const { return m_dbz_impl.unpack(id); }

inline int RpcIdHelper::doubletPhi(const Identifier& id) const { return m_dbp_impl.unpack(id); }

inline int RpcIdHelper::gasGap(const Identifier& id) const { return m_gap_impl.unpack(id); }

inline bool RpcIdHelper::measuresPhi(const Identifier& id) const { return m_mea_impl.unpack(id); }

inline int RpcIdHelper::strip(const Identifier& id) const { return m_str_impl.unpack(id); }

inline int RpcIdHelper::channel(const Identifier& id) const { return strip(id); }

// Access to min and max of level ranges

inline int RpcIdHelper::stationEtaMin() const { return StationEtaMin; }

inline int RpcIdHelper::stationEtaMax() const { return StationEtaMax; }

inline int RpcIdHelper::stationPhiMin() const { return StationPhiMin; }

inline int RpcIdHelper::stationPhiMax() const { return StationPhiMax; }

inline int RpcIdHelper::doubletRMin() const { return DoubletRMin; }

inline int RpcIdHelper::doubletRMax() const { return DoubletRMax; }

inline int RpcIdHelper::doubletZMin() const { return DoubletZMin; }

inline int RpcIdHelper::doubletZMax() const { return DoubletZMax; }

inline int RpcIdHelper::doubletPhiMin() const { return DoubletPhiMin; }

inline int RpcIdHelper::doubletPhiMax() const { return DoubletPhiMax; }

inline int RpcIdHelper::gasGapMin() const { return GasGapMin; }

inline int RpcIdHelper::gasGapMax() const { return m_gasGapMax; }

inline int RpcIdHelper::measuresPhiMin() const { return MeasuresPhiMin; }

inline int RpcIdHelper::measuresPhiMax() const { return MeasuresPhiMax; }

inline int RpcIdHelper::stripMin() const { return StripMin; }

inline int RpcIdHelper::stripMax() const { return StripMax; }
