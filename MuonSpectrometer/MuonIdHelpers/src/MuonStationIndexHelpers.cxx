...
namespace Muon {
  ...
  std::vector<MuonStationIndex::TechnologyIndex> MuonStationIndexHelpers::technologiesInStation( MuonStationIndex::StIndex stIndex ) {
    ...
    static const  std::vector<MuonStationIndex::TechnologyIndex> mmm_endcapInner = { MuonStationIndex::MDT,MuonStationIndex::CSCI,MuonStationIndex::TGC,MuonStationIndex::STGC,MuonStationIndex::MM };
