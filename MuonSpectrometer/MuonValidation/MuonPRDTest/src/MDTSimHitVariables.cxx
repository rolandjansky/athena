...
StatusCode MDTSimHitVariables::fillVariables()
{

  ATH_MSG_INFO("do fillMDTSimHitVariables()");
  ...
  for( auto it : *mdtContainer ) {
    ...
    const MuonGM::MdtReadoutElement* mdtdet = m_detManager->getMdtReadoutElement(offid);
  ...
  ATH_MSG_INFO("processed " << m_MDT_nSimHits << " Mdt hits");
