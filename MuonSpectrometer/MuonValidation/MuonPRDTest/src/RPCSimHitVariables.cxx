...
StatusCode RPCSimHitVariables::fillVariables()
{

  ATH_MSG_INFO("do fillRPCSimHitVariables()");
...
//             <<" dbRZP "<<dbr<<" "<<dbz<<" "<<dbp<<" "<<gg<<" "<<mfi<<" "<<strip<<std::endl;
    ...
    const MuonGM::RpcReadoutElement* rpcdet = m_detManager->getRpcReadoutElement(offid);
  ...
  ATH_MSG_INFO("processed " << m_RPC_nSimHits << " Rpc hits");
