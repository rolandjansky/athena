        ...
        if self.__chamber_name == "MDT_Digit":
            if not (self.__eta_sel(TTree) and self.__sector_sel(TTree)):
                ...
                if TTree.Digits_MDT_stationName[n]=="BIS" and MyHistoFiller.Eta(ord(TTree.Digits_MDT_stationEta[n]))>6: 
                    ...
                    bis_mdtDigitStationEta.Fill(MyHistoFiller.Eta(ord(TTree.Digits_MDT_stationEta[n])))
                    bis_mdtDigitStationPhi.Fill(ord(TTree.Digits_MDT_stationPhi[n]))
                    ...
                    bis_mdtDigitTube.Fill(ord(TTree.Digits_MDT_tube[n]))
                    bis_mdtDigitTubeLayer.Fill(ord(TTree.Digits_MDT_tubeLayer[n]))
                    bis_mdtDigitMultilayer.Fill(ord(TTree.Digits_MDT_multiLayer[n]))
