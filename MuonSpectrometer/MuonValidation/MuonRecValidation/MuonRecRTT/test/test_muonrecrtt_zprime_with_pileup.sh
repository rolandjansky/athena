...
#
# art-input: user.artprod.user.zhidong.valid1.361405.Sherpa_CT10_Zmumu_Pt280_500_CVetoBVeto.recon.RDO_TRIG.e5112_s3195_r9723_tid12019967_00_subset01
# art-input-nfiles: 6
...
case $ArtProcess in
  ...
  *)
     ...
     Reco_tf.py --maxEvents=-1 \
                --inputRDOFile=${infile} \
                --outputAODFile=valid1.361405.Sherpa_CT10_Zmumu_Pt280_500_CVetoBVeto_with_pileup.AOD.pool.root $ValOption \
