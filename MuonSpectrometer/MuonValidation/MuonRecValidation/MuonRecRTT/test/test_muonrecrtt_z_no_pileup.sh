...
#
# art-input: user.artprod.user.zhidong.valid1.361107.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zmumu.recon.RDO.no_pileup.e5112_s3195_tid12019815_01_EXT0
# art-input-nfiles: 6
...
case $ArtProcess in
  ...
  *)
     ...
     Reco_tf.py --maxEvents=-1  \
                --inputRDOFile=${infile} \
                --outputAODFile=valid1.361107.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zmumu_no_pileup.AOD.pool.root     $ValOption \
