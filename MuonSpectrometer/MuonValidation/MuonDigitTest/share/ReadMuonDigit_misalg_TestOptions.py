...
EventSelector.InputCollections +=[ "rfio:/castor/cern.ch/user/m/muonprod/1203/digit_displ_mf_geom/mc12.007211.digit_displ_mf_geom.mu_pt10GeV/mc12.007211.digit_displ_mf_geom.mu_pt10GeV._00001.pool.root" 
]
...
#'ATLAS-CSC-01-01-00'    --> same as ATLAS-CSC-00-01-00 but using
#misaligned  layouts for LAr and Muons using GeoModelTags and condDB for IDET
#bmagatlas04_test1.data with shifts_tilts
...
THistSvc.Output += ["MuonDigits DATAFILE='MuonDigitsVal_misalg_mupt10GeV.aan.root' OPT='NEW'"]
#--------------------------------------------------------------
