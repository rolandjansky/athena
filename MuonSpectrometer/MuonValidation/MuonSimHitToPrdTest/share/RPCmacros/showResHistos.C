  ...
  if (file->IsOpen())
    {
      ...
      cAll->Divide(2,2);
      cAll->cd(1);
      TH1F* digXYsideC_all = (TH1F*)gROOT->FindObject("digXYsideC_all");digXYsideC_all->Draw();
      TH1F* dighitXYsideC_all = (TH1F*)gROOT->FindObject("dighitXYsideC_all");dighitXYsideC_all->SetLineColor(2);dighitXYsideC_all->Draw("SAME");
      cAll->cd(2);
      TH1F* digXYsideA_all = (TH1F*)gROOT->FindObject("digXYsideA_all");digXYsideA_all->Draw();
      TH1F* dighitXYsideA_all = (TH1F*)gROOT->FindObject("dighitXYsideA_all");dighitXYsideA_all->SetLineColor(2);dighitXYsideA_all->Draw("SAME");
      cAll->cd(3);
      h_dighitZResVsZC->SetLineColor(2);h_dighitZResVsZC->Draw();
      TH1F* digZsideC_all  = (TH1F*)gROOT->FindObject("digZsideC_all");digZsideC_all->Draw("SAME");
      cAll->cd(4);
      h_dighitZResVsZA->SetLineColor(2);h_dighitZResVsZA->Draw();
      TH1F* digZsideA_all  = (TH1F*)gROOT->FindObject("digZsideA_all");digZsideA_all->Draw("SAME");
      cAll->SaveAs("resDigAll.png");


      cLowPt->Divide(2,2);
      cLowPt->cd(1);
      TH1F* digZsideC_lay1  = (TH1F*)gROOT->FindObject("digZsideC_lay1");digZsideC_lay1->Draw();
      cLowPt->cd(2);
      TH1F* digZsideA_lay1  = (TH1F*)gROOT->FindObject("digZsideA_lay1");digZsideA_lay1->Draw();
      cLowPt->cd(3);
      TH1F* digZsideC_lay2  = (TH1F*)gROOT->FindObject("digZsideC_lay2");digZsideC_lay2->Draw();
      cLowPt->cd(4);
      TH1F* digZsideA_lay2  = (TH1F*)gROOT->FindObject("digZsideA_lay2");digZsideA_lay2->Draw();
      cLowPt->SaveAs("resZdigLowPt.png");

      cPivot->Divide(2,2);
      cPivot->cd(1);
      TH1F* digZsideC_lay3  = (TH1F*)gROOT->FindObject("digZsideC_lay3");digZsideC_lay3->Draw();
      cPivot->cd(2);
      TH1F* digZsideA_lay3  = (TH1F*)gROOT->FindObject("digZsideA_lay3");digZsideA_lay3->Draw();
      cPivot->cd(3);
      TH1F* digZsideC_lay4  = (TH1F*)gROOT->FindObject("digZsideC_lay4");digZsideC_lay4->Draw();
      cPivot->cd(4);
      TH1F* digZsideA_lay4  = (TH1F*)gROOT->FindObject("digZsideA_lay4");digZsideA_lay4->Draw();
      cPivot->SaveAs("resZdigPivot.png");

      cHighPt->Divide(2,2);
      cHighPt->cd(1);
      TH1F* digZsideC_lay5  = (TH1F*)gROOT->FindObject("digZsideC_lay5");digZsideC_lay5->Draw();
      cHighPt->cd(2);
      TH1F* digZsideA_lay5  = (TH1F*)gROOT->FindObject("digZsideA_lay5");digZsideA_lay5->Draw();
      cHighPt->cd(3);
      TH1F* digZsideC_lay6  = (TH1F*)gROOT->FindObject("digZsideC_lay6");digZsideC_lay6->Draw();
      cHighPt->cd(4);
      TH1F* digZsideA_lay6  = (TH1F*)gROOT->FindObject("digZsideA_lay6");digZsideA_lay6->Draw();
      ...
      plotIdealEff(cEffVsZlpt, 
		   h_hitVsZlay1, h_digeffVsZlay1, h_digitVsZlay1, 
		   h_hitVsZlay2, h_digeffVsZlay2, h_digitVsZlay2);
      plotIdealEff(cEffVsZpiv, 
		   h_hitVsZlay3, h_digeffVsZlay3, h_digitVsZlay3, 
		   h_hitVsZlay4, h_digeffVsZlay4, h_digitVsZlay4);
      plotIdealEff(cEffVsZhpt, 
		   h_hitVsZlay5, h_digeffVsZlay5, h_digitVsZlay5, 
		   h_hitVsZlay6, h_digeffVsZlay6, h_digitVsZlay6);

      plotIdealEff(cEffVsPlpt, 
		   h_hitVsPlay1, h_digeffVsPlay1, h_digitVsPlay1, 
		   h_hitVsPlay2, h_digeffVsPlay2, h_digitVsPlay2);
      plotIdealEff(cEffVsPpiv, 
		   h_hitVsPlay3, h_digeffVsPlay3, h_digitVsPlay3, 
		   h_hitVsPlay4, h_digeffVsPlay4, h_digitVsPlay4);
      plotIdealEff(cEffVsPhpt, 
		   h_hitVsPlay5, h_digeffVsPlay5, h_digitVsPlay5, 
		   h_hitVsPlay6, h_digeffVsPlay6, h_digitVsPlay6);
