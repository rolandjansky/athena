...
// Sun Nov  8 10:10:16 2009 by ROOT version 5.22/00d
// from TTree csc_cluster/CSC clusters
// found on file: /susyraid1/home/wpark/atlas/AtlasOffline-15.5.1/MuonSpectrometer/MuonValidation/MuonCscValidation/CscClusterValidation/run/../run/cosmic125032.20000_0.0xsigma_RNDM.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           evt;
   Int_t           nentry;
   Float_t         pos[2000];   //[nentry]
   Float_t         error[2000];   //[nentry]
   Float_t         x[2000];   //[nentry]
   Float_t         y[2000];   //[nentry]
   Float_t         z[2000];   //[nentry]
   Int_t           nstrip[2000];   //[nentry]
   Float_t         qstrip[2000][10];   //[nentry]
   Float_t         tstrip[2000][10];   //[nentry]
   Float_t         qpeak[2000];   //[nentry]
   Int_t           speak[2000];   //[nentry]
   Float_t         qsum[2000];   //[nentry]
   Float_t         qleft[2000];   //[nentry]
   Int_t           sleft[2000];   //[nentry]
   Float_t         qright[2000];   //[nentry]
   Int_t           sright[2000];   //[nentry]
   Float_t         tpeak[2000];   //[nentry]
   Int_t           sfit[2000];   //[nentry]
   Int_t           measphi[2000];   //[nentry]
   Int_t           wlay[2000];   //[nentry]
   Int_t           istation[2000];   //[nentry]
   Int_t           zsec[2000];   //[nentry]
   Int_t           phisec[2000];   //[nentry]
   Int_t           sector[2000];   //[nentry]
   Float_t         pitch[2000];   //[nentry]
   Int_t           srefit[2000][10];   //[nentry]
   Float_t         posrefit[2000][10];   //[nentry]
   Float_t         errrefit[2000][10];   //[nentry]
   Float_t         maxstrip[2000];   //[nentry]
   Int_t           strip0[2000];   //[nentry]
   Int_t           pstrip[2000];   //[nentry]
   Float_t         scor1[2000];   //[nentry]
   Float_t         scor2[2000];   //[nentry]
   Float_t         scor[2000];   //[nentry]
   Float_t         dscor1[2000];   //[nentry]
   Float_t         dscor2[2000];   //[nentry]
   Float_t         dscor[2000];   //[nentry]
   Float_t         scordiff[2000];   //[nentry]
   Float_t         dscordiff[2000];   //[nentry]
