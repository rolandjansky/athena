...
if not doReadBS:
  ...
  ServiceMgr.EventSelector.InputCollections += [ "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.001.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.002.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.003.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.004.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.005.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.006.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.007.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.008.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.009.pool.root", "root://castoratlas//castor/cern.ch/user/k/kbachas/Simulation/Mu_10GeV/rel_4/hits.Mu_10GeV.010.pool.root" ]
...
sampletype='mu_pt10GeV';
atlastag='GEO-08-00-02';
RootHistOutputFileName = 'MuonHitsVal_'+str(atlastag)+'.'+str(sampletype)+'.root' 
RootTupleOutputFileName = 'MuonHitsVal_'+str(atlastag)+'.'+str(sampletype)+'.aan.root' 
#-------------------------------------------------------------- 
# histograms
#-------------------------------------------------------------- 
