...
def browseDir( dir ):
    ...
    for key in dir.GetListOfKeys():
        ...
        if obj.IsA().InheritsFrom(ROOT.TH2.Class()) or obj.IsA().InheritsFrom(ROOT.TProfile.Class()) or "_Eff_" in obj.GetName() or "PtResol" in obj.GetName() or "PtScale" in obj.GetName():
            continue
