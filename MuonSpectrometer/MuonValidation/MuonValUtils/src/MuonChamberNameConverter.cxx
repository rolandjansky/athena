...
#include "MuonValUtils/MuonChamberNameConverter.h"
#include <cstdlib>
using namespace std;
...
std::string convertChamberName(int ChamberName , int ChamberEta , int ChamberPhi , std::string ChamberType) {
  ...
  if (m_Type=="MDT" || m_Type=="CSC" || m_Type=="TGC"){
	...
	// identifier :   harware name	  : limit eta	       : forbiden eta	    : min phi		 :  max phi	      :   allowed    phi1     :	allowed phi2      :  long/short
      ...
      case 14 : m_Name_string = "EEL_DOES_NOT_EXIST!"; limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-1); break;
      case 15 : m_Name_string = "EES_DOES_NOT_EXIST!"; limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-100); limits.push_back(-1); break;
	...
	// TGC end   ;    harware name	  : limit eta	       : forbiden eta	    : min phi		 :  max phi	      :   allowed    phi1     :	allowed phi2      :  long/short
      ...
      case 50 : m_Name_string = "CSS"; break;
      case 51 : m_Name_string = "CSL"; break;
