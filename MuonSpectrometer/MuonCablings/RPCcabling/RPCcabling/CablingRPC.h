...
class CablingRPC : public CablingRPCBase
{
    ...
    public:
    static const CablingRPCBase* instance(void);
    static const CablingRPCBase* instance(std::string,std::string,std::string,bool);
...
bool correct (unsigned short int SubsystemId,
  ...
  //  need to implement a new interface used in MuonRPC_Cabling
  unsigned long int strip_code_fromOffId(std::string /*stationName*/, int /*stationEta*/, int /*stationPhi*/, int /*doubletR*/, int /*doubletZ*/, int /*doubletPhi*/, int /*gasGap*/, int /*measuresPhi*/, int /*strip*/) {return 0;}
    
  RPCofflineId strip_id_fromCode(unsigned long int /*strip_code*/) {RPCofflineId empty; return empty;}
