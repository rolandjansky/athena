...
#include "RPCcablingSim/RPCchamberdata.h"
#include "RPCcablingSim/WiredORdata.h"
#include "RPCcablingSim/CMApivotdata.h"
#include "RPCcablingSim/CMAcablingdata.h"
...
class SectorLogicSetup : public BaseObject
{
    ...
    public:
    SectorLogicSetup();
    SectorLogicSetup(int,std::string,bool conf);
    ...
    bool        lowpt_1031(void)         const {return m_lowpt_1031;}
