...
#include "MuonEventTPCnv/MuonSimEvent/TGCSimHitCollection_p3.h"
...
void TGCSimHitCollectionCnv_p3::transToPers(const TGCSimHitCollection* transCont, Muon::TGCSimHitCollection_p3* persCont, MsgStream &log)
{
...
TGCSimHitCollection* TGCSimHitCollectionCnv_p3::createTransient(const Muon::TGCSimHitCollection_p3* persObj, MsgStream &log) {
...
void TGCSimHitCollectionCnv_p3::persToTrans(const Muon::TGCSimHitCollection_p3* persCont, TGCSimHitCollection* transCont, MsgStream &log) 
{
    HepMcParticleLinkCnv_p1 hepMcPLCnv;
