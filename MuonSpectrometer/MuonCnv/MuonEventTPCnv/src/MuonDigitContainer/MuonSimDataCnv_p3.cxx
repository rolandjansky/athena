...
void MuonSimDataCnv_p3::persToTrans(const Muon::MuonSimData_p3 * persObj, MuonSimData * transObj, MsgStream & log){
   log << MSG::DEBUG << "MuonSimDataCnv_p3::persToTrans" << endreq;
   ...
   for (const std::pair<HepMcParticleLink_p3, Muon::MuonMCData_p1>& p :
          persObj->m_deposits)
   {
...
void MuonSimDataCnv_p3::transToPers( const MuonSimData * transObj, Muon::MuonSimData_p3 * persObj, MsgStream & log){
  log << MSG::DEBUG << "MuonSimDataCnv_p3::TransToPers" << endreq;
