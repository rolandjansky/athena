	     ...
	     Muon::RpcClusterOnTrack *transObj, MsgStream &log )
{
  ...
  EigenHelpers::vectorToEigenMatrix(dummy.values, transObj->m_localCovariance, "RpcClusterOnTrackCnv_p3");
	     ...
	     Muon::RpcClusterOnTrack_p3 *persObj, MsgStream &log ) 
{
  // Prepare ELs
   ...
   EigenHelpers::eigenMatrixToVector(pMat.values, transObj->m_localCovariance, "RpcClusterOnTrackCnv_p3");
