...
StatusCode Muon::TgcCoinDataContainerCnv_p4::initialize(MsgStream &log) {
...
void Muon::TgcCoinDataContainerCnv_p4::transToPers(const Muon::TgcCoinDataContainer* transCont,  Muon::MuonCoinDataContainer_p1* persCont, MsgStream &log) 
{
...
void  Muon::TgcCoinDataContainerCnv_p4::persToTrans(const Muon::MuonCoinDataContainer_p1* persCont, Muon::TgcCoinDataContainer* transCont, MsgStream &log) 
{
...
//================================================================
Muon::TgcCoinDataContainer* Muon::TgcCoinDataContainerCnv_p4::createTransient(const Muon::MuonCoinDataContainer_p1* persObj, MsgStream& log) 
{
    if(!m_isInitialized) {
        if (this->initialize(log) != StatusCode::SUCCESS) {
            log << MSG::FATAL << "Could not initialize TgcCoinDataContainerCnv_p4 " << endmsg;
            return 0;
        } 
    }
