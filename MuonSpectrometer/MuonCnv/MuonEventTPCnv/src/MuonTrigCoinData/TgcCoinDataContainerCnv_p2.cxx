...
void Muon::TgcCoinDataContainerCnv_p2::transToPers(const Muon::TgcCoinDataContainer* transCont,  Muon::MuonCoinDataContainer_p1* persCont, MsgStream &log) 
{
...
//================================================================
Muon::TgcCoinDataContainer* Muon::TgcCoinDataContainerCnv_p2::createTransient(const Muon::MuonCoinDataContainer_p1* persObj, MsgStream& log) 
{
    if(!m_isInitialized) {
