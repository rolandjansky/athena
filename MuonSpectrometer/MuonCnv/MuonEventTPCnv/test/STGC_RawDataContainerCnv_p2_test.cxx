...
*/
/**
 * @file MuonEventTPCnv/test/STGC_RawDataContainerCnv_p2_test.cxx
 * @brief Regression tests, modified of STGC_RawDataContainerCnv_p1_test.cxx.
 */
...
void testit (const STGC_RawDataContainer& trans1, const MuonGM::MuonDetectorManager& muon_dd)
{
  ...
  Muon::STGC_RawDataContainerCnv_p2 cnv;
  cnv.initialize(muon_dd.stgcIdHelper());
  Muon::STGC_RawDataContainer_p2 pers;
