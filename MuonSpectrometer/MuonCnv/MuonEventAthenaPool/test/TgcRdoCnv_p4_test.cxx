...
void test1 ATLAS_NOT_THREAD_SAFE ()
{
  ...
  // sector logic
  trans1.push_back (new TgcRawData (71, 72, 73, 74, 75, static_cast<bool>(false), static_cast<bool>(true), 76, 77, false,
                                    78, true, false, 79));

  // new sector logic roi
  trans1.push_back (new TgcRawData (81, 82, 83, 84, 85, true, 86, 87, 88, false,
                                    89, 90));

  // nsw
  trans1.push_back (new TgcRawData( 91, 92, 93, 94, static_cast<uint16_t>(95), static_cast<bool>(true), static_cast<uint16_t>(96), 97,
