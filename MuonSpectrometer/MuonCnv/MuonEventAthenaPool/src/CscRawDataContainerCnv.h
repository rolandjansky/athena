...
/*
  ...
  @author Marcin Nowak
*/
typedef MuonRdoContainerTPCnv<CscRawDataContainer, CscRawDataContainer_p4, CscRawDataContainerCnv_p4 >
...
CscRawDataContainerCnv::createTransient()
{
   ...
   if( compareClassGuid(p4_guid) ) {
      ...
      CscRawDataContainerCnv_p3        tpConvertor_p3;       
       
      std::unique_ptr< CscRawDataContainer_p3 > col_vect( poolReadObject< CscRawDataContainer_p3 >() );
      trans_cont = tpConvertor_p3.createTransient( col_vect.get(), log );
