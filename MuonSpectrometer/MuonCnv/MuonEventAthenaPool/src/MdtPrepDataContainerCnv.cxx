...
StatusCode MdtPrepDataContainerCnv::initialize() {
   // Call base clase initialize
    ...
    // messageService()->setOutputLevel( "MdtPrepDataContainerCnv", MSG::DEBUG );

   // Get the messaging service, print where you are
    MsgStream log(messageService(), "MdtPrepDataContainerCnv");
    log << MSG::INFO << "MdtPrepDataContainerCnv::initialize()" << endreq;
