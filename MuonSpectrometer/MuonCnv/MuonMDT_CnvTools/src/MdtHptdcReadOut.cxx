...
// End of TDC
uint32_t MdtHptdcReadOut::makeEOT(uint16_t jt, uint16_t ecnt, uint16_t wcnt)
{
...
uint32_t MdtHptdcReadOut::makeTSM(uint16_t jt, uint16_t channel, bool leading,
...
uint32_t MdtHptdcReadOut::makeTCM(uint16_t jt, uint16_t channel, uint16_t width,
...
uint32_t MdtHptdcReadOut::makeTMC(uint16_t jt, uint32_t masked)
{
