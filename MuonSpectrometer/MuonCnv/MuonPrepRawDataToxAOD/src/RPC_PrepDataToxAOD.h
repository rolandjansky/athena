...
public:
  ...
  void addPRD_TechnologyInformation( xAOD::PrepRawData& xprd, const Muon::RpcPrepData& prd ) const;

  // overload base class function to add technology specific information
  void addSDO_TechnologyInformation( xAOD::PrepRawData& xprd, const Muon::RpcPrepData& prd, const MuonSimData& sdo ) const;
private:
