...
public:
  ...
  void addPRD_TechnologyInformation( xAOD::PrepRawData& xprd, const Muon::MdtPrepData& prd ) const;

  // overload this function to add detector specific information 
  void addSDO_TechnologyInformation( xAOD::PrepRawData& xprd, const Muon::MdtPrepData& prd, const MuonSimData& sdo ) const;
