...
namespace MuonCalib{
  ...
  /**
     ...
     A MuonCalibXxxRawHit is constructed from PrepRawData hits, collected from stations which have a MuonCalibSegment. These raw hits are uncalibrated. In order to know wether the raw hit is NOT assigned to a MuonCalibSegment, check the occupancy variable. It yields the number of times that the raw hit is used on a MuonCalibSegment (yes, one hit may be used multiple times on different segments). A raw hit not used on any segment yields an occupancy of -1.
  ...
  */
  ...
  class MuonCalibRawHitCollection{
    ...
    MuonCalibRawHitCollection( MuonCalibRawMdtHitVec rawMdtHitVec, 
			       ...
			       MuonCalibRawCscHitVec rawCscHitVec ) :  m_rawMdtHitVec(rawMdtHitVec), m_rawRpcHitVec(rawRpcHitVec), m_rawTgcHitVec(rawTgcHitVec), m_rawTgcCoinVec(rawTgcCoinVec), m_rawCscHitVec(rawCscHitVec){} ;//!< constructor initializing all raw hit collections
    ~MuonCalibRawHitCollection() ; //!< destructor
    MuonCalibRawHitCollection( const MuonCalibRawHitCollection& MuonCalibRawHitCollection ); //!< copyconstructor
      
    MuonCalibRawHitCollection& operator=( const MuonCalibRawHitCollection& rhs ); //!< assingment operator
  ...
  inline MuonCalibRawHitCollection::MuonCalibRawMdtHitVecIt MuonCalibRawHitCollection::rawMdtHitCollectionBegin() {    return m_rawMdtHitVec.begin() ; }   
  inline MuonCalibRawHitCollection::MuonCalibRawMdtHitVecIt MuonCalibRawHitCollection::rawMdtHitCollectionEnd() {    return m_rawMdtHitVec.end() ;  }  
  inline MuonCalibRawHitCollection::MuonCalibRawMdtHitVecCit MuonCalibRawHitCollection::rawMdtHitCollectionBegin() const {    return m_rawMdtHitVec.begin() ; }  
  inline MuonCalibRawHitCollection::MuonCalibRawMdtHitVecCit MuonCalibRawHitCollection::rawMdtHitCollectionEnd() const {    return m_rawMdtHitVec.end() ; }

  inline MuonCalibRawHitCollection::MuonCalibRawRpcHitVecIt MuonCalibRawHitCollection::rawRpcHitCollectionBegin() {    return m_rawRpcHitVec.begin() ; }   
  inline MuonCalibRawHitCollection::MuonCalibRawRpcHitVecIt MuonCalibRawHitCollection::rawRpcHitCollectionEnd() {    return m_rawRpcHitVec.end() ;  }  
  inline MuonCalibRawHitCollection::MuonCalibRawRpcHitVecCit MuonCalibRawHitCollection::rawRpcHitCollectionBegin() const {    return m_rawRpcHitVec.begin() ; }  
  inline MuonCalibRawHitCollection::MuonCalibRawRpcHitVecCit MuonCalibRawHitCollection::rawRpcHitCollectionEnd() const {    return m_rawRpcHitVec.end() ; }

  inline MuonCalibRawHitCollection::MuonCalibRawTgcHitVecIt MuonCalibRawHitCollection::rawTgcHitCollectionBegin() {    return m_rawTgcHitVec.begin() ; }   
  inline MuonCalibRawHitCollection::MuonCalibRawTgcHitVecIt MuonCalibRawHitCollection::rawTgcHitCollectionEnd() {    return m_rawTgcHitVec.end() ;  }  
  inline MuonCalibRawHitCollection::MuonCalibRawTgcHitVecCit MuonCalibRawHitCollection::rawTgcHitCollectionBegin() const {    return m_rawTgcHitVec.begin() ; }  
  inline MuonCalibRawHitCollection::MuonCalibRawTgcHitVecCit MuonCalibRawHitCollection::rawTgcHitCollectionEnd() const {    return m_rawTgcHitVec.end() ; }

  inline MuonCalibRawHitCollection::MuonCalibRawTgcCoinVecIt MuonCalibRawHitCollection::rawTgcCoinCollectionBegin() {    return m_rawTgcCoinVec.begin() ; }   
  inline MuonCalibRawHitCollection::MuonCalibRawTgcCoinVecIt MuonCalibRawHitCollection::rawTgcCoinCollectionEnd() {    return m_rawTgcCoinVec.end() ;  }  
  inline MuonCalibRawHitCollection::MuonCalibRawTgcCoinVecCit MuonCalibRawHitCollection::rawTgcCoinCollectionBegin() const {    return m_rawTgcCoinVec.begin() ; }  
  inline MuonCalibRawHitCollection::MuonCalibRawTgcCoinVecCit MuonCalibRawHitCollection::rawTgcCoinCollectionEnd() const {    return m_rawTgcCoinVec.end() ; }

  inline MuonCalibRawHitCollection::MuonCalibRawCscHitVecIt MuonCalibRawHitCollection::rawCscHitCollectionBegin() {    return m_rawCscHitVec.begin() ; }   
  inline MuonCalibRawHitCollection::MuonCalibRawCscHitVecIt MuonCalibRawHitCollection::rawCscHitCollectionEnd() {    return m_rawCscHitVec.end() ;  }  
  inline MuonCalibRawHitCollection::MuonCalibRawCscHitVecCit MuonCalibRawHitCollection::rawCscHitCollectionBegin() const {    return m_rawCscHitVec.begin() ; }  
  inline MuonCalibRawHitCollection::MuonCalibRawCscHitVecCit MuonCalibRawHitCollection::rawCscHitCollectionEnd() const {    return m_rawCscHitVec.end() ; }

  inline int MuonCalibRawHitCollection::numberOfMuonCalibRawMdtHits() const { return m_rawMdtHitVec.size() ; }
  inline int MuonCalibRawHitCollection::numberOfMuonCalibRawRpcHits() const { return m_rawRpcHitVec.size() ; }
  inline int MuonCalibRawHitCollection::numberOfMuonCalibRawTgcHits() const { return m_rawTgcHitVec.size() ; }
  inline int MuonCalibRawHitCollection::numberOfMuonCalibRawTgcCoins() const { return m_rawTgcCoinVec.size() ; }
  inline int MuonCalibRawHitCollection::numberOfMuonCalibRawCscHits() const { return m_rawCscHitVec.size() ; }
