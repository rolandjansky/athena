...
namespace MuonCalib {
  ...
  */
  class MuonCalibMdtTruthHit{
    ...
    MuonCalibMdtTruthHit( MuonFixedId id, int barCode, double driftRadius, double positionAlongTube, double gpositionX, double gpositionY, double gpositionZ, double time ); //<! constructor initializing all attributes of the MuonCalibMdtTruthHit
