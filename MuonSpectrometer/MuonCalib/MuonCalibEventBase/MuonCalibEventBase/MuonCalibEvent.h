...
namespace MuonCalib {
  ...
  /**
     ...
     - MuonCalibTruthCollection: This truth collection is the CalibrationEDM version
     of a Truth Track and SDO's from the several technologies
     - MuonCalibRawHitCollection: CalibrationEDM hits collected from PrepRawData objects. These can
     be assigned to a segment (see the 'occupancy' variable). 
     - MuonCalibPattern: 
...
*/
  ...
  class MuonCalibEvent{
    ...
    MuonCalibEvent( MCPVec patvec, const MuonCalibRawHitCollection* RHColl ) ; //!< Constructor initializing its MuonCalibPatterns and raw hits.
    ...
    const MuonCalibRawHitCollection* rawHitCollection() const { return m_rawColl ; } ; //!< retrieve  pointer to MuonCalibRawHitCollection
    const MuonCalibRawTriggerHitCollection* rawTriggerHitCollection() const { return m_rawTriggerColl ; } ; //!< retrieve  pointer to MuonCalibRawHitCollection
    const MuonCalibTruthCollection* calibTruthCollection() const { return m_truthColl ; } ; //!< retrieve the pointer to the MuonCalibTruthCollection.
    ...
    void setMuonCalibRawTriggerHitCollection(const MuonCalibRawTriggerHitCollection* THColl) ; //!< set the MuonCalibRawTriggerHitCollection.
    ...
    void setRpcSectorLogicContainer( const RpcSectorLogicContainer* rpcSlContainer ) { m_rpcSlLogicContainer = rpcSlContainer ; } ; //!< set the RpcSectorLogicContainer
  ...
  inline void MuonCalibEvent::setMuonCalibTruthCollection(const MuonCalibTruthCollection* MCTColl){
    m_truthColl = MCTColl;
  }

  inline void MuonCalibEvent::setMuonCalibRawHitCollection(const MuonCalibRawHitCollection* RHColl){
    m_rawColl = RHColl ;
  }
  ...
  inline void MuonCalibEvent::setMuonCalibPatternVec(const MuonCalibEvent::MCPVec& mcpvec){
    m_patternVec = mcpvec;
  }
