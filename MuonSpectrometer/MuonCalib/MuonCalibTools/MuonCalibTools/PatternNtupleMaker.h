...
namespace MuonCalib {
    ...
    */
    ...
    public:
        ...
        StatusCode
        initialize();  //!< AlgTool initailize method: Creates an instance of MuonCalib::MuonCalibBranchNtuple, retrieves Storegate.
        StatusCode finalize();  //!< AlgTool finalize method: does not do anything special

        virtual bool handleEvent(const MuonCalibEvent* event);  //!< Interface method: feeds the several constituents of the MuonCalibEvent
                                                                //!< to the MuonCalibBranchNtuple.
        virtual bool analyse();                                 //!< Interface method: writes the Tree.

    private:
        bool handleEventInfo(const MuonCalibEventInfo* eventInfo,
                             const MuonCalibTriggerTimeInfo* trigTimeInfo);  //!< Feeds MuonCalibEventInfo to muonCalibBranchNtuple
        bool handleTruthCollection(
            const MuonCalibTruthCollection* truthCollection);          //!< Feeds MuonCalibTruthCollection to muonCalibBranchNtuple
        ...
        bool m_delayFinish;  //!< property flag used to delay the writing of the CalibrationNtuple when a MuonCalibExtraTree is created in
                             //!< the same Tree.
