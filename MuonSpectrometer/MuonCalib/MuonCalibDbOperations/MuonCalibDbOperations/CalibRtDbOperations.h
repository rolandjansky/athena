...
namespace MuonCalib {
    ...
    public:
        ...
        bool LoadRt(const NtupleStationId &id, int head_id, bool validated, const std::string & /*site_name*/,
                    std::vector<SamplePoint> &points, RtFullInfo *full_info);
        // write/update rt
        bool WriteUpdateRt(const NtupleStationId &id, int head_id, const std::string & /*site_name*/,
    ...
    private:
        ...
        inline void fullInfoInitData(const RtFullInfo *full_info, const int &validflag, coral::AttributeList &updateData, const int &n_bins,
