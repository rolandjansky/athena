...
class CalibNtupleLoader: public AlgTool, virtual public CalibSegmentPreparationTool
	{
	public:
//=========================constructor==========================================
...
//=========================private data=========================================
	...
	//! scip double events (event numbers) - job options
		bool m_scip_double_events;
	//!prev event number
		int m_prev_event_nr;
	//! prev run number
