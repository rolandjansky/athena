...
#		self.__good_run_list_tool.EventSelectorMode = True
	...
	#tool that do not need segment recalibration
	...
	#idf b-field should be corrected, set BSwitch either to "UNAPPLY" or to "FILE"
...
#------------------------------------------------------------
	...
	def __set_db(self):
		...
		# ROMA
			self.DbIoTool.ConnectionString = "oracle://atlas-oracle-01.roma1.infn.it/atlrome.roma1.infn.it/ATLAS_MUONCALIB_READER"
			self.DbIoTool.WorkingSchema = "ATLAS_MUONCALIB_RM_META"
			self.DbIoTool.WriterConnectionString = "oracle://atlas-oracle-01.roma1.infn.it/atlrome.roma1.infn.it/ATLAS_MUONCALIB_WRITER"			
		...
		# ROMA
			self.DbIoTool.ConnectionString = "oracle://atlas-oracle-01.roma1.infn.it/atlrome.roma1.infn.it/atlas_muoncalib_rome"
