...
UpdateBField :: UpdateBField(const std::string & t, const std::string & n, const IInterface *p): AlgTool(t, n, p),   
...
StatusCode UpdateBField :: initialize(void)
	{
          if( m_fieldServiceHandle.retrieve().isFailure() )           return  StatusCode::FAILURE;
