...
/**
   @class NTReaderBase
   created by the ROOT MakeClass() method on the CalibrationNtuple. Holds all variables of the CalibrationNtuple
...
public :
   ...
   Float_t         mdt_xtwin[3000]; //[mdt_unmet]
   Bool_t          mdt_segmentT0Applied[3000]; //[mdt_unmet]
   ...
   bool m_storeTruth;                               //!< flag keeping track wether truth info is stored on the CalibrationNtuple
};
}//namespace MuonCalib
#endif
