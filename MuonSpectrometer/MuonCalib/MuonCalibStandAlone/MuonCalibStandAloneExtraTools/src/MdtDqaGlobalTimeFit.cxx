...
MdtDqaGlobalTimeFit::MdtDqaGlobalTimeFit(int nbHitsMin, int nbHitsMax, float chi2cut, int BfieldON,  bool debug) :
  ...
  m_tfile_debug(NULL), m_hit_ntuple(NULL), m_nb_hits(-1.), m_cal_region(NULL), m_rtRel(NULL), qfitter(NULL),
...
StatusCode 
MdtDqaGlobalTimeFit::handleEvent( const MuonCalibEvent & /*event*/,
				  int /*eventnumber*/,
