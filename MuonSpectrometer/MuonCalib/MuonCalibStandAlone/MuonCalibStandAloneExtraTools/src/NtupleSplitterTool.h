...
//==============================================================================
	...
	/** we dont need to keep the segments*/
		...
		inline StatusCode analyseSegments(const std::vector<MuonCalibSegment *> & segemnts)
			{
			return  m_calib_tool_handle->analyseSegments(segemnts);
			}		
