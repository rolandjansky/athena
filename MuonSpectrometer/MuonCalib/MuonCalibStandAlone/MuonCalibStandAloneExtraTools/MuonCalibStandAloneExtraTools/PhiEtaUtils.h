...
#include "MuonCalibStandAloneExtraTools/StringUtil.h"
  ...
  class PhiEtaNameConverter {
    ...
    inline string chamberHardwareName(int stationId, int phi, int eta){
         string chamberName = "UNDEFINED" ;
    ...
    inline string chamberAthenaName(int stationId, int phi, int eta){
         string chamberName = "UNDEFINED" ;
         MuonCalib::MuonFixedId id(stationId) ;
         ToString ts ;
         if (!id.is_mdt() ) return chamberName ;
