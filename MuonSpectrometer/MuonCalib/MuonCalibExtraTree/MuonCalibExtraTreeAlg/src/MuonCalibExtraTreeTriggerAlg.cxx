 ...
 // copied from CBNTAA_MuctpiRoI
  ...
  void MuonCalibExtraTreeTriggerAlg::addCalo() {
	...
	energyToIndex[-(iti->second)] = iti->first;  
      ...
      //    Acces towers Highest first with highest energy etc.a
      //    Store information 
      int nmaxstore = 5;
      int nstore = 0;
    ...
    } // endif TileID helper && detStore succesfull  
  ...
  } // endif MBTS retrieve succesfull
  ...
  void MuonCalibExtraTreeTriggerAlg::finishEvent(){
    ...
    log << MSG::DEBUG << "finish eventready... " << endreq;
  }
