...
*/
  ...
  */
  ...
  public:
    ...
    inline void reset() { m_index = 0; }                                  //!< set pat_index to zero 
  ...
  private:
    ...
    float m_z0[m_blockSize];
    float m_r0[m_blockSize];
    float m_invP[m_blockSize];
    float m_phi[m_blockSize];
    float m_theta[m_blockSize]; 
    int   m_nSegments[m_blockSize];
    int   m_nmdt[m_blockSize];
    int   m_nrpc[m_blockSize];
    int   m_ncsc[m_blockSize];
    int   m_ntgc[m_blockSize];
  };
