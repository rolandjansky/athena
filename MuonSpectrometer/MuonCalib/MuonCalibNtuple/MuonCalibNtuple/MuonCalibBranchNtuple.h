...
namespace MuonCalib {
  ...
  /**
     ...
     Class to handle ntuple containing MuonCalibEvents. Steers the separate NtupleBranches. Uses FillToBranch class for short-notation filling of certain NtupleBranches.
  */
