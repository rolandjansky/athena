...
namespace MuonCalib {
  ...
  MuonEventNtupleBranch::MuonEventNtupleBranch(std::string branchName) : m_branchName(branchName),  branchesInit(false), index(0), eventNumber(0), runNumber(0), timeStamp(0), lumiBlock(0), bcId(0), dMbtsTime(0), dLarTime(0),  n_on_TAV_bits(0), n_on_TAP_bits(0)
  {
