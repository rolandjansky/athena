...
namespace MuonCalib {
  ...
  m_file(NULL), m_directory(NULL), m_tree(NULL), m_fitter(NULL), event(0), truthBranch(NULL), mdtTruthBranch(NULL), rpcTruthBranch(NULL), tgcTruthBranch(NULL), cscTruthBranch(NULL), m_printLevel(0)
  ...
  MuonCalibBranchNtuple::MuonCalibBranchNtuple(std::string RegionName, bool fillTruth, bool doRawTgc) : m_file(0), m_directory(0), m_tree(0) , m_fitter(NULL), event(0), truthBranch(NULL), mdtTruthBranch(NULL), rpcTruthBranch(NULL), tgcTruthBranch(NULL), cscTruthBranch(NULL), m_printLevel(0)
  {
    event = 0;
    m_printLevel = 0;
    if( m_printLevel >= 1){
