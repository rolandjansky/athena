...
endDate=str(datetime.date.today()) ##-->today

fileName="./runs_"+startDate+"_"+endDate+".txt"
...
String_Pattern='ATLAS'
# String_Pattern='point-1'
...
print "      Number of nosiy strips in the last uploaded run ", RunsInDB[0],": ", noisyStripsInDB_lastRun
print "--------------------------------------------------------------------------------"
