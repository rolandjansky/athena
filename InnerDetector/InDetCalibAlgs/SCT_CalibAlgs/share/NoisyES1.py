...
DoNoisyStrip     = True #False
DoNoisyLB        = True #False
DoHV             = False
DoDeadStrip      = False
DoDeadChip       = False
#--- Algs using HIST
...
#--------------------------------------------------------------
TagID4NoisyStrips    = 'SctDerivedMonitoring-UPD1-001' # UPD4, open IOV for BLK
TagID4DeadStrips     = 'SctDerivedDeadStrips-003-00'
TagID4DeadChips      = 'SctDerivedDeadChips-003-00'
TagID4NoiseOccupancy = 'SctDerivedNoiseOccupancy-003-00'
