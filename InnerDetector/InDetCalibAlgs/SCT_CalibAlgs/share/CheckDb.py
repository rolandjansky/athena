...
#############################################################################################
#def main():
#  #assuming using /afs/cern.ch/user/s/sctcalib/scratch0/test_results/data/data10_7TeV.00167661.calibration_SCTNoise.daq.RAW._lb0000._SFO-9._0003.data
#  referenceRun=167661
#  startOfReferenceRun=0
#  endOfReferenceRun=10
#  Period=7 ##-->7 days ago
