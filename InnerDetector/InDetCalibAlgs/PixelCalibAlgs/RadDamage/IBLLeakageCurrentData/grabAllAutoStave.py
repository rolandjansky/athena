...
def checkDates(dataType,dataFolder):
	...
	if not os.path.exists(dataFolder+dataType+".txt"):
		...
		firstTempDate = datetime.datetime(2018,1,10,1,1,1,1)
		lastTempDate = datetime.datetime(2017,12,21,1,1,1)
...
# Function to save data of type dataType in dataFolder for all sensors, for specified dates. 
# Currently used fof HV_VMease, PP4LV and TModules
