...
class CompetingTRT_DriftCirclesOnTrack
  ...
  , public Trk::SurfacePtrHolderDetEl
{

public:
  /** @brief InDet::CompetingTRT_DriftCirclesOnTrackTool is a friend to allow
     for updates of the assignment probabilities */
  ...
  //! Copy Constructor
  CompetingTRT_DriftCirclesOnTrack(
    const CompetingTRT_DriftCirclesOnTrack& compROT);
  //! Assignment operator
  CompetingTRT_DriftCirclesOnTrack& operator=(
    const CompetingTRT_DriftCirclesOnTrack& compROT);
  /** Move assignment operator */
  CompetingTRT_DriftCirclesOnTrack& operator=(
    CompetingTRT_DriftCirclesOnTrack&& compROT) noexcept;

  /** @brief Constructor with all parameters: PLEASE do not use directly,
      but call InDet::CompetingTRT_DriftCirclesOnTrackTool, otherwise
  ...
  /** @brief returns the vector of TRT_DriftCircleOnTrack objects .
      - specific for this CompetingTRT_DriftCirclesOnTrack:
     TRT_DriftCircleOnTrack */
  const std::vector<const InDet::TRT_DriftCircleOnTrack*>& containedROTs()
    const;
  ...
  //! returns some information about this
  //! MeasurementBase/CompetingTRT_DriftCirclesOnTrack.
...
inline CompetingTRT_DriftCirclesOnTrack*
CompetingTRT_DriftCirclesOnTrack::clone() const
{
...
CompetingTRT_DriftCirclesOnTrack::associatedSurface() const
{
