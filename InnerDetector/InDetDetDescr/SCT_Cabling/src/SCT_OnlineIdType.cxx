...
namespace SCT_Cabling{
  ...
  onlineIdType(const unsigned int rodId){
    ...
    const UintSet commonSet=list_of(0x210000)( 0x210001)( 0x210002)( 0x210003)( 0x210004)( 0x210005)( 0x210006)
    ...
    const UintSet dbSet=list_of(0x210100)( 0x210101)( 0x210102)( 0x210103)( 0x210104)( 0x210105)( 0x210106)
    ...
    const UintSet mcSet=list_of( 0x21000b)( 0x21000c)( 0x21000d)( 0x21000e)( 0x21000f)( 0x210010)( 0x210011)( 0x210012)( 0x210013)
