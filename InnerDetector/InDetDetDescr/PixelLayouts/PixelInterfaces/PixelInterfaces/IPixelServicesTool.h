...
//  static const InterfaceID IID_IPixelServicesTool( "InDet::IPixelServicesTool", 1, 0 );
  ...
  public:
    ...
    virtual std::string getLayerStaveModuleMaterialName(int, int, int) const =0;
    virtual std::string getLayerStaveModuleMaterialName(int, int, std::vector<int>) const =0;
    ...
    virtual double getMaterialFudgeModuleSvc(int iLayer) const =0;
