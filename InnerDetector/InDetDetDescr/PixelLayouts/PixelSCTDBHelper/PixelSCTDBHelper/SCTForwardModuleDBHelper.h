...
#ifndef SCT_GeoModel_SCT_ForwardModuleDBHelper_H
#define SCT_GeoModel_SCT_ForwardModuleDBHelper_H

#include <string>

#include "InDetGeoModelUtils/OraclePixGeoAccessor.h"

  class SCTForwardModuleDBHelper {
    
  public:
    
    // Constructor 
    SCTForwardModuleDBHelper(const OraclePixGeoAccessor* geoAccessor);
