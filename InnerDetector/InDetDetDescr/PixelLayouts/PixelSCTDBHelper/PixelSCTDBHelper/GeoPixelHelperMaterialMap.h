...
#ifndef GeoPixelHelperMaterialMap_H
#define GeoPixelHelperMaterialMap_H
...
#include "InDetGeoModelUtils/OraclePixGeoAccessor.h"
  ...
  public:
    GeoPixelHelperMaterialMap(const OraclePixGeoAccessor * db, IRDBRecordset_ptr mapTable);
