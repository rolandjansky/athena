...
#ifndef SCTModule_SCTBarrelDBHelper_H
#define SCTModule_SCTBarrelDBHelper_H
...
#include "InDetGeoModelUtils/OraclePixGeoAccessor.h"
  ...
  class SCTBarrelDBHelper {
    
  public:
    
    // Constructor 
    SCTBarrelDBHelper(const OraclePixGeoAccessor* geoAccessor);
...
private:
  ...
  IRDBRecordset_ptr skiTable;
  IRDBRecordset_ptr   skiZTable;
  IRDBRecordset_ptr   layerTable;
  IRDBRecordset_ptr   srvPerLayerTable;
  IRDBRecordset_ptr   serviceTable;
  IRDBRecordset_ptr   FSITable;
  IRDBRecordset_ptr   FSIlocTable;
  IRDBRecordset_ptr   thShieldTable;
  IRDBRecordset_ptr   generalTable;

};


#endif // SCT_GeoModel_SCTBarrelDBHelper_H
