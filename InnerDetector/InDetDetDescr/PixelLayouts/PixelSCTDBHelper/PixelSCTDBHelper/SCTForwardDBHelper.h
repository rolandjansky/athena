...
#ifndef SCTModule_SCTForwardDBHelper_H
#define SCTModule_SCTForwardDBHelper_H
...
#include "InDetGeoModelUtils/OraclePixGeoAccessor.h"
  ...
  class SCTForwardDBHelper {
    
  public:
    
    // Constructor 
    SCTForwardDBHelper(const OraclePixGeoAccessor* geoAccessor);
...
#endif // SCT_GeoModel_SCTForwardDBHelper_H
