...
StaveDynServices ComputeDynStaveServices::compute( DetTypeDyn::Type type, DetTypeDyn::Part part, int layerNumber,
						   int nModulesPerStave, int nChipsPerModule) const

{
  msg(MSG::DEBUG) << "Computing services for " << DetTypeDyn::name( type, part) << " layer " << layerNumber 
