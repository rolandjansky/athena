...
class GeoPixelLadderExtRef : public PixelGeoBuilder {

 public:
  GeoPixelLadderExtRef(const PixelGeoBuilderBasics* basics, const InDet::StaveTmp *staveTmp, int iLayer, HepGeom::Transform3D trf);
