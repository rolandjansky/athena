...
class GeoPixelEnvelopeExtRefTool : virtual public IGeoPixelEnvelopeTool, public AthAlgTool {

 public:
  GeoPixelEnvelopeExtRefTool(const std::string&,const std::string&,const IInterface*);
