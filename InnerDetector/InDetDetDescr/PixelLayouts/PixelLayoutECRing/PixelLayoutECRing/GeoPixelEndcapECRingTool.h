...
class GeoPixelEndcapECRingTool : virtual public IGeoPixelEndcapTool, public AthAlgTool {
 public:
  GeoPixelEndcapECRingTool(const std::string&,const std::string&,const IInterface*);
