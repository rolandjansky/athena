...
GeoVPhysVol* GeoPixelLayerInclRefTool::buildLayer(const PixelGeoBuilderBasics* basics, int iLayer) 
{
  ...
  for(int iLadder=0; iLadder<nbLadderType; iLadder++)
    {
      vPixelLadder.push_back( new GeoPixelLadderInclRef(basics, staveTmp[iLadder], m_layer, iLadder, nSectors, nSectorsLastLayer, nSectorsNextLayer, phiOfStaveZero, phiOfStaveZeroLastLayer, transRadiusAndTilt)); 
