...
class GeoPixelStaveSupportLoI;
class GeoDetModulePixelBuilder;

class GeoPixelLadderLoI : public PixelGeoBuilder {

 public:
  GeoPixelLadderLoI(const PixelGeoBuilderBasics* basics, const InDet::StaveTmp *staveTmp, int iLayer, HepGeom::Transform3D trf);
 ...
 private:
  ...
  GeoPixelStaveSupportLoI* m_staveSupport;
