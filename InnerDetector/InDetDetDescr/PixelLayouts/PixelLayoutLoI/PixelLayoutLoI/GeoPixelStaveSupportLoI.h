...
class GeoPixelStaveSupportLoI : public PixelGeoBuilder {

public:  
  GeoPixelStaveSupportLoI(const PixelGeoBuilderBasics* basics, int iLayer, const GeoDetModulePixel& barrelModule);
