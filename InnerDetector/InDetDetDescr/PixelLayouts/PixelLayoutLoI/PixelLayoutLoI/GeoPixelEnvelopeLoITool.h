...
class GeoPixelEnvelopeLoITool : virtual public IGeoPixelEnvelopeTool, public AthAlgTool {

 public:
  GeoPixelEnvelopeLoITool(const std::string&,const std::string&,const IInterface*);
