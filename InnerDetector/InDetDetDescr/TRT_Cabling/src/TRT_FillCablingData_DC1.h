...
//
// TRT_FillCablingData_DC1 class - class used for filling
//      of TRT Mapping in case of DC1 
//    A.Zalite
//

#ifndef TRT_FILLCABLINGDATA_DC1_H
#define TRT_FILLCABLINGDATA_DC1_H
...
class TRT_FillCablingData_DC1: public AthAlgTool
{
public:
    // Constructor   
  TRT_FillCablingData_DC1(const std::string& type, const std::string& name,
