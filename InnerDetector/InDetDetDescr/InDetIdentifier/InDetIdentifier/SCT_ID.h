...
**  identifier depend on the xml file defining them. For the SCT they are:
**
** @verbatim
...
inline Identifier SCT_ID::module_id(int barrel_ec,
                                    int layer_disk,
                                    int phi_module,
                                    int eta_module) const {
    // Build identifier
...
inline Identifier SCT_ID::module_id(const Identifier &wafer_id) const {
...
inline Identifier SCT_ID::wafer_id(int barrel_ec,
                                   int layer_disk,
                                   int phi_module,
                                   int eta_module,
                                   int side) const {
...
inline Identifier SCT_ID::wafer_id(const Identifier &strip_id) const {
...
inline Identifier SCT_ID::strip_id(int barrel_ec,
                                   int layer_disk,
                                   int phi_module,
                                   int eta_module,
                                   int side,
...
inline Identifier SCT_ID::strip_id(int barrel_ec,
    ...
    if (m_do_checks) {
        if (m_hasRows) {
            strip_id_checks(barrel_ec, layer_disk, phi_module, eta_module, side, row, strip);
        }
        else {
            strip_id_checks(barrel_ec, layer_disk, phi_module, eta_module, side, strip);
        }
...
inline Identifier SCT_ID::strip_id(const ExpandedIdentifier &id) const {
    // Build identifier
    Identifier result((Identifier::value_type) 0);
...
inline Identifier SCT_ID::strip_id(const Identifier &wafer_id, int strip) const {
    // Build identifier
    Identifier result(wafer_id);
...
inline Identifier SCT_ID::strip_id(const Identifier &wafer_id, int row, int strip) const {
    // Build identifier
    Identifier result(wafer_id);
...
inline Identifier::diff_type SCT_ID::calc_offset(const Identifier &base, const Identifier &target) const {
...
inline Identifier SCT_ID::strip_id_offset(const Identifier &base,
                                          Identifier::diff_type offset) const {
...
inline int SCT_ID::base_bit(void) const {
...
inline IdContext SCT_ID::wafer_context(void) const {
    ExpandedIdentifier id;

    return(IdContext(id, 0, m_SIDE_INDEX));
}

inline IdContext SCT_ID::strip_context(void) const {
    ExpandedIdentifier id;

    return(IdContext(id, 0, m_STRIP_INDEX));
}

inline bool SCT_ID::is_barrel(const Identifier &id) const {
    // match bec field
    return(m_barrel_field.match(m_bec_impl.unpack(id)));
}

inline int SCT_ID::barrel_ec(const Identifier &id) const {
    return(m_bec_impl.unpack(id));
}

inline int SCT_ID::layer_disk(const Identifier &id) const {
    return(m_lay_disk_impl.unpack(id));
}

inline int SCT_ID::phi_module(const Identifier &id) const {
    return(m_phi_mod_impl.unpack(id));
}

inline int SCT_ID::eta_module(const Identifier &id) const {
    return(m_eta_mod_impl.unpack(id));
}

inline int SCT_ID::side(const Identifier &id) const {
    return(m_side_impl.unpack(id));
}

inline int SCT_ID::row(const Identifier &id) const {
    if (m_hasRows) return(m_row_impl.unpack(id));
    else return -1;
}

inline int SCT_ID::strip(const Identifier &id) const {
