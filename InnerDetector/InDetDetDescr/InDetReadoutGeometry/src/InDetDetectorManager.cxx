...
namespace InDetDD 
{
  ...
  //InDetDD::AlignFolderType InDetDetectorManager::getAlignInfo() 
  //  {
        // might want to use this for more Info later
        //std::string alignFolderStr = "none";
	//if (m_alignfoldertype == InDetDD::static_run1)        alignFolderStr = "/Indet/Align";
	//if (m_alignfoldertype == InDetDD::timedependent_run2) alignFolderStr = "/Indet/AlignL3";
	//return alignFolderStr;
  //	return m_alignfoldertype;
  // }
