...
Concrete implementations can be found in InDetAlignGenTools
...
The following interface classes are defined
   ...
   - InDetAlignment::ICollectionProcessor: interface for the collection processor tools,
which are used to prepare track collections prior to alignment.
