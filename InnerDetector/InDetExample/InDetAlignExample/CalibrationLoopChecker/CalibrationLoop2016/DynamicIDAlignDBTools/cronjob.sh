...
project=data16_hip8TeV
Tier0LogFile=/afs/cern.ch/user/a/atlidali/w0/calibLoop/Tier0_TEST/${project}/GoodEndedRuns/GoodEndedRuns.txt
...
cd /afs/cern.ch/user/a/atlidali/CalibrationLoop2016/DynamicIDAlignDBTools
...
asetup 20.7.6.2,gcc49,64,here &>/dev/null
...
do
    ...
    ./run_checker.sh ${runNumber} CRONJOB --exec &>lastlog
    #./run_checker.sh ${runNumber} CRONJOB &>lastlog
