...
User_ConstantsFile = "AfterTS1_d0fixed_globalFolders"
#
Def_Mode = "Test"
User_Mode = "Exec"#exec
#
...
# 
New_InDet_TagNameL1 = "InDetAlignL1_" + TheNewTag
New_InDet_TagNameL2Pix = "InDetAlignL2PIX_" + TheNewTag
New_InDet_TagNameL2Sct = "InDetAlignL2SCT_" + TheNewTag
New_TRT_TagName = "TRTAlignL1_" + TheNewTag
#
...
if (1):
    ...
    print '> InDet tags    = %s, %s, %s' %(New_InDet_TagNameL1,New_InDet_TagNameL2Pix,New_InDet_TagNameL2Sct)
...
# -- prepare the command 
CommandLine1_Silicon_l1 = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /Indet/AlignL1/ID -outtag " + New_InDet_TagNameL1 + " -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4

CommandLine1_Silicon_l2pix = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /Indet/AlignL2/PIX -outtag " + New_InDet_TagNameL2Pix + " -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4

CommandLine1_Silicon_l2sct = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /Indet/AlignL2/SCT -outtag " + New_InDet_TagNameL2Sct + " -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4

CommandLine1_TRT = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /TRT/AlignL1/TRT -outtag " + New_TRT_TagName +" -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4
...
# 2nd step
# ===============================
CommandLine2_Silicon_l1 = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug  --batch --comment \""+CommentOnConstants+"\" --tag " + New_InDet_TagNameL1 + " --passopt='-ctl' --folder /Indet/AlignL1/ID "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_INDET_W WCOOLOFL4INDET1"

CommandLine2_Silicon_l2pix = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug  --batch --comment \""+CommentOnConstants+"\" --tag " + New_InDet_TagNameL2Pix + " --passopt='-ctl' --folder /Indet/AlignL2/PIX "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_INDET_W WCOOLOFL4INDET1"

CommandLine2_Silicon_l2sct = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug  --batch --comment \""+CommentOnConstants+"\" --tag " + New_InDet_TagNameL2Sct + " --passopt='-ctl' --folder /Indet/AlignL2/SCT "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_INDET_W WCOOLOFL4INDET1"

CommandLine2_TRT = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug --batch --comment \""+CommentOnConstants+"\" --tag " + New_TRT_TagName + " --passopt='-ctl' --folder /TRT/AlignL1/TRT "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_TRT_W WCOOLOFL4TRT2"
...
if Upload_Mode in ("Exec"):
   ...
   if (Do_Silicon == 1):
       print ' =============> Uploading silicon constants L1============'
       print " == step1 ==> " + CommandLine1_Silicon_l1 + "\n"
       os.system(CommandLine1_Silicon_l1)
       print " \n == step2 ==> " + CommandLine2_Silicon_l1 + "\n"
       os.system(CommandLine2_Silicon_l1)

       print ' =============> Uploading silicon constants L2 PIX============'
       print " == step1 ==> " + CommandLine1_Silicon_l2pix + "\n"
       os.system(CommandLine1_Silicon_l2pix)
       print " \n == step2 ==> " + CommandLine2_Silicon_l2pix + "\n"
       os.system(CommandLine2_Silicon_l2pix)

       print ' =============> Uploading silicon constants L2 SCT============'
       print " == step1 ==> " + CommandLine1_Silicon_l2sct + "\n"
       os.system(CommandLine1_Silicon_l2sct)
       print " \n == step2 ==> " + CommandLine2_Silicon_l2sct + "\n"
       os.system(CommandLine2_Silicon_l2sct)
   ...
   print " =========== Silicon L1============= " 
   print " == step1 ==> " + CommandLine1_Silicon_l1 + "\n"
   print " == step2 ==> " + CommandLine2_Silicon_l1 + "\n\n"
   print " =========== Silicon L2 PIX============= " 
   print " == step1 ==> " + CommandLine1_Silicon_l2pix + "\n"
   print " == step2 ==> " + CommandLine2_Silicon_l2pix + "\n\n"
   print " =========== Silicon L2 SCT============= " 
   print " == step1 ==> " + CommandLine1_Silicon_l2sct + "\n"
   print " == step2 ==> " + CommandLine2_Silicon_l2sct + "\n\n"
   print " ===========  TRT  ============= " 
   print " == step1 ==> " + CommandLine1_TRT + "\n"
