...
User_ConstantsFile = "AfterTS1_d0fixed_localFolders"
#
Def_Mode = "Test"
User_Mode = "Exec"#exec
#
Def_Comment = "This is a test" 
User_Comment ="Re-corrected constants after TS1 resolving the d0 bias -- new dynamic DB"
#
Def_Tag = "new_tag"
User_Tag = "R2dynamic_Post_TS1_June2016_d0corrected"
#
Def_UPD4 = ""
User_UPD4 = ""
#
Def_DBName = "COMP200"
User_DBName = "CONDBR2"#"COMP200"#"OFLP200"
#
Def_Conditions = "cond10_data.gen.COND"
User_Conditions = " condR2_data.gen.COND"
#
# =====================================================================
...
# -- prepare the command 
CommandLine1_Silicon = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /Indet/AlignL3 -outtag " + New_InDet_TagName + " -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4

CommandLine1_TRT = "AtlCoolCopy.exe \"sqlite://schema="+DotDbFile+";dbname="+DBName+"\" \"sqlite://;schema="+OutputDbFile+";dbname="+DBName+"\" -create -folder /TRT/AlignL2 -outtag " + New_TRT_TagName +" -tl \""+ CommentOnConstants +"\" -alliov "+CommandUPD4
...
# 2nd step
# ===============================
CommandLine2_Silicon = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug  --batch --comment \""+CommentOnConstants+"\" --tag " + New_InDet_TagName + " --passopt='-ctl' --folder /Indet/AlignL3 "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_INDET_W WCOOLOFL4INDET1"

CommandLine2_TRT = "/afs/cern.ch/user/a/atlcond/utils/AtlCoolMerge.py --debug --batch --comment \""+CommentOnConstants+"\" --tag " + New_TRT_TagName + " --passopt='-ctl' --folder /TRT/AlignL2 "+ OutputDbFile +" "+DBName+" ATLAS_COOLWRITE ATLAS_COOLOFL_TRT_W WCOOLOFL4TRT2"
