...
ClassImp(GenGauss3Dclone) 

 GenGauss3Dclone::GenGauss3Dclone(const char *name, const char *title, 
                        RooArgList& _xvec,
                        RooArgList& _muvec,
                        RooAbsReal& _vxx,
                        RooAbsReal& _vxy,
 ...
 GenGauss3Dclone::GenGauss3Dclone(const GenGauss3Dclone& other, const char* name) :  
 ...
 { 
   ...
   GenGauss3Dclone* self =  const_cast<GenGauss3Dclone*>(this);
   self->updateCov();
 ...
 Int_t GenGauss3Dclone::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const  
 { 
 ...
 Double_t GenGauss3Dclone::analyticalIntegral(Int_t code, const char* rangeName) const  
 { 
