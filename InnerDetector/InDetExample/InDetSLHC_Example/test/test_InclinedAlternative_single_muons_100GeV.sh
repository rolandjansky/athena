...
dcube_sim_muons_alt_100GeV_fixref="dcube_sim_muons_alt_100GeV"
dcube_sim_muons_alt_100GeV_lastref="dcube_sim_muons_alt_100GeV_last"
dcube_digi_pixel_muons_alt_100GeV_fixref="dcube_digi_pixel_muons_alt_100GeV"
dcube_digi_pixel_muons_alt_100GeV_lastref="dcube_digi_pixel_muons_alt_100GeV_last"
dcube_digi_strip_muons_alt_100GeV_fixref="dcube_digi_strip_muons_alt_100GeV"
dcube_digi_strip_muons_alt_100GeV_lastref="dcube_digi_strip_muons_alt_100GeV_last"
dcube_rec_muons_alt_100GeV_fixref="dcube_muons_alt_100GeV"
dcube_rec_muons_alt_100GeV_lastref="dcube_muons_alt_100GeV_last"
...
evnt_muons_alt_100GeV=$artdata/InDetSLHC_Example/inputs/EVNT.09244578.*.pool.root.1
hits_ref_muons_alt_100GeV=$artdata/InDetSLHC_Example/inputs/InclinedDuals_HITS_mu_100GeV.root

if [ $dosim -ne 0 ]; then
  hits_muons_alt_100GeV=physval_muons_alt_100GeV.HITS.root
else
  hits_muons_alt_100GeV="$hits_ref_muons_alt_100GeV"
fi
if [ $dorec -ne 0 ]; then
  esd_muons_alt_100GeV=physval_muons_alt_100GeV.ESD.root
  daod_muons_alt_100GeV=physval_muons_alt_100GeV.DAOD_IDTRKVALID.root
else
  esd_muons_alt_100GeV=$artdata/InDetSLHC_Example/inputs/InclinedAlternative_ESD_mu_100GeV.root
  daod_muons_alt_100GeV=$artdata/InDetSLHC_Example/inputs/physval_muons_alt_100GeV.DAOD_IDTRKVALID.root
fi
#jo=$artdata/InDetSLHC_Example/jobOptions/PhysValITk_jobOptions.py moved to share/
dcubemon_muons_alt_100GeV_sim=SiHitValid_muons_alt_100GeV.root
dcubemon_muons_alt_100GeV_digi_pixel=PixelRDOAnalysis_muons_alt_100GeV.root
dcubemon_muons_alt_100GeV_digi_strip=SCT_RDOAnalysis_muons_alt_100GeV.root
dcubemon_muons_alt_100GeV_rec=physval_muons_alt_100GeV.root
...
dcuberef_muons_alt_100GeV_sim=$artdata/InDetSLHC_Example/ReferenceHistograms/InclinedDuals_muons_100GeV_SiHitValid.root
dcuberef_muons_alt_100GeV_digi_pixel=$artdata/InDetSLHC_Example/ReferenceHistograms/PixelRDOAnalysis_muons_100GeV.root
dcuberef_muons_alt_100GeV_digi_strip=$artdata/InDetSLHC_Example/ReferenceHistograms/SCT_RDOAnalysis_muons_100GeV.root
dcuberef_muons_alt_100GeV_rec=$artdata/InDetSLHC_Example/ReferenceHistograms/InclinedDuals_muons_100GeV_physval.root
art_dcube=/cvmfs/atlas.cern.ch/repo/sw/art/dcube/bin/art-dcube
lastref_muons_alt_100GeV_dir=last_results_muons_100GeV

if [ \( $dosim -ne 0 -a -n "$dcube_sim_muons_alt_100GeV_lastref" \) -o \( $dophy -ne 0 -a -n "$dcube_rec_muons_alt_100GeV_lastref" \) ]; then
  run art.py download --user=artprod --dst="$lastref_muons_alt_100GeV_dir" InDetSLHC_Example "$script"
  run ls -la "$lastref_muons_alt_100GeV_dir"
fi
...
if [ $dosim -ne 0 ]; then
  ...
  run Sim_tf.py \
    --inputEVNTFile   "$evnt_muons_alt_100GeV" \
    --outputHITSFile  "$hits_muons_alt_100GeV" \
    --skipEvents      0 \
    --maxEvents       10000 \
    --randomSeed      873254 \
  ...
  mv ./SiHitValid.root ./$dcubemon_muons_alt_100GeV_sim

  # DCube Sim hit plots
  dcube Sim_tf sim-plot "$dcubemon_muons_alt_100GeV_sim" "$dcubecfg_sim" "$lastref_muons_alt_100GeV_dir/$dcubemon_muons_alt_100GeV_sim" "$dcube_sim_muons_alt_100GeV_lastref"
  dcube Sim_tf ""       "$dcubemon_muons_alt_100GeV_sim" "$dcubecfg_sim"                         "$dcuberef_muons_alt_100GeV_sim" "$dcube_sim_muons_alt_100GeV_fixref"
...
if [ $dorec -ne 0 ]; then
  ...
  if [ $dosim -ne 0 ] && [ ! -s "$hits_muons_alt_100GeV" ] && [ -s "$hits_ref_muons_alt_100GeV" ]; then
    echo "$script: Sim_tf output '$hits_muons_alt_100GeV' not created. Run Reco_tf on '$hits_ref_muons_alt_100GeV' instead." 2>&1
    hits_muons_alt_100GeV="$hits_ref_muons_alt_100GeV"
  fi
  ...
  run Reco_tf.py \
    --inputHITSFile    "$hits_muons_alt_100GeV" \
    --outputRDOFile    physval_muons_alt_100GeV.RDO.root \
    --outputESDFile    "$esd_muons_alt_100GeV" \
    --outputAODFile    physval_muons_alt_100GeV.AOD.root \
    --outputDAOD_IDTRKVALIDFile "$daod_muons_alt_100GeV" \
    --maxEvents        -1 \
  ...
  mv ./PixelRDOAnalysis.root ./$dcubemon_muons_alt_100GeV_digi_pixel
  mv ./SCT_RDOAnalysis.root ./$dcubemon_muons_alt_100GeV_digi_strip
  
  # DCube digi plots
  dcube Reco_tf digi-plot "$dcubemon_muons_alt_100GeV_digi_pixel" "$dcubecfg_digi_pixel" "$lastref_muons_alt_100GeV_dir/$dcubemon_muons_alt_100GeV_digi_pixel" "$dcube_digi_pixel_muons_alt_100GeV_lastref"
  dcube Reco_tf  ""       "$dcubemon_muons_alt_100GeV_digi_pixel" "$dcubecfg_digi_pixel"                           "$dcuberef_muons_alt_100GeV_digi_pixel" "$dcube_digi_pixel_muons_alt_100GeV_fixref"
  
  dcube Reco_tf digi-plot "$dcubemon_muons_alt_100GeV_digi_strip" "$dcubecfg_digi_strip" "$lastref_muons_alt_100GeV_dir/$dcubemon_muons_alt_100GeV_digi_strip" "$dcube_digi_strip_muons_alt_100GeV_lastref"
  dcube Reco_tf  ""       "$dcubemon_muons_alt_100GeV_digi_strip" "$dcubecfg_digi_strip"                           "$dcuberef_muons_alt_100GeV_digi_strip" "$dcube_digi_strip_muons_alt_100GeV_fixref"
...
if [ $dophy -ne 0 ]; then
  ...
  run ls -lLU "$esd_muons_alt_100GeV"

  if [ ! -s "$esd_muons_alt_100GeV" ]; then
    echo "$script: Reco_tf output '$esd_muons_alt_100GeV' not created - exit" 2>&1
    echo "art-result: 21 physval"
#   test -n "$dcube_rec_fixref"  && echo "art-result: 22 plot-fixref"
    test -n "$dcube_rec_muons_alt_100GeV_lastref" && echo "art-result: 22 plot"
    exit
  fi
  ...
  ( set -x
    inputDAOD_IDTRKVALIDFile="$daod_muons_alt_100GeV" exec athena.py InDetSLHC_Example/PhysValITk_jobOptions.py
  )
  echo "art-result: $? physval"
  
  mv ./physval.root ./$dcubemon_muons_alt_100GeV_rec
  
  # DCube InDetPhysValMonitoring performance plots
  dcube InDetPhysValMonitoring plot "$dcubemon_muons_alt_100GeV_rec" "$dcubecfg_rec" "$lastref_muons_alt_100GeV_dir/$dcubemon_muons_alt_100GeV_rec" "$dcube_rec_muons_alt_100GeV_lastref"
  dcube InDetPhysValMonitoring ""   "$dcubemon_muons_alt_100GeV_rec" "$dcubecfg_rec"                         "$dcuberef_muons_alt_100GeV_rec" "$dcube_rec_muons_alt_100GeV_fixref"
