...
dcuberef_muons_10GeV_sim=$artdata/InDetSLHC_Example/ReferenceHistograms/InclinedDuals_muons_10GeV_SiHitValid.root
dcuberef_muons_10GeV_digi_pixel=$artdata/InDetSLHC_Example/ReferenceHistograms/PixelRDOAnalysis_muons_10GeV.root
dcuberef_muons_10GeV_digi_strip=$artdata/InDetSLHC_Example/ReferenceHistograms/SCT_RDOAnalysis_muons_10GeV.root
dcuberef_muons_10GeV_rec=$artdata/InDetSLHC_Example/ReferenceHistograms/InclinedDuals_muons_10GeV_physval.root
...
if [ $dosim -ne 0 ]; then
  ...
  run Sim_tf.py \
    ...
    --maxEvents       10000 \
    --randomSeed      873254 \
    --geometryVersion ATLAS-P2-ITK-20-04-00_VALIDATION \
...
if [ $dorec -ne 0 ]; then
  ...
  run Reco_tf.py \
    ...
    --outputDAOD_IDTRKVALIDFile "$daod_muons_10GeV" \
    --maxEvents        -1 \
    --digiSteeringConf StandardInTimeOnlyTruth \
    --geometryVersion  ATLAS-P2-ITK-20-04-00 \
    --conditionsTag    OFLCOND-MC15c-SDR-14-03 \
    --DataRunNumber    242000 \
    --steering doRAWtoALL \
...
#   test -n "$dcube_rec_fixref"  && echo "art-result: 22 plot-fixref"
  ...
  ( set -x
    inputDAOD_IDTRKVALIDFile="$daod_muons_10GeV" exec athena.py InDetSLHC_Example/PhysValITk_jobOptions.py
  )
