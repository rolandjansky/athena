...
if [ $dorec -ne 0 ]; then
  ...
  esd_muons_10GeV=$artdata/InDetSLHC_Example/inputs/physval_muons_10GeV_25x100_2020.ESD.root
  daod_muons_10GeV=$artdata/InDetSLHC_Example/inputs/physval_muons_10GeV_25x100_2020.DAOD_IDTRKVALID.root
fi
