...
class SLHC_Setup_XMLReader :
    ...
    def __init__(self):
        ...
        SLHC_Setup_XMLReader(PixelLayout = "Alpine4",
                             SCTLayout   = "LoI",
                             dictionaryFileName = "InDetIdDictFiles/IdDictInnerDetector_SLHC_Alpine_VF.xml",
                             createXML = False,
                             doPix=True,
                             doSCT=False,
                             isGMX=False,
...
##        pixelTool.Alignable = False
        ...
        xmlFileDict={}
        xmlFileDict["Pixel"]={
            "PIXELGENERAL":"AlpinePixelGeneral_VF",
            "PIXELSIMPLESERVICE":"AlpinePixelSimpleService_VF",
