...
class SLHC_Setup_XMLReader :
    ...
    def __init__(self):
        ...
        if (SLHC_Flags.LayoutOption == "InclinedQuads" ):
            SLHC_Setup_XMLReader(PixelLayout = "InclBrl4Ref_InclinedQuads_25x100",
                                 PixelEndcapLayout = "ECRing4Ref_InclinedQuads_25x100",
            ...
            SLHC_Setup_XMLReader(PixelLayout = "InclBrl4Ref_InclinedDuals_25x100",
                                 PixelEndcapLayout = "ECRing4Ref_InclinedDuals_25x100",
                                 SCTLayout = "FourLayersNoStub_23-25-dev0",
                                 dictionaryFileName = "InDetIdDictFiles/IdDictInnerDetector_SLHC_InclBrl_4.xml",
                                 createXML = True,
                                 doPix=True,
