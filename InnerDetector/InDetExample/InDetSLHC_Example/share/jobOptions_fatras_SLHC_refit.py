...
if TrkDetFlags.MaterialDatabaseLocal() is True :
   ...
   TrkDetFlags.MaterialDatabaseLocalName    = 'SLHC_LayerMaterial-'+DetDescrVersion+'.db'
TrkDetFlags.MagneticFieldCallbackEnforced         = False
...
#InDetFlags.doFatrasRefit         = False
...
# (ID)
FatrasFlags.RefittingID      = True
FatrasFlags.ReconstructionID = False
# (MS)
...
FatrasSingleTrackSimulationFlags.MinimumMomentum = 10000.
FatrasSingleTrackSimulationFlags.MaximumMomentum = 10000.
FatrasSingleTrackSimulationFlags.MinimumEta      = -2.5
FatrasSingleTrackSimulationFlags.MaximumEta      =  2.5
FatrasSingleTrackSimulationFlags.ParticleType    = 11
...
if not FatrasFlags.SingleTrackSimulation() :
  ...
  ServiceMgr.EventSelector.InputCollections = [
      'root://castoratlas//castor/cern.ch/user/n/nstyles/100GeVMuons_pu100_stripped.pool.root'   
     ]
...
# Final setup
#--------------------------------------------------------------
# the master jobOptions to (local version rather than from InDetRec_Example, to pick up changes for stand-alone fatras refit)  
include("InDetSLHC_Example/Fatras_jobOptions.py")
