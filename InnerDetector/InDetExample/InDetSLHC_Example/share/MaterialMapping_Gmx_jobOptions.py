...
TrkDetFlags.BeamPipeLayerMaterialBinsZ              = 5
TrkDetFlags.PixelBarrelLayerMaterialBinsZ           = 10
TrkDetFlags.PixelEndcapLayerMaterialBinsR           = 5
TrkDetFlags.SCT_BarrelLayerMaterialBinsZ            = 10
TrkDetFlags.SCT_EndcapLayerMaterialBinsR            = 5
TrkDetFlags.InDetPassiveLayerMaterialBinsRz         = 10
...
if 'myMaxEvent' in dir() :
   ...
   theApp.EvtMax =100000   # 50000 #5000 #00 #0
