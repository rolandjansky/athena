...
globalflags.ConditionsTag = "OFLCOND-SDR-BS14T-ATLAS-00" # FIXME - should this be an IBL conditions tag? 'OFLCOND-SDR-BS14T-IBL-01'
...
TrkDetFlags.BeamPipeRadius = 28.0 
...
TrkDetFlags.MaterialMagicTag                = 'ATLAS-IBL-01'
if TrkDetFlags.MaterialDatabaseLocal() is True :
   TrkDetFlags.MaterialVersion                 = 13
   TrkDetFlags.MaterialMagicTag                = 'ATLAS-IBL-00-00-00'
   TrkDetFlags.MaterialDatabaseLocalPath    = 'data/'
   TrkDetFlags.MaterialDatabaseLocalName    = 'AtlasLayerMaterial-ATLAS-IBL-00-00-00.db'
TrkDetFlags.MagneticFieldCallbackEnforced         = False
