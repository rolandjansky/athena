...
__author__ =   "John Stupak"
__version__=   "$Revision: 446944 $"
__doc__    =   "SLHC_PathSetting"
__all__    = [ "SLHC_PathSetting" ]

# kindly stolen from InDetSLHC_Example by Andreas Salzburger
...
class SLHC_Setup :
    ...
    def __init__(self):
        ...
        if (SLHC_Flags.SLHC_Version() and not (SLHC_Flags.SLHC_Version() == 'None')) : 
            ...
            svcMgr.InDetGeometryDBSvc.Sections = ["Pixel"]

            # Override identifier dictionary
