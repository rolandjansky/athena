      ...
      if InDetFlags.doSiSPSeededTrackFinder():
         ...
         if InDetFlags.doFastTracking() :
            ...
            if NewTrackingCuts.mode() == "SLHC":
               ...
               InDetSiSpacePointsSeedMaker.usePixel              = False
               InDetSiSpacePointsSeedMaker.etaMax = NewTrackingCuts.maxEta()
         if NewTrackingCuts.mode() == "SLHC" and InDetFlags.doStagingStudies():
            if InDetFlags.stagingConfig() == "no5thLayer" or InDetFlags.stagingConfig() == "no5thLayerBarrel":
               InDetSiSpacePointsSeedMaker.rmaxPPPSeedConfBarrel = 0 # No PPP seed confirmation, because 4 pixel layers only
