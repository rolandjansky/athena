...
if DetFlags.haveRIO.pixel_on():
    ...
    if InDetFlags.usePixelDCS():
        ...
        if athenaCommonFlags.isOnline():
            ...
            if (rec.doMonitoring() and globalflags.DataSource() == 'data' and ( geoFlags.Run() == "RUN2" or geoFlags.Run() == "RUN3" ) and conddb.dbdata == "CONDBR2"):
                # idGeoFlags.isIBL() == True may work too instead of ( geoFlags.Run() == "RUN2" or geoFlags.Run() == "RUN3" )
