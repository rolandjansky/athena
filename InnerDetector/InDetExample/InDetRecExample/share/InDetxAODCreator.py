...
if InDetFlags.doR3LargeD0() and InDetFlags.storeSeparateLargeD0Container(): # TODO: Should this include the flag doLargeD0? Will this flag be converted to doLargeD0 once incorporated? -RN
    if doCreation :
