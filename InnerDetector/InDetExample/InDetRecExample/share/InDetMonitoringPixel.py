...
#STSTST  from PixelConditionsTools.PixelConditionsToolsConf import PixelByteStreamErrorsTool
#STSTST  # never attempt to write bytestream error objects
#STSTST  pixelAthMonAlgErrorMonAlg.PixelByteStreamErrorsTool = PixelByteStreamErrorsTool(ReadingESD = True)
