...
void stripHitStandardLoI() {
    ...
    UInt_t nStripHits;
    std::vector<double> *stripHitLocX;
    std::vector<double> *stripHitLocY;
    std::vector<double> *stripHitLocZ;
    std::vector<double> *stripHitBarrelEC;
    std::vector<double> *stripHitLayer;
    std::vector<double> *stripHitEta;
    std::vector<double> *stripHitPhi;
    std::vector<double> *stripHitSide;
    ...
    TH1F *h_EClocalX = new TH1F("EClocalX", "EC Hit local X-coordinate; x [mm]; nEvents", 120, -60.0, 60.0);
    ...
    TH2F *h_EClocalYX = new TH2F("EClocalYX", "EC Hit local coords Y vs X; x [mm]; y[mm]", 120, -60.0, 60.0, 140, -70.0, 70.0);
