...
namespace InDet
{
  ...
  private:
    ...
    /*
     std::vector<double> m_resPixellocXResTypeUnbiased;
     std::vector<double> m_resPixellocYResTypeUnbiased;
     std::vector<double> m_pullPixellocXResTypeUnbiased;
     std::vector<double> m_pullPixellocYResTypeUnbiased;
