...
namespace InDet
{
  ...
  private:
    ...
    std::vector<double> m_resPixellocXBiased;
    std::vector<double> m_resPixellocYBiased;
    std::vector<double> m_pullPixellocXBiased;
    std::vector<double> m_pullPixellocYBiased;
    std::vector<double> m_resSCTBiased;
    std::vector<double> m_pullSCTBiased;
    
    std::vector<double> m_resPixellocXUnbiased;
    std::vector<double> m_resPixellocYUnbiased;
    std::vector<double> m_pullPixellocXUnbiased;
    std::vector<double> m_pullPixellocYUnbiased;
