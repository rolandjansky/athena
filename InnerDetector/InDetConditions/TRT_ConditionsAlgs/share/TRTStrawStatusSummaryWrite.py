outputFile = "trtstrawstatus-03_test.root"
objectList = [ "TRTCond::StrawStatusMultChanContainer#/TRT/Cond/Status"]
tagList = ["TrtStrawStatus-03_test"]
...
IOVDbSvc.dbConnection="impl=cool;techno=sqlite;schema=trtstrawstatus-03_test.db;X:COMP200"
...
TSW.StatusInputFile="strawstatustest.txt"
topSequence +=TSW
