...
std::tuple<std::unique_ptr<InDet::SiDetectorElementStatus>, EventIDRange> PixelByteStreamErrorDetectorElementStatusTool::getDetectorElementStatus(const EventContext& ctx) const  {
