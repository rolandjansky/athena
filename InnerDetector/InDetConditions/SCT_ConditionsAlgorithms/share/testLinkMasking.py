...
msg = logging.getLogger("testLinkMasking")
...
# This folder can be created by SCT_ConditionsTools/share/createLinkMaskingSQLiteFile.py
...
if numThreads >= 2:
    ...
    LinkMaskingTestAlg.Cardinality = numThreads    
