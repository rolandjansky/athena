...
SetNextInputFile('/afs/cern.ch/user/h/hoide/workdir/alignment/tutorial_r21_git/athena/align_tutorial/tutorial_Iter0_try1/TotalMonitoring.root', 'Iter0', 24, kGray+1, 'AlignTracks_all', 'run_311481')
SetNextInputFile('/afs/cern.ch/user/h/hoide/workdir/alignment/tutorial_r21_git/athena/align_tutorial/tutorial_Iter1_try1/TotalMonitoring.root', 'Iter1', 20, kRed+2, 'AlignTracks_all', 'run_311481')
