...
StatusCode IDAlignMonGenericTracks::fillHistograms()
{
  ...
  //DataVector<Trk::Track>::const_iterator trkPsItr  = trkPs->begin();
  //DataVector<Trk::Track>::const_iterator trkPsItrE = trkPs->end();
  ...
  for (; trkPsItr != trkPsItrE; ++trkPsItr) {
    ...
    if (m_doIP){
      ...
      if (vtx) myIPandSigma = m_trackToVertexIPEstimator->estimate(*trkPsItr, vtx, true);
    } 
