//
#include "PlotEvolution.h"
//
fit_results PlotEvolution(int etabin=1, int phibin=1)
{
  bool debug = true;
  ...
  //TString FileName("ZmumuValidationExampleOutput.Data.stableperiodPeriodE.PROVAIFICSINFORMULALnewmodelv2epsilon0_3_eta_1_phi_30iter_mcbiasRefit2Params.root");
  //TString FileName("ZmumuValidationExampleOutput.Data.stableperiodPeriodE.PROVAIFICSINFORMULALnewmodelv2epsilon0_3_eta_6_phi_30iter_mcbiasRefit1Params.root");
  //TString FileName("ZmumuValidationExampleOutput.Data.stableperiodPeriodE.PROVAIFICSINFORMULALBIASSTUDYnewmodelv2epsilon0_3_eta_1_phi_30iter_mcbiasRefit2Params.root");
  ...
  //TF1 *sinewave = new TF1("sinewave","[0]+[1]*sin([2]*x+[3])",4.5, v_iter.size()+0.5);
  //TF1 *sinewave = new TF1("sinewave","[0]+[1]*x",21.5, v_iter.size()+0.5);
