...
if (useIDADynamicFolders):
    ...
    if (False):
        print (" == runzmumu == configuring 2018 Salva test (Runset2) -- step29 ")
        conddb.addOverride("/Indet/AlignL1/ID", "IndetAlignL1ID-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/Indet/AlignL2/PIX", "IndetAlignL2PIX-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/Indet/AlignL2/SCT", "IndetAlignL2SCT-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/Indet/IBLDist", "IndetAlignIBLDIST-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/Indet/AlignL3", "IndetAlignL3-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/TRT/AlignL1/TRT", "TRTAlignL1-R2dynamic-2018-Runset2-step29")
        conddb.addOverride("/TRT/AlignL2", "TRTAlignL2-R2dynamic-2018-Runset2-step29")            
        if readPool and False:
            print " == runzmumu == configuring 2018 Salva test -- step29 == conddb.blockFolder(/Indet/AlignL3)"
            conddb.blockFolder("/Indet/AlignL3")
            conddb.blockFolder("/TRT/AlignL2")
    if (False):
