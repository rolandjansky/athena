...
void PixelBarrelIniLocalPos() {
  ...
  if (iPixelHits>0) {
    ...
    if (inFile==NULL) cout << "No LocalPositions.txt file found!" << endl;
      ...
      treePixelPos->ReadFile(inFile,"mcode:Tx:Ty:Tz:Rx:Ry:Rz");
      // treePixelPos->Scan();

      cPixelBarrelPos = new TCanvas("cPixelBarrelPos","Initial Pixel Module Position",1100,600);
...
//       sprintf(name,"Tx>>hPixelEndCapCTx(100,%2.3f,%2.3f)",-1.6,1.6);
//       treePixelPos->Draw(name,"mcode<-22000000 && mcode>-22430000","goff");
//       float iPixEC = hPixelEndCapCTx->GetEntries();
//       if (normalizePlots) hPixelEndCapCTx->Scale(100./iPixEC);
//       hPixelEndCapCTx->SetLineColor(ColorForEndCapC+2);
//       hPixelEndCapCTx->SetLineWidth(1);
//       hPixelEndCapCTx->SetFillColor(ColorForEndCapC);
//       hPixelEndCapCTx->SetFillStyle(3001);
//       hPixelEndCapCTx->DrawCopy("SAME");

//       sprintf(name,"Tx>>hPixelEndCapATx(100,%2.3f,%2.3f)",-1.6,1.6);
//       treePixelPos->Draw(name,"mcode<22430000 && mcode>22000000","goff");
//       float iPixEC = hPixelEndCapATx->GetEntries();
//       if (normalizePlots) hPixelEndCapATx->Scale(100./iPixEC);
//       hPixelEndCapATx->SetLineColor(ColorForEndCapA+2);
//       hPixelEndCapATx->SetLineWidth(1);
//       hPixelEndCapATx->SetFillColor(ColorForEndCapA);
//       hPixelEndCapATx->SetFillStyle(3001);
//       hPixelEndCapATx->DrawCopy("SAME");
	...
	if (mcode<1300000 && mcode>1000000) {
      ...
      cPixelBarrelMeanPos = new TCanvas("cPixelBarrelMeanPos",
					"Initial Pixel Module Mean Position Vs Layer",1100,600);
