...
class PixelMonModules
{
   public:
      ...
      virtual void formatHist(std::string)=0;//pass the bin lables here if needed
      virtual void Reset()=0;
      virtual StatusCode regHist(ManagedMonitorToolBase* thisptr, std::string path, ManagedMonitorToolBase::Interval_t Run)=0;
      //virtual StatusCode regHist(ManagedMonitorToolBase* thisptr, std::string path, ManagedMonitorToolBase::Interval_t Run, ManagedMonitorToolBase::MgmtAttr_t m=ATTRIB_MANAGED)=0;
protected:
      int m_nBins;
...
//StatusCode regHist(ManagedMonitorToolBase* thisptr, std::string path, ManagedMonitorToolBase::Interval_t Run, ManagedMonitorToolBase::MgmtAttr_t m=ATTRIB_MANAGED);
      TH1F* IBL[20][14];
      TH1F* B0[13][22];
      TH1F* B1[13][38];
      TH1F* B2[13][52];
      TH1F* A[3][48];
      TH1F* C[3][48];
      virtual void formatHist(std::string opt="");  //pass the bin lables here if needed
