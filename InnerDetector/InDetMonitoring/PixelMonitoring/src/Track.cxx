...
StatusCode PixelMainMon::BookTrackMon(void)
{
  ...
  if (m_do2DMaps && !m_doOnline) {
    m_tsos_hitmap = new PixelMon2DMapsLW("TSOS_Measurement", ("TSOS of type Measurement" + m_histTitleExt), PixMon::HistConf::kPixDBMIBL2D3D, m_doIBL, true);
    sc = m_tsos_hitmap->regHist(trackHistos);
    m_tsos_holemap = new PixelMon2DMapsLW("TSOS_Hole", ("TSOS of type Hole" + m_histTitleExt), PixMon::HistConf::kPixDBMIBL2D3D, m_doIBL, true);
