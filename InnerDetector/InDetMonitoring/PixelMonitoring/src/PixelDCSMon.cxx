...
StatusCode PixelMainMon::BookPixelDCSMon(void)
{
   ...
   if(msgLvl(MSG::DEBUG)) msg(MSG::DEBUG)  << "[BookPixelDCSMon]" << endreq;  
...
{
   if(msgLvl(MSG::DEBUG)) msg(MSG::DEBUG)  << "[FillPixelDCSMon]" << endreq;  
...
{
   if(msgLvl(MSG::DEBUG)) msg(MSG::DEBUG)  << "[ProcPixelDCSMon]" << endreq;  
   return StatusCode::SUCCESS;                  
}                                               
