...
// Mon Feb 14 23:26:19 2011 by ROOT version 5.26/00e
// from TTree InDetTrackTree/InDetTrackTree
// found on file: root://castoratlas//castor/cern.ch/atlas/atlascerngroupdisk/perf-idtracking/trackptstudies/group.perf-idtracking.mc10_7TeV.105001.pythia_minbias.VTX_NTUPMON.e574_s932_s946_r2054_tid272149_00/group.perf-idtracking.13339_000285.D3PD._00011.root.1
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://castoratlas//castor/cern.ch/atlas/atlascerngroupdisk/perf-idtracking/trackptstudies/group.perf-idtracking.mc10_7TeV.105001.pythia_minbias.VTX_NTUPMON.e574_s932_s946_r2054_tid272149_00/group.perf-idtracking.13339_000285.D3PD._00011.root.1");
      if (!f) {
         f = new TFile("root://castoratlas//castor/cern.ch/atlas/atlascerngroupdisk/perf-idtracking/trackptstudies/group.perf-idtracking.mc10_7TeV.105001.pythia_minbias.VTX_NTUPMON.e574_s932_s946_r2054_tid272149_00/group.perf-idtracking.13339_000285.D3PD._00011.root.1");
      }
...
void InDetTrackTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("mcVx_event_number", &mcVx_event_number, &b_mcVx_event_number);
   ...
   fChain->SetBranchAddress("vxsplit_cov_xy", &vxsplit_cov_xy, &b_vxsplit_cov_xy);
   fChain->SetBranchAddress("vxsplit_cov_xz", &vxsplit_cov_xz, &b_vxsplit_cov_xz);
   fChain->SetBranchAddress("vxsplit_cov_yz", &vxsplit_cov_yz, &b_vxsplit_cov_yz);
   ...
   fChain->SetBranchAddress("pevt_n", &pevt_n, &b_pevt_n);
   fChain->SetBranchAddress("pevt_time", &pevt_time, &b_pevt_time);
   fChain->SetBranchAddress("pevt_index", &pevt_index, &b_pevt_index);
   fChain->SetBranchAddress("pevt_type", &pevt_type, &b_pevt_type);
