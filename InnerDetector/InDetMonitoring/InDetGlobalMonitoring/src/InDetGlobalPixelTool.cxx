...
//---------------------------------------------------------
StatusCode InDetGlobalPixelTool::bookHistogramsRecurrent()
{
  MonGroup monGr_shift ( this, "InDetGlobal/Pixel",  run);
  ...
  if (newRun){ 
    ...
    registerHist(monGr_exp,m_Pixel_track_pull_phi = new TH1F("m_Pixel_track_pull_phi","Pixel pull LocX",500,-5,5));
    registerHist(monGr_shift,m_Pixel_track_res_eta = new TH1F("m_Pixel_track_res_eta","Pixel Residual LocY",500,-5,5));
    registerHist(monGr_exp,m_Pixel_track_pull_eta = new TH1F("m_Pixel_track_pull_eta","Pixel Pull LocY",500,-5,5));   
    registerHist(monGr_exp,m_Pixel_track_ecA_cluster_occupancy = new TH2F("m_Pixel_track_ecA_cluster_occupancy","Pixel cluster occupancy in ECA",3,0,3,48,0,48));       
    registerHist(monGr_exp,m_Pixel_track_ecC_cluster_occupancy = new TH2F("m_Pixel_track_ecC_cluster_occupancy","Pixel cluster occupancy in ECC",3,0,3,48,0,48));     
    registerHist(monGr_exp,m_Pixel_track_bar_lay0_cluster_occupancy = new TH2F("m_Pixel_track_bar_lay0_cluster_occupancy","Pixel cluster occupancy in the first barrel layer",13,-6.5,6.5,22,-0.5,21.5));  
    registerHist(monGr_exp,m_Pixel_track_bar_lay1_cluster_occupancy = new TH2F("m_Pixel_track_bar_lay1_cluster_occupancy","Pixel cluster occupancy in the second barrel layer",13,-6.5,6.5,38,-0.5,37.5));
    registerHist(monGr_exp,m_Pixel_track_bar_lay2_cluster_occupancy = new TH2F("m_Pixel_track_bar_lay2_cluster_occupancy","Pixel cluster occupancy in the third barrel layer",13,-6.5,6.5,52,-0.5,51.5));
    registerHist(monGr_exp,m_Pixel_track_Lvl1A = new TH1F("m_Pixel_track_Lvl1A","Level 1 Accept on track",17,-0.5,16.5));
    registerHist(monGr_exp,m_Pixel_track_chi2  = new TH1F("m_Pixel_track_chi2",  "chi2/DoF of reconstructed track (with >0 pixel hits)", 80,-0.,20.));
    registerHist(monGr_exp,m_Pixel_track_qOverP  = new TH1F("m_Pixel_track_qOverP",  "Reconstructed inverse momentum of track (with >0 pixel hits)", 100,-5.,5.));
    TAxis *xaxis = m_Pixel_track_qOverP->GetXaxis();
    xaxis->SetTitle("Inverse momentum [GeV^{-1}]");
    registerHist(monGr_exp,m_Pixel_track_d0  = new TH1F("m_Pixel_track_d0",  "Reconstructed d_0 of track (with >0 pixel hits)", 400,-200.,200.));
    xaxis = m_Pixel_track_d0->GetXaxis();
    xaxis->SetTitle("d_0 [mm]");
    registerHist(monGr_exp,m_Pixel_track_z0  = new TH1F("m_Pixel_track_z0",  "Reconstructed z_0 of track (with >0 pixel hits)", 300,-1000.,1000.));
    xaxis = m_Pixel_track_z0->GetXaxis();
    xaxis->SetTitle("z_0 [mm]");
    registerHist(monGr_exp,m_Pixel_track_phi0  = new TH1F("m_Pixel_track_phi0",  "Reconstructed #phi_0 of track (with >0 pixel hits)", 40,-4.,4.));
    xaxis = m_Pixel_track_phi0->GetXaxis();
    xaxis->SetTitle("#phi_0");
    registerHist(monGr_exp,m_Pixel_track_theta  = new TH1F("m_Pixel_track_theta",  "Reconstructed #theta of track (with >0 pixel hits)", 30,-0.,4.));
    xaxis = m_Pixel_track_d0->GetXaxis();
    xaxis->SetTitle("#theta");
    registerHist(monGr_exp,m_Pixel_track_eta  = new TH1F("m_Pixel_track_eta",  "Reconstructed #eta of track (with >0 pixel hits)", 40,-4.,4.));
