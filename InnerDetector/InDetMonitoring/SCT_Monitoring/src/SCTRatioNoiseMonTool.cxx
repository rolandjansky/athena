...
StatusCode SCTRatioNoiseMonTool::fillHistograms(){
  ...
  for (int i = 0; i < n_layers[ENDCAP_C_INDEX] ; i++){
   ...
   int count_SCT_RDO = 0;
   if( isSelectedTrigger == true || m_environment==AthenaMonManager::online){
...
//  StatusCode SCTRatioNoiseMonTool::bookRatioNoiseHistos(bool isNewRun){       // hidetoshi 14.01.22
  StatusCode SCTRatioNoiseMonTool::bookRatioNoiseHistos(){       // hidetoshi 14.01.22
    ...
    //    if(isNewRun){                                          // hidetoshi 14.01.22
      ...
      m_side=h1Factory("h_side", "Side",RatioNoise, 0, 6, 6);
      ...
      m_NZ1 = h1Factory("h_NZ1", "NoZeroSide-1d", RatioNoise, 0, 6000, 1000);
      ...
      m_NO->SetTitle("Noise Occupancy for Barrel and Endcaps; Noise Occupancy [10^{-5}]; Modules");
      m_NOEC = h1Factory("h_NOEC", "Noise Occupancy Endcap",RatioNoise, 0, 100, 500);
      m_NOEC->SetTitle("Noise Occupancy for Endcaps; Noise Occupancy [10^{-5}]; Modules");
      m_NOb = h1Factory("h_NOb", "Noise Occupancy Barrel",RatioNoise, 0, 100, 500);
      m_NOb->SetTitle("Noise Occupancy for Barrel; Noise Occupancy [10^{-5}]; Modules");
      m_NZ1_vs_modnum = h1Factory("h_NZ1_vs_modnum", "Num zero side hits vs module number", RatioNoise, 0,4088, 4088);
      m_N11_vs_modnum = h1Factory("h_N11_vs_modnum", "Num 1 side hits vs module number", RatioNoise, 0,4088, 4088);
      
      for(int l=0;l< n_layers[BARREL_INDEX];l++){
	//granularity set to one histogram/layer for now
	m_NOEV_Barrel[l] = h1Factory("h_NOEV_Barrel"+hNumBarrel[l], "Event Noise Occupancy Barrel "+hNumBarrel[l], RatioNoise, 0, 5,500);
	...
	m_NZ1BAR[l]=h1Factory("h_NZ1BAR"+hNumBarrel[l], "NoZeroSide-1d Barrel Layer "+hNumBarrel[l], RatioNoise, 0, 6000, 1000);
	m_N11BAR[l]=h1Factory("h_N11BAR"+hNumBarrel[l], "NoOneSide-1d Barrel Layer "+hNumBarrel[l], RatioNoise, 0, 6000, 1000);
	m_N21BAR[l]=h1Factory("h_N21BAR"+hNumBarrel[l], "NoTwoSide-1d Barrel Layer "+hNumBarrel[l], RatioNoise, 0, 6000, 1000);
	...
	m_NZ1BAR_vsLB[l] = h1Factory("h_NZ1BAR"+hNumBarrel[l]+"_vsLB", "NoZeroSide-1d Barrel Layer "+hNumBarrel[l]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	m_NZ1BAR_vsLB[l]->GetXaxis()->SetTitle("LumiBlock");
	m_NZ1BAR_vsLB[l]->GetYaxis()->SetTitle("Num of ZeroSide Hits");
	
	m_N11BAR_vsLB[l] = h1Factory("h_N11BAR"+hNumBarrel[l]+"_vsLB", "NoOneSide-1d Barrel Layer "+hNumBarrel[l]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	...
	m_N11BAR_vsLB[l]->GetYaxis()->SetTitle("Num of OneSide Hits");
      ...
      for(int m=0; m<n_layers[ENDCAP_C_INDEX];m++){
	m_NOEV_EndcapC[m] = h1Factory("h_NOEV_EndcapC"+hNumEndcap[m], "Event Noise Occupancy Endcap C "+hNumEndcap[m], RatioNoise, 0, 5,500);
	m_NZ1ECC[m]=h1Factory("h_NZ1ECC"+hNumEndcap[m], "NoZeroSide-1d Endcap C Layer "+hNumEndcap[m], RatioNoise, 0, 6000, 1000);
	m_N11ECC[m]=h1Factory("h_N11ECC"+hNumEndcap[m], "NoOneSide-1d Endcap C Layer "+hNumEndcap[m], RatioNoise, 0, 6000, 1000);
	m_N21ECC[m]=h1Factory("h_N21ECC"+hNumEndcap[m], "NoTwoSide-1d Endcap C Layer "+hNumEndcap[m], RatioNoise, 0, 6000, 1000);
	m_NOECC_disk[m] = h1Factory("h_NOECC_disk"+hNumEndcap[m], "Noise Occupancy Endcap C Disk "+hNumEndcap[m],RatioNoise, 0, 100, 500);
	
	m_NOECC_disk_vsLB[m] = h1Factory("h_NOECC_disk"+hNumEndcap[m]+"_vsLB", "Noise Occupancy Barrel Disk "+hNumEndcap[m]+" vs LB",RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	m_NOECC_disk_vsLB[m]->GetXaxis()->SetTitle("LumiBlock");
	m_NOECC_disk_vsLB[m]->GetYaxis()->SetTitle("Noise Occupancy [10^{-5}]");
	
	m_NZ1ECC_vsLB[m] = h1Factory("h_NZ1ECC"+hNumEndcap[m]+"_vsLB", "NoZeroSide-1d Barrel Layer "+hNumEndcap[m]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	m_NZ1ECC_vsLB[m]->GetXaxis()->SetTitle("LumiBlock");
	m_NZ1ECC_vsLB[m]->GetYaxis()->SetTitle("Num of ZeroSide Hits");
	
	m_N11ECC_vsLB[m] = h1Factory("h_N11ECC"+hNumEndcap[m]+"_vsLB", "NoOneSide-1d Barrel Layer "+hNumEndcap[m]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	...
	m_NOEV_EndcapA[p] = h1Factory("h_NOEV_EndcapA"+hNumEndcap[p], "Event Noise Occupancy Endcap A "+hNumEndcap[p], RatioNoise, 0, 5,500);
	m_NZ1ECA[p]=h1Factory("h_NZ1ECA"+hNumEndcap[p], "NoZeroSide-1d Endcap A Layer "+hNumEndcap[p], RatioNoise, 0, 6000, 1000);
	m_N11ECA[p]=h1Factory("h_N11ECA"+hNumEndcap[p], "NoOneSide-1d Endcap A Layer "+hNumEndcap[p], RatioNoise, 0, 6000, 1000);
	m_N21ECA[p]=h1Factory("h_N21ECA"+hNumEndcap[p], "NoTwoSide-1d Endcap A Layer "+hNumEndcap[p], RatioNoise, 0, 6000, 1000);
	m_NOECA_disk[p] = h1Factory("h_NOECA_disk"+hNumEndcap[p], "Noise Occupancy Endcap A Disk "+hNumEndcap[p],RatioNoise, 0, 100, 500);
	...
	m_NZ1ECA_vsLB[p] = h1Factory("h_NZ1ECA"+hNumEndcap[p]+"_vsLB", "NoZeroSide-1d Barrel Layer "+hNumEndcap[p]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	m_NZ1ECA_vsLB[p]->GetXaxis()->SetTitle("LumiBlock");
	m_NZ1ECA_vsLB[p]->GetYaxis()->SetTitle("Num of ZeroSide Hits");
	
	m_N11ECA_vsLB[p] = h1Factory("h_N11ECA"+hNumEndcap[p]+"_vsLB", "NoOneSide-1d Barrel Layer "+hNumEndcap[p]+" vs LB", RatioNoise, 0, NBINS_LBs, NBINS_LBs);
	...
	m_N11ECA_vsLB[p]->GetYaxis()->SetTitle("Num of OneSide Hits");
      ...
      m_NOEC_Outer = h1Factory("h_NOEC_Outer", "Noise Occupancy Outer Endcap Modules",RatioNoise, 0, 100, 500);
      m_NOEC_ShortMiddle = h1Factory("h_NOEC_ShortMiddle", "Noise Occupancy Short Middle Endcap Modules",RatioNoise, 0, 100, 500);
      m_NOEC_Inner = h1Factory("h_NOEC_Inner", "Noise Occupancy Inner Endcap Modules",RatioNoise, 0, 100, 500);
      m_NOEC_Middle = h1Factory("h_NOEC_Middle", "Noise Occupancy Middle Endcap Modules", RatioNoise, 0, 100, 500);
