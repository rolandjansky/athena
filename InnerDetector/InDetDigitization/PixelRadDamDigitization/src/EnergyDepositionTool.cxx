...
std::vector<std::pair<double,double> > EnergyDepositionTool::BichselSim(double BetaGamma, int ParticleType, double TotalLength, double InciEnergy) const{
  ...
  // load relevant data
  RadDam::BichselData iData = m_BichselData[ParticleType-1];
...
//=======================================
std::pair<int,int> EnergyDepositionTool::GetBetaGammaIndices(double BetaGammaLog10, RadDam::BichselData& iData) const{
...
double EnergyDepositionTool::GetColE(std::pair<int,int> indices_BetaGammaLog10, double IntXLog10, RadDam::BichselData& iData) const{
...
//===========================================
double EnergyDepositionTool::GetColE(double BetaGammaLog10, double IntXLog10, RadDam::BichselData& iData) const{
  std::pair<int,int> indices_BetaGammaLog10 = GetBetaGammaIndices(BetaGammaLog10, iData);
...
//==========================================
double EnergyDepositionTool::GetUpperBound(std::pair<int,int> indices_BetaGammaLog10, double BetaGammaLog10, RadDam::BichselData& iData) const{
...
//==========================================
double EnergyDepositionTool::GetUpperBound(double BetaGammaLog10, RadDam::BichselData& iData) const{
  std::pair<int,int> indices_BetaGammaLog10 = GetBetaGammaIndices(BetaGammaLog10, iData);
