...
///////////////////////////////////////////////////////////////////
// SensorSimITk3DTool.h
//   Header file for class SensorSimITk3DTool
///////////////////////////////////////////////////////////////////
...
#ifndef PIXELDIGITIZATION_SensorSimITk3DTool_H
#define PIXELDIGITIZATION_SensorSimITk3DTool_H
...
class SensorSimITk3DTool : public SensorSimTool {

  public:
    SensorSimITk3DTool( const std::string& type, const std::string& name,const IInterface* parent);
    virtual StatusCode initialize();
    virtual StatusCode finalize();
    virtual ~SensorSimITk3DTool();
...
#endif // PIXELDIGITIZATION_SensorSimITk3DTool_H
