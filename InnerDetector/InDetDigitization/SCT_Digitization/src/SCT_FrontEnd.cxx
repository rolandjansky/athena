...
//
// ----------------------------------------------------------------------
StatusCode SCT_FrontEnd::randomNoise(SiChargedDiodeCollection &collection, const
                                     Identifier &moduleId) const {
    // Add random noise
...
StatusCode SCT_FrontEnd::doThresholdCheckForRealHits(
    SiChargedDiodeCollection &collection) const {
    // **********************************************************************************
...
//
// ----------------------------------------------------------------------
StatusCode SCT_FrontEnd::doThresholdCheckForCrosstalkHits(
    SiChargedDiodeCollection &collection) const {
