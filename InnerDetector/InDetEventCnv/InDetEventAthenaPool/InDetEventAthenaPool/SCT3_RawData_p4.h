...
// List of Cnv classes that convert this into Rdo objects
  ...
  //private:
  unsigned short m_rowStrip=0; // row and strip numbers from Identifier. Bits 0-12 for strip, Bits 13-15 for row
  unsigned short m_word=0; // raw data word. Bits 0-10 for group size, Bits 11-13 for time bin
