    ...
    c) Adjust the references in the test/InDetPhysValMonitoring_TestConfiguration.xml to
       ...
       For example:
         ...
         <arg>
            ...
            <argvalue>/afs/cern.ch/work/u/user/ws/rtt/ref/IdPhysValMinBias/InDetPhysVal.xml</argvalue>
         </arg>
         <arg>
            <argname>DCubeRef</argname>
            <argvalue>/afs/cern.ch/work/u/user/ws/rtt/ref/IdPhysValMinBias/physval.root</argvalue>
         </arg>
    
       [In the InDetPerformanceRTT no path is given for the DCube configuration and reference file.
        Don't know what the default search path would be.]
