...
InDetPerfPlot_Pt::initializePlots() {	
  ...
  m_recPt  = Book1D("recpT",hd.title,hd.nBinsX,hd.xAxis.first,hd.xAxis.second, prependDirectory);
  hd= retrieveDefinition("recpTlow", "default");
  m_recPtLow  = Book1D("recpTlow",hd.title,hd.nBinsX,hd.xAxis.first,hd.xAxis.second, prependDirectory);
}
