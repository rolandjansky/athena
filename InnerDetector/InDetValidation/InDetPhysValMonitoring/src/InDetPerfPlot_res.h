...
public:
  ...
  void SetEtaBinning(int trackEtaBins, float etaMin, float etaMax/*, int PtBins, float PtMin, float PtMax*/) { m_trackEtaBins = trackEtaBins; m_etaMin = etaMin; m_etaMax = etaMax; /*m_PtBins = PtBins; m_PtMin = PtMin; m_PtMax = PtMax;*/ };
