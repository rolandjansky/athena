...
InDetPhysValDecoratorAlg::InDetPhysValDecoratorAlg(const std::string& name, ISvcLocator* pSvcLocator):AthAlgorithm( name, pSvcLocator ),
...
StatusCode InDetPhysValDecoratorAlg::initialize(){
...
StatusCode InDetPhysValDecoratorAlg::execute(){
  ...
  ATH_MSG_INFO("Both track and truth containers were retrieved");
  //
  //retrieve trackParticle container
	//
	...
	ATH_MSG_INFO(nTracks <<" tracks were retrieved; " << num_truthmatch_match <<" had associated truth.");
  return StatusCode::SUCCESS;
}
