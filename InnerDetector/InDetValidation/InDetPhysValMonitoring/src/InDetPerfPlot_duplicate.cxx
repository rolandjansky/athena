...
InDetPerfPlot_duplicate::InDetPerfPlot_duplicate(InDetPlotBase* pParent, const std::string & sDir):InDetPlotBase(pParent, sDir){
}
...
void
InDetPerfPlot_duplicate::fillTwoMatchDuplicate(const float prob1,const float prob2,const xAOD::TrackParticle & trackParticle,const xAOD::TrackParticle & particle, const xAOD::TruthParticle&  tp ){
