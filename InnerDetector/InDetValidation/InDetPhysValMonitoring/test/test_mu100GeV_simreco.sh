...
dcuberef_sim=$artdata/InDetPhysValMonitoring/ReferenceHistograms/SiHitValid_mu_100GeV_simreco.root
dcubecfg_pixel=$artdata/InDetPhysValMonitoring/dcube/config/run2_PixelRDOAnalysis.xml
dcuberef_pixel=$artdata/InDetPhysValMonitoring/ReferenceHistograms/PixelRDOAnalysis_mu_100GeV_simreco.root
dcubecfg_sct=$artdata/InDetPhysValMonitoring/dcube/config/run2_SCTRDOAnalysis.xml
dcuberef_sct=$artdata/InDetPhysValMonitoring/ReferenceHistograms/SCT_RDOAnalysis_mu_100GeV_simreco.root
dcubecfg_rec=$artdata/InDetPhysValMonitoring/dcube/config/IDPVMPlots_R22.xml
dcuberef_rec=$artdata/InDetPhysValMonitoring/ReferenceHistograms/physval_mu_100GeV_simreco.root
...
if [ $sim_tf_exit_code -eq 0 ]  ;then
 ...
 if [ $rec_tf_exit_code -eq 0 ]  ;then
   ...
   $ATLAS_LOCAL_ROOT/dcube/current/DCubeClient/python/dcube.py \
     ...
     ${dcubemon_rec}
   echo "art-result: $? dcube_rec_lastplots"
