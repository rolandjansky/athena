...
class InDetSecVertexTruthMatchTool : public virtual IInDetSecVertexTruthMatchTool,
 ...
 private:
  ...
  TH1F* m_matchedTruthX; 
  TH1F* m_matchedTruthY;
  TH1F* m_matchedTruthZ;
  TH1F* m_matchedTruthR;  
  TH1F* m_matchedTruthEta;
  TH1F* m_matchedTruthPhi; 
  TH1F* m_matchedTruthBarcode; 
