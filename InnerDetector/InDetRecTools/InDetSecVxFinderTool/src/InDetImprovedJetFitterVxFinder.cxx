...
namespace InDet
{
  ...
  InDetImprovedJetFitterVxFinder::InDetImprovedJetFitterVxFinder(const std::string& t, const std::string& n, const IInterface*  p) :
    ...
    m_routines("Trk::JetFitterRoutines",this),
    m_trkFilter("InDet::InDetDetailedTrackSelectorTool",this),
    m_extrapolator("Trk::Extrapolator/InDetExtrapolator",this),
    m_jetFitterUtils("InDet::InDetJetFitterUtils/InDetJetFitterUtils",this),
    m_CrossDistancesSeedFinder("Trk::CrossDistancesSeedFinder/CrossDistancesSeedFinder",this),
    m_mode3dfinder("Trk::Mode3dTo1dFinder/Mode3dTo1dFinder",this),
    m_SequentialVertexFitter("Trk::SequentialVertexFitter/SequentialVertexFitter",this),
    //m_convUtils("Trk::NeutralParticleParameterCalculator"),
    m_VertexEdmFactory("Trk::VertexInternalEdmFactory",this),
