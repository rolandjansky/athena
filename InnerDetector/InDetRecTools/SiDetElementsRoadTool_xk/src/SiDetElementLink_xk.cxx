...
{
  m_z            = float(P[ 1])                        ; //  Z
  m_dz           = float(fabs(P[12]-P[11])*.5)         ; // dZ
  ...
  m_geo   [6]    = m_geo[3]*m_geo[4]                   ;
  m_geo   [7]    = m_geo[2]*m_geo[4]                   ;
  m_geo   [8]    = float(P[18])                        ; // center[0]
  m_geo   [9]    = float(P[19])                        ; // center[1]
