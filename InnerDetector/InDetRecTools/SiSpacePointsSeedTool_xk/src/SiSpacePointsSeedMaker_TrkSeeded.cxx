...
void InDet::SiSpacePointsSeedMaker_TrkSeeded::writeNtuple(const SiSpacePointsSeed*, const Trk::Track*, int, long) const{
}

bool InDet::SiSpacePointsSeedMaker_TrkSeeded::getWriteNtupleBoolProperty() const{
    return false;
}
