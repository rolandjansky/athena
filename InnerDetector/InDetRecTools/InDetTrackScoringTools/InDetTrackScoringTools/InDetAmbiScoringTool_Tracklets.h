...
//////////////////////////////////////////////////////
// Markus Elsing 
// Modificatios for tracklets by Matthew Gignac
//////////////////////////////////////////////////////

#ifndef INDETAMBISCORINGTOOL_TRACKLETS_H
#define INDETAMBISCORINGTOOL_TRACKLETS_H
...
class InDetAmbiScoringTool_Tracklets : virtual public Trk::ITrackScoringTool,  
                             virtual public IIncidentListener, 
                             public AthAlgTool
{

 public:
  InDetAmbiScoringTool_Tracklets(const std::string&,const std::string&,const IInterface*);
  virtual ~InDetAmbiScoringTool_Tracklets ();
