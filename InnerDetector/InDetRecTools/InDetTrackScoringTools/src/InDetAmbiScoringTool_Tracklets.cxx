...
#include "InDetTrackScoringTools/InDetAmbiScoringTool_Tracklets.h"
...
InDet::InDetAmbiScoringTool_Tracklets::InDetAmbiScoringTool_Tracklets(const std::string& t,
              const std::string& n,
              const IInterface*  p ) :
  AthAlgTool(t,n,p),
...
InDet::InDetAmbiScoringTool_Tracklets::~InDetAmbiScoringTool_Tracklets()
{
}

//---------------------------------------------------------------------------------------------------------------------

StatusCode InDet::InDetAmbiScoringTool_Tracklets::initialize()
{
  ...
  if (m_useAmbigFcn) setupScoreModifiers();
...
StatusCode InDet::InDetAmbiScoringTool_Tracklets::finalize()
{
...
Trk::TrackScore InDet::InDetAmbiScoringTool_Tracklets::score( const Trk::Track& track, const bool suppressHoleSearch )
{
...
Trk::TrackScore InDet::InDetAmbiScoringTool_Tracklets::simpleScore( const Trk::Track& track, const Trk::TrackSummary& trackSummary )
{
  if(!m_mapFilled)
    newEvent();
...
Trk::TrackScore InDet::InDetAmbiScoringTool_Tracklets::ambigScore( const Trk::Track& track, const Trk::TrackSummary& trackSummary ) 
{
  ...
  /*
    Should we priortize shorter tracks here?
    Let's try to penalize tracks that have more than 2 SCT hits?
   */
...
void InDet::InDetAmbiScoringTool_Tracklets::setupScoreModifiers() 
{
  //
  // --- number of Pixel holes
  //
...
void InDet::InDetAmbiScoringTool_Tracklets::handle(const Incident& inc) 
{ 
...
void InDet::InDetAmbiScoringTool_Tracklets::newEvent()
{
  // Reload ROI's
  if(m_useEmClusSeed) {
    m_emF.clear();
...
//==========================================================================================
bool InDet::InDetAmbiScoringTool_Tracklets::isEmCaloCompatible(const Trk::Track& track) const
{
