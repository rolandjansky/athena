 ...
 )
{
  ...
  m_useITKclusterSizeCuts= m_tools->useITKclusterSizeCuts(); // ITK (long barrel)
  m_Nsigma_clSizeZcut= m_tools->Nsigma_clSizeZcut(); // ITK (long barrel) 
...
int InDet::SiTrajectoryElement_xk::deltaSize(double sizeZ, 
