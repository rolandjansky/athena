...
(TRTProcessingOfBarrelHits* pProcessing): pProcessingOfBarrelHits(pProcessing), m_msg("TRTParametersForBarrelHits")
{
  pParameters = TRTParameters::GetPointer();

  printMessages = pParameters->GetInteger("PrintMessages");
 
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "##### Constructor TRTParametersForBarrelHits" << endreq;
  ...
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "##### Constructor TRTParametersForBarrelHits done" << endreq;
}
...
TRTParametersForBarrelHits::~TRTParametersForBarrelHits()
{
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "##### Destructor TRTParametersForBarrelHits" << endreq;
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "##### Destructor TRTParametersForBarrelHits done" << endreq;
}
...
{
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "######### Method TRTParametersForBarrelHits::DefineParameters" << endreq;
  ...
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "######### Method TRTParametersForBarrelHits::DefineParameters done" << endreq;
...
void TRTParametersForBarrelHits::PrintParameters() const
{
  ...
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "######### Method TRTParametersForBarrelHits::PrintParameters" << endreq;
  ...
  if (msgLevel(MSG::VERBOSE)) msg(MSG::VERBOSE) << "######### Method TRTParametersForBarrelHits::PrintParameters done" << endreq;
}
