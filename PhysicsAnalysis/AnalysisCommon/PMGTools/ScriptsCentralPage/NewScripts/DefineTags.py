...
def SortKeyWordsToSampleCategory(Keywords, AODname):
    ...
    #jets       photon     diphoton     monophoton
    #tau     multilepton     BSM     BSMtop     FCNC     4thGen
    #SM     heavyFlavour     heavyBoson     hiddenValley
    #Higgsless     Jpsi     leptoquark     longLived
    #WIMP     boosted     compositeness     resonance
    #egamma     MPI     BSMHiggs     partonShower     peaking     pileUp     rareDecay
