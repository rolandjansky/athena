...
class StatusFileCreator(object):
    ...
    def __init__(self, StatusFile, StatusFolder, Dataset, Comment, SortingTag, Xsec, Kfactor, FilterEff, BR, higherOrderXsecTag, Title, DSID):
        #print StatusFile, StatusFolder, Dataset, Comment, SortingTag, Xsec, Kfactor, FilterEff, BR, higherOrderXsecTag, Title, DSID
        ...
        if not os.path.exists(StatusFileName):
            ...
            if "36240" in DSID:
                print " TEST ",Xsec,"  ",Kfactor,"  ",FilterEff,"  ",BR,"  ",HelpAMIXsec,"  ",kfac,"  ",FilterEff,"  ",HelpBR,"  ",str(float(HelpAMIXsec)*float(kfac)*float(FilterEff)*float(HelpBR))
