...
CopyFlavorLabelTruthParticles::CopyFlavorLabelTruthParticles(const std::string& name, ISvcLocator* pSvcLocator)
...
bool CopyFlavorLabelTruthParticles::classify(const xAOD::TruthParticle* tp) {
