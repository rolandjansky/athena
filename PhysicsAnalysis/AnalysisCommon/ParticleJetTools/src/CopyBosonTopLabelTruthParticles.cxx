...
CopyBosonTopLabelTruthParticles::CopyBosonTopLabelTruthParticles(const std::string& name, ISvcLocator* pSvcLocator)
...
bool CopyBosonTopLabelTruthParticles::classify(const xAOD::TruthParticle* tp) {
