...
namespace Analysis
{
  ...
  class ParticleToJetAssociator : public AthAlgTool //, virtual public IParticleToJetAssociator
  {
    public:

      /** Constructors and destructors */
      ParticleToJetAssociator(const std::string&,const std::string&,const IInterface*);
