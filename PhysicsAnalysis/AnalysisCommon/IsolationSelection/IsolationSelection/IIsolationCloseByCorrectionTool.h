    ...
    class IIsolationCloseByCorrectionTool: public virtual asg::IAsgTool {
        ...
        public:
         enum TopoConeCorrectionModel {
                     DirectCaloClusters = -1,
                     ParticleCaloCorrection = 0,
                     CaloCorrectionExtCore = 1,
                     CaloCorrectionVarAnulus = 2
         };
            ...
            virtual const Root::TAccept& acceptCorrected(const xAOD::IParticle& x, const std::vector<const xAOD::IParticle*>& closePar, int topoetconeModel = -1) const = 0;
            ...
            virtual const CP::CorrectionCode getCloseByCorrection(std::vector<float>& corrections, const xAOD::IParticle& par, const std::vector<xAOD::Iso::IsolationType>& types, const std::vector<const xAOD::IParticle*>& closePar, int topoetconeModel = -1) const = 0;
