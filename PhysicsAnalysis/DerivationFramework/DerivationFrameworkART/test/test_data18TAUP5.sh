...
# art-description: DAOD building TAUP5 data18
# art-type: grid
...
DAODMerge_tf.py --inputDAOD_TAUP5File DAOD_TAUP5.art.pool.root --outputDAOD_TAUP5_MRGFile art_merged.pool.root

echo "art-result: $? merge"

checkFile.py DAOD_TAUP5.art.pool.root > checkFile.txt

echo "art-result: $?  checkfile"

checkxAOD.py DAOD_TAUP5.art.pool.root > checkxAOD.txt
