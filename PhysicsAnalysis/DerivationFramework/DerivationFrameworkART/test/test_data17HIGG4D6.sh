...
# art-description: DAOD building HIGG4D6 data17
# art-type: grid
...
DAODMerge_tf.py --maxEvents 5 --inputDAOD_HIGG4D6File DAOD_HIGG4D6.art.pool.root --outputDAOD_HIGG4D6_MRGFile art_merged.pool.root
