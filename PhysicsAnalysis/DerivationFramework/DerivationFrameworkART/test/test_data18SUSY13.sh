...
# art-description: DAOD building SUSY13 data18
# art-type: grid
...
DAODMerge_tf.py --inputDAOD_SUSY13File DAOD_SUSY13.art.pool.root --outputDAOD_SUSY13_MRGFile art_merged.pool.root

echo "art-result: $? merge"

checkFile.py DAOD_SUSY13.art.pool.root > checkFile.txt

echo "art-result: $?  checkfile"

checkxAOD.py DAOD_SUSY13.art.pool.root > checkxAOD.txt
