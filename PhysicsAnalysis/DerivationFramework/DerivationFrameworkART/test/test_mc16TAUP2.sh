...
DAODMerge_tf.py --inputDAOD_TAUP2File DAOD_TAUP2.art.pool.root --outputDAOD_TAUP2_MRGFile art_merged.pool.root
checkFile.py DAOD_TAUP2.art.pool.root > checkFile.txt
checkxAOD.py DAOD_TAUP2.art.pool.root > checkxAOD.txt