...
checkFile.py DAOD_BPHY16.art.pool.root > checkFile.txt

echo "art-result: $?  checkfile"

checkxAOD.py DAOD_BPHY16.art.pool.root > checkxAOD.txt

echo "art-result: $?  checkxAOD"

checkIndexRefs.py DAOD_BPHY16.art.pool.root > checkIndexRefs.txt
