...
void
select(const xAOD::IParticle* particle,
       const float coneSize,
       const xAOD::CaloClusterContainer* clusters,
       std::vector<bool>& mask);
// Overload for Egamma
void
select(const xAOD::Egamma* particle,
       const float coneSize,
       const xAOD::CaloClusterContainer* clusters,
       std::vector<bool>& mask);
// Overload for Muons
void
select(const xAOD::Muon* particle,
       const float coneSize,
       const xAOD::CaloClusterContainer* clusters,
       std::vector<bool>& mask,
       MsgStream& msg);
...
bool
GetExtrapEtaPhi(const xAOD::Muon* mu, float& eta, float& phi);
}
}
