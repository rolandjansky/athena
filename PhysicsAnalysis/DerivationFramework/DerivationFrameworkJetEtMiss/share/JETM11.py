...
cutExpression = "(count(DFCommonElectronsLHLoose && DFCommonElectrons_pt > (20 * GeV) && abs(DFCommonElectrons_eta) < 2.47) + count(DFCommonMuonsPreselection && Muons.pt > (20*GeV) && abs(Muon.eta) < 2.47) ) >= 1"
...
contentManager = METTriggerDerivationContentManager("JETM11", JETM11Stream)
