...
# Reco_tf.py --inputFileValidation False --preExec 'rec.doApplyAODFix.set_Value_and_Lock(True)' --inputAODFile $input --outputDAODFile ${output}.pool.root --reductionConf MUON0 MUON1 MUON2 MUON3 MUON4 $otherOpt
Reco_tf.py --inputFileValidation False --inputAODFile $input --outputDAODFile ${output}.pool.root --reductionConf MUON0 MUON1 MUON2 MUON3 MUON4 $otherOpt
# Reco_tf.py --inputFileValidation False --inputAODFile $input --outputDAODFile ${output}.pool.root --reductionConf EGAM1 MUON1 $otherOpt
...
# runJob $INPUT ${OUT}3
# 
# INPUT4=/home/dzhang/links/SAMPLES/R20/Data15/MC15/AOD/mc15_13TeV.361107.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zmumu.merge.AOD.e3601_s2576_s2132_r7725_r7676/AOD.07918992._000046.pool.root.1
# runJob $INPUT4 ${OUT}4 "--passThrough True"

INPUT5=root://eosatlas//eos/atlas/user/m/mdobre/forRTTdata16/Data16_210.AOD.pool.root
runJob $INPUT5 ${OUT}5
