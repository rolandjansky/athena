...
"TruthParticlesAux.prodVtxLink.decayVtxLink.m.px.py.pz.pdgId.barcode.status.e.polarizationPhi.polarizationTheta",
"TruthVertices",
"TruthVerticesAux.incomingParticleLinks.outgoingParticleLinks.barcode"
]