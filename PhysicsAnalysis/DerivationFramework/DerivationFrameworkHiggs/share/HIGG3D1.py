...
# SKIMMING TOOL 
#====================================================================
wjetsRequirements = '((Electrons.topoetcone30/DFCommonElectrons_pt) < 0.6)'
electronIDRequirements = '((Electrons.DFCommonElectronsLHLoose) || (Electrons.DFCommonElectronsIsEMLoose))'
electronRequirements = '(DFCommonElectrons_pt > 7*GeV) && (abs(DFCommonElectrons_eta) < 2.6) && ( '+electronIDRequirements+' || '+wjetsRequirements+' )'
leadElectron = electronRequirements + ' && (DFCommonElectrons_pt > 17*GeV)'
muonsRequirements = '(Muons.pt > 7*GeV) && (abs(Muons.eta) < 2.6) && (Muons.DFCommonMuonsLoose)'
...
svcMgr += createThinningSvc( svcName="HIGG3D1ThinningSvc", outStreams=[evtStream] )
...
#HIGG3D1SlimmingHelper.UserContent = HIGG3D1Content
