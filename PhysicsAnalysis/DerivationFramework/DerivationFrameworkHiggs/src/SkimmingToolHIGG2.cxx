...
StatusCode DerivationFramework::SkimmingToolHIGG2::addBranches() const 
{
...
void DerivationFramework::SkimmingToolHIGG2::fillElectrons() const
{
...
void DerivationFramework::SkimmingToolHIGG2::fillMuons() const
{
  m_goodMuons.clear();
...
void DerivationFramework::SkimmingToolHIGG2::fillJets() const
{
  m_goodJets.clear();
  if(m_nJets>0) {
...
void DerivationFramework::SkimmingToolHIGG2::fillMergedJets() const
{
...
void DerivationFramework::SkimmingToolHIGG2::fillPhotons() const
{
  m_goodPhotons.clear();
...
void DerivationFramework::SkimmingToolHIGG2::fillTracks() const
{
  m_goodTracks.clear();
...
bool DerivationFramework::SkimmingToolHIGG2::checkElectronQuality(const xAOD::Electron *el, const bool isTight, const bool isVertexing) const 
{
  if(!el) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::checkMuonQuality(const xAOD::Muon *mu, const bool isTight, const bool isVertexing) const 
{
  if(!mu) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::checkPhotonQualityForW(const xAOD::Photon *ph) const 
{
  if(!ph) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::checkTrackQualityLoose(const xAOD::TrackParticle *trk) const 
{
  if(!trk) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::checkTrackQualityForW(const xAOD::TrackParticle *trk) const 
{
  if(!trk) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::check2L(const bool onlyVertexing) const 
{
...
bool DerivationFramework::SkimmingToolHIGG2::check4L(const bool onlyVertexing) const 
{
  if(not onlyVertexing) {
    if(not (m_nLeptons>0 and m_goodElectrons.size()+m_goodMuons.size()>=m_nLeptons)) return false;
    if(not (m_goodJets.size()>=m_nJets and m_goodPhotons.size()>=m_nPhotons)) return false;
...
bool DerivationFramework::SkimmingToolHIGG2::checkRHO() const 
{
  // Check if there are candidates
...
bool DerivationFramework::SkimmingToolHIGG2::checkWPIGAMMA() const 
{
  // Check if there are candidates
...
bool DerivationFramework::SkimmingToolHIGG2::formQuads(std::vector<const xAOD::IParticle*> *goodLeptons, bool doAllCombinations, std::vector<std::vector<const xAOD::IParticle*> *>* quads) const
{
...
void DerivationFramework::SkimmingToolHIGG2::doVertexing(std::vector< std::vector<const xAOD::IParticle*> *> *quads) const 
{
...
const double DerivationFramework::SkimmingToolHIGG2::s_MPiplus(139.570*CLHEP::MeV);
