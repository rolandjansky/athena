...
getPFlowfJVT(jetalg='AntiKt4EMPFlow',sequence=SeqSUSY10, algname='JetForwardPFlowJvtToolAlg')
applyMVfJvtAugmentation(jetalg='AntiKt4EMTopo',sequence=SeqSUSY10, algname='JetForwardJvtToolBDTAlg')
