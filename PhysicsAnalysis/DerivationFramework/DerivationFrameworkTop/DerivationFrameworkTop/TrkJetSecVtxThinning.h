...
#ifndef DERIVATIONFRAMEWORKTOP_TRKJETSECVTXTHINNING_H
#define DERIVATIONFRAMEWORKTOP_TRKJETSECVTXTHINNING_H
...
namespace DerivationFramework {
   ...
   /// output stream.
   ///
   class TrkJetSecVtxThinning : public AthAlgTool, public IThinningTool {

   public:
      /// AlgTool constructor
      TrkJetSecVtxThinning(const std::string& type,
   ...
   private:
      ...
      /// method for thinning SecVtx vertices
      StatusCode thinSV1Vertices(std::vector<bool>& mask,
      ...
      /// SG key for the SecVtx vertices container to use
   ...
   }; // class TrkJetSecVtxThinning

} // namespace DerivationFramework

#endif // DERIVATIONFRAMEWORKTOP_TRKJETSECVTXTHINNING_H
