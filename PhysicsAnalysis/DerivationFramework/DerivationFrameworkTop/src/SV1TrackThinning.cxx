...
namespace DerivationFramework {
   ...
   SV1TrackThinning::SV1TrackThinning( const std::string& type,
   ...
   StatusCode SV1TrackThinning::initialize() {
   ...
   StatusCode SV1TrackThinning::finalize() {
   ...
   StatusCode SV1TrackThinning::doThinning() const {
