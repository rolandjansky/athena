...
StatusCode ExKtbbAugmentation::addBranches() const{
  ...
  static SG::AuxElement::Decorator<double> jet_maxMV2rmu(algName+"_MaxMV2rmu");
  ...
  static SG::AuxElement::Decorator<double> jet_maxDL1rmu_pb(algName+"_MaxDL1rmu_pb");
  static SG::AuxElement::Decorator<double> jet_maxDL1rmu_pc(algName+"_MaxDL1rmu_pc");
  static SG::AuxElement::Decorator<double> jet_maxDL1rmu_pu(algName+"_MaxDL1rmu_pu");

  static SG::AuxElement::Decorator<double> jet_minmv2(algName+"_MinMV2c10");
  static SG::AuxElement::Decorator<double> jet_minMV2rmu(algName+"_MinMV2rmu");
  ...
  static SG::AuxElement::Decorator<double> jet_minDL1rmu_pb(algName+"_MinDL1rmu_pb");
  static SG::AuxElement::Decorator<double> jet_minDL1rmu_pc(algName+"_MinDL1rmu_pc");
  static SG::AuxElement::Decorator<double> jet_minDL1rmu_pu(algName+"_MinDL1rmu_pu");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_MV2rmu(algName3+"_j1_MV2rmu");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rmu_pb(algName3+"_j1_DL1rmu_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rmu_pc(algName3+"_j1_DL1rmu_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rmu_pu(algName3+"_j1_DL1rmu_pu");

  static SG::AuxElement::Decorator<double> jet_exkt3_j2_MV2rmu(algName3+"_j2_MV2rmu");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rmu_pb(algName3+"_j2_DL1rmu_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rmu_pc(algName3+"_j2_DL1rmu_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rmu_pu(algName3+"_j2_DL1rmu_pu");

  static SG::AuxElement::Decorator<double> jet_exkt3_j3_MV2rmu(algName3+"_j3_MV2rmu");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rmu_pb(algName3+"_j3_DL1rmu_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rmu_pc(algName3+"_j3_DL1rmu_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rmu_pu(algName3+"_j3_DL1rmu_pu");
  ...
  for (unsigned j = 0; j <  smalljets->size() ; j++){
        ...
        jet_maxMV2rmu(*(smalljets->at(j))) = -999;
        jet_maxDL1_pb(*(smalljets->at(j))) = -999;
        jet_maxDL1_pc(*(smalljets->at(j))) = -999;
        jet_maxDL1_pu(*(smalljets->at(j))) = -999;
        jet_maxDL1rmu_pb(*(smalljets->at(j))) = -999;
        jet_maxDL1rmu_pc(*(smalljets->at(j))) = -999;
        jet_maxDL1rmu_pu(*(smalljets->at(j))) = -999;

        jet_minmv2(*(smalljets->at(j))) = -999;
        jet_minMV2rmu(*(smalljets->at(j))) = -999;
        jet_minDL1_pb(*(smalljets->at(j))) = -999;
        jet_minDL1_pc(*(smalljets->at(j))) = -999;
        jet_minDL1_pu(*(smalljets->at(j))) = -999;
        jet_minDL1rmu_pb(*(smalljets->at(j))) = -999;
        jet_minDL1rmu_pc(*(smalljets->at(j))) = -999;
        jet_minDL1rmu_pu(*(smalljets->at(j))) = -999;
        ...
        jet_exkt3_j1_MV2rmu(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rmu_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rmu_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rmu_pu(*(smalljets->at(j))) = -999;

        jet_exkt3_j2_MV2rmu(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rmu_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rmu_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rmu_pu(*(smalljets->at(j))) = -999;

        jet_exkt3_j3_MV2rmu(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rmu_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rmu_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rmu_pu(*(smalljets->at(j))) = -999;
  ...
  for (unsigned i = 0; i < jets->size() ; i++){
    ...
    double maxmv2 = -999;
    double maxMV2rmu = -999;
    double maxDL1_pb = -999;
    double maxDL1_pc = -999;
    double maxDL1_pu = -999;
    double maxDL1rmu_pb = -999;
    double maxDL1rmu_pc = -999;
    double maxDL1rmu_pu = -999;

    double minmv2 = -999;
    double minMV2rmu = -999;
    double minDL1_pb = -999;
    double minDL1_pc = -999;
    double minDL1_pu = -999;
    double minDL1rmu_pb = -999;
    double minDL1rmu_pc = -999;
    double minDL1rmu_pu = -999;
    ...
    double exkt3_j1_MV2rmu = -999;
    double exkt3_j1_DL1_pb = -999;
    double exkt3_j1_DL1_pc = -999;
    double exkt3_j1_DL1_pu = -999;
    double exkt3_j1_DL1rmu_pb = -999;
    double exkt3_j1_DL1rmu_pc = -999;
    double exkt3_j1_DL1rmu_pu = -999;

    double exkt3_j2_MV2rmu = -999;
    double exkt3_j2_DL1_pb = -999;
    double exkt3_j2_DL1_pc = -999;
    double exkt3_j2_DL1_pu = -999;
    double exkt3_j2_DL1rmu_pb = -999;
    double exkt3_j2_DL1rmu_pc = -999;
    double exkt3_j2_DL1rmu_pu = -999;

    double exkt3_j3_MV2rmu = -999;
    double exkt3_j3_DL1_pb = -999;
    double exkt3_j3_DL1_pc = -999;
    double exkt3_j3_DL1_pu = -999;
    double exkt3_j3_DL1rmu_pb = -999;
    double exkt3_j3_DL1rmu_pc = -999;
    double exkt3_j3_DL1rmu_pu = -999;
    ...
    if(ExKtSubjets.size() == 2){
      ...
      maxMV2rmu    = std::max(bjet_LeadExKtSubJet->auxdata<double>("MV2r_discriminant"),bjet_SubLeadExKtSubJet->auxdata<double>("MV2r_discriminant"));
      ...
      maxDL1rmu_pb    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pb"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pb"));
      maxDL1rmu_pc    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pc"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pc"));
      maxDL1rmu_pu    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pu"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pu"));
      ...
      minMV2rmu    = std::min(bjet_LeadExKtSubJet->auxdata<double>("MV2r_discriminant"),bjet_SubLeadExKtSubJet->auxdata<double>("MV2r_discriminant"));
      ...
      minDL1rmu_pb    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pb"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pb"));
      minDL1rmu_pc    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pc"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pc"));
      minDL1rmu_pu    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rmu_pu"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rmu_pu"));
    ...
    if(ExKt3Subjets.size() == 3){
      ...
      exkt3_j1_MV2rmu = bjet_LeadExKt3SubJet->auxdata<double>("MV2r_discriminant");
      ...
      exkt3_j1_DL1rmu_pb = bjet_LeadExKt3SubJet->auxdata<double>("DL1rmu_pb");
      exkt3_j1_DL1rmu_pc = bjet_LeadExKt3SubJet->auxdata<double>("DL1rmu_pc");
      exkt3_j1_DL1rmu_pu = bjet_LeadExKt3SubJet->auxdata<double>("DL1rmu_pu");

      exkt3_j2_MV2rmu = bjet_SubLeadExKt3SubJet->auxdata<double>("MV2r_discriminant");
      ...
      exkt3_j2_DL1rmu_pb = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rmu_pb");
      exkt3_j2_DL1rmu_pc = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rmu_pc");
      exkt3_j2_DL1rmu_pu = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rmu_pu");

      exkt3_j3_MV2rmu = bjet_SubsubLeadExKt3SubJet->auxdata<double>("MV2r_discriminant");
      ...
      exkt3_j3_DL1rmu_pb = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rmu_pb");
      exkt3_j3_DL1rmu_pc = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rmu_pc");
      exkt3_j3_DL1rmu_pu = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rmu_pu");
    ...
    jet_maxMV2rmu(*(smalljets->at(j))) = maxMV2rmu;
    jet_maxDL1_pb(*(smalljets->at(j))) = maxDL1_pb;
    jet_maxDL1_pc(*(smalljets->at(j))) = maxDL1_pc;
    jet_maxDL1_pu(*(smalljets->at(j))) = maxDL1_pu;
    jet_maxDL1rmu_pb(*(smalljets->at(j))) = maxDL1rmu_pb;
    jet_maxDL1rmu_pc(*(smalljets->at(j))) = maxDL1rmu_pc;
    jet_maxDL1rmu_pu(*(smalljets->at(j))) = maxDL1rmu_pu;

    jet_minmv2(*(smalljets->at(j))) = minmv2;
    jet_minMV2rmu(*(smalljets->at(j))) = minMV2rmu;
    jet_minDL1_pb(*(smalljets->at(j))) = minDL1_pb;
    jet_minDL1_pc(*(smalljets->at(j))) = minDL1_pc;
    jet_minDL1_pu(*(smalljets->at(j))) = minDL1_pu;
    jet_minDL1rmu_pb(*(smalljets->at(j))) = minDL1rmu_pb;
    jet_minDL1rmu_pc(*(smalljets->at(j))) = minDL1rmu_pc;
    jet_minDL1rmu_pu(*(smalljets->at(j))) = minDL1rmu_pu;
    ...
    jet_exkt3_j1_MV2rmu(*(smalljets->at(j))) = exkt3_j1_MV2rmu;
    ...
    jet_exkt3_j1_DL1rmu_pb(*(smalljets->at(j))) = exkt3_j1_DL1rmu_pb;
    jet_exkt3_j1_DL1rmu_pc(*(smalljets->at(j))) = exkt3_j1_DL1rmu_pc;
    jet_exkt3_j1_DL1rmu_pu(*(smalljets->at(j))) = exkt3_j1_DL1rmu_pu;

    jet_exkt3_j2_MV2rmu(*(smalljets->at(j))) = exkt3_j2_MV2rmu;
    ...
    jet_exkt3_j2_DL1rmu_pb(*(smalljets->at(j))) = exkt3_j2_DL1rmu_pb;
    jet_exkt3_j2_DL1rmu_pc(*(smalljets->at(j))) = exkt3_j2_DL1rmu_pc;
    jet_exkt3_j2_DL1rmu_pu(*(smalljets->at(j))) = exkt3_j2_DL1rmu_pu;

    jet_exkt3_j3_MV2rmu(*(smalljets->at(j))) = exkt3_j3_MV2rmu;
    ...
    jet_exkt3_j3_DL1rmu_pb(*(smalljets->at(j))) = exkt3_j3_DL1rmu_pb;
    jet_exkt3_j3_DL1rmu_pc(*(smalljets->at(j))) = exkt3_j3_DL1rmu_pc;
    jet_exkt3_j3_DL1rmu_pu(*(smalljets->at(j))) = exkt3_j3_DL1rmu_pu;
