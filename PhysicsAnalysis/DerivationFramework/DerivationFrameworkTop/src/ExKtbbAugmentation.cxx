...
StatusCode ExKtbbAugmentation::addBranches() const{
  ...
  static SG::AuxElement::Decorator<double> jet_maxmv2c10rnn(algName+"_MaxMV2c10rnn");
  ...
  static SG::AuxElement::Decorator<double> jet_maxDL1rnn_pb(algName+"_MaxDL1rnn_pb");
  static SG::AuxElement::Decorator<double> jet_maxDL1rnn_pc(algName+"_MaxDL1rnn_pc");
  static SG::AuxElement::Decorator<double> jet_maxDL1rnn_pu(algName+"_MaxDL1rnn_pu");

  static SG::AuxElement::Decorator<double> jet_minmv2(algName+"_MinMV2c10");
  static SG::AuxElement::Decorator<double> jet_minmv2c10rnn(algName+"_MinMV2c10rnn");
  ...
  static SG::AuxElement::Decorator<double> jet_minDL1rnn_pb(algName+"_MinDL1rnn_pb");
  static SG::AuxElement::Decorator<double> jet_minDL1rnn_pc(algName+"_MinDL1rnn_pc");
  static SG::AuxElement::Decorator<double> jet_minDL1rnn_pu(algName+"_MinDL1rnn_pu");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_mv2c10rnn(algName3+"_j1_MV2c10rnn");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rnn_pb(algName3+"_j1_DL1rnn_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rnn_pc(algName3+"_j1_DL1rnn_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j1_DL1rnn_pu(algName3+"_j1_DL1rnn_pu");

  static SG::AuxElement::Decorator<double> jet_exkt3_j2_mv2c10rnn(algName3+"_j2_MV2c10rnn");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rnn_pb(algName3+"_j2_DL1rnn_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rnn_pc(algName3+"_j2_DL1rnn_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j2_DL1rnn_pu(algName3+"_j2_DL1rnn_pu");

  static SG::AuxElement::Decorator<double> jet_exkt3_j3_mv2c10rnn(algName3+"_j3_MV2c10rnn");
  ...
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rnn_pb(algName3+"_j3_DL1rnn_pb");
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rnn_pc(algName3+"_j3_DL1rnn_pc");
  static SG::AuxElement::Decorator<double> jet_exkt3_j3_DL1rnn_pu(algName3+"_j3_DL1rnn_pu");
  ...
  for (unsigned j = 0; j <  smalljets->size() ; j++){
        ...
        jet_maxmv2c10rnn(*(smalljets->at(j))) = -999;
        jet_maxDL1_pb(*(smalljets->at(j))) = -999;
        jet_maxDL1_pc(*(smalljets->at(j))) = -999;
        jet_maxDL1_pu(*(smalljets->at(j))) = -999;
        jet_maxDL1rnn_pb(*(smalljets->at(j))) = -999;
        jet_maxDL1rnn_pc(*(smalljets->at(j))) = -999;
        jet_maxDL1rnn_pu(*(smalljets->at(j))) = -999;

        jet_minmv2(*(smalljets->at(j))) = -999;
        jet_minmv2c10rnn(*(smalljets->at(j))) = -999;
        jet_minDL1_pb(*(smalljets->at(j))) = -999;
        jet_minDL1_pc(*(smalljets->at(j))) = -999;
        jet_minDL1_pu(*(smalljets->at(j))) = -999;
        jet_minDL1rnn_pb(*(smalljets->at(j))) = -999;
        jet_minDL1rnn_pc(*(smalljets->at(j))) = -999;
        jet_minDL1rnn_pu(*(smalljets->at(j))) = -999;
        ...
        jet_exkt3_j1_mv2c10rnn(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rnn_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rnn_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j1_DL1rnn_pu(*(smalljets->at(j))) = -999;

        jet_exkt3_j2_mv2c10rnn(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rnn_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rnn_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j2_DL1rnn_pu(*(smalljets->at(j))) = -999;

        jet_exkt3_j3_mv2c10rnn(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1_pu(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rnn_pb(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rnn_pc(*(smalljets->at(j))) = -999;
        jet_exkt3_j3_DL1rnn_pu(*(smalljets->at(j))) = -999;
  ...
  for (unsigned i = 0; i < jets->size() ; i++){
    ...
    double maxmv2 = -999;
    double maxmv2c10rnn = -999;
    double maxDL1_pb = -999;
    double maxDL1_pc = -999;
    double maxDL1_pu = -999;
    double maxDL1rnn_pb = -999;
    double maxDL1rnn_pc = -999;
    double maxDL1rnn_pu = -999;

    double minmv2 = -999;
    double minmv2c10rnn = -999;
    double minDL1_pb = -999;
    double minDL1_pc = -999;
    double minDL1_pu = -999;
    double minDL1rnn_pb = -999;
    double minDL1rnn_pc = -999;
    double minDL1rnn_pu = -999;
    ...
    double exkt3_j1_mv2c10rnn = -999;
    double exkt3_j1_DL1_pb = -999;
    double exkt3_j1_DL1_pc = -999;
    double exkt3_j1_DL1_pu = -999;
    double exkt3_j1_DL1rnn_pb = -999;
    double exkt3_j1_DL1rnn_pc = -999;
    double exkt3_j1_DL1rnn_pu = -999;

    double exkt3_j2_mv2c10rnn = -999;
    double exkt3_j2_DL1_pb = -999;
    double exkt3_j2_DL1_pc = -999;
    double exkt3_j2_DL1_pu = -999;
    double exkt3_j2_DL1rnn_pb = -999;
    double exkt3_j2_DL1rnn_pc = -999;
    double exkt3_j2_DL1rnn_pu = -999;

    double exkt3_j3_mv2c10rnn = -999;
    double exkt3_j3_DL1_pb = -999;
    double exkt3_j3_DL1_pc = -999;
    double exkt3_j3_DL1_pu = -999;
    double exkt3_j3_DL1rnn_pb = -999;
    double exkt3_j3_DL1rnn_pc = -999;
    double exkt3_j3_DL1rnn_pu = -999;
    ...
    if(ExKtSubjets.size() == 2){
      ...
      maxmv2c10rnn    = std::max(bjet_LeadExKtSubJet->auxdata<double>("MV2c10rnn_discriminant"),bjet_SubLeadExKtSubJet->auxdata<double>("MV2c10rnn_discriminant"));
      ...
      maxDL1rnn_pb    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pb"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pb"));
      maxDL1rnn_pc    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pc"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pc"));
      maxDL1rnn_pu    = std::max(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pu"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pu"));
      ...
      minmv2c10rnn    = std::min(bjet_LeadExKtSubJet->auxdata<double>("MV2c10rnn_discriminant"),bjet_SubLeadExKtSubJet->auxdata<double>("MV2c10rnn_discriminant"));
      ...
      minDL1rnn_pb    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pb"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pb"));
      minDL1rnn_pc    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pc"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pc"));
      minDL1rnn_pu    = std::min(bjet_LeadExKtSubJet->auxdata<double>("DL1rnn_pu"),bjet_SubLeadExKtSubJet->auxdata<double>("DL1rnn_pu"));
    ...
    if(ExKt3Subjets.size() == 3){
      ...
      exkt3_j1_mv2c10rnn = bjet_LeadExKt3SubJet->auxdata<double>("MV2c10rnn_discriminant");
      ...
      exkt3_j1_DL1rnn_pb = bjet_LeadExKt3SubJet->auxdata<double>("DL1rnn_pb");
      exkt3_j1_DL1rnn_pc = bjet_LeadExKt3SubJet->auxdata<double>("DL1rnn_pc");
      exkt3_j1_DL1rnn_pu = bjet_LeadExKt3SubJet->auxdata<double>("DL1rnn_pu");

      exkt3_j2_mv2c10rnn = bjet_SubLeadExKt3SubJet->auxdata<double>("MV2c10rnn_discriminant");
      ...
      exkt3_j2_DL1rnn_pb = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rnn_pb");
      exkt3_j2_DL1rnn_pc = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rnn_pc");
      exkt3_j2_DL1rnn_pu = bjet_SubLeadExKt3SubJet->auxdata<double>("DL1rnn_pu");

      exkt3_j3_mv2c10rnn = bjet_SubsubLeadExKt3SubJet->auxdata<double>("MV2c10rnn_discriminant");
      ...
      exkt3_j3_DL1rnn_pb = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rnn_pb");
      exkt3_j3_DL1rnn_pc = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rnn_pc");
      exkt3_j3_DL1rnn_pu = bjet_SubsubLeadExKt3SubJet->auxdata<double>("DL1rnn_pu");
    ...
    jet_maxmv2c10rnn(*(smalljets->at(j))) = maxmv2c10rnn;
    jet_maxDL1_pb(*(smalljets->at(j))) = maxDL1_pb;
    jet_maxDL1_pc(*(smalljets->at(j))) = maxDL1_pc;
    jet_maxDL1_pu(*(smalljets->at(j))) = maxDL1_pu;
    jet_maxDL1rnn_pb(*(smalljets->at(j))) = maxDL1rnn_pb;
    jet_maxDL1rnn_pc(*(smalljets->at(j))) = maxDL1rnn_pc;
    jet_maxDL1rnn_pu(*(smalljets->at(j))) = maxDL1rnn_pu;

    jet_minmv2(*(smalljets->at(j))) = minmv2;
    jet_minmv2c10rnn(*(smalljets->at(j))) = minmv2c10rnn;
    jet_minDL1_pb(*(smalljets->at(j))) = minDL1_pb;
    jet_minDL1_pc(*(smalljets->at(j))) = minDL1_pc;
    jet_minDL1_pu(*(smalljets->at(j))) = minDL1_pu;
    jet_minDL1rnn_pb(*(smalljets->at(j))) = minDL1rnn_pb;
    jet_minDL1rnn_pc(*(smalljets->at(j))) = minDL1rnn_pc;
    jet_minDL1rnn_pu(*(smalljets->at(j))) = minDL1rnn_pu;
    ...
    jet_exkt3_j1_mv2c10rnn(*(smalljets->at(j))) = exkt3_j1_mv2c10rnn;
    ...
    jet_exkt3_j1_DL1rnn_pb(*(smalljets->at(j))) = exkt3_j1_DL1rnn_pb;
    jet_exkt3_j1_DL1rnn_pc(*(smalljets->at(j))) = exkt3_j1_DL1rnn_pc;
    jet_exkt3_j1_DL1rnn_pu(*(smalljets->at(j))) = exkt3_j1_DL1rnn_pu;

    jet_exkt3_j2_mv2c10rnn(*(smalljets->at(j))) = exkt3_j2_mv2c10rnn;
    ...
    jet_exkt3_j2_DL1rnn_pb(*(smalljets->at(j))) = exkt3_j2_DL1rnn_pb;
    jet_exkt3_j2_DL1rnn_pc(*(smalljets->at(j))) = exkt3_j2_DL1rnn_pc;
    jet_exkt3_j2_DL1rnn_pu(*(smalljets->at(j))) = exkt3_j2_DL1rnn_pu;

    jet_exkt3_j3_mv2c10rnn(*(smalljets->at(j))) = exkt3_j3_mv2c10rnn;
    ...
    jet_exkt3_j3_DL1rnn_pb(*(smalljets->at(j))) = exkt3_j3_DL1rnn_pb;
    jet_exkt3_j3_DL1rnn_pc(*(smalljets->at(j))) = exkt3_j3_DL1rnn_pc;
    jet_exkt3_j3_DL1rnn_pu(*(smalljets->at(j))) = exkt3_j3_DL1rnn_pu;
