...
namespace DerivationFramework {
    ...
    xAOD::Vertex* FourMuonTool::fit(std::vector<const xAOD::TrackParticle*> inputTracks,
        ...
        if (m_useV0Fitter) {
            xAOD::Vertex* myVxCandidate = concreteVertexFitter->fit(inputTracks, vertex /*startingPoint*/ );
            ...
            xAOD::Vertex* myVxCandidate = m_iVertexFitter->fit(inputTracks, vertex /*startingPoint*/ );
