...
BPHY11JpsiFinder = Analysis__JpsiFinder(
    name                        = "BPHY11JpsiFinder",
    OutputLevel                 = INFO,
    muAndMu                     = True,
    muAndTrack                  = False,
    TrackAndTrack               = False,
...
ToolSvc += BPHY11JpsiFinder
print      BPHY11JpsiFinder
...
BPHY11_Reco_mumu = DerivationFramework__Reco_mumu(
  name                   = "BPHY11_Reco_mumu",
  JpsiFinder             = BPHY11JpsiFinder,
  OutputVtxContainerName = "BPHY11OniaCandidates",
  PVContainerName        = "PrimaryVertices",
  RefPVContainerName     = "BPHY11RefittedPrimaryVertices",
  RefitPV                = True,
  MaxPVrefit             = 100000,
  DoVertexType           = 7)
  
ToolSvc += BPHY11_Reco_mumu
print BPHY11_Reco_mumu
...
BPHY11_Select_B2mumu = DerivationFramework__Select_onia2mumu(
  name                  = "BPHY11_Select_B2mumu",
  HypothesisName        = "Bmumu",
  InputVtxContainerName = "BPHY11OniaCandidates",
  VtxMassHypo           = 5366.79,
  MassMin               = 4000.0,
  MassMax               = 7000.0,
  Chi2Max               = 200,
...
ToolSvc += BPHY11_Select_B2mumu
print BPHY11_Select_B2mumu
...
expression = "count(BPHY11OniaCandidates.passed_Bmumu) > 0"
from DerivationFrameworkTools.DerivationFrameworkToolsConf import DerivationFramework__xAODStringSkimmingTool
BPHY11_SelectEvent = DerivationFramework__xAODStringSkimmingTool(name = "BPHY11_SelectEvent",
                                                                expression = expression)
ToolSvc += BPHY11_SelectEvent
print BPHY11_SelectEvent
...
BPHY11Thin_vtxTrk = DerivationFramework__Thin_vtxTrk(
  name                       = "BPHY11Thin_vtxTrk",
  ThinningService            = "BPHY11ThinningSvc",
  TrackParticleContainerName = "InDetTrackParticles",
  VertexContainerNames       = ["BPHY11OniaCandidates"],
  PassFlags                  = ["passed_Bmumu"] )

ToolSvc += BPHY11Thin_vtxTrk
...
BPHY11MuonTPThinningTool = DerivationFramework__MuonTrackParticleThinning(name                    = "BPHY11MuonTPThinningTool",
                                                                         ThinningService         = "BPHY11ThinningSvc",
                                                                         MuonKey                 = "Muons",
                                                                         InDetTrackParticlesKey  = "InDetTrackParticles")
ToolSvc += BPHY11MuonTPThinningTool

# Added by ASC
# Only save truth informtion directly associated with Onia
from DerivationFrameworkMCTruth.DerivationFrameworkMCTruthConf import DerivationFramework__GenericTruthThinning
BPHY11TruthThinTool = DerivationFramework__GenericTruthThinning(name                    = "BPHY11TruthThinTool",
                                                        ThinningService         = "BPHY11ThinningSvc",
...
ToolSvc += BPHY11TruthThinTool
print BPHY11TruthThinTool
...
# Added by ASC
BPHY11ThinningTools = [BPHY11Thin_vtxTrk, BPHY11MuonTPThinningTool]
if globalflags.DataSource()=='geant4':
    BPHY11ThinningTools.append(BPHY11TruthThinTool)

# The name of the kernel (BPHY11Kernel in this case) must be unique to this derivation
from DerivationFrameworkCore.DerivationFrameworkCoreConf import DerivationFramework__DerivationKernel
DerivationFrameworkJob += CfgMgr.DerivationFramework__DerivationKernel(
  "BPHY11Kernel",
   AugmentationTools = [BPHY11_Reco_mumu, BPHY11_Select_B2mumu],
   SkimmingTools     = [BPHY11_SelectEvent],
   ThinningTools     = BPHY11ThinningTools
   )
...
BPHY11Stream.AcceptAlgs(["BPHY11Kernel"])
# Special lines for thinning
# Thinning service name must match the one passed to the thinning tools
from AthenaServices.Configurables import ThinningSvc, createThinningSvc
augStream = MSMgr.GetStream( streamName )
evtStream = augStream.GetEventStream()
svcMgr += createThinningSvc( svcName="BPHY11ThinningSvc", outStreams=[evtStream] )
...
BPHY11SlimmingHelper = SlimmingHelper("BPHY11SlimmingHelper")
AllVariables = []
StaticContent = []

# Needed for trigger objects
BPHY11SlimmingHelper.IncludeMuonTriggerContent = True
BPHY11SlimmingHelper.IncludeBPhysTriggerContent = True

## primary vertices
AllVariables += ["PrimaryVertices"]
StaticContent += ["xAOD::VertexContainer#BPHY11RefittedPrimaryVertices"]
StaticContent += ["xAOD::VertexAuxContainer#BPHY11RefittedPrimaryVerticesAux."]
...
## Jpsi candidates 
StaticContent += ["xAOD::VertexContainer#%s"        % BPHY11_Reco_mumu.OutputVtxContainerName]
StaticContent += ["xAOD::VertexAuxContainer#%sAux." % BPHY11_Reco_mumu.OutputVtxContainerName]
## we have to disable vxTrackAtVertex branch since it is not xAOD compatible
StaticContent += ["xAOD::VertexAuxContainer#%sAux.-vxTrackAtVertex" % BPHY11_Reco_mumu.OutputVtxContainerName]
...
BPHY11SlimmingHelper.AllVariables = AllVariables
BPHY11SlimmingHelper.StaticContent = StaticContent
BPHY11SlimmingHelper.AppendContentToStream(BPHY11Stream)
