...
# helpers for AllVariables appended to content of FTAG derivations

## ----------------------------------------------------------------------------
## b-jet triggers: vertices for performance studies 
FTAllVars_bjetTriggerVtx=[ "HLT_xAOD__BTagVertexContainer_BjetVertexFex",
