...
namespace DerivationFramework {
   ...
   GenericObjectThinning::GenericObjectThinning( const std::string& type,
   ...
   StatusCode GenericObjectThinning::initialize() {
   ...
   StatusCode GenericObjectThinning::finalize() {
   ...
   StatusCode GenericObjectThinning::doThinning() const {
