...
''' A basic postInclude file to test high lossy float compression in DAOD_PHYSVAL production  '''

# Get a handle to the StreamDAOD_PHYSVAL
from OutputStreamAthenaPool.MultipleStreamManager import MSMgr
from DerivationFrameworkCore.DerivationFrameworkProdFlags import derivationFlags
myStream = MSMgr.GetStream( derivationFlags.WriteDAOD_PHYSVALStream.StreamName )
