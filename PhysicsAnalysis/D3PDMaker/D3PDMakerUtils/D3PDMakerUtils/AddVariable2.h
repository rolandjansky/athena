...
// $Id$
/**
 * @file D3PDMakerUtils/AddVariable2.h
 * @author scott snyder <snyder@bnl.gov>
 * @date Aug, 2009
 * @brief Common implementation of @c IAddVariable.
 *
 * Variant that also allows a suffix.
 * FIXME: unify with @c AddVariable when we can do a full rebuild.
 */

#ifndef D3PDMAKERUTILS_ADDVARIABLE2_H
#define D3PDMAKERUTILS_ADDVARIABLE2_H
...
public:
   ...
   */
  AddVariable2 (const std::string& prefix,
