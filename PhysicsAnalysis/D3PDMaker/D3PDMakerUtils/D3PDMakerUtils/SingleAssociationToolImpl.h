...
// $Id$
/**
 * @file D3PDMakerUtils/SingleAssociationToolImpl.h
 * @author scott snyder <snyder@bnl.gov>
 * @date Aug, 2009
 * @brief Non-template parts of @c SingleAssociationTool.
 */


#ifndef D3PDMAKERUTILS_SINGLEASSOCIATIONTOOLIMPL_H
#define D3PDMAKERUTILS_SINGLEASSOCIATIONTOOLIMPL_H
 ...
 * @brief Non-template parts of @c SingleAssociationTool.
 *
 * The class @c SingleAssociationTool provides a type-safe wrapper for the
 * @c ISingleAssociationTool interface; it is templated on the types of
 * the source and target of the association.
 * This class serves as a common base
 * class for the @c SingleAssociationTool instantiations, and factors
 ...
 * done by @c SingleAssociationTool).  The @c book method may also
...
protected:
   ...
   * return Source object, as a pointer to the type given by @c fromTypeinfo.
   */
...
#endif // not D3PDMAKERUTILS_SINGLEASSOCIATIONTOOLIMPL_H
