...
// $Id$
/**
 * @file D3PDMakerUtils/src/AddVariable2.cxx
...
#include "D3PDMakerUtils/AddVariable2.h"
...
std::string AddVariable2::s_emptyString;
 ...
 */
AddVariable2::AddVariable2 (const std::string& prefix,
 ...
 */
StatusCode AddVariable2::configureD3PD (IAddVariable* tree)
{
  m_tree = tree;
  m_metadata.clear();
 ...
 */
StatusCode AddVariable2::addVariable (const std::string& name,
 ...
 */
StatusCode
AddVariable2::addDimensionedVariable (const std::string& name,
                                      const std::type_info& ti,
                                      void* & ptr,
