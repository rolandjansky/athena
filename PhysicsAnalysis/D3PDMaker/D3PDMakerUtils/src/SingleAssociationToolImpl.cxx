...
// $Id$
/**
 * @file D3PDMakerUtils/src/SingleAssociationToolImpl.cxx
 ...
 */
SingleAssociationToolImpl::SingleAssociationToolImpl
 ...
 */
StatusCode
SingleAssociationToolImpl::queryInterface
 ...
 */
StatusCode
SingleAssociationToolImpl::configureD3PD (IAddVariable* tree,
 ...
 */
StatusCode
SingleAssociationToolImpl::configureMulti (D3PD::IAddVariable* tree,
                                           const std::type_info& ti,
 ...
 */
StatusCode
SingleAssociationToolImpl::book()
{
  return StatusCode::SUCCESS;
}
 ...
 * return Source object, as a pointer to the type given by @c typeinfoFrom.
 */
const void* SingleAssociationToolImpl::doConversion (const void* p)
{
  if (!p) return 0;
