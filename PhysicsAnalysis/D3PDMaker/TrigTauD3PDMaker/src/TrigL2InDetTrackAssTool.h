...
#ifndef TRIGTAUD3PDMAKER_TRIGL2INDETTRACKASSTOOL_H
#define TRIGTAUD3PDMAKER_TRIGL2INDETTRACKASSTOOL_H
...
/**
 * @brief Associate to a TrigInDetTrack object 
 ...
 */
class TrigL2InDetTrackAssTool
  : public SingleAssociationTool<TrigTau, TrigInDetTrack>,
    public IIncidentListener
{
public:
  typedef SingleAssociationTool<TrigTau, TrigInDetTrack> Base;
   ...
   */
  TrigL2InDetTrackAssTool (const std::string& type,
   ...
   */
  const TrigInDetTrack* get (const TrigTau& p);
...
#endif // not TRIGTAUD3PDMAKER_TRIGL2INDETTRACKASSTOOL_H
