...
#ifndef TRIGTAUD3PDMAKER_TRIGL2TAUTRACKSINFOASSTOOL_H
#define TRIGTAUD3PDMAKER_TRIGL2TAUTRACKSINFOASSTOOL_H
...
#define TRIGREADNAVTOOL_GETANCESTOR_FUNC getObjsFromObjs<TrigTauTracksInfo,TrigTauTracksInfo>
#define TRIGREADNAVTOOL_GETOBJS_FUNC getObjsFromObj<TrigTau,TrigTau>
...
/**
 * @brief Associate to a TrigTauTracksInfo object 
 ...
 */
class TrigL2TauTracksInfoAssTool
  : public SingleAssociationTool<TrigTau, TrigTauTracksInfo>,
    public IIncidentListener
{
public:
  typedef SingleAssociationTool<TrigTau, TrigTauTracksInfo> Base;
   ...
   */
  TrigL2TauTracksInfoAssTool (const std::string& type,
   ...
   */
  const TrigTauTracksInfo* get (const TrigTau& p);
...
#endif // not TRIGTAUD3PDMAKER_TRIGL2TAUTRACKSINFOASSTOOL_H
