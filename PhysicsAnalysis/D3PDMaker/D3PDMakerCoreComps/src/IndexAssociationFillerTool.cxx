...
// $Id: IndexAssociationFillerTool.cxx 486128 2012-03-02 08:54:20Z krasznaa $
/**
 * @file D3PDMakerCoreComps/src/IndexAssociationFillerTool.cxx
 ...
 */
IndexAssociationFillerTool::IndexAssociationFillerTool
 ...
 */
StatusCode
IndexAssociationFillerTool::queryInterface( const InterfaceID& riid,
                                            void** ppvIf )
{
 ...
 */
StatusCode
IndexAssociationFillerTool::initialize()
{
 ...
 */
StatusCode
IndexAssociationFillerTool::configureD3PD (IAddVariable* tree,
                                           const std::type_info& ti)
{
  ...
  if (m_map.target()) {
    CHECK( m_converter.init (m_associator->typeinfo(),
 ...
 */
StatusCode IndexAssociationFillerTool::book()
{
 ...
 */
StatusCode
IndexAssociationFillerTool::fillUntyped (const void* p,
                                         bool /*again = false*/)
{
