...
// $Id: IndexMultiAssociationFillerTool.h 486128 2012-03-02 08:54:20Z krasznaa $
/**
 * @file D3PDMakerCoreComps/src/IndexMultiAssociationFillerTool.h
 ...
 * objects.  It also takes as a property a collection getter
 * label.  This defines an `index' collection.
 * The tool searches this collection
 * for each target of the association and finds the index of that
 * object within that collection.  The result is booked as a vector
 * of ints.
 *
 * Objects that aren't found in the index collection are omitted
...
public:
   ...
   */
  IndexMultiAssociationFillerTool (const std::string& type,
...
#endif // not D3PDMAKERCORECOMPS_INDEXMULTIASSOCIATIONFILLERTOOL_H
