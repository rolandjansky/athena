...
InDetFlags.doSimpleV0Finder   = reDoV0Finder
...
## InDetFlags.primaryVertexSetup.set_Value_and_Lock('AdaptiveFinding')
## InDetFlags.useBeamConstraint.set_Value_and_Lock(True)
InDetFlags.primaryVertexCutSetup.set_Value_and_Lock('StartUp')
...
# InDetTrackSelectorTool.pTMin = 100.
