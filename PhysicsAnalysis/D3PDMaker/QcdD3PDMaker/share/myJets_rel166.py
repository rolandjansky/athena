...
if QcdD3PDMakerFlags.doRecJet():
  ...
  if not rec.readAOD():
    ...
    if QcdD3PDMakerFlags.doGhostJet():   # not default
      #GhostJets
      make_StandardJetGetter('AntiKt', 0.4, 'Tower', doEMCut=False, minPt=7*GeV, replaceNegEnergy=True, calibName='EM:GCW_JES', GCWScheme='GhostTower', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt4GhostTowerGCWJets')
      make_StandardJetGetter('AntiKt', 0.6, 'Tower', doEMCut=False, minPt=7*GeV, replaceNegEnergy=True, calibName='EM:GCW_JES', GCWScheme='GhostTower', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt6GhostTowerGCWJets')
      make_StandardJetGetter('AntiKt', 0.4, 'Tower', doEMCut=False, minPt=7*GeV, replaceNegEnergy=True, calibName='EM:JES', GCWScheme='GhostTower', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt4GhostTowerEMJets')
      make_StandardJetGetter('AntiKt', 0.6, 'Tower', doEMCut=False, minPt=7*GeV, replaceNegEnergy=True, calibName='EM:JES', GCWScheme='GhostTower', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt6GhostTowerEMJets')

  if QcdD3PDMakerFlags.doLCTopoJet() and not QcdD3PDMakerFlags.doRecJetOnlyAdditional():
    #LC
    make_StandardJetGetter('AntiKt',0.4,'LCTopo', doEMCut=False, minPt=7*GeV, doCalib=True, calibName='LC:ORIGIN_ETAJES', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt4LCTopoNewJets')
    make_StandardJetGetter('AntiKt',0.6,'LCTopo', doEMCut=False, minPt=7*GeV, doCalib=True, calibName='LC:ORIGIN_ETAJES', addJetQualityMoments=True, writeMoments=True, outputCollectionName='AntiKt6LCTopoNewJets')
...
#Truth pile-up jets
if rec.doTruth() and QcdD3PDMakerFlags.doRecTruthPileupJet():
  from JetRec.JetGetters import make_StandardJetGetter

  # rebuild an intermediate input collecion fr pile-up.
  from JetRec.JetGetterBase import  InputTruthPileupJetGetter_RDO
  InputTruthPileupJetGetter_RDO._output = { "JetCollection" : "PileupJetTruthParticlesBis" }
  InputTruthPileupJetGetter_RDO()
  topSequence.PileupJetTruthParticlesBis.JetCollectionName = "PileupJetTruthParticlesBis"
  topSequence.PileupJetTruthParticlesBis.AlgTools = [ topSequence.PileupJetTruthParticlesBis.AlgTools[0] ]
  if rec.readAOD():
    topSequence.PileupJetTruthParticlesBis.AlgTools[0].TruthCollectionName = "GEN_AOD"

  # run jet finders on this input.
  make_StandardJetGetter('AntiKt',0.6, 'Truth', doTruthPileup=True,inputSuff="Pileup",inputCollectionNames=["PileupJetTruthParticlesBis"],outputCollectionName='AntiKt6TruthPileupNewJets')
  # overwrite AntiKt4 with pileup
  make_StandardJetGetter('AntiKt',0.4, 'Truth', doTruthPileup=True,inputSuff="Pileup",globalSuff="Bis", inputCollectionNames=["PileupJetTruthParticlesBis"],outputCollectionName='AntiKt4TruthPileupNewJets')
