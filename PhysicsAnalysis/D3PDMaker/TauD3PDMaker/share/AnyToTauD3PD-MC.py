...
myOptions['poolFileInput']    = '/xdata02/mpedraza/TauD3PDscratch00/TestFiles/mc11_7TeV.106052.PythiaZtautau.recon.AOD.e825_s1349_s1300_r3043_tid619638_00/AOD.619638._000383.pool.root.1'
myOptions['perfSize']         = "SmallMedium"
myOptions['EvtMax']           = 50
myOptions['doTruth']          = True
myOptions['doClusters']       = True
myOptions['doTracks']         = True
myOptions['doHadrons']        = True
...
D3PDMakerFlags.JetSGKey = 'AntiKt4LCTopoJets' #rel 16 'AntiKt4TopoJets' # should be tau seed
...
if perfSize.lower().find("small") is not -1:
	...
	tauPerfSmall (file=tupleFileOutput+"Small.root", level=tauDetailsLevel, tuplename="tau", streamName="TauSMALL")
	
if perfSize.lower().find("medium") is not -1:
	from TauD3PDMaker.tauPerfMedium import tauPerfMedium
	tauPerfMedium (file=tupleFileOutput+".root", doCl = doClusters, doTrk = doTracks, doHad = doHadrons, level=tauDetailsLevel, tuplename='tau', streamName="TauMEDIUM")	
