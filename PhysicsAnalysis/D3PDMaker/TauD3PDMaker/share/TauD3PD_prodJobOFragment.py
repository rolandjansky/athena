# $Id: TauD3PD_prodJobOFragment.py 540713 2013-03-12 21:54:48Z mtm $
...
include.block( "TauD3PDMaker/TauD3PD_prodJobOFragment.py" )
...
TauD3PDStream_msg = logging.getLogger( 'TauD3PD_prodJobOFragment.py' )

# Check if the configuration makes sense:
if prodFlags.WriteTauD3PD.isVirtual:
    TauD3PDStream_msg.error( "The Tau D3PD stream can't be virtual! " +
                                "It's a configuration error!" )
    raise NameError( "Tau D3PD set to be a virtual stream" )
    pass

# Construct the stream and file names for the Tau D3PD:
streamName = prodFlags.WriteTauD3PD.StreamName
fileName   = buildFileName( prodFlags.WriteTauD3PD )
TauD3PDStream_msg.info( "Configuring TauD3PD with streamName '%s' and fileName '%s'" % \
                           ( streamName, fileName ) )
