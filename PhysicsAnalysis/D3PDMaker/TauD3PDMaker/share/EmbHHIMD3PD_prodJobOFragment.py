# $Id: EmbHHIMD3PD_prodJobOFragment.py 543602 2013-04-04 14:26:57Z mtm $
...
include.block( "TauD3PDMaker/EmbHHIMD3PD_prodJobOFragment.py" )
...
TauD3PDStream_msg = logging.getLogger( 'EmbHHIMD3PD_prodJobOFragment.py' )

# Check if the configuration makes sense:
if prodFlags.WriteEmbHHIMD3PD.isVirtual:
    TauD3PDStream_msg.error( "The Tau D3PD EMBHHIM stream can't be virtual! " +
                                "It's a configuration error!" )
    raise NameError( "Tau D3PD EMBHHIM set to be a virtual stream" )
    pass

# Construct the stream and file names for the Tau D3PD:
streamName = prodFlags.WriteEmbHHIMD3PD.StreamName
fileName   = buildFileName( prodFlags.WriteEmbHHIMD3PD )
TauD3PDStream_msg.info( "Configuring EmbHHIMD3PD with streamName '%s' and fileName '%s'" % \
                           ( streamName, fileName ) )
