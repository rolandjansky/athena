# $Id: TauFullD3PD_prodJobOFragment.py 540713 2013-03-12 21:54:48Z mtm $
...
include.block( "TauD3PDMaker/TauFullD3PD_prodJobOFragment.py" )
...
TauD3PDStream_msg = logging.getLogger( 'TauFullD3PD_prodJobOFragment.py' )

# Check if the configuration makes sense:
if prodFlags.WriteTauFullD3PD.isVirtual:
...
streamName = prodFlags.WriteTauFullD3PD.StreamName
fileName   = buildFileName( prodFlags.WriteTauFullD3PD )
TauD3PDStream_msg.info( "Configuring TauFullD3PD with streamName '%s' and fileName '%s'" % \
                           ( streamName, fileName ) )
...
from TauD3PDMaker.tauPerf import tauPerf as tauPerfFull
tauPerfFull( TauD3PDStream, doCl = False, doOtherTrk = True )
