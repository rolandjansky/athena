# $Id: EmbLLDND3PD_prodJobOFragment.py 543602 2013-04-04 14:26:57Z mtm $
...
include.block( "TauD3PDMaker/EmbLLDND3PD_prodJobOFragment.py" )
...
TauD3PDStream_msg = logging.getLogger( 'EmbLLDND3PD_prodJobOFragment.py' )

# Check if the configuration makes sense:
if prodFlags.WriteEmbLLDND3PD.isVirtual:
    TauD3PDStream_msg.error( "The Tau D3PD EMBLLDN stream can't be virtual! " +
                                "It's a configuration error!" )
    raise NameError( "Tau D3PD EMBLLDN set to be a virtual stream" )
    pass

# Construct the stream and file names for the Tau D3PD:
streamName = prodFlags.WriteEmbLLDND3PD.StreamName
fileName   = buildFileName( prodFlags.WriteEmbLLDND3PD )
TauD3PDStream_msg.info( "Configuring EmbLLDND3PD with streamName '%s' and fileName '%s'" % \
                           ( streamName, fileName ) )
