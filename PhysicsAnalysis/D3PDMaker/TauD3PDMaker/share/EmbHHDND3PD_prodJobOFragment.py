# $Id: EmbHHDND3PD_prodJobOFragment.py 543602 2013-04-04 14:26:57Z mtm $
...
include.block( "TauD3PDMaker/EmbHHDND3PD_prodJobOFragment.py" )
...
TauD3PDStream_msg = logging.getLogger( 'EmbHHDND3PD_prodJobOFragment.py' )

# Check if the configuration makes sense:
if prodFlags.WriteEmbHHDND3PD.isVirtual:
    TauD3PDStream_msg.error( "The Tau D3PD EMBHHDN stream can't be virtual! " +
                                "It's a configuration error!" )
    raise NameError( "Tau D3PD EMBHHDN set to be a virtual stream" )
    pass

# Construct the stream and file names for the Tau D3PD:
streamName = prodFlags.WriteEmbHHDND3PD.StreamName
fileName   = buildFileName( prodFlags.WriteEmbHHDND3PD )
TauD3PDStream_msg.info( "Configuring EmbHHDND3PD with streamName '%s' and fileName '%s'" % \
                           ( streamName, fileName ) )
