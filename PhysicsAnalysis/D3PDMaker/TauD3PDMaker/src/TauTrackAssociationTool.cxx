...
TauTrackAssociationTool::TauTrackAssociationTool
 ...
 */
StatusCode TauTrackAssociationTool::reset (const Analysis::TauJet& p)
{
  m_tauJet = &p;
  m_trackCounter = 0;
 ...
 */
const Rec::TrackParticle* TauTrackAssociationTool::next()
{
  // reached the end
