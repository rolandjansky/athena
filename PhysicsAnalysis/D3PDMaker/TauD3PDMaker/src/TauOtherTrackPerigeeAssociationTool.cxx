...
// $Id: TauOtherTrackPerigeeAssociationTool.cxx 577665 2014-01-09 23:18:59Z ssnyder $
/**
 * @file TauD3PDMaker/src/TauOtherTrackPerigeeAssociationTool.cxx
 ...
 */
TauOtherTrackPerigeeAssociationTool::TauOtherTrackPerigeeAssociationTool
...
StatusCode TauOtherTrackPerigeeAssociationTool::initialize()
{
 ...
 */
StatusCode TauOtherTrackPerigeeAssociationTool::reset(const Analysis::TauJet& p)
{
  m_tauJet = &p;
 ...
 */
const Trk::Perigee *TauOtherTrackPerigeeAssociationTool::next()
{
 ...
 */
void TauOtherTrackPerigeeAssociationTool::releaseElement (const Trk::Perigee* p)
{
  if(p) delete p;
}
