...
// $Id: TauWideTrackPerigeeAssociationTool.h 577665 2014-01-09 23:18:59Z ssnyder $
/**
 * @file TauD3PDMaker/src/TauWideTrackPerigeeAssociationTool.h
 * @author KG <kong.guan.tan@cern.ch>
 * @date October, 2011
 * @brief Associate from a TrackParticle to its perigee at the tau's origin
 */
#ifndef TAUD3PDMAKER_TAUWIDETRACKPERIGEEASSOCIATIONTOOL_H
#define TAUD3PDMAKER_TAUWIDETRACKPERIGEEASSOCIATIONTOOL_H
 ...
 * @brief Associate from a TrackParticle to its perigee at the tau's origin.
 */
class TauWideTrackPerigeeAssociationTool
...
public:
   ...
   */
  TauWideTrackPerigeeAssociationTool (const std::string& type,
...
#endif // not TAUD3PDMAKER_TAUWIDETRACKPERIGEEASSOCIATIONTOOL_H
