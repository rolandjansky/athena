...
// $Id: TauOtherTrackPerigeeAssociationTool.h 577665 2014-01-09 23:18:59Z ssnyder $
/**
 * @file TauD3PDMaker/src/TauOtherTrackPerigeeAssociationTool.h
 * @author KG <kong.guan.tan@cern.ch>
 * @date October, 2011
 * @brief Associate from a TrackParticle to its perigee at the tau's origin
 */
#ifndef TAUD3PDMAKER_TAUOTHERTRACKPERIGEEASSOCIATIONTOOL_H
#define TAUD3PDMAKER_TAUOTHERTRACKPERIGEEASSOCIATIONTOOL_H
 ...
 * @brief Associate from a TrackParticle to its perigee at the tau's origin.
 */
class TauOtherTrackPerigeeAssociationTool
...
public:
   ...
   */
  TauOtherTrackPerigeeAssociationTool(const std::string& type,
...
#endif // not TAUD3PDMAKER_TAUOTHERTRACKPERIGEEASSOCIATIONTOOL_H
