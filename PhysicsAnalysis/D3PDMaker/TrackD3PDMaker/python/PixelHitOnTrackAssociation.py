...
from TrackD3PDMaker.TrackD3PDMakerConf import D3PD__ClusterAssocPixelFillerTool as ClusterAssocPixelFillerTool
...
def PixelHitOnTrackAssociation (parent, associator, _prefix = '',
    ...
    assoc.defineBlock(0, _blocknameprefix+'clAssoc',
                      TrackD3PDMaker.ClusterAssocPixelFillerTool)
