...
/**
 * @file EventCommonD3PDMaker/src/VertexFitQualityAssociationTool.h
 * @author remi zaidan <remi.zaidan@cern.ch>
 * @date Feb, 2010
 * @brief Associate from a VxCandidate to its FitQuality.
 */
#ifndef TRACKD3PDMAKER_VERTEXFITQUALITYASSOCIATIONTOOL_H
#define TRACKD3PDMAKER_VERTEXFITQUALITYASSOCIATIONTOOL_H
...
#endif // not TRACKD3PDMAKER_VERTEXFITQUALITYASSOCIATIONTOOL_H
