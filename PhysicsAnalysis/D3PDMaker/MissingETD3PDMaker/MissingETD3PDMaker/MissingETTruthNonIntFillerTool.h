...
#ifndef MISSINGETD3PPDMAKER_MISSINGETTRUTHNONINTFILLERTOOL_H
#define MISSINGETD3PPDMAKER_MISSINGETTRUTHNONINTFILLERTOOL_H
 ...
 */
class MissingETTruthNonIntFillerTool
...
public:
   ...
   */
  MissingETTruthNonIntFillerTool (const std::string& type,
...
private:
  /// Variable: x component.
  float* m_etx;

  /// Variable: y component.
  float* m_ety;
