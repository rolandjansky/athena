...
// $Id$
/**
 * @file MissingETD3PDMaker/src/SumETTruthNonIntFillerTool.h
...
#ifndef MISSINGETD3PPDMAKER_SUMETTRUTHNONINTFILLERTOOL_H
#define MISSINGETD3PPDMAKER_SUMETTRUTHNONINTFILLERTOOL_H
 ...
 */
class SumETTruthNonIntFillerTool
...
public:
   ...
   */
  SumETTruthNonIntFillerTool (const std::string& type,
...
#endif // not MISSINGETD3PPDMAKER_SUMETTRUTHNONINTFILLERTOOL_H
