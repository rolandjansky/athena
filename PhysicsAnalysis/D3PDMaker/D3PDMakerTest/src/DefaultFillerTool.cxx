...
// $Id$
/**
 * @file D3PDMakerTest/src/DefaultFillerTool.cxx
 ...
 */
DefaultFillerTool::DefaultFillerTool (const std::string& type,
 ...
 */
StatusCode DefaultFillerTool::book()
{
 ...
 */
StatusCode DefaultFillerTool::fill()
{
  return StatusCode::SUCCESS;
}
