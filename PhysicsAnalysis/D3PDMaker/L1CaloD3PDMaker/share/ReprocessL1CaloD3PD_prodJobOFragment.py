...
include.block( "L1CaloD3PDMaker/ReprocessL1CaloD3PD_prodJobOFragment.py" )
...
L1CALOD3PDStream_msg = logging.getLogger( 'ReprocessL1CaloD3PD_prodJobOFragment' )
...
# Reprocessing Configurations
include("TrigT1CaloCalibConditions/L1CaloCalibConditions_jobOptions.py")
include('L1CaloD3PDMaker/L1CaloReprocessingConfigurations.py')
...
L1CaloD3PD( fileName, level = 3, Jets = True, Egamma = True, MET = True,
            ...
            Reprocess = True, ReprocessList =  L1CaloConfig(topSequence))
