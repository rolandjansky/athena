...
/**
 * @brief Test if ElectronPhotonVariableCorrectionToolWrapper runs fine on electrons and (un-)converted photons
...
int main(int argc, char* argv[])
{
    ...
    // initialize the tool
    ElectronPhotonVariableCorrectionToolWrapper myTool("WrapperTestTool");
    std::string configFile = "ElectronPhotonShowerShapeFudgeTool/ElectronPhotonVariableCorrectionToolWrapper_ExampleConf.conf";
