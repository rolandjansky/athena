...
class AthElectronLikelihoodTool;
...
namespace Root {
    ...
    public TSelectorToolBase
  {
    ...
    friend class ::AthElectronLikelihoodTool;
  ...
  private:
    ...
    //static TElectronLikelihoodTool& Instance(std::string,std::string,std::string);
  ...
  public:
    ...
    int doCutConversion;
    /** @brief do remove f3 variable from likelihood at high Et (>45 GeV)*/
