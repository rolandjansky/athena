...
/**
    ...
    The methodology is largely based on the likelihood of central electrons, so
   please refer to ElectronPhotonSelectorTools/TElectronLikelihoodTool.h for
   details

    The forward likelihood ID relies on the following list of topo-cluster
   variables: el_secondLambda : longitudinal second moment el_lateral      :
   normalised lateral moment el_longitudinal : normalised longitudinal moment
