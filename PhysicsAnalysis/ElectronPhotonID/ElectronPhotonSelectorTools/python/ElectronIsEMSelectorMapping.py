...
ElectronIsEMMap2011 = {
    egammaPID.ElectronIDLoose:   (
        ...
        ElectronIsEMSelectorCutDefs.ElectronIsEMSelectorConfig2011),
    ...
    egammaPID.ElectronIDLoosePP: (
        ...
        ElectronIsEMLooseSelectorCutDefs.ElectronIsEMLooseSelectorConfig2011),
    egammaPID.ElectronIDMediumPP: (
        egammaPID.ElectronMediumPP,
        ElectronIsEMMediumSelectorCutDefs.ElectronIsEMMediumSelectorConfig2011),
    egammaPID.ElectronIDTightPP: (
        egammaPID.ElectronTightPP,
        ElectronIsEMTightSelectorCutDefs.ElectronIsEMTightSelectorConfig2011),
    egammaPID.NoIDCut: (
        0, ElectronIsEMLooseSelectorCutDefs.ElectronIsEMLooseSelectorConfig2011)
}
...
ElectronIsEMMap2012OLD = {
    egammaPID.ElectronIDLoosePP: (
        egammaPID.ElectronLoosePP,
        ElectronIsEMLooseSelectorCutDefs.ElectronIsEMLooseSelectorConfig2012OLD),
    egammaPID.ElectronIDMediumPP: (
        egammaPID.ElectronMediumPP,
        ElectronIsEMMediumSelectorCutDefs.ElectronIsEMMediumSelectorConfig2012OLD),
    egammaPID.ElectronIDTightPP: (
        egammaPID.ElectronTightPP,
        ElectronIsEMTightSelectorCutDefs.ElectronIsEMTightSelectorConfig2012OLD),
    egammaPID.NoIDCut: (
        0,
        ElectronIsEMLooseSelectorCutDefs.ElectronIsEMLooseSelectorConfig2012OLD)
}
...
def ElectronIsEMMap(quality, menu):
    if menu == electronPIDmenu.menu2011:
        ...
        tuple = (egammaPID.ElectronLoosePP,
                 ElectronIsEMH4l2011SelectorCutDefs.ElectronIsEMH4l2011SelectorConfig)
        return tuple
    else:
