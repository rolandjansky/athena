...
int main( int argc, char* argv[] ) {
    ...
    //Then the tools
    std::vector<std::string> id_configFiles{"ElectronEfficiencyCorrection/2012/offline/efficiencySF.offline.FwdTight.2012.8TeV.rel17p2.GEO21.v02.root"};
...
//    CHECK( ElEffCorrectionTool.setProperty("IdKey", "Medium"));
    ...
    for(long  long int entry=0  ; entry < entries; ++entry ) {
	    ...
	    if(fabs(el->caloCluster()->eta()) < 2.5) continue; //skip electrons outside of recommendations
            ...
            double totalNeg{};
            double totalPos{}; 
            // ElEffCorrectionTool.getEfficiencyScaleFactor(*el,nominalSF);
