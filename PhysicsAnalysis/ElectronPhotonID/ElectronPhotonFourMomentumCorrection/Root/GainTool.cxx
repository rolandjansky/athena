...
namespace egGain {
	...
	m_TOFile = 0;
	m_varFile = 0; 
	std::fill(m_funcTO, m_funcTO + sizeof(m_funcTO)/sizeof(TF1*), nullptr);
	...
	m_TOFile = new TFile( filenameTO.c_str() );
	m_varFile = new TFile(filenameVar.c_str()); 
	...
	double m_diffES[28] = {-0.0763457,0.198092,-0.0288093,-0.0808452,0.0271571,-0.0975428,-0.0164521,-0.0737317,0.136447,0.0352632,-0.00197711,0.0244447,-0.0641183,0.0810265,0.00735352,-0.013568,-0.0169185,-0.0142155,-0.0255637,0.0586014,-0.163098,0.0237162,-0.0690589,-0.0346536,-0.0886648,-0.0914096,0.0738988,-0.0376201}; 
    
    
	double m_corrHG[28] = {-0.484364,0.263687,-0.037742,-0.0553371,-0.0640682,-0.201265,-0.176052,-0.206764,0.0224639,0.00855262,-0.00583258,0.00196343,-0.108951,0.0708467,-0.00438541,-0.0928867,-0.0487188,-0.0214743,-0.0619355,-0.055117,-0.297427,-0.0795861,-0.173311,-0.0905191,-0.297548,-0.147814,-0.0867268,-0.384337}; 
    
	double m_corrMG[28]={-0.0160707,0.199527,-0.000845413,-0.0611091,0.0877896,0.0479742,0.141414,0.639507,0.72873,0.21984,0.0643192,0.146518,0.0279768,0.140151,0.0682126,0.167472,0.154887,0.122343,0.212282,0.657224,0.576652,0.135954,0.0798118,0.0167071,-0.0221686,-0.0398211,0.128146,-0.0226478}; 
	...
	if (ptype == PATCore::ParticleType::UnconvertedPhoton){
	    ...
	    m_funcG_com[0][id_eta]= (TF1*)m_conv_funcG[0][id_eta];
	    m_funcG_com[1][id_eta]= (TF1*)m_conv_funcG[1][id_eta];
	    m_funcG_com[2][id_eta]= (TF1*)m_conv_funcG[2][id_eta];
	}
	else if (ptype==PATCore::ParticleType::Electron){
	    m_funcG_com[0][id_eta]= (TF1*)m_funcG[0][id_eta];
	    m_funcG_com[1][id_eta]= (TF1*)m_funcG[1][id_eta];
	    m_funcG_com[2][id_eta]= (TF1*)m_funcG[2][id_eta];
	}
	...
	if(ptype==PATCore::ParticleType::ConvertedPhoton || ptype==PATCore::ParticleType::Electron){
		...
		if (energy_input<105) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<400 && energy_input>=105) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta])); 
		else if (energy_input>=400) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta])); 

	    }
 
	    else if(id_eta == 11 || id_eta ==16){
		if (energy_input<130) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<440 && energy_input>=130) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=440) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
 
	    else if(id_eta == 10 || id_eta ==17){
		if (energy_input<190) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<400 && energy_input>=190) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=400) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
 
	    else if(id_eta == 9 || id_eta ==18){
		if (energy_input<200) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<480 && energy_input>=200) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=480) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
 
	    else if(id_eta==7 || id_eta == 8 || id_eta ==19 || id_eta==20){
		if (energy_input<250) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<450 && energy_input>=250) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=450) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
 
	    else if(id_eta == 6 || id_eta ==21){
		if (energy_input<180) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<385 && energy_input>=180) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=385) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
 
	    else if(id_eta == 5 || id_eta ==22){
		if (energy_input<165) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<460 && energy_input>=165) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=460) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
    
	    else if(id_eta == 4 || id_eta ==23){
		if (energy_input<160) corrM_G = (m_funcG_com[0][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input<450 && energy_input>=160) corrM_G = (m_funcG_com[1][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
		else if (energy_input>=450) corrM_G = (m_funcG_com[2][id_eta]->Eval(energy_input))/(m_funcG_com[0][id_eta]->Eval(range_energy[id_eta]));
	    }
