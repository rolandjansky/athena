...
int main() {
  ...
  for (Scale::Variation var = Scale::None; var<Scale::LastScaleVariation; var = Scale::Variation(var+1))
	...
	double eVar = ect12c.getCorrectedEnergy(runnumber, PATCore::ParticleDataType::Full, piUnc, 
						var, egEnergyCorr::Resolution::None);
	
	double eNom = ect12c.getCorrectedEnergy(runnumber, PATCore::ParticleDataType::Full, piUnc,
...
;
    ...
    gPad->RedrawAxis();
    char plotname[99];
    sprintf(plotname,"lin_samplings_unconv_eta%d.png",i);
    c.SaveAs(plotname);
