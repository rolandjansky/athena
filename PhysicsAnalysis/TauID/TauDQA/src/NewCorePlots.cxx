...
namespace Tau{
  ...
  void NewCorePlots::initializePlots(){
    ...
    m_isolFrac 	                       = Book1D("Seed_Calo_isolFrac",m_sTauJetContainerName + "Tau Seed Calo isolFrac ;isolFrac ;# of Taus",    40,  0., 2.);	  
    m_centFrac 	                       = Book1D("Seed_Calo_centFrac",m_sTauJetContainerName + "Tau Seed Calo centFrac ;centFrac ;# of Taus",    40,  0., 2.);
    ...
    m_mEflowApprox		       = Book1D("mEflowApprox",m_sTauJetContainerName + "Tau mEflowApprox; mEflowApprox; #Taus", 30, 0., 3000.);
  }
  ...
  void NewCorePlots::fill(const xAOD::TauJet& tau, float weight) {
    ...
    if(test) m_ipZ0SinThetaSigLeadTrk->Fill(avariable, weight);
    ...
    if(test) m_ipSigLeadTrk->Fill(avariable, weight);
