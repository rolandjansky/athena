...
def JSD3PD  (jetsToWrite, alg = None):
    ...
    myBtagleveloffset=7
    if "Topo" in jetsToWrite[0]:
        myBtagleveloffset=0
    MyJetD3PDObject = getJetD3PDObject(objectname='MyJetD3PDObject', btagleveloffset=myBtagleveloffset)
    MyGroomedJetD3PDObject = getJetD3PDObject(objectname='MyGroomedJetD3PDObject', btagleveloffset=myBtagleveloffset)
