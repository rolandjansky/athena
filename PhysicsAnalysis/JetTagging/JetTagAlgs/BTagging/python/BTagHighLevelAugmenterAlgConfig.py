...
Analysis__BTagHighLevelAugmenterAlg=CompFactory.Analysis__BTagHighLevelAugmenterAlg

def BTagHighLevelAugmenterAlgCfg(ConfigFlags, BTagCollection, Associator, doFlipTagger=False, **options):
