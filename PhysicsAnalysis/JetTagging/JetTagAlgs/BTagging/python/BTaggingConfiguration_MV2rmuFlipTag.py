...
# Configuration functions for MV2rmuFlipTag
# Author: Wouter van den Wollenberg (2013-2014)
from BTagging.BTaggingFlags import BTaggingFlags

metaMV2rmuFlipTag = { 'IsATagger'          : False,#True,
                  'xAODBaseName'       : 'MV2rmuFlip',
                  ...
                  'ToolCollection'     : 'MV2rmuFlipTag'}

def toolMV2rmuFlipTag(name, useBTagFlagsDefaults = True, **options):
