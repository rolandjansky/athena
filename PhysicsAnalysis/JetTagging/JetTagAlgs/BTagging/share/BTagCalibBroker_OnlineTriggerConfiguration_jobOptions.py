...
include("JetTagCalibration/BTagCalibrationBroker_OnlineTriggerConfiguration_jobOptions.py")
BTagCalibrationBrokerTool_OnlineTriggerConfiguration.folders[:] = [] # Wipe folders; these will be dynamically filled by the configuration code
from BTagging.BTaggingConfiguration import getConfiguration
ConfInst = getConfiguration("Trig")
ConfInst.registerTool("BTagCalibrationBrokerTool", BTagCalibrationBrokerTool_OnlineTriggerConfiguration)
