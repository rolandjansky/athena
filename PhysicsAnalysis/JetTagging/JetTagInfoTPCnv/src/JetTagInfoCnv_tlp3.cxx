...
namespace Analysis {
  ...
  ///
  JetTagInfoCnv_tlp3::JetTagInfoCnv_tlp3 (void)
  {
  ...
  ///
  void JetTagInfoCnv_tlp3::setPStorage (JetTagInfo_tlp3 *storage)
  {
    ...
    m_gbbnnTagCnv.setPStorage(&storage->m_gbbnnTag);
