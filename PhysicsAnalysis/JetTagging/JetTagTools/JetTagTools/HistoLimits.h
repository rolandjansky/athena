...
struct HistoLimits {
  ...
  /** 1D: */
  HistoLimits(unsigned int bin, double xmi, double xma) : bins(bin), xmin(xmi), xmax(xma) {};
  /** 2D: */
  HistoLimits(unsigned int bin, double xmi, double xma, unsigned int biny, double ymi, double yma) : bins(bin), xmin(xmi), xmax(xma), binsy(biny), ymin(ymi), ymax(yma) {};
  /** 3D: */
