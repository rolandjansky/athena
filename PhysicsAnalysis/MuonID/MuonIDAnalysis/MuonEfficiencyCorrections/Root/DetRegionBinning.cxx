...
int DetRegionBinning::getSector(double phi) const {
...
int DetRegionBinning::getECSector(double phi) const {
...
int DetRegionBinning::getCoarseNSector(double phi) const {

    if ((fabs(phi) >= 0.18 && fabs(phi) < 0.285) || (fabs(phi) >= 0.5 && fabs(phi) < 0.605) || (fabs(phi) >= 0.965 && fabs(phi) < 1.07) || (fabs(phi) >= 1.285 && fabs(phi) < 1.39) || (fabs(phi) >= 1.75 && fabs(phi) < 1.855) || (fabs(phi) >= 2.07 && fabs(phi) < 2.175) || (fabs(phi) >= 2.535 && fabs(phi) < 2.64) || (fabs(phi) >= 2.855 && fabs(phi) < 2.96)) return 2;
    else return 1;

}

int DetRegionBinning::symmetricBin(const TLorentzVector & mst) const {
    ...
    //Feet
    if (fabs(mu_eta) < 0.97 && ((mu_phi < -1.01 && mu_phi > -1.36) || (mu_phi < -1.79 && mu_phi > -2.14))) return binFEET;
    if ((fabs(mu_eta) > 0.51 && fabs(mu_eta) < 0.81) && (mu_phi < -1.36 && mu_phi > -1.79)) return binFEET;
    ...
    if (fabs(mu_eta) >= 0.97 && fabs(mu_eta) < 1.11) return binTRANSITION;
    ...
    //BEE
    if (fabs(mu_eta) >= 1.42 && fabs(mu_eta) < 1.72 && mu_nsect == 1 && isSmSect) return binBEE;
