...
namespace CP {
    ...
    StatusCode MuonCalibrationPeriodTool::initialize() {
        ...
        bool statComb1516(false), sagittaCorr1516(false), sagittaMCDistortion1516(false), sagittaCorrPhaseSpace1516(false),
            do2StationsHighPt1516(m_do2StationsHighPt), doExtraSmearing1516(m_doExtraSmearing);
        bool statComb17(false), sagittaCorr17(false), sagittaMCDistortion17(false), sagittaCorrPhaseSpace17(false),
            do2StationsHighPt17(m_do2StationsHighPt), doExtraSmearing17(m_doExtraSmearing);
        bool statComb18(false), sagittaCorr18(false), sagittaMCDistortion18(false), sagittaCorrPhaseSpace18(false),
            do2StationsHighPt18(m_do2StationsHighPt), doExtraSmearing18(m_doExtraSmearing);
        ...
        if (m_calib_mode == MuonCalibrationPeriodTool::correctData) {
            ...
            ATH_MSG_FATAL("Invalid  calibration mode: " << m_calib_mode << " Allowed modes are correctData("
                                                        << MuonCalibrationPeriodTool::correctData << ") additionalMCsys ("
                                                        << MuonCalibrationPeriodTool::additionalMCsys << ") or expert ("
                                                        << MuonCalibrationPeriodTool::expert << ")");
            return StatusCode::FAILURE;
        }
