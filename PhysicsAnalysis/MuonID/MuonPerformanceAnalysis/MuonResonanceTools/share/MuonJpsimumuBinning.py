...
MuonJpsiBinning={ 
    ...
    "h_Zpt_mu_1stPt": JpsiMassBin+[ 500, 1., 1000000.],
    ...
    "h_Zm_mu_avPt": JpsiMassBin+[ 500, 1., 1000000.],
    "h_Zm_Pexp": [ 200, 1., 2000000.]+ JpsiMassBin,                            #Mmumu vs. p* (as defined in ATL-COM-MUON 2014-001)
    ...
    "h_Zm_1stPt_truth":  [ 500, 1., 1000000., 500, 1., 1000000. ],             #Mmumu(truth) vs. pt(truth) of leading muon
    "h_Zm_2ndPt_truth":  [ 500, 1., 1000000., 500, 1., 1000000. ],             #Mmumu(truth) vs. pt(truth) of subleading muon
    "h_Zm_mu_avPt_truth": JpsiMassBin+[ 500, 1., 1000000.],                    #Mmumu(truth) vs. avPt(truth) of subleading muon
    "h_Zm_Pexp_truth"  : [ 200, 1., 2000000.]+ JpsiMassBin,                    #Mmumu(truth) vs. p*(truth)
    ...
    "Res_Zm_2D"     : [ 50, -50000., 50000.]+JpsiMassBin,                         #Mmumu-Mmumu(truth) vs. Mmumu
    ...
    "Res_Zm_Pt_2D"  : [50, -50000., 50000.]+JpsiMassBin,                          #Mmumu-Mmumu(truth) vs. pt of leading muon
