...
MuonZBinning={ 
    ...
    "h_Zpt_mu_1stPt": [500, 1., 1000000., 500, 1., 1000000.],
    ...
    "h_Zm_1stPhi": [ 128, -Pi, Pi, 500, 1., 1000000.],
    "h_Zm_2ndPhi": [ 128, -Pi, Pi, 500, 1., 1000000.],
    "h_Zm_1stEta": [ 100, -3.5, 3.5, 500, 1., 1000000.],
    "h_Zm_2ndEta": [ 100, -3.5, 3.5, 500, 1., 1000000.],
    "h_Zm_1stPt":  [ 500, 1., 1000000., 500, 1., 1000000. ],
    "h_Zm_2ndPt":  [ 500, 1., 1000000., 500, 1., 1000000. ],
    "h_Zm_mu_avPt": [ 500, 1., 1000000., 500, 1., 1000000.],
    "h_Zm_Pexp": [ 200, 1., 2000000., 500, 1., 1000000.],                           #Mmumu vs. p* (as defined in ATL-COM-MUON 2014-001)
    
    #correlation plots (truth-info)
    "h_Zm_1stPhi_truth" : [ 128, -Pi, Pi, 500, 1., 1000000.],                       #Mmumu(truth) vs. phi(truth) of leading muon 
    "h_Zm_2ndPhi_truth" : [ 128, -Pi, Pi, 500, 1., 1000000.],                       #Mmumu(truth) vs. phi(truth) of subleading muon
    "h_Zm_1stEta_truth" : [ 100, -3.5, 3.5, 500, 1., 1000000.],                     #Mmumu(truth) vs. eta(truth) of leading muon
    "h_Zm_2ndEta_truth" : [ 100, -3.5, 3.5, 500, 1., 1000000.],                     #Mmumu(truth) vs. eta(truth) of subleading muon
    "h_Zm_1stPt_truth"  : [ 500, 1., 1000000., 500, 1., 1000000. ],                 #Mmumu(truth) vs. pt(truth) of subleading muon
    "h_Zm_2ndPt_truth"  : [ 500, 1., 1000000., 500, 1., 1000000. ],                 #Mmumu(truth) vs. pt(truth) of subleading muon
    "h_Zm_mu_avPt_truth": [ 500, 1., 1000000., 500, 1., 1000000.],                  #Mmumu(truth) vs. avPt(truth) of muons
    "h_Zm_Pexp_truth"   : [ 200, 1., 2000000., 500, 1., 1000000.],                  #Mmumu(truth) vs. p*(truth)
    ...
    "Res_Zm_2D"     :[ 500, 1., 1000000., 50, -50000., 50000.],                     #Mmumu-Mmumu(truth) vs. Mmumu
    ...
    "Res_Zm_Pt_2D"  :[ 500, 1., 1000000., 50, -50000., 50000.],                     #Mmumu-Mmumu(truth) vs. pt of leading muon
    ...
    #Chi^2 of tracks
    "ChiSquared":[  200,  1.,  10.],                                                #Chi^2/DoF for track of leading muon 
