...
#         ProbeContainer = CommonMuonTPConfig.AddHighPtTrackPicker(10000.).Output
    ...
    SelectionTools += [CommonMuonTPConfig.AddZmumuTPSelectionTool(name="ZmumuTPSelectionTool_OC_%s"%name_suffix,
                                                                  EffiFlag="%s_OC"%name_suffix,IsRunOnDAOD=IsRunOnDAOD,
                                                                  ProbeType = ProbeKind)]
    if not "Truth" in ProbeKind:
        if doProbeWithoutCuts:
            SelToolAny = CommonMuonTPConfig.AddZmumuTPSelectionTool(name="ZmumuTPSelectionTool_Any_%s"%name_suffix,
                                                                  EffiFlag="%s_Any"%name_suffix,IsRunOnDAOD=IsRunOnDAOD,
                                                                  ProbeType = ProbeKind)
            # apply *very* loose probe cuts here, to be able to optimise them offline
            SelToolAny.HighMassWindow = 121000.
            SelToolAny.LowMassWindow = 41000.
            SelToolAny.ProbeD0Cut = -1
            SelToolAny.ProbeD0SignCut = -1
            SelToolAny.ProbeZ0Cut = -1
            SelToolAny.DoProbeIsolation = False
            SelToolAny.AcceptOppCharge = True
            SelToolAny.AcceptSameCharge = True


            SelectionTools += [SelToolAny]


        SelectionTools += [CommonMuonTPConfig.AddZmumuTPSelectionTool(name="ZmumuTPSelectionTool_SC_%s"%name_suffix,
                                                                      EffiFlag="%s_SC"%name_suffix,IsRunOnDAOD=IsRunOnDAOD,
                                                                      ProbeType = ProbeKind,
                                                                      SameSign=True)]
        SelectionTools += [CommonMuonTPConfig.AddZmumuTPSelectionTool(name="ZmumuTPSelectionTool_OCAntiIso_%s"%name_suffix,
                                                                      EffiFlag="%s_OCAntiIso"%name_suffix,IsRunOnDAOD=IsRunOnDAOD,
                                                                      ProbeType = ProbeKind,
                                                                      AntiIso=True)]
        SelectionTools += [CommonMuonTPConfig.AddZmumuTPSelectionTool(name="ZmumuTPSelectionTool_SCAntiIso_%s"%name_suffix,
                                                                      EffiFlag="%s_SCAntiIso"%name_suffix,IsRunOnDAOD=IsRunOnDAOD,
                                                                      ProbeType = ProbeKind,
                                                                      SameSign=True,
                                                                      AntiIso=True)]
    ...
    if doID:
        ...
        thistoolIDptr.MaximumDrCut = MATCH_DR
        MatchingTools += [thistoolIDptr]
    ...
    if writeProbeIso:
        ...
        isotool_Loose = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_Loose"%name_suffix,EffiFlag="IsoLoose",doClosure=doClosure,IsNominal=True)
        ...
        isotool_Tight = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_Tight"%name_suffix,EffiFlag="IsoTight",doClosure=doClosure,IsNominal=True)
        ...
        isotool_Gradient = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_Gradient"%name_suffix,EffiFlag="IsoGradient",doClosure=doClosure,IsNominal=True)
        ...
        isotool_GradientLoose = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_GradientLoose"%name_suffix,EffiFlag="IsoGradientLoose",doClosure=doClosure,IsNominal=True)
        ...
        isotool_FixedCutLoose = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_FixedCutLoose"%name_suffix,EffiFlag="IsoFixedCutLoose",doClosure=doClosure,IsNominal=True)
        ...
        isotool_FixedCutTightTrackOnly = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="ZmumuTPIsoEfficiencyTool_Reco_%s_FixedCutTightTrackOnly"%name_suffix,EffiFlag="IsoFixedCutTightTrackOnly",doClosure=doClosure,IsNominal=True)
    ...
    for ntuple in ntuples:
        ...
        if "Truth" in ProbeKind:
            ntuple.ProbeIsTruth = True
...
def AddZmumuTPRecoAnalysis(doEtaSlices=False,writeNtuple=False,
                           doClosure=False,doDRSys=False, doValid=False,
                           DoProbeMatchPlots=True,writeProbeIso=True,
                           ProduceEfficiencies=False,
                           doProbeWithoutCuts = False,
                           IsRunOnDAOD=False):
    ...
    #########################################################################################
    #Add the Zmm TP algorithm using very loose muons as probes and matching to muons
