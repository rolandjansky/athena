...
def AddIsolPlots(name_suffix,
    ...
    if doEtaSlices:
        ...
        for etaslice, interval in Slices.iteritems():
            PlotTool = CommonMuonTPConfig.AddPlottingTool(name="JPsiTPIsoPlottingTool_%s_%s"%(name_suffix,etaslice),
                                                          EffiFlag=name_suffix+"_"+etaslice,applySF = False,
            ...
            if doClosure:
                PlotToolCL = CommonMuonTPConfig.AddPlottingTool(name="JPsiTPIsoPlottingToolClosure_%s_%s"%(name_suffix,etaslice),
        ...
        PlotTools = [CommonMuonTPConfig.AddPlottingTool(name="JPsiTPIsoPlottingTool_%s_All"%name_suffix,EffiFlag=name_suffix+"_All",
                                                        applySF = False,DoProbeMatchPlots=DoProbeMatchPlots,
                                                        ProduceEfficiencies=ProduceEfficiencies,
                                                        IsRunOnDAOD=IsRunOnDAOD)]
        if doClosure:
            PlotTools.append(CommonMuonTPConfig.AddPlottingTool(name="JPsiTPIsoPlottingToolClosure_%s_All"%name_suffix,
...
def AddIsolMatchTools(name_suffix,doLooseTrackOnly=True,doLoose=True,doTight=True,doGradient=True,doGradientLoose=True,doFixedCutLoose=True,doFixedCutTightTrackOnly=True,doClosure=True ):
    MatchingTools = []
    if doLooseTrackOnly:
        thistool_LooseTrackOnly = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="JPsiTPIsoEfficiencyTool_%s_LooseTrackOnly"%name_suffix,EffiFlag="IsoLooseTrackOnly",doClosure=doClosure,IsNominal=True)
    ...
    if doLoose:
        thistool_Loose = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="JPsiTPIsoEfficiencyTool_%s_Loose"%name_suffix,EffiFlag="IsoLoose",doClosure=doClosure,IsNominal=True)
    ...
    if doTight:
        thistool_Tight = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="JPsiTPIsoEfficiencyTool_%s_Tight"%name_suffix,EffiFlag="IsoTight",doClosure=doClosure,IsNominal=True)
    ...
    if doGradient:
        thistool_Gradient = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="JPsiTPIsoEfficiencyTool_%s_Gradient"%name_suffix,EffiFlag="IsoGradient",doClosure=doClosure,IsNominal=True)
    ...
    if doGradientLoose:
        thistool_GradientLoose = CommonMuonTPConfig.AddIsolTPEfficiencyTool(name="JPsiTPIsoEfficiencyTool_%s_GradientLoose"%name_suffix,EffiFlag="IsoGradientLoose",doClosure=doClosure,IsNominal=True)
