...
namespace ana
{
  ...
  QUICK_ANA_MET_DEFINITION_MAKER( "susy2L",    makeMetTool(args,true,true,true,false,true) )
  QUICK_ANA_MET_DEFINITION_MAKER( "ejetORMod", makeMetTool(args,true,true,true,false,true,false,"Default",0.3,20*GeV) )
