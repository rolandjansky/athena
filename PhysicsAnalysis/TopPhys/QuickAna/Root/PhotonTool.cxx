...
namespace ana
{
  ...
  initialize()
  {
    ...
    TString ffFile = "ElectronPhotonShowerShapeFudgeTool/v1/PhotonFudgeFactors.root";
    ATH_CHECK (m_fudgeMCTool.setProperty("FFCalibFile", ffFile.Data())); //only for rel21 
