...
namespace top {
  ...
  bool JetCleaningSelector::checkBadBatman(const top::Event& event) const{
    ...
    top::check(event.m_info->isAvailable<char>("DFCommonJets_isBadBatman"),"JetCleaningSelector: DFCommonJets_isBadBatman not available in EventInfo. Needed for BadBatman cleaning");
