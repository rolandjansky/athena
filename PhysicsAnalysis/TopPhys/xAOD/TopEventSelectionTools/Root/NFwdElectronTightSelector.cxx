...
bool NFwdElectronTightSelector::applyParticleLevel(const top::ParticleLevelEvent& /*event*/) const {
    std::cout<<"NFwdElectronTightSelector::applyParticleLevel : no separate fwdElectrons container currently defined at particleLevel, FWDEL_N_TIGHT always returning true at particle level"<<std::endl;
    return true;
