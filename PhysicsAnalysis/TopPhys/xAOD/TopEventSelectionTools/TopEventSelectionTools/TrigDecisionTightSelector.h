...
#ifndef TRIGDECISIONTIGHTSELECTOR_H_
#define TRIGDECISIONTIGHTSELECTOR_H_
...
namespace top {
   ...
   */
  class TrigDecisionTightSelector: public EventSelectorBase {
  public:
    /**
...
#endif /* TRIGDECISIONTIGHTSELECTOR_H_ */
