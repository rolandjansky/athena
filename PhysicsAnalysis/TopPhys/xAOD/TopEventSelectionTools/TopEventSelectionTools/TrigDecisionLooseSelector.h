...
#ifndef TRIGDECISIONLOOSESELECTOR_H_
#define TRIGDECISIONLOOSESELECTOR_H_
...
namespace top {
   ...
   */
  class TrigDecisionLooseSelector: public EventSelectorBase {
  public:
    /**
...
#endif /* TRIGDECISIONLOOSESELECTOR_H_ */
