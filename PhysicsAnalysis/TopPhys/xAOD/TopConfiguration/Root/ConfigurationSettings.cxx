...
namespace top {
  ...
  ConfigurationSettings::ConfigurationSettings() : m_configured(false) {
    ...
    registerParameter("do2StationsHighPt", "True/False, to turn on/off the reco with 2-station muons with missing inner MS station allowed for abs(eta)<1.3, only with MuonQuality HighPt Default: false", "false");
    ...
    registerParameter("do2StationsHighPtLoose", "True/False, to turn on/off the reco with 2-station muons with missing inner MS station allowed for abs(eta)<1.3, only with MuonQualityLoose HighPt Default: false", "false");
    registerParameter("doExtraSmearingLoose", "True/False, To be used by analyses willing to check their sensitivity to momentum resolution effects at large muon momenta. Default: false", "false");
