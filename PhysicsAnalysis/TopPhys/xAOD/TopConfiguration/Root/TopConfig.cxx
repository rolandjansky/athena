...
namespace top {
  ...
  void TopConfig::setConfigSettings(top::ConfigurationSettings* const& settings) {
    ...
    if (m_aodMetaData->valid() && !m_useHIJets) {
      try {
    ...
    m_electronIDSFFileLoose_path = settings->value("ElectronIDSFFilePathLoose");
  ...
  void TopConfig::sgKeyJets(const std::string& s) {
    if (!m_configFixed) {
      ...
      if (s == "BTagging_DFAntiKt4HIJets") {
        m_useHIJets = true;
        m_sgKeyJetsType = "DFAntiKt4HIJets";
        m_sgKeyJets = "DFAntiKt4HIJets";
      } else if (s == "BTagging_AntiKt4HIJets") {
        m_useHIJets = true;
        m_sgKeyJetsType = "AntiKt4HIJets";
        m_sgKeyJets = "AntiKt4HIJets";
      } else {
        m_sgKeyJets = s;
      }
    }
