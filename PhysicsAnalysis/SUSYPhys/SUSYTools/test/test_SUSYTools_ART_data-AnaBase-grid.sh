...
echo "Running SUSYTools test: \'TestSUSYToolsAlg.py -t data18 -m 1500\'"
TestSUSYToolsAlg.py -t data18 -m 1500
echo  "art-result: $? TEST"

mv submitDir/hist-SUSYTools.root ./hist-DATA_DAOD_PHYSVAL.root
