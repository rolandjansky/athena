...
getMetadata.py --timestamp="2018-06-23 08:00:00" --physicsGroups="SUSY,PMG,MCGN" --fields="dataset_number,physics_short,crossSection_pb,kFactor,genFiltEff,crossSectionTotalRelUncertUP" --inDsTxt="susy_bkg_datasets.txt" > Backgrounds_2018-06-23.txt
