...
#defaultRecoTags = ["r7772", "r7725"] # only r-tags as combining with s-tags
defaultRecoTags = ["r7772", "r7725", "a818", "a821"] # for AF-II, enable this line
defaultDerivationTags = ["p2622", "p2623", "p2613", "p2614"] # in order of priority (in case several are available)
...
def main():
    ...
    for dsid in dsids:
        ...
        samples[dsid] = getSamplesFromPattern(dsid.strip(), args.projectTag, defaultSimTags, defaultRecoTags, args.verbose, args.format, defaultDerivationTags)
