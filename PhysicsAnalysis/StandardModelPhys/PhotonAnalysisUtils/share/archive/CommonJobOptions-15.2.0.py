...
CBNT_AthenaAware.PAUanalysis.EgDetailContainerName = PhotonsDetailsContainerName
...
# moved to PAUhybridPrimaryVertexTool CBNT_AthenaAware.PAUanalysis.ExtrapolationTool=theAtlasExtrapolator
...
#CBNT_AthenaAware.PAUanalysis.VertexFitterTool = InDetConversionVxFitterTool
...
NewTrackIsolationTool = TrackIsolationTool(
    ...
    InnerCone                = 0.1,
    PtMaxInnerCone           = 15000,
    UseInnerConeTrkSelection = True,
    TrackParticleCollection  = "TrackParticleCandidate",
    ConversionContainer      = "ConversionCandidate",
    CaloCellContainer        = "AllCalo", # ESD: "AllCalo", AOD: "AODCellContainer"
