...
#ifndef SAMPLE_HANDLER__DISK_LIST_LOCAL_H
#define SAMPLE_HANDLER__DISK_LIST_LOCAL_H
...
namespace SH
{
  /// \brief a DiskList implementation for local directories
  class DiskListLocal : public DiskList
  {
    //
    // public interface
    //
  ...
  private:
    ...
    /// \brief the directory pointer used
  private:
    void *m_dirp;

    /// \brief the file we last fetched
  private:
    std::string m_file;
  };
}
