...
// Constructor
//=============================================================================
D2PDPhotonSelector::D2PDPhotonSelector( const std::string& name,
                                        ISvcLocator* pSvcLocator ) :
  D2PDSelectorBase< Analysis::Photon, PhotonContainer >( name, pSvcLocator ),
  m_clusterKinSelectorTool( "KinematicSelector/ClusterKinematicSelectorForPhotonSelector", this ),
  m_clusterCaloLayerKinSelectorTool( "KinematicSelector/ClusterEMCaloLayerKinematicSelectorForPhotonSelector", this ),
  m_trackKinSelectorTool( "KinematicSelector/TrackKinematicSelectorForPhotonSelector", this ),
  m_doIsEM(false),
  m_idxIsEM(0),
  m_doPassID(false),
  m_idxPassID(0),
  ...
  m_tmp4Mom(0)
{
  ...
  declareProperty("clusterEMCaloLayerKinematicSelectorTool",
  ...
  declareProperty("photonIsEM",           m_isEM=0,    "Photon IsEM" );
  m_isEM.declareUpdateHandler( &D2PDPhotonSelector::setupIsEM, this );

  declareProperty("photonID",             m_passID=-1, "Photon egamma ID quality" );
  m_passID.declareUpdateHandler( &D2PDPhotonSelector::setupPassID, this );

  declareProperty("photonAuthor",         m_author=0,  "Photon author bitmask" );
  m_author.declareUpdateHandler( &D2PDPhotonSelector::setupAuthor, this );

  declareProperty("photonAcceptAuthorList",  m_acceptAuthorList,  "EGamma author list for accept (logical OR combination)" );
  declareProperty("photonRequireAuthorList", m_requireAuthorList, "EGamma author list for require (logical AND combination)" );
  declareProperty("photonVetoAuthorList",    m_vetoAuthorList,    "EGamma author list for veto (logical NOT combination)" );



  declareProperty("uncombinedEtMin",         m_uncombinedEtMin=-DBL_MAX, "Uncombined min E_T" );
  m_uncombinedEtMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedEt, this );
  declareProperty("uncombinedEtMax",         m_uncombinedEtMax=DBL_MAX,  "Uncombined max E_T" );
  m_uncombinedEtMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedEt, this );

  declareProperty("uncombinedEMin",          m_uncombinedEMin=-DBL_MAX,  "Uncombined min E" );
  m_uncombinedEMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedE, this );
  declareProperty("uncombinedEMax",          m_uncombinedEMax=DBL_MAX,   "Uncombined max E" );
  m_uncombinedEMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedE, this );

  declareProperty("uncombinedEtaMin",        m_uncombinedEtaMin=-DBL_MAX, "Uncombined min eta" );
  m_uncombinedEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedEta, this );
  declareProperty("uncombinedEtaMax",        m_uncombinedEtaMax=DBL_MAX,  "Uncombined max eta" );
  m_uncombinedEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedEta, this );

  declareProperty("uncombinedAbsEtaMin",     m_uncombinedAbsEtaMin=-DBL_MAX, "Uncombined min |eta|" );
  m_uncombinedAbsEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedAbsEta, this );
  declareProperty("uncombinedAbsEtaMax",     m_uncombinedAbsEtaMax=DBL_MAX,  "Uncombined max |eta|" );
  m_uncombinedAbsEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedAbsEta, this );

  declareProperty("uncombinedPhiMin",        m_uncombinedPhiMin=-DBL_MAX, "Uncombined min phi" );
  m_uncombinedPhiMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedPhi, this );
  declareProperty("uncombinedPhiMax",        m_uncombinedPhiMax=DBL_MAX,  "Uncombined max phi" );
  m_uncombinedPhiMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedPhi, this );

  declareProperty("uncombinedMassMin",       m_uncombinedMassMin=-DBL_MAX, "Uncombined min mass" );
  m_uncombinedMassMin.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedMass, this );
  declareProperty("uncombinedMassMax",       m_uncombinedMassMax=DBL_MAX,  "Uncombined max mass" );
  m_uncombinedMassMax.declareUpdateHandler( &D2PDPhotonSelector::setupUncombinedMass, this );


  declareProperty("clusterEtMin",         m_clusterEtMin=-DBL_MAX, "Cluster min E_T" );
  m_clusterEtMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterEt, this );
  declareProperty("clusterEtMax",         m_clusterEtMax=DBL_MAX,  "Cluster max E_T" );
  m_clusterEtMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterEt, this );

  declareProperty("clusterEMin",          m_clusterEMin=-DBL_MAX,  "Cluster min E" );
  m_clusterEMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterE, this );
  declareProperty("clusterEMax",          m_clusterEMax=DBL_MAX,   "Cluster max E" );
  m_clusterEMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterE, this );

  declareProperty("clusterEtaMin",        m_clusterEtaMin=-DBL_MAX, "Cluster min eta" );
  m_clusterEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterEta, this );
  declareProperty("clusterEtaMax",        m_clusterEtaMax=DBL_MAX,  "Cluster max eta" );
  m_clusterEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterEta, this );

  declareProperty("clusterAbsEtaMin",     m_clusterAbsEtaMin=-DBL_MAX, "Cluster min |eta|" );
  m_clusterAbsEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterAbsEta, this );
  declareProperty("clusterAbsEtaMax",     m_clusterAbsEtaMax=DBL_MAX,  "Cluster max |eta|" );
  m_clusterAbsEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterAbsEta, this );

  declareProperty("clusterEtaVetoRanges", m_clusterEtaVetoRanges="", "Cluster eta-ranges to veto" );
  m_clusterEtaVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupClusterEtaVeto, this );

  declareProperty("clusterPhiMin",        m_clusterPhiMin=-DBL_MAX, "Cluster min phi" );
  m_clusterPhiMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterPhi, this );
  declareProperty("clusterPhiMax",        m_clusterPhiMax=DBL_MAX,  "Cluster max phi" );
  m_clusterPhiMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterPhi, this );

  declareProperty("clusterPhiVetoRanges", m_clusterPhiVetoRanges="", "Cluster phi-ranges to veto" );
  m_clusterPhiVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupClusterPhiVeto, this );

  declareProperty("clusterMassMin",       m_clusterMassMin=-DBL_MAX, "Cluster min mass" );
  m_clusterMassMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterMass, this );
  declareProperty("clusterMassMax",       m_clusterMassMax=DBL_MAX,  "Cluster max mass" );
  m_clusterMassMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterMass, this );
  ...
  m_clusterCaloLayerEMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerE, this );
  declareProperty("clusterEMCaloLayerEMax",          m_clusterCaloLayerEMax=DBL_MAX,
                  "Cluster max E in specific EM calorimeter layer" );
  m_clusterCaloLayerEMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerE, this );
  ...
  m_clusterCaloLayerEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerEta, this );
  ...
  m_clusterCaloLayerEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerEta, this );

  declareProperty("clusterEMCaloLayerAbsEtaMin",     m_clusterCaloLayerAbsEtaMin=-DBL_MAX,
                  "Cluster min |eta| in specific EM calorimeter layer" );
  m_clusterCaloLayerAbsEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerAbsEta, this );
  declareProperty("clusterEMCaloLayerAbsEtaMax",     m_clusterCaloLayerAbsEtaMax=DBL_MAX,
                  "Cluster max |eta| in specific EM calorimeter layer" );
  m_clusterCaloLayerAbsEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerAbsEta, this );
  ...
  m_clusterCaloLayerEtaVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerEtaVeto, this );
  ...
  m_clusterCaloLayerPhiMin.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerPhi, this );
  ...
  m_clusterCaloLayerPhiMax.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerPhi, this );
  ...
  m_clusterCaloLayerPhiVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupClusterLayerPhiVeto, this );



  declareProperty("trackPtMin",         m_trackPtMin=-DBL_MAX, "Track min P_T" );
  m_trackPtMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackPt, this );
  declareProperty("trackPtMax",         m_trackPtMax=DBL_MAX,  "Track max P_T" );
  m_trackPtMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackPt, this );

  declareProperty("trackPMin",          m_trackPMin=-DBL_MAX,  "Track min P" );
  m_trackPMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackP, this );
  declareProperty("trackPMax",          m_trackPMax=DBL_MAX,   "Track max P" );
  m_trackPMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackP, this );

  declareProperty("trackEtaMin",        m_trackEtaMin=-DBL_MAX, "Track min eta" );
  m_trackEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackEta, this );
  declareProperty("trackEtaMax",        m_trackEtaMax=DBL_MAX,  "Track max eta" );
  m_trackEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackEta, this );

  declareProperty("trackAbsEtaMin",     m_trackAbsEtaMin=-DBL_MAX, "Track min |eta|" );
  m_trackAbsEtaMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackAbsEta, this );
  declareProperty("trackAbsEtaMax",     m_trackAbsEtaMax=DBL_MAX,  "Track max |eta|" );
  m_trackAbsEtaMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackAbsEta, this );

  declareProperty("trackEtaVetoRanges", m_trackEtaVetoRanges="", "Track eta-ranges to veto" );
  m_trackEtaVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupTrackEtaVeto, this );

  declareProperty("trackPhiMin",        m_trackPhiMin=-DBL_MAX, "Track min phi" );
  m_trackPhiMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackPhi, this );
  declareProperty("trackPhiMax",        m_trackPhiMax=DBL_MAX,  "Track max phi" );
  m_trackPhiMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackPhi, this );

  declareProperty("trackPhiVetoRanges", m_trackPhiVetoRanges="", "Track phi-ranges to veto" );
  m_trackPhiVetoRanges.declareUpdateHandler( &D2PDPhotonSelector::setupTrackPhiVeto, this );

  declareProperty("trackMassMin",       m_trackMassMin=-DBL_MAX, "Track min mass" );
  m_trackMassMin.declareUpdateHandler( &D2PDPhotonSelector::setupTrackMass, this );
  declareProperty("trackMassMax",       m_trackMassMax=DBL_MAX,  "Track max mass" );
  m_trackMassMax.declareUpdateHandler( &D2PDPhotonSelector::setupTrackMass, this );
...
// Destructor
//=============================================================================
D2PDPhotonSelector::~D2PDPhotonSelector()
{
}
...
//=============================================================================
StatusCode D2PDPhotonSelector::initializeMore()
{
  ...
  if ( m_printSetup || msgLvl(MSG::DEBUG) )
    {
      ...
      ATH_MSG_INFO ( " using photonIsEM                      = " << m_isEM );
      ATH_MSG_INFO ( " using photonID                        = " << m_passID );
      ATH_MSG_INFO ( " using photonAuthor                    = " << m_author );

      ATH_MSG_INFO ( " using photonAcceptAuthorList          = " << m_acceptAuthorList  );
      ATH_MSG_INFO ( " using photonRequireAuthorList         = " << m_requireAuthorList );
      ATH_MSG_INFO ( " using photonVetoAuthorList            = " << m_vetoAuthorList    );
...
//=============================================================================
StatusCode D2PDPhotonSelector::processObject( const Analysis::Photon* photon,
                                              bool &isPassed )
{
  // Make sure we have a photon
  if ( photon )
    {
      //--------------------------
      // Do the selections
      ...
      // Photon author selection
      if ( isPassed && m_doAuthor && m_author != 0 )
        {
          isPassed = ( photon->author(m_author) == true );
          if ( isPassed && m_printInternalCutflow ) { m_objCutFlow[m_idxAuthor] += 1; }
        }

      // Photon author accept list selection
      ...
      if ( isPassed && m_doVetoAuthorList )
        {
          ...
          for ( ; vetoItr != vetoItrEnd; ++vetoItr )
            {
              passVeto = passVeto || ( photon->author((*vetoItr)) == true );
      ...
      if ( m_doCaloEtIso || m_doAbsCaloEtIso
        ...
        {
          emshower = photon->detail<EMShower>(m_egammaDetailKey);
        }
      ...
      //----------------------------------------------------------
      const egamma::momentum_type& uncombined = photon->get4Mom(egamma::Uncombined);
      ...
      //----------------------------------------------------------
      // Get the cluster for this photon
      //----------------------------------------------------------
  ...
  else
    {
      // Return false 
      isPassed = false;
      ATH_MSG_WARNING ( "Could not dynamic_cast to an photon!" );
    } // End: if/else have photon
...
//=============================================================================
StatusCode D2PDPhotonSelector::finalizeMore()
{  
