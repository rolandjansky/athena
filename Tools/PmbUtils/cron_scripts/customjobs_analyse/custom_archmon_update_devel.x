...
targetdir=/afs/cern.ch/atlas/project/pmb/archive/custom_webcache/pages_custom_devel && \
...
python /afs/cern.ch/atlas/project/pmb/rtt-mon/PmbUtils/cron_scripts/customjobs_analyse/custom_archmon.py $tmpdir verbose $* && \
touch $targetdir_tmp && \
