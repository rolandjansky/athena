...
#
# $Id: makeTrfJSONSignatures.py 634639 2014-12-09 08:56:18Z graemes $
#
...
def main():
    ...
    msg.info('Successfully generated signature file "%s" for transforms %s' % (cliargs['output'], processedTrfs))
    sys.exit(0)
