...
if 'userRunLumiOverride' in dir():
    ...
    protectedInclude('RunDependentSimData/configLumi_run310000.py')

from Digitization.DigitizationFlags import digitizationFlags
digitizationFlags.numberOfLowPtMinBias = 99.2404608
digitizationFlags.numberOfHighPtMinBias = 0.2595392
