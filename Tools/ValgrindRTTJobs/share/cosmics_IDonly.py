...
runArgs.preExec = ['rec.doCalo=False', 'rec.doInDet=True', 'rec.doMuon=False', 'rec.doJetMissingETTag=False', 'rec.doEgamma=False', 'rec.doMuonCombined=False', 'rec.doTau=False', 'rec.doTrigger=False', 'rec.doPerfMon=False']
