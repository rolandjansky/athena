...
runArgs.preExec = ['rec.doCalo=False', 'rec.doInDet=False', 'rec.doMuon=True', 'rec.doJetMissingETTag=False', 'rec.doEgamma=False', 'rec.doMuonCombined=False', 'rec.doTau=False', 'rec.doTrigger=False', 'rec.doPerfMon=False']
