...
double
findModeGlobal(double, int, const std::array<std::vector<Mixture>, 5>& mixture);

double
width(int i, const std::array<std::vector<Mixture>, 5>& mixture);
