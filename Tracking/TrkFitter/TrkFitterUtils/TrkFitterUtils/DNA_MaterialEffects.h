...
#include "TrkSurfaces/Surface.h" // for msg overload
...
namespace Trk{
  ...
  */
  ...
  public:
    ...
    //! copy constructor
    DNA_MaterialEffects( const DNA_MaterialEffects& dmef);
    //! default desctructor
    ~DNA_MaterialEffects();
  ...
  MsgStream& operator << ( MsgStream& sl, const DNA_MaterialEffects& dme);
  //! Overload of << operator for std::ostream for debug output
  std::ostream& operator << ( std::ostream& sl, const DNA_MaterialEffects& dme);

  inline double DNA_MaterialEffects::xmin() const
  { return m_xmin; }
  inline double DNA_MaterialEffects::dxmin() const
  { return m_dxmin; }
  inline double DNA_MaterialEffects::chi2min() const
  { return m_chi2min; }
  inline double DNA_MaterialEffects::thicknessInX0() const
  { return m_thickness; }
  inline double DNA_MaterialEffects::sigmaDNA() const
  { return m_sigmaDNA; }
  ...
  { return m_deltaP; }
  inline double DNA_MaterialEffects::sigmaDeltaP() const
  { return m_sigmaDeltaP; }
  inline bool   DNA_MaterialEffects::foundByForwardFilter() const
