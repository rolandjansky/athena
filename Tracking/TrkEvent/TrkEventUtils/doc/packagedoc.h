...
Note that the event data primitives, which formerly had also been part of this
package, have been moved to a separate location, TrkEventPrimitives, with release 10.4.0.
