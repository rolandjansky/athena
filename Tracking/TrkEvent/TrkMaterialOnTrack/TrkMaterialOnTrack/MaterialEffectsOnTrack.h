...
class MaterialEffectsOnTrack : public MaterialEffectsBase
 ...
 public:
   ...
   */
   ...
   /** @brief returns the energy loss object. Careful: DO NOT DELETE!
              Pointer may be NULL if no E loss but only scattering angles are contained. */
 ...
 private:
   ...
   const EnergyLoss* m_energyLoss;
};

}//end of Trk ns

inline const Trk::ScatteringAngles* Trk::MaterialEffectsOnTrack::scatteringAngles() const
{
  return m_scatteringAngles;
}

inline const Trk::EnergyLoss* Trk::MaterialEffectsOnTrack::energyLoss() const
{
  return m_energyLoss;
}

inline Trk::MaterialEffectsOnTrack* Trk::MaterialEffectsOnTrack::clone() const
