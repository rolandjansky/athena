...
- Trk::AtaCone            : contains the parameters on a cone surfaces, defined as \f$(locphi, locZ, \phi, \theta, q/p)\f$
- Trk::AtaCylinder        : contains the parameters on a cylinder, defined as \f$(locR\phi, locZ, \phi, \theta, q/p)\f$
- Trk::AtaDisc            : contains the parameters on a disc, defined as \f$(locR, locPhi, \phi, \theta, q/p)\f$
- Trk::AtaPlane           : contains the parameters on an arbitrary oriented plane, defined as \f$(R\phi, z, \phi, \theta, q/p)\f$
- Trk::AtaStraightLine    : contains the parameters at a straight line, defined as \f$(locR, locZ, \phi, \theta, q/p)\f$
- Trk::Perigee            : contains the perigee parameters, defined as \f$(d_0, z_0, \phi_0, \theta, q/p)\f$
