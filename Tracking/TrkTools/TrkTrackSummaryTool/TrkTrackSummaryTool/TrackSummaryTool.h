    ...
    public:
      ...
      virtual void updateAdditionalInfo(Track& track, const Trk::PRDtoTrackMap *prd_to_track_map) const override {
         if (!track.trackSummary()) {
            ...
            updateAdditionalInfo(track,prd_to_track_map,*track.trackSummary(),true); // @TODO set to false; true for backward compatibility
         }
      }
       ...
       */
      virtual void updateSharedHitCount(const Track& track, const Trk::PRDtoTrackMap *prd_to_track_map,TrackSummary &summary) const override;
       ...
       */
      virtual void updateAdditionalInfo(const Track& track, const Trk::PRDtoTrackMap *prd_to_track_map, TrackSummary &summary) const override {
      ...
      virtual void updateAdditionalInfo(Track& track) const override {
         if (!track.trackSummary()) {
            ...
            updateAdditionalInfo(track,nullptr,*track.trackSummary(),true); // @TODO set to false; true for backward compatibility
         }
      }

    private:
      void updateAdditionalInfo(const Track& track, const Trk::PRDtoTrackMap *prd_to_track_map, TrackSummary &summary, bool initialise_to_zero) const;
