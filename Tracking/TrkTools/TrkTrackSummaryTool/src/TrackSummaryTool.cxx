  ...
  Trk::TrackSummaryTool::initialize()
{
  ...
  // Troels.Petersen@cern.ch:
    ...
    int nCompPixelVar = 2;
    if ( m_geometryType == "BrlIncl4.0_ref" || m_geometryType == "IBrlExt4.0ref" || m_geometryType == "BrlInclOptRing4.0_ref" || "Inclined_Quads" == m_geometryType || "Inclined_Alternative" == m_geometryType || "Inclined_LightBarrel" == m_geometryType || "Inclined_Duals" == m_geometryType ) nCompPixelVar = 3;
    ...
    if (m_geometryType == "BrlInclOptRing4.0_ref") {
      ...
      pixel[0][2] = 16+1; pixel[1][2] = 13+1; pixel[2][2] =  8+1; pixel[3][2] = 10+1; pixel[4][2] = 11+1; //incl 
      ...
      pixel[0][1] = 4+1; pixel[1][1] = 11+1; pixel[2][1] =  10+1; pixel[3][1] = 8+1; pixel[4][1] = 9+1; //rings
      pixel[0][2] = 16+1; pixel[1][2] = 13+1; pixel[2][2] =  11+1; pixel[3][2] = 13+1; pixel[4][2] = 13+1; //incl 
    }
...
const Trk::TrackSummary* Trk::TrackSummaryTool::createSummary( const Track& track, bool onlyUpdateTrack ) const
{
  ...
  if(m_isITkLayout){ 
    ...
    if ( m_geometryType == "BrlIncl4.0_ref" || m_geometryType == "IBrlExt4.0ref" || m_geometryType == "BrlInclOptRing4.0_ref" || "Inclined_Quads" == m_geometryType || "Inclined_Alternative" == m_geometryType || "Inclined_LightBarrel" == m_geometryType || "Inclined_Duals" == m_geometryType ) {
