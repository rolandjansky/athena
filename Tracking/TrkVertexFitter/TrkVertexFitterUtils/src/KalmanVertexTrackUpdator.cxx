...
//updator-related stuff  
 ...
 void KalmanVertexTrackUpdator::update(VxTrackAtVertex& trk, const RecVertex& vtx) const
 {
...
//this operation invokes removing of the track from the vertex
  ...
  RecVertex reducedVrt = m_Updator->positionUpdate(vtx,linTrack,trk.weight(),-1);
