  ...
  */
  ...
  public:
    ...
    virtual xAOD::Vertex * fit(const std::vector<const TrackParameters*> & perigeeList,
                               ...
                               const Amg::Vector3D& startingPoint) const override
    {msg(MSG::WARNING) << "FastVertexFitter::fit(fit(const std::vector<const TrackParameters*>&,const std::vector<const Trk::NeutralParameters*>&,const Amg::Vector3D&) ignoring neutrals" << endmsg; return fit(perigeeList, startingPoint);};
    ...
    virtual xAOD::Vertex * fit(const std::vector<const TrackParameters*> & perigeeList,
                               const std::vector<const Trk::NeutralParameters*> & /*neutralPerigeeList*/,
                               const xAOD::Vertex& constraint) const override
    {msg(MSG::WARNING) << "FastVertexFitter::fit(fit(const std::vector<const TrackParameters*>&,const std::vector<const Trk::NeutralParameters*>&,const xAOD::Vertex&) ignoring neutrals" << endmsg; return fit(perigeeList, constraint);};
    ...
    */
    ...
    virtual xAOD::Vertex * fit(const std::vector<const TrackParameters*>& perigeeList,const std::vector<const Trk::NeutralParameters*> & /*neutralPerigeeList*/) const override
    {msg(MSG::WARNING) << "FastVertexFitter::fit(fit(const std::vector<const TrackParameters*>&,const std::vector<const Trk::NeutralParameters*>&) ignoring neutrals" << endmsg; return fit(perigeeList);};
    ...
    virtual xAOD::Vertex * fit(const std::vector<const xAOD::TrackParticle*>& vectorTrk,
                               ...
                               const Amg::Vector3D& startingPoint) const override
    {msg(MSG::WARNING) << "FastVertexFitter::fit(fit(const std::vector<const TrackParticle*>&,const std::vector<const Trk::NeutralParticle*>&,const Amg::Vector3D&) ignoring neutrals" << endmsg; return fit(vectorTrk, startingPoint);}; 
    ...
    virtual xAOD::Vertex * fit(const std::vector<const xAOD::TrackParticle*>& vectorTrk, 
                               const std::vector<const xAOD::NeutralParticle*>& /*vectorNeut*/, 
                               const xAOD::Vertex& constraint) const override
    {msg(MSG::WARNING) << "FastVertexFitter::fit(fit(const std::vector<const TrackParticle*>&,const std::vector<const Trk::NeutralParticle*>&,const xAOD::Vertex&) ignoring neutrals" << endmsg; return fit(vectorTrk, constraint);}; 
