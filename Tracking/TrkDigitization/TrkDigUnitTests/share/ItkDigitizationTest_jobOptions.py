...
# Display test 
DigitizationModuleTest.BinsX                  = 336
...
DigitizationModuleTest.ModuleHalfThickness    = 0.075
DigitizationModuleTest.ModuleReadoutDirection = -1
DigitizationModuleTest.LorentzAngle           = -0.1714
...
# smearing and cut off
DigitizationModuleTest.SmearingMode           = 0
DigitizationModuleTest.SmearingSigma          = 0.
DigitizationModuleTest.PathCutOff             = 0.  
# number of tests                             
