...
void EfficiencyPurityCalculator::inverseSum( TH1* in, TH1* out, int axis ){
...
void EfficiencyPurityCalculator::calculateIntegrated( TH1* all, TH1* matched, TH1* puri,int axis, int /*dim*/) {
...
void EfficiencyPurityCalculator::calculateEfficiency( TH1* reference, TH1* matched, TH1* effPur ) {
  effPur->Add(matched);
  effPur->Sumw2();
