...
void RecoInfoPlots::initializePlots(){
  ...
  trackfitndof = Book1D("tndof"+m_sType,m_sType+" Track fit ndof;Number of degrees of freedom;Entries",101,-0.5,100.5);
  trackcon     = Book1D("chi2ndof"+m_sType,m_sType+" Track fit chi2/ndof;Track fit chi2/ndof;Entries", 100, 0, 5);
  trackchi2prob= Book1D("chi2prob"+m_sType,m_sType+" Track fit chi2 probability;Track fit p(#chi^2);Entries", 20, 0., 1.);
}
