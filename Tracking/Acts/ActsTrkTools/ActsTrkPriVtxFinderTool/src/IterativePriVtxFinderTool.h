...
#define ACTSTRKPRIVTXFINDERTOOL_ITERATIVEPRIVTXFINDERTOOL_H
...
namespace ActsTrk {
  class IterativePriVtxFinderTool : public extends<AthAlgTool, InDet::IVertexFinder>
  {
...
#endif // ACTSTRKPRIVTXFINDERTOOL_ITERATIVEPRIVTXFINDERTOOL_H
