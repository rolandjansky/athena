...
pool::Guid PRD_MultiTruthCollectionCnv::p4_guid("146138A6-2314-498F-80A7-2347C9822981");
...
PRD_MultiTruthCollectionPERS* PRD_MultiTruthCollectionCnv::createPersistent(PRD_MultiTruthCollection* trans) {
  ...
  log<<MSG::DEBUG<<"Writing PRD_MultiTruthCollection_p4"<<endreq;
...
PRD_MultiTruthCollection* PRD_MultiTruthCollectionCnv::createTransient() {
  ...
  if (compareClassGuid(p4_guid)) {
    log<<MSG::DEBUG<<"Read PRD_MultiTruthCollection_p4. GUID="<<m_classID.toString()<<endreq;
