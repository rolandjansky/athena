...
void TrackTruthCollectionCnv_p2::persToTrans( const Trk::TrackTruthCollection_p2* pers,
                                              ...
                                              MsgStream& msg )
{
  msg<<MSG::DEBUG<<"TrackTruthCollectionCnv_p2::persToTrans(): PERS size = "<<pers->m_entries.size()<<endreq;
  ...
  msg<<MSG::DEBUG<<"TrackTruthCollectionCnv_p2::persToTrans() DONE"<<endreq;
}
...
void TrackTruthCollectionCnv_p2::transToPers( const TrackTruthCollection* trans,
                                              ...
                                              MsgStream& msg )
{
  msg<<MSG::DEBUG<<"TrackTruthCollectionCnv_p2::transToPers()"<<endreq;
  msg<<MSG::DEBUG<<"TrackTruthCollectionCnv_p2::transToPers(): input size = "<<trans->size()<<endreq;
  ...
  msg<<MSG::DEBUG<<"TrackTruthCollectionCnv_p2::transToPers() DONE"<<endreq;
}
