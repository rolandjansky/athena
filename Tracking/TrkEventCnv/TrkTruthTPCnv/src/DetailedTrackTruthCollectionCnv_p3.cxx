...
void DetailedTrackTruthCollectionCnv_p3::transToPers( const DetailedTrackTruthCollection* trans,
                                                      ...
                                                      MsgStream& msg )
{
  msg<<MSG::DEBUG<<"DetailedTrackTruthCollectionCnv_p3::transToPers()"<<endreq;
  msg<<MSG::DEBUG<<"DetailedTrackTruthCollectionCnv_p3::transToPers(): input size = "<<trans->size()<<endreq;
  ...
  msg<<MSG::DEBUG<<"DetailedTrackTruthCollectionCnv_p3::transToPers() DONE"<<endreq;
}
