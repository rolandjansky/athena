...
//-----------------------------------------------------------------------------
void TrackCnv_p2::persToTrans( const Trk::Track_p1 *persObj,
			       Trk::Track    *transObj,
			       MsgStream       &log )
{
...
//-----------------------------------------------------------------------------
void TrackCnv_p2::transToPers( const Trk::Track    *,
			       Trk::Track_p1 *,
			       MsgStream       & )
{
  throw std::runtime_error("TrackCnv_p2::transToPers is deprecated!");   
}
