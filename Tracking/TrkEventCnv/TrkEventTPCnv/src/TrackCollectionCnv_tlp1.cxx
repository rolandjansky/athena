...
TrackCollectionCnv_tlp1::TrackCollectionCnv_tlp1( )
{
   ...
   addTPConverterForReading( &m_scatterAnglesCnv );            
   ...
   addTPConverterForReading( &m_materialEffectsCnv );       
...
void TrackCollectionCnv_tlp1::setPStorage( Trk::TrackCollection_tlp1 *storage )
{
   // for implicit TrackCollection_p1 from the base class:
     ...
     m_scatterAnglesCnv.            setPStorage( &storage->m_scatterAngles );            
