...
// initialize
StatusCode Trk::NIMatEffUpdator::initialize()
{
    ...
    } else ATH_MSG_DEBUG( "Successfully retrieved " << m_matUpdator );

    return StatusCode::SUCCESS;
}

// finalize
StatusCode Trk::NIMatEffUpdator::finalize()
{
...
const Trk::TrackParameters* Trk::NIMatEffUpdator::update(const Trk::TrackParameters* parm,
							 const Trk::Layer& lay,
...
// update method
const Trk::TrackParameters* Trk::NIMatEffUpdator::update(double /*time*/,
