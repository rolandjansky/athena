...
/**
 ...
 the actual implementation class TimedExtrapolator which inherits from this one.
...
public:
  ...
  /** Extrapolation method allowing treatment of unstable particles. Search of
     intersections with active surfaces on demand. The extrapolation is
     interrupted at subdetector boundary for surviving/stable particles. */
  ...
  /** Transport method for neutral and/or unstable particles. Search of
     intersections with active surfaces/layers on demand. The extrapolation is
     interrupted at subdetector boundary for surviving/stable particles.
  */

  virtual std::unique_ptr<const Trk::TrackParameters> transportNeutralsWithPathLimit(
    const Trk::TrackParameters& parm,
    Trk::PathLimit& pathLim,
    Trk::TimeLimit& time,
    Trk::PropDirection dir,
