...
public:
  ...
  GeometrySignature
    nextGeometrySignature; //!< when a boundary is reached the geometry
                           //!< signature is updated to the next volume one
  ...
  ParticleHypothesis
    pHypothesis; //!< what particle hypothesis to be used, default : pion
  MagneticFieldProperties
    mFieldMode; //!< what magnetic field mode to be used, default : fullField
  ...
  /** fill or attach the parameters from a step - memory management steered by
