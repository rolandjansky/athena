...
namespace Trk {
  ...
  chamber shifts used to plot chi2 as a function of alignment parameter. */
    void setNChamberShifts(int nShifts) { m_nChamberShifts = nShifts; }
    int  nChamberShifts() const { return m_nChamberShifts; }

    /** Used only for numerical derivatives to get chi2 as a function of 
  alignment parameters */
    void     setChi2VAlignParamArray(double** chi2VAlignParam) { m_chi2VAlignParam = chi2VAlignParam; }
    double** chi2VAlignParamArray() const { return m_chi2VAlignParam; }

    /** sets the values of chamber shifts in array */
    void     setChi2VAlignParamXArray(double** chi2VAlignParamX) { m_chi2VAlignParamX = chi2VAlignParamX; }
    ...
    void     setChi2VAlignParamArrayMeasType(int measType, double** chi2VAlignParam) { m_chi2VAlignParamMeasType[measType]=chi2VAlignParam; }
    ...
    void addTrack(int ntracks=1) { m_ntracks+=ntracks; }
    ...
    void addTrackChi2(double chi2) { m_trackchi2+=chi2; }
    double trackChi2() const { return m_trackchi2; }
    void setTrackChi2(double chi2) { m_trackchi2=chi2; }

    /** Increments and returns number of hits in align module */
    void addHit(int nhits=1) { m_nhits+=nhits; }
    ...
    void addNDoF(int nDoF) { m_nDoF+=nDoF; }
  ...
  private:
    ...
    int m_ntracks; // number of tracks going through module
    int m_nhits;   // number of hits in the module
