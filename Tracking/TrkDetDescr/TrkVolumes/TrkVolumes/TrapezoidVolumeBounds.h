...
#undef double
 ...
 inline double TrapezoidVolumeBounds::minHalflengthX() const { return m_minHalfX; }
 inline double TrapezoidVolumeBounds::maxHalflengthX() const { return m_maxHalfX; } 
...
inline const ObjectAccessor& TrapezoidVolumeBounds::boundarySurfaceAccessor(const Amg::Vector3D&,
                                                        const Amg::Vector3D&,
                                                        bool) const
