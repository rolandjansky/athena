...
namespace Trk {
  ...
  /**
   ...
   Trk::VolumeBounds are a set of up to six confining Surfaces that are stored in a std::vector.
   Each type of Trk::VolumeBounds has to implement a decomposeToSurfaces() and a inside() method.
