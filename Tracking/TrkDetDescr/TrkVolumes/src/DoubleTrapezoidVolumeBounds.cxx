...
const std::vector<const Trk::Surface*>*
  ...
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(transform * Amg::Translation3D(Amg::Vector3D(
                                           0., 0., this->halflengthZ()))),
      this->faceXYDiamondBounds()));
  // face surfaces yz
  // transmute cyclical
  //   (3) - at point A, attached to alpha opening angle
  Amg::Vector3D A(diamondCenter - this->minHalflengthX() * diamondX -
  ...
  Amg::Vector3D faceAlpha1Position(A + alpha1Rotation.col(0) *
                                           faceAlpha1Bounds->halflengthX());
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(alpha1Rotation *
                           Amg::Translation3D(faceAlpha1Position)),
      faceAlpha1Bounds));
  //   (4) - at point B, attached to beta opening angle
  Amg::Vector3D B(diamondCenter + this->minHalflengthX() * diamondX -
                  2 * this->halflengthY1() * diamondY);
  ...
  Amg::Vector3D faceBeta1Position(B + beta1Rotation.col(0) *
                                          faceBeta1Bounds->halflengthX());
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(beta1Rotation *
                           Amg::Translation3D(faceBeta1Position)),
      faceBeta1Bounds));
  // face surfaces yz
  // transmute cyclical
  //   (5) - at point A', attached to alpha opening angle
  Amg::Vector3D AA(diamondCenter - this->maxHalflengthX() * diamondX +
  ...
  Amg::Vector3D faceAlpha2Position(AA + alpha2Rotation.col(0) *
                                            faceAlpha2Bounds->halflengthX());
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(alpha2Rotation *
                           Amg::Translation3D(faceAlpha2Position)),
      faceAlpha2Bounds));
  //   (6) - at point B', attached to beta opening angle
  Amg::Vector3D BB(diamondCenter + this->maxHalflengthX() * diamondX +
                   2 * this->halflengthY2() * diamondY);
  ...
  Amg::Vector3D faceBeta2Position(BB + beta2Rotation.col(0) *
                                           faceBeta2Bounds->halflengthX());
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(beta2Rotation *
                           Amg::Translation3D(faceBeta2Position)),
      faceBeta2Bounds));
  // face surfaces zx
  ...
  retsf->push_back(new Trk::PlaneSurface(
      new Amg::Transform3D(
          transform *
          Amg::AngleAxis3D(180. * Gaudi::Units::deg,
                           Amg::Vector3D(1., 0., 0.)) *
          Amg::Translation3D(Amg::Vector3D(0., 2 * this->halflengthY1(), 0.)) *
          Amg::AngleAxis3D(-90 * Gaudi::Units::deg, Amg::Vector3D(0., 1., 0.)) *
          Amg::AngleAxis3D(-90. * Gaudi::Units::deg,
                           Amg::Vector3D(1., 0., 0.))),
...
// faces in xy
Trk::DiamondBounds* Trk::DoubleTrapezoidVolumeBounds::faceXYDiamondBounds()
    const {
  return new Trk::DiamondBounds(m_minHalfX, m_medHalfX, m_maxHalfX, m_halfY1,
                                m_halfY2);
}
