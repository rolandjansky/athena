...
Trk::CylinderVolumeBoundaryAccessors::CylinderVolumeBoundaryAccessors()
{
  ...
  m_tubeAccessors[Trk::TubeRincreaseZincrease] =
    Trk::FourObjectsAccessor{ { Trk::tubeOuterCover,
                                Trk::positiveFaceXY,
                                Trk::negativeFaceXY,
                                Trk::tubeInnerCover },
                              false };
  ...
  m_tubeAccessors[Trk::TubeZincreaseRincrease] =
    Trk::FourObjectsAccessor{ { Trk::positiveFaceXY,
                                Trk::tubeOuterCover,
                                Trk::negativeFaceXY,
                                Trk::tubeInnerCover },
                              false };
  ...
  m_tubeAccessors[Trk::TubeZdecreaseRincrease] =
    Trk::FourObjectsAccessor{ { Trk::negativeFaceXY,
                                Trk::tubeOuterCover,
                                Trk::positiveFaceXY,
                                Trk::tubeInnerCover },
                              false };
  ...
  m_tubeAccessors[Trk::TubeRdecreaseZincrease] =
    Trk::FourObjectsAccessor{ { Trk::tubeInnerCover,
                                Trk::positiveFaceXY,
                                Trk::negativeFaceXY,
                                Trk::tubeOuterCover },
                              false };
  ...
  m_sectoralCylinderAccessors[Trk::StandardSectoralCylinder] =
    Trk::FiveObjectsAccessor{ Trk::negativeFaceXY,
                              Trk::positiveFaceXY,
                              Trk::tubeOuterCover,
                              Trk::tubeInnerCover,
                              4 };
