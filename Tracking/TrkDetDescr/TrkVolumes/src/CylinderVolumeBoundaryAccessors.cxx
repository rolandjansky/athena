  ...
  // the tube case
     //(A) non-inverse cases
      ...
      m_tubeAccessors[Trk::TubeRincreaseZincrease]
        = Trk::FourObjectsAccessor{{Trk::tubeOuterCover,Trk::positiveFaceXY,Trk::negativeFaceXY,Trk::tubeInnerCover},false};
      // RincreaseZdecrease = 1
      m_tubeAccessors[Trk::TubeRincreaseZdecrease]
        = Trk::FourObjectsAccessor{{Trk::tubeOuterCover,Trk::negativeFaceXY,Trk::positiveFaceXY,Trk::tubeInnerCover},false};
      // ZincreaseRincrease = 2
      m_tubeAccessors[Trk::TubeZincreaseRincrease]
        = Trk::FourObjectsAccessor{{Trk::positiveFaceXY,Trk::tubeOuterCover,Trk::negativeFaceXY,Trk::tubeInnerCover},false};
      // ZdecreaseRincrease = 3
      m_tubeAccessors[Trk::TubeZdecreaseRincrease]
        = Trk::FourObjectsAccessor{{Trk::negativeFaceXY,Trk::tubeOuterCover,Trk::positiveFaceXY,Trk::tubeInnerCover},false};
      //  RdecreaseZincrease = 4
      m_tubeAccessors[Trk::TubeRdecreaseZincrease]
        = Trk::FourObjectsAccessor{{Trk::tubeInnerCover,Trk::positiveFaceXY,Trk::negativeFaceXY,Trk::tubeOuterCover},false};
      // RdecreaseZdecrease = 5
      m_tubeAccessors[Trk::TubeRdecreaseZdecrease]
        = Trk::FourObjectsAccessor{{Trk::tubeInnerCover,Trk::negativeFaceXY,Trk::positiveFaceXY,Trk::tubeOuterCover},false};
      // ZincreaseRdecrease = 6
      m_tubeAccessors[Trk::TubeZincreaseRdecrease]
        = Trk::FourObjectsAccessor{{Trk::positiveFaceXY,Trk::tubeInnerCover,Trk::negativeFaceXY,Trk::tubeOuterCover},false};
      // ZdecreaseRdecrease = 7
      m_tubeAccessors[Trk::TubeZdecreaseRdecrease]
        = Trk::FourObjectsAccessor{{Trk::negativeFaceXY,Trk::tubeInnerCover,Trk::positiveFaceXY,Trk::tubeOuterCover},false};
    //(B) inverse cases
