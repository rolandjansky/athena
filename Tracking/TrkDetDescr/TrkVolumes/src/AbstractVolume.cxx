...
// Default constructor
Trk::AbstractVolume::AbstractVolume() : Volume(), m_boundarySurfaces(nullptr) {}
...
Trk::AbstractVolume::AbstractVolume(const Trk::AbstractVolume& vol)
    : Volume(vol), m_boundarySurfaces(nullptr) {}

// destructor
Trk::AbstractVolume::~AbstractVolume() { delete m_boundarySurfaces; }

// assignment operator
Trk::AbstractVolume& Trk::AbstractVolume::operator=(
    const Trk::AbstractVolume& vol) {
  if (this != &vol) {
    Volume::operator=(vol);
