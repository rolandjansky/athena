...
Trk::AnnulusBoundsPC::fromCartesian(const Trk::AnnulusBounds& annbo)
{
  ...
  double minR = annbo.m_boundValues[AnnulusBounds::bv_minR];
  double maxR = annbo.m_boundValues[AnnulusBounds::bv_maxR];
  double phi = annbo.m_boundValues[AnnulusBounds::bv_phi];
  double phiS = annbo.m_boundValues[AnnulusBounds::bv_phiS];
