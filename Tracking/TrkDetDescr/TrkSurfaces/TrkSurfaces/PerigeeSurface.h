...
namespace Trk {
  ...
  class PerigeeSurface : public Surface {
    ...
    public:
      ...
      /**Virtual constructor*/
      virtual PerigeeSurface* clone() const;
      ...
      virtual SurfaceType type() const { return Surface::Perigee; }
      ...
      */
      ...
      virtual bool isOnSurface(const Amg::Vector3D& glopo, BoundaryCheck bchk=true, double tol1=0., double tol2=0.) const;
      ...
      virtual const NoBounds& bounds() const;
        
      /** Return properly formatted class name for screen output */
      virtual std::string name() const { return "Trk::PerigeeSurface"; }
  ...
  inline SurfaceIntersection PerigeeSurface::straightLineIntersection(const Amg::Vector3D& pos, 
                                                                      const Amg::Vector3D& dir, 
                                                                      bool forceDir,
                                                                      Trk::BoundaryCheck) const
  {
       ...
       Amg::Vector3D        eb = Amg::Vector3D::UnitZ();
       // now go ahead
       ...
       if (fabs(denom)>10e-7){
          ...
          return Trk::SurfaceIntersection( (ma+lambda0*ea),lambda0, isValid );
       }
