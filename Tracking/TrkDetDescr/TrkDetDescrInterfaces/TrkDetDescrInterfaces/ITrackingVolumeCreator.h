...
namespace Trk {
  ...
  static const InterfaceID IID_ITrackingVolumeCreator("ITrackingVolumeCreator", 1, 0);
  ...
  class ITrackingVolumeCreator : virtual public IAlgTool {
    ...
    public:
      ...
      /** create a TrackingVolume* from a set of layers and (optional) parameters
          ...
          */
      virtual const TrackingVolume* createTrackingVolume(
      ...
      virtual const TrackingVolume* createTrackingVolume(
        ...
        */                                                      
      virtual const TrackingVolume* createGapTrackingVolume(
                                                      Material& matprop,
                                                      double loc1Min, double loc1Max,
                                                      double loc2Min, double loc2Max,
