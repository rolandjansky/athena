 ...
 */
/**
 * @file TileRecUtils/src/TileBeamElemDumper.cxx
 ...
 */
TileBeamElemDumper::TileBeamElemDumper (const std::string& name, ISvcLocator* svcloc)
 ...
 */
StatusCode TileBeamElemDumper::initialize()
{
...
StatusCode TileBeamElemDumper::execute (const EventContext& ctx) const
{
  ...
  SG::ReadHandle<TileBeamElemContainer> cont (m_contKey, ctx);

  fout << "TileBeamElemContainer/" << m_contKey.key() << " "
