  ...
  for (int j=0; j<nrOfLayers; j++)
    {
      ...
      G4LogicalVolume *scintillatorLayerV = new G4LogicalVolume(scintillatorLayer,scintillatorMaterial,"MuScintillatorLayer");
  ...
  for (int j=0; j<nScintLayers; j++)
    {
      ...
      G4LogicalVolume* scintillatorLayerV = new G4LogicalVolume(scintillatorLayer,scintillatorMaterial,"SideMuScintiLayer");
