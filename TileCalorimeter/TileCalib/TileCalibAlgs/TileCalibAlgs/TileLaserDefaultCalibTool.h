...
class TileLaserDefaultCalibTool : public AlgTool, virtual public ITileCalibTool
{
 ...
 private:
  ...
  RunningStat* meantime[4];
  RunningStat* diode_signal[4];
  RunningStat* PMT_signal[2];
  RunningStat* time[4][64][48][2];
  RunningStat* signal[4][64][48][2];
  RunningStat* ratio[4][4][64][48][2];
  RunningStat* m_reducedKappa[4][64][22][2];
