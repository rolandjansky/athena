...
#ifndef TILESIMALGS_TILEDIGITSMAKERQIE_H
#define TILESIMALGS_TILEDIGITSMAKERQIE_H
 ...
 */
class TileDigitsMakerQIE: public AthAlgorithm {
  public:
    // Constructor
    TileDigitsMakerQIE(std::string name, ISvcLocator* pSvcLocator);

    //Destructor 
    virtual ~TileDigitsMakerQIE();
  ...
  private:
    ...
    //in ns (offset of the integration window to the in-time hits with slightly negative time into the sample #3
    float m_time_offset;

};

#endif // TILESIMALGS_TILEDIGITSMAKERQIE_H
