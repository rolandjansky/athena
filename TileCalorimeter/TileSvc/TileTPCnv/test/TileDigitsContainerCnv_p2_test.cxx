...
*/
/**
 * @file TileTPCnv/test/TileDigitsContainerCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Nov, 2019
 * @brief Tests for TileDigitsContainerCnv_p2.
 */
...
void testit (const TileDigitsContainer& trans1)
{
  ...
  TileDigitsContainerCnv_p2 cnv;
  TileDigitsContainer_p2 pers;
...
void test1 ATLAS_NOT_THREAD_SAFE (const TileID& tileid)
{
  ...
  std::unique_ptr<const TileDigitsContainer> trans1 = makecont (tileid);
...
{
  std::cout << "TileTPCnv/TileDigitsContainerCnv_p2_test\n";
  IdDictParser parser;
