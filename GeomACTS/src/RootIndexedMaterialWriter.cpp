...
#include "GeomACTS/RootIndexedMaterialWriter.hpp"
#include <ios>
#include <iostream>
#include <stdexcept>
...
Acts::RootIndexedMaterialWriter::RootIndexedMaterialWriter(
    Acts::RootIndexedMaterialWriter::Config& cfg)
  : m_cfg(std::move(cfg))
...
void
Acts::RootIndexedMaterialWriter::write(
