  ...
  def check_files_dirs(self):
    ...
    if self.gccxmlpath :
      if sys.platform == 'win32' :
        self.gccxml = self.gccxmlpath + os.sep + 'gccxml_plugin.exe'
      else :
        self.gccxml = self.gccxmlpath + os.sep + 'gccxml_plugin'
    ...
    if len(self.gccxml) == 0 :
      if self.which('gccxml_plugin') :
        self.gccxml = 'gccxml_plugin'
        print '--->> genreflex: INFO: Using gccxml_plugin from', self.which('gccxml_plugin')
      else :
        print '--->> genreflex: ERROR: Cannot find gccxml_plugin script, aborting!'
        sys.exit(1)
    #---------------Open selection file-------------------
    try :
