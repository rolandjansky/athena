...
#ifndef VP1TrackPlugin_VP1AutoFactory_H
#define VP1TrackPlugin_VP1AutoFactory_H
...
class VP1TrackPlugin_VP1AutoFactory : public QObject, public IVP1ChannelWidgetFactory
{
  Q_OBJECT
  Q_PLUGIN_METADATA(IID "VP1TrackPlugin" )
