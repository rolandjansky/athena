...
#include "ui_perelectroncollectionsettings_form.h"
...
class ElectronCollectionSettingsButton::Imp {
public:
  ...
  : VP1MaterialButtonBase(parent,0,"VP1MaterialButton"), m_d(new Imp)
{
  ...
  m_d->trackDrawStyle->setName("ElectronDrawStyle");
  ...
  m_d->trackLightModel->setName("ElectronLightModel");
...
// QWidget& ElectronCollectionSettingsButton::editWindow() {
//   if (!m_d->editwindow)
//     initEditWindow();
//   return *(m_d->editwindow);color
// } 
...
void ElectronCollectionSettingsButton::updateButton()
{
  if (objectName().isEmpty())
    setObjectName("ElectronCollectionSettingsButton");
...
{  
	// std::cout<<"ElectronCollectionSettingsButton::setMaterial with mat="<<mat<<std::endl;
...
// }
// 
// void ElectronCollectionSettingsButton::setParameterMaterial(SoMaterial*, xAOD::ParameterPosition){
//   // FIXME!
// }
...
bool ElectronCollectionSettingsButton::showParameters() const
{
  if (!m_d->editwindow)
    m_d->initEditWindow();
  messageVerbose("ElectronCollectionSettingsButton::showParameters returning  "+str(m_d->editwindow_ui.checkBox_showparameters->isChecked()));
...
bool ElectronCollectionSettingsButton::colourParametersByType() const
{
  if (!m_d->editwindow)
    m_d->initEditWindow();
  messageVerbose("ElectronCollectionSettingsButton::colourParametersByType returning  "+str(m_d->editwindow_ui.checkBox_parameters_colourByType->isChecked()));
...
{
  messageVerbose("ElectronCollectionSettingsButton::possibleChange_showParameters emitting showParametersChanged  ");
...
{
  messageVerbose("ElectronCollectionSettingsButton::possibleChange_parameterColours emitting  colourParametersByTypeChanged ");
