...
{
  GLshort i(0), j(0), in = 0, out = 0, in0[5], in1[5], out0[5], out1[5];
  for (unsigned k=0;k<5;++k)
    in0[k]=in1[k]=out0[k]=out1[k]=0;
  GLint type;
  GLfloat d[5];
...
static void gl2psPrintSVGPixmap(
#if defined(GL2PS_HAVE_LIBPNG)
GLfloat x, GLfloat y, GL2PSimage *pixmap
#else
GLfloat, GLfloat, GL2PSimage *
#endif
)
